...
void petersontest(void)
{
  ...
  38:	ba4b0b13          	addi	s6,s6,-1116 # bd8 <tournament_release+0x13a>
            printf("Parent process in critical section\n");
  3c:	00001a97          	auipc	s5,0x1
  40:	b74a8a93          	addi	s5,s5,-1164 # bb0 <tournament_release+0x112>
  44:	a891                	j	98 <petersontest+0x98>
        printf("Failed to create lock\n");
  46:	00001517          	auipc	a0,0x1
  4a:	b3a50513          	addi	a0,a0,-1222 # b80 <tournament_release+0xe2>
  ...
  64:	b3850513          	addi	a0,a0,-1224 # b98 <tournament_release+0xfa>
  ...
  bc:	b4850513          	addi	a0,a0,-1208 # c00 <tournament_release+0x162>
  ...
  e4:	b3850513          	addi	a0,a0,-1224 # c18 <tournament_release+0x17a>
 ...
 10c:	b3050513          	addi	a0,a0,-1232 # c38 <tournament_release+0x19a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c2:	79a50513          	addi	a0,a0,1946 # c58 <digits>
 4c6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 58e:	6ceb8b93          	addi	s7,s7,1742 # c58 <digits>
 ...
 6ce:	58690913          	addi	s2,s2,1414 # c50 <tournament_release+0x1b2>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 916:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 918:	ecbd                	bnez	s1,996 <tournament_create+0xa2>
  if (n <= 1) 
 91a:	4785                	li	a5,1
 91c:	0937d763          	bge	a5,s3,9aa <tournament_create+0xb6>
  int l = 0;
 920:	8726                	mv	a4,s1
 922:	87ce                	mv	a5,s3
  while (n > 1) {
 924:	458d                	li	a1,3
    n /= 2;
 926:	86be                	mv	a3,a5
 928:	01f7d61b          	srliw	a2,a5,0x1f
 92c:	9fb1                	addw	a5,a5,a2
 92e:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 932:	2705                	addiw	a4,a4,1
  while (n > 1) {
 934:	fed5c9e3          	blt	a1,a3,926 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 938:	00000797          	auipc	a5,0x0
 93c:	6ce7aa23          	sw	a4,1748(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 940:	00000917          	auipc	s2,0x0
 944:	6e090913          	addi	s2,s2,1760 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 948:	00000097          	auipc	ra,0x0
 94c:	b12080e7          	jalr	-1262(ra) # 45a <peterson_create>
 950:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 954:	04054063          	bltz	a0,994 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 958:	2485                	addiw	s1,s1,1
 95a:	0911                	addi	s2,s2,4
 95c:	ff44c6e3          	blt	s1,s4,948 <tournament_create+0x54>
 ...
 964:	6a07a423          	sw	zero,1704(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 968:	4785                	li	a5,1
 96a:	0537d863          	bge	a5,s3,9ba <tournament_create+0xc6>
 96e:	4485                	li	s1,1
        int pid = fork() ;
 970:	00000097          	auipc	ra,0x0
 974:	a42080e7          	jalr	-1470(ra) # 3b2 <fork>
        if(pid < 0)
 978:	02054763          	bltz	a0,9a6 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 97c:	c509                	beqz	a0,986 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 97e:	2485                	addiw	s1,s1,1
 980:	fe9998e3          	bne	s3,s1,970 <tournament_create+0x7c>
 984:	a81d                	j	9ba <tournament_create+0xc6>
            trnmnt_idx = i ;
 986:	00000797          	auipc	a5,0x0
 98a:	6897a123          	sw	s1,1666(a5) # 1008 <trnmnt_idx>
            break ;
 98e:	a035                	j	9ba <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 990:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 9a4:	8082                	ret
            return -1 ;
 9a6:	557d                	li	a0,-1
 9a8:	b7fd                	j	996 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 9aa:	00000797          	auipc	a5,0x0
 9ae:	6607a123          	sw	zero,1634(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 9b2:	00000797          	auipc	a5,0x0
 9b6:	6407ab23          	sw	zero,1622(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 9ba:	00000517          	auipc	a0,0x0
 9be:	64e52503          	lw	a0,1614(a0) # 1008 <trnmnt_idx>
 9c2:	bfd1                	j	996 <tournament_create+0xa2>

00000000000009c4 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9c4:	00000797          	auipc	a5,0x0
 9c8:	6447a783          	lw	a5,1604(a5) # 1008 <trnmnt_idx>
 9cc:	0a07c763          	bltz	a5,a7a <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 9d0:	715d                	addi	sp,sp,-80
 9d2:	e486                	sd	ra,72(sp)
 9d4:	e0a2                	sd	s0,64(sp)
 9d6:	fc26                	sd	s1,56(sp)
 9d8:	f84a                	sd	s2,48(sp)
 9da:	f44e                	sd	s3,40(sp)
 9dc:	f052                	sd	s4,32(sp)
 9de:	ec56                	sd	s5,24(sp)
 9e0:	e85a                	sd	s6,16(sp)
 9e2:	e45e                	sd	s7,8(sp)
 9e4:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9e6:	00000497          	auipc	s1,0x0
 9ea:	6264a483          	lw	s1,1574(s1) # 100c <num_levels>
 9ee:	08905863          	blez	s1,a7e <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9f2:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9f4:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9f8:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 9fc:	4705                	li	a4,1
 9fe:	0097173b          	sllw	a4,a4,s1
 a02:	9fb9                	addw	a5,a5,a4
 a04:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a06:	4739                	li	a4,14
 a08:	06f74d63          	blt	a4,a5,a82 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a0c:	00000997          	auipc	s3,0x0
 a10:	61498993          	addi	s3,s3,1556 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a14:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a16:	00000b97          	auipc	s7,0x0
 a1a:	5f6b8b93          	addi	s7,s7,1526 # 100c <num_levels>
 a1e:	00000b17          	auipc	s6,0x0
 a22:	5eab0b13          	addi	s6,s6,1514 # 1008 <trnmnt_idx>
 a26:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a28:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a2a:	078a                	slli	a5,a5,0x2
 a2c:	97ce                	add	a5,a5,s3
 a2e:	4388                	lw	a0,0(a5)
 a30:	00000097          	auipc	ra,0x0
 a34:	a32080e7          	jalr	-1486(ra) # 462 <peterson_acquire>
 a38:	04054763          	bltz	a0,a86 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a3c:	fff4869b          	addiw	a3,s1,-1
 a40:	0006849b          	sext.w	s1,a3
 a44:	03448963          	beq	s1,s4,a76 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a48:	000ba703          	lw	a4,0(s7)
 a4c:	40d706bb          	subw	a3,a4,a3
 a50:	fff6879b          	addiw	a5,a3,-1
 a54:	000b2703          	lw	a4,0(s6)
 a58:	00f915bb          	sllw	a1,s2,a5
 a5c:	8df9                	and	a1,a1,a4
 a5e:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a62:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a66:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a6a:	9fb9                	addw	a5,a5,a4
 a6c:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a6e:	fafadee3          	bge	s5,a5,a2a <tournament_acquire+0x66>
 a72:	557d                	li	a0,-1
 a74:	a811                	j	a88 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 a76:	4501                	li	a0,0
 a78:	a801                	j	a88 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a7a:	557d                	li	a0,-1
}
 a7c:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a7e:	557d                	li	a0,-1
 a80:	a021                	j	a88 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a82:	557d                	li	a0,-1
 a84:	a011                	j	a88 <tournament_acquire+0xc4>
        return -1;
 a86:	557d                	li	a0,-1
}
 a88:	60a6                	ld	ra,72(sp)
 a8a:	6406                	ld	s0,64(sp)
 a8c:	74e2                	ld	s1,56(sp)
 a8e:	7942                	ld	s2,48(sp)
...
int tournament_release(void) {
 ...
 aa6:	0a07c663          	bltz	a5,b52 <tournament_release+0xb4>
 aaa:	00000717          	auipc	a4,0x0
 aae:	56272703          	lw	a4,1378(a4) # 100c <num_levels>
 ab2:	0ae05263          	blez	a4,b56 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ab6:	fff7069b          	addiw	a3,a4,-1
 aba:	4585                	li	a1,1
 abc:	00d595bb          	sllw	a1,a1,a3
 ac0:	8dfd                	and	a1,a1,a5
 ac2:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ac6:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 aca:	4739                	li	a4,14
 acc:	08f74763          	blt	a4,a5,b5a <tournament_release+0xbc>
int tournament_release(void) {
 ...
 aea:	53a98993          	addi	s3,s3,1338 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 aee:	00000a17          	auipc	s4,0x0
 af2:	51ea0a13          	addi	s4,s4,1310 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 af6:	00000b17          	auipc	s6,0x0
 afa:	512b0b13          	addi	s6,s6,1298 # 1008 <trnmnt_idx>
 afe:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b00:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 b02:	078a                	slli	a5,a5,0x2
 b04:	97ce                	add	a5,a5,s3
 b06:	4388                	lw	a0,0(a5)
 b08:	00000097          	auipc	ra,0x0
 b0c:	962080e7          	jalr	-1694(ra) # 46a <peterson_release>
 b10:	04054763          	bltz	a0,b5e <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 b14:	0014871b          	addiw	a4,s1,1
 b18:	0007049b          	sext.w	s1,a4
 b1c:	000a2783          	lw	a5,0(s4)
 b20:	02f4d763          	bge	s1,a5,b4e <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b24:	40e7873b          	subw	a4,a5,a4
 b28:	fff7079b          	addiw	a5,a4,-1
 b2c:	000b2683          	lw	a3,0(s6)
 b30:	00f915bb          	sllw	a1,s2,a5
 b34:	8df5                	and	a1,a1,a3
 b36:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b3a:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b3e:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 b42:	9fb9                	addw	a5,a5,a4
 b44:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b46:	fafadee3          	bge	s5,a5,b02 <tournament_release+0x64>
 b4a:	557d                	li	a0,-1
 b4c:	a811                	j	b60 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 b4e:	4501                	li	a0,0
 b50:	a801                	j	b60 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b52:	557d                	li	a0,-1
 b54:	8082                	ret
 b56:	557d                	li	a0,-1
