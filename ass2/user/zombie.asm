...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	6c250513          	addi	a0,a0,1730 # a78 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 486:	5f6b8b93          	addi	s7,s7,1526 # a78 <digits>
 ...
 5c6:	4ae90913          	addi	s2,s2,1198 # a70 <tournament_release+0xda>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 7fc:	fff5071b          	addiw	a4,a0,-1
 800:	47bd                	li	a5,15
 802:	00e7ee63          	bltu	a5,a4,81e <tournament_create+0x32>
 806:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 808:	8a3a                	mv	s4,a4
 80a:	00e574b3          	and	s1,a0,a4
 80e:	c0b9                	beqz	s1,854 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 810:	54fd                	li	s1,-1
 812:	a809                	j	824 <tournament_create+0x38>
 ...
 818:	7e97aa23          	sw	s1,2036(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 81c:	a021                	j	824 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 81e:	54fd                	li	s1,-1
 820:	a011                	j	824 <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 834:	8082                	ret
            return -1 ;
 836:	54fd                	li	s1,-1
 838:	b7f5                	j	824 <tournament_create+0x38>
   num_levels = log2(processes) ;
 83a:	00000797          	auipc	a5,0x0
 83e:	7c07ab23          	sw	zero,2006(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 842:	00000797          	auipc	a5,0x0
 846:	7c07a323          	sw	zero,1990(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 84a:	00000497          	auipc	s1,0x0
 84e:	7be4a483          	lw	s1,1982(s1) # 1008 <trnmnt_idx>
 852:	bfc9                	j	824 <tournament_create+0x38>
   num_processes = processes ;
 854:	00000797          	auipc	a5,0x0
 858:	7aa7ac23          	sw	a0,1976(a5) # 100c <num_processes>
  if (n <= 1) 
 85c:	4785                	li	a5,1
 85e:	fca7dee3          	bge	a5,a0,83a <tournament_create+0x4e>
  int l = 0;
 862:	8726                	mv	a4,s1
 864:	87aa                	mv	a5,a0
  while (n > 1) {
 866:	458d                	li	a1,3
    n /= 2;
 868:	86be                	mv	a3,a5
 86a:	01f7d61b          	srliw	a2,a5,0x1f
 86e:	9fb1                	addw	a5,a5,a2
 870:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 874:	2705                	addiw	a4,a4,1
  while (n > 1) {
 876:	fed5c9e3          	blt	a1,a3,868 <tournament_create+0x7c>
   num_levels = log2(processes) ;
 87a:	00000797          	auipc	a5,0x0
 87e:	78e7ab23          	sw	a4,1942(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 882:	00000917          	auipc	s2,0x0
 886:	7ae90913          	addi	s2,s2,1966 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 88a:	00000097          	auipc	ra,0x0
 88e:	ac8080e7          	jalr	-1336(ra) # 352 <peterson_create>
 892:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 896:	f80546e3          	bltz	a0,822 <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 89a:	2485                	addiw	s1,s1,1
 89c:	0911                	addi	s2,s2,4
 89e:	ff44c6e3          	blt	s1,s4,88a <tournament_create+0x9e>
   trnmnt_idx = 0;
 8a2:	00000797          	auipc	a5,0x0
 8a6:	7607a323          	sw	zero,1894(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 8aa:	4785                	li	a5,1
 8ac:	f937dfe3          	bge	a5,s3,84a <tournament_create+0x5e>
 8b0:	4485                	li	s1,1
        int pid = fork() ;
 8b2:	00000097          	auipc	ra,0x0
 8b6:	9f8080e7          	jalr	-1544(ra) # 2aa <fork>
        if(pid < 0)
 8ba:	f6054ee3          	bltz	a0,836 <tournament_create+0x4a>
        if(pid == 0){
 8be:	d939                	beqz	a0,814 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 8c0:	2485                	addiw	s1,s1,1
 8c2:	fe9998e3          	bne	s3,s1,8b2 <tournament_create+0xc6>
 8c6:	b751                	j	84a <tournament_create+0x5e>

00000000000008c8 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 8c8:	00000797          	auipc	a5,0x0
 8cc:	7407a783          	lw	a5,1856(a5) # 1008 <trnmnt_idx>
 8d0:	0a07cd63          	bltz	a5,98a <tournament_acquire+0xc2>
 8d4:	00000717          	auipc	a4,0x0
 8d8:	73c72703          	lw	a4,1852(a4) # 1010 <num_levels>
 8dc:	0ae05963          	blez	a4,98e <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 8e0:	fff7069b          	addiw	a3,a4,-1
 8e4:	4585                	li	a1,1
 8e6:	00d595bb          	sllw	a1,a1,a3
 8ea:	8dfd                	and	a1,a1,a5
 8ec:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 8f0:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 8f4:	4739                	li	a4,14
 8f6:	08f74e63          	blt	a4,a5,992 <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 910:	00000a17          	auipc	s4,0x0
 914:	720a0a13          	addi	s4,s4,1824 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 918:	00000997          	auipc	s3,0x0
 91c:	6f898993          	addi	s3,s3,1784 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 920:	00000b17          	auipc	s6,0x0
 924:	6e8b0b13          	addi	s6,s6,1768 # 1008 <trnmnt_idx>
 928:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 92a:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 92c:	078a                	slli	a5,a5,0x2
 92e:	97d2                	add	a5,a5,s4
 930:	4388                	lw	a0,0(a5)
 932:	00000097          	auipc	ra,0x0
 936:	a28080e7          	jalr	-1496(ra) # 35a <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 93a:	0014871b          	addiw	a4,s1,1
 93e:	0007049b          	sext.w	s1,a4
 942:	0009a783          	lw	a5,0(s3)
 946:	02f4d763          	bge	s1,a5,974 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 94a:	40e7873b          	subw	a4,a5,a4
 94e:	fff7079b          	addiw	a5,a4,-1
 952:	000b2683          	lw	a3,0(s6)
 956:	00f915bb          	sllw	a1,s2,a5
 95a:	8df5                	and	a1,a1,a3
 95c:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 960:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 964:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 968:	9fb9                	addw	a5,a5,a4
 96a:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 96c:	fcfad0e3          	bge	s5,a5,92c <tournament_acquire+0x64>
 970:	557d                	li	a0,-1
 972:	a011                	j	976 <tournament_acquire+0xae>
...
0000000000000996 <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 996:	00000797          	auipc	a5,0x0
 99a:	6727a783          	lw	a5,1650(a5) # 1008 <trnmnt_idx>
 99e:	0a07cf63          	bltz	a5,a5c <tournament_release+0xc6>
int tournament_release(void) {
 9a2:	715d                	addi	sp,sp,-80
 9a4:	e486                	sd	ra,72(sp)
 9a6:	e0a2                	sd	s0,64(sp)
 9a8:	fc26                	sd	s1,56(sp)
 9aa:	f84a                	sd	s2,48(sp)
 9ac:	f44e                	sd	s3,40(sp)
 9ae:	f052                	sd	s4,32(sp)
 9b0:	ec56                	sd	s5,24(sp)
 9b2:	e85a                	sd	s6,16(sp)
 9b4:	e45e                	sd	s7,8(sp)
 9b6:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9b8:	00000497          	auipc	s1,0x0
 9bc:	6584a483          	lw	s1,1624(s1) # 1010 <num_levels>
 9c0:	0a905063          	blez	s1,a60 <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 9c4:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9c6:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9ca:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 9ce:	4705                	li	a4,1
 9d0:	0097173b          	sllw	a4,a4,s1
 9d4:	9fb9                	addw	a5,a5,a4
 9d6:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9d8:	4739                	li	a4,14
 9da:	08f74563          	blt	a4,a5,a64 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 9de:	00000a17          	auipc	s4,0x0
 9e2:	652a0a13          	addi	s4,s4,1618 # 1030 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 9e6:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9e8:	00000b97          	auipc	s7,0x0
 9ec:	628b8b93          	addi	s7,s7,1576 # 1010 <num_levels>
 9f0:	00000b17          	auipc	s6,0x0
 9f4:	618b0b13          	addi	s6,s6,1560 # 1008 <trnmnt_idx>
 9f8:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9fa:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 9fc:	078a                	slli	a5,a5,0x2
 9fe:	97d2                	add	a5,a5,s4
 a00:	4388                	lw	a0,0(a5)
 a02:	00000097          	auipc	ra,0x0
 a06:	960080e7          	jalr	-1696(ra) # 362 <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a0a:	fff4869b          	addiw	a3,s1,-1
 a0e:	0006849b          	sext.w	s1,a3
 a12:	03348963          	beq	s1,s3,a44 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a16:	000ba703          	lw	a4,0(s7)
 a1a:	40d706bb          	subw	a3,a4,a3
 a1e:	fff6879b          	addiw	a5,a3,-1
 a22:	000b2703          	lw	a4,0(s6)
 a26:	00f915bb          	sllw	a1,s2,a5
 a2a:	8df9                	and	a1,a1,a4
 a2c:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a30:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a34:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a38:	9fb9                	addw	a5,a5,a4
 a3a:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a3c:	fcfad0e3          	bge	s5,a5,9fc <tournament_release+0x66>
 a40:	557d                	li	a0,-1
 a42:	a011                	j	a46 <tournament_release+0xb0>
...
return 0 ;
 ...
 a4a:	74e2                	ld	s1,56(sp)
 a4c:	7942                	ld	s2,48(sp)
 a4e:	79a2                	ld	s3,40(sp)
 a50:	7a02                	ld	s4,32(sp)
 a52:	6ae2                	ld	s5,24(sp)
 a54:	6b42                	ld	s6,16(sp)
 a56:	6ba2                	ld	s7,8(sp)
 ...
 a5e:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a60:	557d                	li	a0,-1
 a62:	b7d5                	j	a46 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a64:	557d                	li	a0,-1
 a66:	b7c5                	j	a46 <tournament_release+0xb0>
