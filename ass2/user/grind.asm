 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <lock_ids+0x1cf05>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <lock_ids+0x1d8f>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <lock_ids+0xffffffffffffd0d4>
...
int tournament_create(int processes) {
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    13ce:	fff5071b          	addiw	a4,a0,-1
    13d2:	47bd                	li	a5,15
    13d4:	08e7eb63          	bltu	a5,a4,146a <tournament_create+0x9c>
int tournament_create(int processes) {
    ...
    13e4:	e052                	sd	s4,0(sp)
    13e6:	1800                	addi	s0,sp,48
    13e8:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
    13ea:	8a3a                	mv	s4,a4
   ...
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    13f0:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
    13f2:	ecbd                	bnez	s1,1470 <tournament_create+0xa2>
  if (n <= 1) 
    13f4:	4785                	li	a5,1
    13f6:	0937d763          	bge	a5,s3,1484 <tournament_create+0xb6>
  int l = 0;
    13fa:	8726                	mv	a4,s1
    13fc:	87ce                	mv	a5,s3
  while (n > 1) {
    ...
    n /= 2;
    1400:	86be                	mv	a3,a5
    1402:	01f7d61b          	srliw	a2,a5,0x1f
    1406:	9fb1                	addw	a5,a5,a2
    1408:	4017d79b          	sraiw	a5,a5,0x1
    l++;
    140c:	2705                	addiw	a4,a4,1
  while (n > 1) {
    140e:	fed5c9e3          	blt	a1,a3,1400 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
    1412:	00001797          	auipc	a5,0x1
    1416:	c0e7a523          	sw	a4,-1014(a5) # 201c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
    141a:	00001917          	auipc	s2,0x1
    141e:	ffe90913          	addi	s2,s2,-2 # 2418 <lock_ids>
    lock_ids[i]= peterson_create() ;
    1422:	00000097          	auipc	ra,0x0
    1426:	b12080e7          	jalr	-1262(ra) # f34 <peterson_create>
    142a:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
    142e:	04054063          	bltz	a0,146e <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
    1432:	2485                	addiw	s1,s1,1
    1434:	0911                	addi	s2,s2,4
    1436:	ff44c6e3          	blt	s1,s4,1422 <tournament_create+0x54>
   ...
   trnmnt_idx = 0;
    ...
    143e:	bc07af23          	sw	zero,-1058(a5) # 2018 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
    1442:	4785                	li	a5,1
    1444:	0537d863          	bge	a5,s3,1494 <tournament_create+0xc6>
    1448:	4485                	li	s1,1
        int pid = fork() ;
    144a:	00000097          	auipc	ra,0x0
    144e:	a42080e7          	jalr	-1470(ra) # e8c <fork>
        if(pid < 0)
    1452:	02054763          	bltz	a0,1480 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
    1456:	c509                	beqz	a0,1460 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
    1458:	2485                	addiw	s1,s1,1
    145a:	fe9998e3          	bne	s3,s1,144a <tournament_create+0x7c>
    145e:	a81d                	j	1494 <tournament_create+0xc6>
            trnmnt_idx = i ;
    1460:	00001797          	auipc	a5,0x1
    1464:	ba97ac23          	sw	s1,-1096(a5) # 2018 <trnmnt_idx>
            break ;
    1468:	a035                	j	1494 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    146a:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
    ...
    1470:	70a2                	ld	ra,40(sp)
    1472:	7402                	ld	s0,32(sp)
    1474:	64e2                	ld	s1,24(sp)
    1476:	6942                	ld	s2,16(sp)
    1478:	69a2                	ld	s3,8(sp)
    147a:	6a02                	ld	s4,0(sp)
    147c:	6145                	addi	sp,sp,48
    147e:	8082                	ret
            return -1 ;
    1480:	557d                	li	a0,-1
    1482:	b7fd                	j	1470 <tournament_create+0xa2>
   num_levels = log2(processes) ;
    1484:	00001797          	auipc	a5,0x1
    1488:	b807ac23          	sw	zero,-1128(a5) # 201c <num_levels>
   trnmnt_idx = 0;
    148c:	00001797          	auipc	a5,0x1
    1490:	b807a623          	sw	zero,-1140(a5) # 2018 <trnmnt_idx>
return trnmnt_idx ;
    1494:	00001517          	auipc	a0,0x1
    1498:	b8452503          	lw	a0,-1148(a0) # 2018 <trnmnt_idx>
    149c:	bfd1                	j	1470 <tournament_create+0xa2>

000000000000149e <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    149e:	00001797          	auipc	a5,0x1
    14a2:	b7a7a783          	lw	a5,-1158(a5) # 2018 <trnmnt_idx>
    14a6:	0a07c763          	bltz	a5,1554 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
    14aa:	715d                	addi	sp,sp,-80
    14ac:	e486                	sd	ra,72(sp)
    14ae:	e0a2                	sd	s0,64(sp)
    14b0:	fc26                	sd	s1,56(sp)
    14b2:	f84a                	sd	s2,48(sp)
    14b4:	f44e                	sd	s3,40(sp)
    14b6:	f052                	sd	s4,32(sp)
    14b8:	ec56                	sd	s5,24(sp)
    14ba:	e85a                	sd	s6,16(sp)
    14bc:	e45e                	sd	s7,8(sp)
    14be:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    14c0:	00001497          	auipc	s1,0x1
    14c4:	b5c4a483          	lw	s1,-1188(s1) # 201c <num_levels>
    14c8:	08905863          	blez	s1,1558 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    14cc:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    14ce:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    14d2:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
    14d6:	4705                	li	a4,1
    14d8:	0097173b          	sllw	a4,a4,s1
    14dc:	9fb9                	addw	a5,a5,a4
    14de:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    14e0:	4739                	li	a4,14
    14e2:	06f74d63          	blt	a4,a5,155c <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
    14e6:	00001997          	auipc	s3,0x1
    14ea:	f3298993          	addi	s3,s3,-206 # 2418 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    14ee:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    14f0:	00001b97          	auipc	s7,0x1
    14f4:	b2cb8b93          	addi	s7,s7,-1236 # 201c <num_levels>
    14f8:	00001b17          	auipc	s6,0x1
    14fc:	b20b0b13          	addi	s6,s6,-1248 # 2018 <trnmnt_idx>
    1500:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1502:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
    1504:	078a                	slli	a5,a5,0x2
    1506:	97ce                	add	a5,a5,s3
    1508:	4388                	lw	a0,0(a5)
    150a:	00000097          	auipc	ra,0x0
    150e:	a32080e7          	jalr	-1486(ra) # f3c <peterson_acquire>
    1512:	04054763          	bltz	a0,1560 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    1516:	fff4869b          	addiw	a3,s1,-1
    151a:	0006849b          	sext.w	s1,a3
    151e:	03448963          	beq	s1,s4,1550 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    1522:	000ba703          	lw	a4,0(s7)
    1526:	40d706bb          	subw	a3,a4,a3
    152a:	fff6879b          	addiw	a5,a3,-1
    152e:	000b2703          	lw	a4,0(s6)
    1532:	00f915bb          	sllw	a1,s2,a5
    1536:	8df9                	and	a1,a1,a4
    1538:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    153c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    1540:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
    1544:	9fb9                	addw	a5,a5,a4
    1546:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1548:	fafadee3          	bge	s5,a5,1504 <tournament_acquire+0x66>
    154c:	557d                	li	a0,-1
    154e:	a811                	j	1562 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
    1550:	4501                	li	a0,0
    1552:	a801                	j	1562 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    1554:	557d                	li	a0,-1
}
    1556:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    1558:	557d                	li	a0,-1
    155a:	a021                	j	1562 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
    155c:	557d                	li	a0,-1
    155e:	a011                	j	1562 <tournament_acquire+0xc4>
        return -1;
    1560:	557d                	li	a0,-1
}
    1562:	60a6                	ld	ra,72(sp)
    1564:	6406                	ld	s0,64(sp)
    1566:	74e2                	ld	s1,56(sp)
    1568:	7942                	ld	s2,48(sp)
    156a:	79a2                	ld	s3,40(sp)
    156c:	7a02                	ld	s4,32(sp)
    156e:	6ae2                	ld	s5,24(sp)
    1570:	6b42                	ld	s6,16(sp)
    1572:	6ba2                	ld	s7,8(sp)
    1574:	6161                	addi	sp,sp,80
    1576:	8082                	ret
...
int tournament_release(void) {
    ...
    1580:	0a07c663          	bltz	a5,162c <tournament_release+0xb4>
    1584:	00001717          	auipc	a4,0x1
    1588:	a9872703          	lw	a4,-1384(a4) # 201c <num_levels>
    158c:	0ae05263          	blez	a4,1630 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    1590:	fff7069b          	addiw	a3,a4,-1
    1594:	4585                	li	a1,1
    1596:	00d595bb          	sllw	a1,a1,a3
    159a:	8dfd                	and	a1,a1,a5
    159c:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    15a0:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
    15a4:	4739                	li	a4,14
    15a6:	08f74763          	blt	a4,a5,1634 <tournament_release+0xbc>
int tournament_release(void) {
    ...
    15bc:	0080                	addi	s0,sp,64
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    15be:	4481                	li	s1,0

        if (peterson_release(lock_ids[lockidx] , role) < 0)
    15c0:	00001997          	auipc	s3,0x1
    15c4:	e5898993          	addi	s3,s3,-424 # 2418 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    15c8:	00001a17          	auipc	s4,0x1
    15cc:	a54a0a13          	addi	s4,s4,-1452 # 201c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    15d0:	00001b17          	auipc	s6,0x1
    15d4:	a48b0b13          	addi	s6,s6,-1464 # 2018 <trnmnt_idx>
    15d8:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    15da:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
    15dc:	078a                	slli	a5,a5,0x2
    15de:	97ce                	add	a5,a5,s3
    15e0:	4388                	lw	a0,0(a5)
    15e2:	00000097          	auipc	ra,0x0
    15e6:	962080e7          	jalr	-1694(ra) # f44 <peterson_release>
    15ea:	04054763          	bltz	a0,1638 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    15ee:	0014871b          	addiw	a4,s1,1
    15f2:	0007049b          	sext.w	s1,a4
    15f6:	000a2783          	lw	a5,0(s4)
    15fa:	02f4d763          	bge	s1,a5,1628 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    15fe:	40e7873b          	subw	a4,a5,a4
    1602:	fff7079b          	addiw	a5,a4,-1
    1606:	000b2683          	lw	a3,0(s6)
    160a:	00f915bb          	sllw	a1,s2,a5
    160e:	8df5                	and	a1,a1,a3
    1610:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    1614:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    1618:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
    161c:	9fb9                	addw	a5,a5,a4
    161e:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1620:	fafadee3          	bge	s5,a5,15dc <tournament_release+0x64>
    1624:	557d                	li	a0,-1
    1626:	a811                	j	163a <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
    1628:	4501                	li	a0,0
    162a:	a801                	j	163a <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    162c:	557d                	li	a0,-1
    162e:	8082                	ret
    1630:	557d                	li	a0,-1
    ...
    1648:	6b02                	ld	s6,0(sp)
    164a:	6121                	addi	sp,sp,64
    164c:	8082                	ret
