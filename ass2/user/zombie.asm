...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c6:	2ce90913          	addi	s2,s2,718 # 890 <tournament_release+0x10>
        while(*s != 0){
 ...
 6bc:	00e6ea63          	bltu	a3,a4,6d0 <free+0x50>
{
 ...
 6fe:	90f73b23          	sd	a5,-1770(a4) # 1010 <freep>
}
 702:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 730:	8e453503          	ld	a0,-1820(a0) # 1010 <freep>
 ...
 758:	8bc90913          	addi	s2,s2,-1860 # 1010 <freep>
  if(p == (char*)-1)
 75c:	5afd                	li	s5,-1
 75e:	a88d                	j	7d0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 760:	00001797          	auipc	a5,0x1
 764:	8d078793          	addi	a5,a5,-1840 # 1030 <base>
 ...
 792:	88a73123          	sd	a0,-1918(a4) # 1010 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 7f0:	47bd                	li	a5,15
 7f2:	00e7eb63          	bltu	a5,a4,808 <tournament_create+0x1c>
 7f6:	fff5079b          	addiw	a5,a0,-1
 7fa:	8fe9                	and	a5,a5,a0
 7fc:	2781                	sext.w	a5,a5
 7fe:	c799                	beqz	a5,80c <tournament_create+0x20>
}
 ...
 802:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 804:	557d                	li	a0,-1
 806:	a095                	j	86a <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 808:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 818:	80a7a623          	sw	a0,-2036(a5) # 1020 <num_processes>
   while(temp >>=1)
 81c:	4015551b          	sraiw	a0,a0,0x1
 820:	c105                	beqz	a0,840 <tournament_create+0x54>
 822:	00001797          	auipc	a5,0x1
 826:	8027a783          	lw	a5,-2046(a5) # 1024 <num_levels>
 82a:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 82c:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 830:	4015551b          	sraiw	a0,a0,0x1
 834:	2785                	addiw	a5,a5,1
 836:	f97d                	bnez	a0,82c <tournament_create+0x40>
 838:	00000797          	auipc	a5,0x0
 83c:	7ee7a623          	sw	a4,2028(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 840:	00000797          	auipc	a5,0x0
 844:	7e47a783          	lw	a5,2020(a5) # 1024 <num_levels>
 848:	4505                	li	a0,1
 84a:	00f5153b          	sllw	a0,a0,a5
 84e:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 850:	0025151b          	slliw	a0,a0,0x2
 854:	00000097          	auipc	ra,0x0
 858:	eb4080e7          	jalr	-332(ra) # 708 <malloc>
 85c:	87aa                	mv	a5,a0
 85e:	00000717          	auipc	a4,0x0
 862:	7aa73d23          	sd	a0,1978(a4) # 1018 <lock_ids>
    return 1 ;    
 866:	4505                	li	a0,1
    if (!lock_ids)
 868:	dfd1                	beqz	a5,804 <tournament_create+0x18>
}
 86a:	60a2                	ld	ra,8(sp)
 86c:	6402                	ld	s0,0(sp)
...
0000000000000872 <tournament_acquire>:
...
0000000000000880 <tournament_release>:
