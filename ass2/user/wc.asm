...
wc(int fd, char *name)
{
  ...
  3c:	ba8a0a13          	addi	s4,s4,-1112 # be0 <tournament_release+0xde>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	b4250513          	addi	a0,a0,-1214 # bf8 <tournament_release+0xf6>
  ...
  e8:	b0450513          	addi	a0,a0,-1276 # be8 <tournament_release+0xe6>
...
main(int argc, char *argv[])
{
 ...
 162:	aaa58593          	addi	a1,a1,-1366 # c08 <tournament_release+0x106>
 166:	4501                	li	a0,0
 ...
 180:	a9450513          	addi	a0,a0,-1388 # c10 <tournament_release+0x10e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 526:	70e50513          	addi	a0,a0,1806 # c30 <digits>
 52a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f2:	642b8b93          	addi	s7,s7,1602 # c30 <digits>
 ...
 732:	4fa90913          	addi	s2,s2,1274 # c28 <tournament_release+0x126>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 95e:	ec26                	sd	s1,24(sp)
 960:	e84a                	sd	s2,16(sp)
 962:	e44e                	sd	s3,8(sp)
 964:	e052                	sd	s4,0(sp)
 966:	1800                	addi	s0,sp,48
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 968:	fff5071b          	addiw	a4,a0,-1
 96c:	47bd                	li	a5,15
 96e:	00e7ee63          	bltu	a5,a4,98a <tournament_create+0x32>
 972:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 974:	8a3a                	mv	s4,a4
 976:	00e574b3          	and	s1,a0,a4
 97a:	c0b9                	beqz	s1,9c0 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 97c:	54fd                	li	s1,-1
 97e:	a809                	j	990 <tournament_create+0x38>
 ...
 984:	6897a423          	sw	s1,1672(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 988:	a021                	j	990 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 98a:	54fd                	li	s1,-1
 98c:	a011                	j	990 <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 9a0:	8082                	ret
            return -1 ;
 9a2:	54fd                	li	s1,-1
 9a4:	b7f5                	j	990 <tournament_create+0x38>
   num_levels = log2(processes) ;
 9a6:	00000797          	auipc	a5,0x0
 9aa:	6607a523          	sw	zero,1642(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 9ae:	00000797          	auipc	a5,0x0
 9b2:	6407ad23          	sw	zero,1626(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 9b6:	00000497          	auipc	s1,0x0
 9ba:	6524a483          	lw	s1,1618(s1) # 1008 <trnmnt_idx>
 9be:	bfc9                	j	990 <tournament_create+0x38>
   num_processes = processes ;
 9c0:	00000797          	auipc	a5,0x0
 9c4:	64a7a623          	sw	a0,1612(a5) # 100c <num_processes>
  if (n <= 1) 
 9c8:	4785                	li	a5,1
 9ca:	fca7dee3          	bge	a5,a0,9a6 <tournament_create+0x4e>
  int l = 0;
 9ce:	8726                	mv	a4,s1
 9d0:	87aa                	mv	a5,a0
  while (n > 1) {
 9d2:	458d                	li	a1,3
    n /= 2;
 9d4:	86be                	mv	a3,a5
 9d6:	01f7d61b          	srliw	a2,a5,0x1f
 9da:	9fb1                	addw	a5,a5,a2
 9dc:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 9e0:	2705                	addiw	a4,a4,1
  while (n > 1) {
 9e2:	fed5c9e3          	blt	a1,a3,9d4 <tournament_create+0x7c>
   num_levels = log2(processes) ;
 9e6:	00000797          	auipc	a5,0x0
 9ea:	62e7a523          	sw	a4,1578(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 9ee:	00001917          	auipc	s2,0x1
 9f2:	84290913          	addi	s2,s2,-1982 # 1230 <lock_ids>
    lock_ids[i]= peterson_create() ;
 9f6:	00000097          	auipc	ra,0x0
 9fa:	ac8080e7          	jalr	-1336(ra) # 4be <peterson_create>
 9fe:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 a02:	f80546e3          	bltz	a0,98e <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 a06:	2485                	addiw	s1,s1,1
 a08:	0911                	addi	s2,s2,4
 a0a:	ff44c6e3          	blt	s1,s4,9f6 <tournament_create+0x9e>
   trnmnt_idx = 0;
 a0e:	00000797          	auipc	a5,0x0
 a12:	5e07ad23          	sw	zero,1530(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 a16:	4785                	li	a5,1
 a18:	f937dfe3          	bge	a5,s3,9b6 <tournament_create+0x5e>
 a1c:	4485                	li	s1,1
        int pid = fork() ;
 a1e:	00000097          	auipc	ra,0x0
 a22:	9f8080e7          	jalr	-1544(ra) # 416 <fork>
        if(pid < 0)
 a26:	f6054ee3          	bltz	a0,9a2 <tournament_create+0x4a>
        if(pid == 0){
 a2a:	d939                	beqz	a0,980 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 a2c:	2485                	addiw	s1,s1,1
 a2e:	fe9998e3          	bne	s3,s1,a1e <tournament_create+0xc6>
 a32:	b751                	j	9b6 <tournament_create+0x5e>

0000000000000a34 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a34:	00000797          	auipc	a5,0x0
 a38:	5d47a783          	lw	a5,1492(a5) # 1008 <trnmnt_idx>
 a3c:	0a07cd63          	bltz	a5,af6 <tournament_acquire+0xc2>
 a40:	00000717          	auipc	a4,0x0
 a44:	5d072703          	lw	a4,1488(a4) # 1010 <num_levels>
 a48:	0ae05963          	blez	a4,afa <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a4c:	fff7069b          	addiw	a3,a4,-1
 a50:	4585                	li	a1,1
 a52:	00d595bb          	sllw	a1,a1,a3
 a56:	8dfd                	and	a1,a1,a5
 a58:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a5c:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 a60:	4739                	li	a4,14
 a62:	08f74e63          	blt	a4,a5,afe <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 a7c:	00000a17          	auipc	s4,0x0
 a80:	7b4a0a13          	addi	s4,s4,1972 # 1230 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 a84:	00000997          	auipc	s3,0x0
 a88:	58c98993          	addi	s3,s3,1420 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a8c:	00000b17          	auipc	s6,0x0
 a90:	57cb0b13          	addi	s6,s6,1404 # 1008 <trnmnt_idx>
 a94:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a96:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 a98:	078a                	slli	a5,a5,0x2
 a9a:	97d2                	add	a5,a5,s4
 a9c:	4388                	lw	a0,0(a5)
 a9e:	00000097          	auipc	ra,0x0
 aa2:	a28080e7          	jalr	-1496(ra) # 4c6 <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 aa6:	0014871b          	addiw	a4,s1,1
 aaa:	0007049b          	sext.w	s1,a4
 aae:	0009a783          	lw	a5,0(s3)
 ab2:	02f4d763          	bge	s1,a5,ae0 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ab6:	40e7873b          	subw	a4,a5,a4
 aba:	fff7079b          	addiw	a5,a4,-1
 abe:	000b2683          	lw	a3,0(s6)
 ac2:	00f915bb          	sllw	a1,s2,a5
 ac6:	8df5                	and	a1,a1,a3
 ac8:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 acc:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ad0:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 ad4:	9fb9                	addw	a5,a5,a4
 ad6:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ad8:	fcfad0e3          	bge	s5,a5,a98 <tournament_acquire+0x64>
 adc:	557d                	li	a0,-1
 ade:	a011                	j	ae2 <tournament_acquire+0xae>
...
0000000000000b02 <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b02:	00000797          	auipc	a5,0x0
 b06:	5067a783          	lw	a5,1286(a5) # 1008 <trnmnt_idx>
 b0a:	0a07cf63          	bltz	a5,bc8 <tournament_release+0xc6>
int tournament_release(void) {
 b0e:	715d                	addi	sp,sp,-80
 b10:	e486                	sd	ra,72(sp)
 b12:	e0a2                	sd	s0,64(sp)
 b14:	fc26                	sd	s1,56(sp)
 b16:	f84a                	sd	s2,48(sp)
 b18:	f44e                	sd	s3,40(sp)
 b1a:	f052                	sd	s4,32(sp)
 b1c:	ec56                	sd	s5,24(sp)
 b1e:	e85a                	sd	s6,16(sp)
 b20:	e45e                	sd	s7,8(sp)
 b22:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b24:	00000497          	auipc	s1,0x0
 b28:	4ec4a483          	lw	s1,1260(s1) # 1010 <num_levels>
 b2c:	0a905063          	blez	s1,bcc <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 b30:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b32:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b36:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 b3a:	4705                	li	a4,1
 b3c:	0097173b          	sllw	a4,a4,s1
 b40:	9fb9                	addw	a5,a5,a4
 b42:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b44:	4739                	li	a4,14
 b46:	08f74563          	blt	a4,a5,bd0 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 b4a:	00000a17          	auipc	s4,0x0
 b4e:	6e6a0a13          	addi	s4,s4,1766 # 1230 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 b52:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b54:	00000b97          	auipc	s7,0x0
 b58:	4bcb8b93          	addi	s7,s7,1212 # 1010 <num_levels>
 b5c:	00000b17          	auipc	s6,0x0
 b60:	4acb0b13          	addi	s6,s6,1196 # 1008 <trnmnt_idx>
 b64:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b66:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 b68:	078a                	slli	a5,a5,0x2
 b6a:	97d2                	add	a5,a5,s4
 b6c:	4388                	lw	a0,0(a5)
 b6e:	00000097          	auipc	ra,0x0
 b72:	960080e7          	jalr	-1696(ra) # 4ce <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 b76:	fff4869b          	addiw	a3,s1,-1
 b7a:	0006849b          	sext.w	s1,a3
 b7e:	03348963          	beq	s1,s3,bb0 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b82:	000ba703          	lw	a4,0(s7)
 b86:	40d706bb          	subw	a3,a4,a3
 b8a:	fff6879b          	addiw	a5,a3,-1
 b8e:	000b2703          	lw	a4,0(s6)
 b92:	00f915bb          	sllw	a1,s2,a5
 b96:	8df9                	and	a1,a1,a4
 b98:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b9c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ba0:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 ba4:	9fb9                	addw	a5,a5,a4
 ba6:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ba8:	fcfad0e3          	bge	s5,a5,b68 <tournament_release+0x66>
 bac:	557d                	li	a0,-1
 bae:	a011                	j	bb2 <tournament_release+0xb0>
...
return 0 ;
 ...
 bb6:	74e2                	ld	s1,56(sp)
 bb8:	7942                	ld	s2,48(sp)
 bba:	79a2                	ld	s3,40(sp)
 bbc:	7a02                	ld	s4,32(sp)
 bbe:	6ae2                	ld	s5,24(sp)
 bc0:	6b42                	ld	s6,16(sp)
 bc2:	6ba2                	ld	s7,8(sp)
 ...
 bca:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 bcc:	557d                	li	a0,-1
 bce:	b7d5                	j	bb2 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 bd0:	557d                	li	a0,-1
 bd2:	b7c5                	j	bb2 <tournament_release+0xb0>
