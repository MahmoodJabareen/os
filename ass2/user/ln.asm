...
main(int argc, char *argv[])
{
  ...
  14:	a9058593          	addi	a1,a1,-1392 # aa0 <tournament_release+0xd4>
  18:	4509                	li	a0,2
  ...
  50:	a6c58593          	addi	a1,a1,-1428 # ab8 <tournament_release+0xec>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f0:	6ec50513          	addi	a0,a0,1772 # ad8 <digits>
 3f4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	620b8b93          	addi	s7,s7,1568 # ad8 <digits>
 ...
 5fc:	4d890913          	addi	s2,s2,1240 # ad0 <tournament_release+0x104>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 832:	fff5071b          	addiw	a4,a0,-1
 836:	47bd                	li	a5,15
 838:	00e7ee63          	bltu	a5,a4,854 <tournament_create+0x32>
 83c:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 83e:	8a3a                	mv	s4,a4
 840:	00e574b3          	and	s1,a0,a4
 844:	c0b9                	beqz	s1,88a <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 846:	54fd                	li	s1,-1
 848:	a809                	j	85a <tournament_create+0x38>
 ...
 84e:	7a97af23          	sw	s1,1982(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 852:	a021                	j	85a <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 854:	54fd                	li	s1,-1
 856:	a011                	j	85a <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 86a:	8082                	ret
            return -1 ;
 86c:	54fd                	li	s1,-1
 86e:	b7f5                	j	85a <tournament_create+0x38>
   num_levels = log2(processes) ;
 870:	00000797          	auipc	a5,0x0
 874:	7a07a023          	sw	zero,1952(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 878:	00000797          	auipc	a5,0x0
 87c:	7807a823          	sw	zero,1936(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 880:	00000497          	auipc	s1,0x0
 884:	7884a483          	lw	s1,1928(s1) # 1008 <trnmnt_idx>
 888:	bfc9                	j	85a <tournament_create+0x38>
   num_processes = processes ;
 88a:	00000797          	auipc	a5,0x0
 88e:	78a7a123          	sw	a0,1922(a5) # 100c <num_processes>
  if (n <= 1) 
 892:	4785                	li	a5,1
 894:	fca7dee3          	bge	a5,a0,870 <tournament_create+0x4e>
  int l = 0;
 898:	8726                	mv	a4,s1
 89a:	87aa                	mv	a5,a0
  while (n > 1) {
 89c:	458d                	li	a1,3
    n /= 2;
 89e:	86be                	mv	a3,a5
 8a0:	01f7d61b          	srliw	a2,a5,0x1f
 8a4:	9fb1                	addw	a5,a5,a2
 8a6:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 8aa:	2705                	addiw	a4,a4,1
  while (n > 1) {
 8ac:	fed5c9e3          	blt	a1,a3,89e <tournament_create+0x7c>
   num_levels = log2(processes) ;
 8b0:	00000797          	auipc	a5,0x0
 8b4:	76e7a023          	sw	a4,1888(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 8b8:	00000917          	auipc	s2,0x0
 8bc:	77890913          	addi	s2,s2,1912 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 8c0:	00000097          	auipc	ra,0x0
 8c4:	ac8080e7          	jalr	-1336(ra) # 388 <peterson_create>
 8c8:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 8cc:	f80546e3          	bltz	a0,858 <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 8d0:	2485                	addiw	s1,s1,1
 8d2:	0911                	addi	s2,s2,4
 8d4:	ff44c6e3          	blt	s1,s4,8c0 <tournament_create+0x9e>
   trnmnt_idx = 0;
 8d8:	00000797          	auipc	a5,0x0
 8dc:	7207a823          	sw	zero,1840(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 8e0:	4785                	li	a5,1
 8e2:	f937dfe3          	bge	a5,s3,880 <tournament_create+0x5e>
 8e6:	4485                	li	s1,1
        int pid = fork() ;
 8e8:	00000097          	auipc	ra,0x0
 8ec:	9f8080e7          	jalr	-1544(ra) # 2e0 <fork>
        if(pid < 0)
 8f0:	f6054ee3          	bltz	a0,86c <tournament_create+0x4a>
        if(pid == 0){
 8f4:	d939                	beqz	a0,84a <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 8f6:	2485                	addiw	s1,s1,1
 8f8:	fe9998e3          	bne	s3,s1,8e8 <tournament_create+0xc6>
 8fc:	b751                	j	880 <tournament_create+0x5e>

00000000000008fe <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 8fe:	00000797          	auipc	a5,0x0
 902:	70a7a783          	lw	a5,1802(a5) # 1008 <trnmnt_idx>
 906:	0a07cd63          	bltz	a5,9c0 <tournament_acquire+0xc2>
 90a:	00000717          	auipc	a4,0x0
 90e:	70672703          	lw	a4,1798(a4) # 1010 <num_levels>
 912:	0ae05963          	blez	a4,9c4 <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 916:	fff7069b          	addiw	a3,a4,-1
 91a:	4585                	li	a1,1
 91c:	00d595bb          	sllw	a1,a1,a3
 920:	8dfd                	and	a1,a1,a5
 922:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 926:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 92a:	4739                	li	a4,14
 92c:	08f74e63          	blt	a4,a5,9c8 <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 94a:	6eaa0a13          	addi	s4,s4,1770 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 94e:	00000997          	auipc	s3,0x0
 952:	6c298993          	addi	s3,s3,1730 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 956:	00000b17          	auipc	s6,0x0
 95a:	6b2b0b13          	addi	s6,s6,1714 # 1008 <trnmnt_idx>
 95e:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 960:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 962:	078a                	slli	a5,a5,0x2
 964:	97d2                	add	a5,a5,s4
 966:	4388                	lw	a0,0(a5)
 968:	00000097          	auipc	ra,0x0
 96c:	a28080e7          	jalr	-1496(ra) # 390 <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 970:	0014871b          	addiw	a4,s1,1
 974:	0007049b          	sext.w	s1,a4
 978:	0009a783          	lw	a5,0(s3)
 97c:	02f4d763          	bge	s1,a5,9aa <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 980:	40e7873b          	subw	a4,a5,a4
 984:	fff7079b          	addiw	a5,a4,-1
 988:	000b2683          	lw	a3,0(s6)
 98c:	00f915bb          	sllw	a1,s2,a5
 990:	8df5                	and	a1,a1,a3
 992:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 996:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 99a:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 99e:	9fb9                	addw	a5,a5,a4
 9a0:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9a2:	fcfad0e3          	bge	s5,a5,962 <tournament_acquire+0x64>
 9a6:	557d                	li	a0,-1
 9a8:	a011                	j	9ac <tournament_acquire+0xae>
...
00000000000009cc <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9cc:	00000797          	auipc	a5,0x0
 9d0:	63c7a783          	lw	a5,1596(a5) # 1008 <trnmnt_idx>
 9d4:	0a07cf63          	bltz	a5,a92 <tournament_release+0xc6>
int tournament_release(void) {
 ...
 9ea:	e45e                	sd	s7,8(sp)
 9ec:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9ee:	00000497          	auipc	s1,0x0
 9f2:	6224a483          	lw	s1,1570(s1) # 1010 <num_levels>
 9f6:	0a905063          	blez	s1,a96 <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 9fa:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9fc:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a00:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 a04:	4705                	li	a4,1
 a06:	0097173b          	sllw	a4,a4,s1
 a0a:	9fb9                	addw	a5,a5,a4
 a0c:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a0e:	4739                	li	a4,14
 a10:	08f74563          	blt	a4,a5,a9a <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 a14:	00000a17          	auipc	s4,0x0
 a18:	61ca0a13          	addi	s4,s4,1564 # 1030 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a1c:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a1e:	00000b97          	auipc	s7,0x0
 a22:	5f2b8b93          	addi	s7,s7,1522 # 1010 <num_levels>
 a26:	00000b17          	auipc	s6,0x0
 a2a:	5e2b0b13          	addi	s6,s6,1506 # 1008 <trnmnt_idx>
 a2e:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a30:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 a32:	078a                	slli	a5,a5,0x2
 a34:	97d2                	add	a5,a5,s4
 a36:	4388                	lw	a0,0(a5)
 a38:	00000097          	auipc	ra,0x0
 a3c:	960080e7          	jalr	-1696(ra) # 398 <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a40:	fff4869b          	addiw	a3,s1,-1
 a44:	0006849b          	sext.w	s1,a3
 a48:	03348963          	beq	s1,s3,a7a <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a4c:	000ba703          	lw	a4,0(s7)
 a50:	40d706bb          	subw	a3,a4,a3
 a54:	fff6879b          	addiw	a5,a3,-1
 a58:	000b2703          	lw	a4,0(s6)
 a5c:	00f915bb          	sllw	a1,s2,a5
 a60:	8df9                	and	a1,a1,a4
 a62:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a66:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a6a:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a6e:	9fb9                	addw	a5,a5,a4
 a70:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a72:	fcfad0e3          	bge	s5,a5,a32 <tournament_release+0x66>
 a76:	557d                	li	a0,-1
 a78:	a011                	j	a7c <tournament_release+0xb0>
...
return 0 ;
 ...
 a94:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a96:	557d                	li	a0,-1
 a98:	b7d5                	j	a7c <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a9a:	557d                	li	a0,-1
 a9c:	b7c5                	j	a7c <tournament_release+0xb0>
