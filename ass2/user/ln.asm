...
main(int argc, char *argv[])
{
  ...
  14:	aa058593          	addi	a1,a1,-1376 # ab0 <tournament_release+0xe4>
  18:	4509                	li	a0,2
  ...
  50:	a7c58593          	addi	a1,a1,-1412 # ac8 <tournament_release+0xfc>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f0:	6fc50513          	addi	a0,a0,1788 # ae8 <digits>
 3f4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	630b8b93          	addi	s7,s7,1584 # ae8 <digits>
 ...
 5fc:	4e890913          	addi	s2,s2,1256 # ae0 <tournament_release+0x114>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 822:	fff5071b          	addiw	a4,a0,-1
 826:	47bd                	li	a5,15
 828:	08e7eb63          	bltu	a5,a4,8be <tournament_create+0x9c>
int tournament_create(int processes) {
 82c:	7179                	addi	sp,sp,-48
 82e:	f406                	sd	ra,40(sp)
 830:	f022                	sd	s0,32(sp)
 832:	ec26                	sd	s1,24(sp)
 834:	e84a                	sd	s2,16(sp)
 836:	e44e                	sd	s3,8(sp)
 838:	e052                	sd	s4,0(sp)
 ...
 844:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 846:	ecbd                	bnez	s1,8c4 <tournament_create+0xa2>
  if (n <= 1) 
 848:	4785                	li	a5,1
 84a:	0937d763          	bge	a5,s3,8d8 <tournament_create+0xb6>
  int l = 0;
 84e:	8726                	mv	a4,s1
 850:	87ce                	mv	a5,s3
  while (n > 1) {
 852:	458d                	li	a1,3
    n /= 2;
 854:	86be                	mv	a3,a5
 856:	01f7d61b          	srliw	a2,a5,0x1f
 85a:	9fb1                	addw	a5,a5,a2
 85c:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 860:	2705                	addiw	a4,a4,1
  while (n > 1) {
 862:	fed5c9e3          	blt	a1,a3,854 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 866:	00000797          	auipc	a5,0x0
 86a:	7ae7a323          	sw	a4,1958(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 86e:	00000917          	auipc	s2,0x0
 872:	7b290913          	addi	s2,s2,1970 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 876:	00000097          	auipc	ra,0x0
 87a:	b12080e7          	jalr	-1262(ra) # 388 <peterson_create>
 87e:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 882:	04054063          	bltz	a0,8c2 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 886:	2485                	addiw	s1,s1,1
 888:	0911                	addi	s2,s2,4
 88a:	ff44c6e3          	blt	s1,s4,876 <tournament_create+0x54>
 ...
 892:	7607ad23          	sw	zero,1914(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 896:	4785                	li	a5,1
 898:	0537d863          	bge	a5,s3,8e8 <tournament_create+0xc6>
 89c:	4485                	li	s1,1
        int pid = fork() ;
 89e:	00000097          	auipc	ra,0x0
 8a2:	a42080e7          	jalr	-1470(ra) # 2e0 <fork>
        if(pid < 0)
 8a6:	02054763          	bltz	a0,8d4 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 8aa:	c509                	beqz	a0,8b4 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 8ac:	2485                	addiw	s1,s1,1
 8ae:	fe9998e3          	bne	s3,s1,89e <tournament_create+0x7c>
 8b2:	a81d                	j	8e8 <tournament_create+0xc6>
            trnmnt_idx = i ;
 8b4:	00000797          	auipc	a5,0x0
 8b8:	7497aa23          	sw	s1,1876(a5) # 1008 <trnmnt_idx>
            break ;
 8bc:	a035                	j	8e8 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 8be:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 8c8:	64e2                	ld	s1,24(sp)
 8ca:	6942                	ld	s2,16(sp)
 8cc:	69a2                	ld	s3,8(sp)
 8ce:	6a02                	ld	s4,0(sp)
 8d0:	6145                	addi	sp,sp,48
 8d2:	8082                	ret
            return -1 ;
 8d4:	557d                	li	a0,-1
 8d6:	b7fd                	j	8c4 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 8d8:	00000797          	auipc	a5,0x0
 8dc:	7207aa23          	sw	zero,1844(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 8e0:	00000797          	auipc	a5,0x0
 8e4:	7207a423          	sw	zero,1832(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 8e8:	00000517          	auipc	a0,0x0
 8ec:	72052503          	lw	a0,1824(a0) # 1008 <trnmnt_idx>
 8f0:	bfd1                	j	8c4 <tournament_create+0xa2>

00000000000008f2 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 8f2:	00000797          	auipc	a5,0x0
 8f6:	7167a783          	lw	a5,1814(a5) # 1008 <trnmnt_idx>
 8fa:	0a07c763          	bltz	a5,9a8 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 8fe:	715d                	addi	sp,sp,-80
 900:	e486                	sd	ra,72(sp)
 902:	e0a2                	sd	s0,64(sp)
 904:	fc26                	sd	s1,56(sp)
 906:	f84a                	sd	s2,48(sp)
 908:	f44e                	sd	s3,40(sp)
 90a:	f052                	sd	s4,32(sp)
 90c:	ec56                	sd	s5,24(sp)
 90e:	e85a                	sd	s6,16(sp)
 910:	e45e                	sd	s7,8(sp)
 912:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 914:	00000497          	auipc	s1,0x0
 918:	6f84a483          	lw	s1,1784(s1) # 100c <num_levels>
 91c:	08905863          	blez	s1,9ac <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 920:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 922:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 926:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 92a:	4705                	li	a4,1
 92c:	0097173b          	sllw	a4,a4,s1
 930:	9fb9                	addw	a5,a5,a4
 932:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 934:	4739                	li	a4,14
 936:	06f74d63          	blt	a4,a5,9b0 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 93a:	00000997          	auipc	s3,0x0
 93e:	6e698993          	addi	s3,s3,1766 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 942:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 944:	00000b97          	auipc	s7,0x0
 948:	6c8b8b93          	addi	s7,s7,1736 # 100c <num_levels>
 94c:	00000b17          	auipc	s6,0x0
 950:	6bcb0b13          	addi	s6,s6,1724 # 1008 <trnmnt_idx>
 954:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 956:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 958:	078a                	slli	a5,a5,0x2
 95a:	97ce                	add	a5,a5,s3
 95c:	4388                	lw	a0,0(a5)
 95e:	00000097          	auipc	ra,0x0
 962:	a32080e7          	jalr	-1486(ra) # 390 <peterson_acquire>
 966:	04054763          	bltz	a0,9b4 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 96a:	fff4869b          	addiw	a3,s1,-1
 96e:	0006849b          	sext.w	s1,a3
 972:	03448963          	beq	s1,s4,9a4 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 976:	000ba703          	lw	a4,0(s7)
 97a:	40d706bb          	subw	a3,a4,a3
 97e:	fff6879b          	addiw	a5,a3,-1
 982:	000b2703          	lw	a4,0(s6)
 986:	00f915bb          	sllw	a1,s2,a5
 98a:	8df9                	and	a1,a1,a4
 98c:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 990:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 994:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 998:	9fb9                	addw	a5,a5,a4
 99a:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 99c:	fafadee3          	bge	s5,a5,958 <tournament_acquire+0x66>
 9a0:	557d                	li	a0,-1
 9a2:	a811                	j	9b6 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 9a4:	4501                	li	a0,0
 9a6:	a801                	j	9b6 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9a8:	557d                	li	a0,-1
}
 9aa:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9ac:	557d                	li	a0,-1
 9ae:	a021                	j	9b6 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 9b0:	557d                	li	a0,-1
 9b2:	a011                	j	9b6 <tournament_acquire+0xc4>
        return -1;
 9b4:	557d                	li	a0,-1
}
...
int tournament_release(void) {
 ...
 9d4:	0a07c663          	bltz	a5,a80 <tournament_release+0xb4>
 9d8:	00000717          	auipc	a4,0x0
 9dc:	63472703          	lw	a4,1588(a4) # 100c <num_levels>
 9e0:	0ae05263          	blez	a4,a84 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9e4:	fff7069b          	addiw	a3,a4,-1
 9e8:	4585                	li	a1,1
 9ea:	00d595bb          	sllw	a1,a1,a3
 9ee:	8dfd                	and	a1,a1,a5
 9f0:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9f4:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 9f8:	4739                	li	a4,14
 9fa:	08f74763          	blt	a4,a5,a88 <tournament_release+0xbc>
int tournament_release(void) {
 ...
 a18:	60c98993          	addi	s3,s3,1548 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a1c:	00000a17          	auipc	s4,0x0
 a20:	5f0a0a13          	addi	s4,s4,1520 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a24:	00000b17          	auipc	s6,0x0
 a28:	5e4b0b13          	addi	s6,s6,1508 # 1008 <trnmnt_idx>
 a2c:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a2e:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 a30:	078a                	slli	a5,a5,0x2
 a32:	97ce                	add	a5,a5,s3
 a34:	4388                	lw	a0,0(a5)
 a36:	00000097          	auipc	ra,0x0
 a3a:	962080e7          	jalr	-1694(ra) # 398 <peterson_release>
 a3e:	04054763          	bltz	a0,a8c <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a42:	0014871b          	addiw	a4,s1,1
 a46:	0007049b          	sext.w	s1,a4
 a4a:	000a2783          	lw	a5,0(s4)
 a4e:	02f4d763          	bge	s1,a5,a7c <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ...
 a72:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a74:	fafadee3          	bge	s5,a5,a30 <tournament_release+0x64>
 a78:	557d                	li	a0,-1
 a7a:	a811                	j	a8e <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 a7c:	4501                	li	a0,0
 a7e:	a801                	j	a8e <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a80:	557d                	li	a0,-1
 a82:	8082                	ret
 a84:	557d                	li	a0,-1
