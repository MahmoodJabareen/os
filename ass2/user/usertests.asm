...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2198:	48090913          	addi	s2,s2,1152 # 1003d480 <lock_ids+0x1002d7f8>
    pid = fork();
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2410:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <lock_ids+0xfffffffffffef378>
    2414:	85a6                	mv	a1,s1
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28f0:	6705                	lui	a4,0x1
      *b = 99;
    28f2:	00d50023          	sb	a3,0(a0) # 40000000 <lock_ids+0x3fff0378>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2a9c:	fee78fa3          	sb	a4,-1(a5) # 63fffff <lock_ids+0x63f0377>
  a = sbrk(0);
    2aa0:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2b00:	fff7c703          	lbu	a4,-1(a5) # 63fffff <lock_ids+0x63f0377>
...
0000000000002f2a <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2f4a:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <lock_ids+0xffffffff7fff0377>
...
000000000000480e <sbrkfail>:
{
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    498e:	6705                	lui	a4,0x1
      n += *(a+i);
    4990:	0007c683          	lbu	a3,0(a5) # 6400000 <lock_ids+0x63f0378>
...
int tournament_create(int processes) {
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    6100:	fff5071b          	addiw	a4,a0,-1
    6104:	47bd                	li	a5,15
    6106:	08e7eb63          	bltu	a5,a4,619c <tournament_create+0x9c>
int tournament_create(int processes) {
    610a:	7179                	addi	sp,sp,-48
    610c:	f406                	sd	ra,40(sp)
    610e:	f022                	sd	s0,32(sp)
    6110:	ec26                	sd	s1,24(sp)
    6112:	e84a                	sd	s2,16(sp)
    6114:	e44e                	sd	s3,8(sp)
    6116:	e052                	sd	s4,0(sp)
    6118:	1800                	addi	s0,sp,48
    611a:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
    611c:	8a3a                	mv	s4,a4
   ...
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    6122:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
    6124:	ecbd                	bnez	s1,61a2 <tournament_create+0xa2>
  if (n <= 1) 
    6126:	4785                	li	a5,1
    6128:	0937d763          	bge	a5,s3,61b6 <tournament_create+0xb6>
  int l = 0;
    612c:	8726                	mv	a4,s1
    612e:	87ce                	mv	a5,s3
  while (n > 1) {
    ...
    n /= 2;
    6132:	86be                	mv	a3,a5
    6134:	01f7d61b          	srliw	a2,a5,0x1f
    6138:	9fb1                	addw	a5,a5,a2
    613a:	4017d79b          	sraiw	a5,a5,0x1
    l++;
    613e:	2705                	addiw	a4,a4,1
  while (n > 1) {
    6140:	fed5c9e3          	blt	a1,a3,6132 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
    6144:	00003797          	auipc	a5,0x3
    6148:	30e7ac23          	sw	a4,792(a5) # 945c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
    614c:	0000a917          	auipc	s2,0xa
    6150:	b3c90913          	addi	s2,s2,-1220 # fc88 <lock_ids>
    lock_ids[i]= peterson_create() ;
    6154:	00000097          	auipc	ra,0x0
    6158:	b12080e7          	jalr	-1262(ra) # 5c66 <peterson_create>
    615c:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
    6160:	04054063          	bltz	a0,61a0 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
    6164:	2485                	addiw	s1,s1,1
    6166:	0911                	addi	s2,s2,4
    6168:	ff44c6e3          	blt	s1,s4,6154 <tournament_create+0x54>
        return -1; //failed to create lock
    }
   }

   trnmnt_idx = 0;
    616c:	00003797          	auipc	a5,0x3
    6170:	2e07a623          	sw	zero,748(a5) # 9458 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
    6174:	4785                	li	a5,1
    6176:	0537d863          	bge	a5,s3,61c6 <tournament_create+0xc6>
    617a:	4485                	li	s1,1
        int pid = fork() ;
    617c:	00000097          	auipc	ra,0x0
    6180:	a42080e7          	jalr	-1470(ra) # 5bbe <fork>
        if(pid < 0)
    6184:	02054763          	bltz	a0,61b2 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
    6188:	c509                	beqz	a0,6192 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
    618a:	2485                	addiw	s1,s1,1
    618c:	fe9998e3          	bne	s3,s1,617c <tournament_create+0x7c>
    6190:	a81d                	j	61c6 <tournament_create+0xc6>
            trnmnt_idx = i ;
    6192:	00003797          	auipc	a5,0x3
    6196:	2c97a323          	sw	s1,710(a5) # 9458 <trnmnt_idx>
            break ;
    619a:	a035                	j	61c6 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    619c:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
    ...
    61a2:	70a2                	ld	ra,40(sp)
    61a4:	7402                	ld	s0,32(sp)
    61a6:	64e2                	ld	s1,24(sp)
    61a8:	6942                	ld	s2,16(sp)
    61aa:	69a2                	ld	s3,8(sp)
    61ac:	6a02                	ld	s4,0(sp)
    61ae:	6145                	addi	sp,sp,48
    61b0:	8082                	ret
            return -1 ;
    61b2:	557d                	li	a0,-1
    61b4:	b7fd                	j	61a2 <tournament_create+0xa2>
   num_levels = log2(processes) ;
    61b6:	00003797          	auipc	a5,0x3
    61ba:	2a07a323          	sw	zero,678(a5) # 945c <num_levels>
   trnmnt_idx = 0;
    61be:	00003797          	auipc	a5,0x3
    61c2:	2807ad23          	sw	zero,666(a5) # 9458 <trnmnt_idx>
return trnmnt_idx ;
    61c6:	00003517          	auipc	a0,0x3
    61ca:	29252503          	lw	a0,658(a0) # 9458 <trnmnt_idx>
    61ce:	bfd1                	j	61a2 <tournament_create+0xa2>

00000000000061d0 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    61d0:	00003797          	auipc	a5,0x3
    61d4:	2887a783          	lw	a5,648(a5) # 9458 <trnmnt_idx>
    61d8:	0a07c763          	bltz	a5,6286 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
    61dc:	715d                	addi	sp,sp,-80
    61de:	e486                	sd	ra,72(sp)
    61e0:	e0a2                	sd	s0,64(sp)
    61e2:	fc26                	sd	s1,56(sp)
    61e4:	f84a                	sd	s2,48(sp)
    61e6:	f44e                	sd	s3,40(sp)
    61e8:	f052                	sd	s4,32(sp)
    61ea:	ec56                	sd	s5,24(sp)
    61ec:	e85a                	sd	s6,16(sp)
    61ee:	e45e                	sd	s7,8(sp)
    61f0:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    61f2:	00003497          	auipc	s1,0x3
    61f6:	26a4a483          	lw	s1,618(s1) # 945c <num_levels>
    61fa:	08905863          	blez	s1,628a <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    61fe:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    6200:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    6204:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
    6208:	4705                	li	a4,1
    620a:	0097173b          	sllw	a4,a4,s1
    620e:	9fb9                	addw	a5,a5,a4
    6210:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    6212:	4739                	li	a4,14
    6214:	06f74d63          	blt	a4,a5,628e <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
    6218:	0000a997          	auipc	s3,0xa
    621c:	a7098993          	addi	s3,s3,-1424 # fc88 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    6220:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    6222:	00003b97          	auipc	s7,0x3
    6226:	23ab8b93          	addi	s7,s7,570 # 945c <num_levels>
    622a:	00003b17          	auipc	s6,0x3
    622e:	22eb0b13          	addi	s6,s6,558 # 9458 <trnmnt_idx>
    6232:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    6234:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
    6236:	078a                	slli	a5,a5,0x2
    6238:	97ce                	add	a5,a5,s3
    623a:	4388                	lw	a0,0(a5)
    623c:	00000097          	auipc	ra,0x0
    6240:	a32080e7          	jalr	-1486(ra) # 5c6e <peterson_acquire>
    6244:	04054763          	bltz	a0,6292 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    6248:	fff4869b          	addiw	a3,s1,-1
    624c:	0006849b          	sext.w	s1,a3
    6250:	03448963          	beq	s1,s4,6282 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    6254:	000ba703          	lw	a4,0(s7)
    6258:	40d706bb          	subw	a3,a4,a3
    625c:	fff6879b          	addiw	a5,a3,-1
    6260:	000b2703          	lw	a4,0(s6)
    6264:	00f915bb          	sllw	a1,s2,a5
    6268:	8df9                	and	a1,a1,a4
    626a:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    626e:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    6272:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
    6276:	9fb9                	addw	a5,a5,a4
    6278:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    627a:	fafadee3          	bge	s5,a5,6236 <tournament_acquire+0x66>
    627e:	557d                	li	a0,-1
    6280:	a811                	j	6294 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
    6282:	4501                	li	a0,0
    6284:	a801                	j	6294 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    6286:	557d                	li	a0,-1
}
    6288:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    628a:	557d                	li	a0,-1
    628c:	a021                	j	6294 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
    628e:	557d                	li	a0,-1
    6290:	a011                	j	6294 <tournament_acquire+0xc4>
        return -1;
    6292:	557d                	li	a0,-1
}
    6294:	60a6                	ld	ra,72(sp)
    6296:	6406                	ld	s0,64(sp)
    6298:	74e2                	ld	s1,56(sp)
    629a:	7942                	ld	s2,48(sp)
    629c:	79a2                	ld	s3,40(sp)
    629e:	7a02                	ld	s4,32(sp)
    62a0:	6ae2                	ld	s5,24(sp)
    62a2:	6b42                	ld	s6,16(sp)
    62a4:	6ba2                	ld	s7,8(sp)
    62a6:	6161                	addi	sp,sp,80
    62a8:	8082                	ret
...
int tournament_release(void) {
    ...
    62b2:	0a07c663          	bltz	a5,635e <tournament_release+0xb4>
    62b6:	00003717          	auipc	a4,0x3
    62ba:	1a672703          	lw	a4,422(a4) # 945c <num_levels>
    62be:	0ae05263          	blez	a4,6362 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    62c2:	fff7069b          	addiw	a3,a4,-1
    62c6:	4585                	li	a1,1
    62c8:	00d595bb          	sllw	a1,a1,a3
    62cc:	8dfd                	and	a1,a1,a5
    62ce:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    62d2:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
    62d6:	4739                	li	a4,14
    62d8:	08f74763          	blt	a4,a5,6366 <tournament_release+0xbc>
int tournament_release(void) {
    62dc:	7139                	addi	sp,sp,-64
    62de:	fc06                	sd	ra,56(sp)
    62e0:	f822                	sd	s0,48(sp)
    62e2:	f426                	sd	s1,40(sp)
    62e4:	f04a                	sd	s2,32(sp)
    62e6:	ec4e                	sd	s3,24(sp)
    62e8:	e852                	sd	s4,16(sp)
    62ea:	e456                	sd	s5,8(sp)
    62ec:	e05a                	sd	s6,0(sp)
    62ee:	0080                	addi	s0,sp,64
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    62f0:	4481                	li	s1,0

        if (peterson_release(lock_ids[lockidx] , role) < 0)
    62f2:	0000a997          	auipc	s3,0xa
    62f6:	99698993          	addi	s3,s3,-1642 # fc88 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    62fa:	00003a17          	auipc	s4,0x3
    62fe:	162a0a13          	addi	s4,s4,354 # 945c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    6302:	00003b17          	auipc	s6,0x3
    6306:	156b0b13          	addi	s6,s6,342 # 9458 <trnmnt_idx>
    630a:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    630c:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
    630e:	078a                	slli	a5,a5,0x2
    6310:	97ce                	add	a5,a5,s3
    6312:	4388                	lw	a0,0(a5)
    6314:	00000097          	auipc	ra,0x0
    6318:	962080e7          	jalr	-1694(ra) # 5c76 <peterson_release>
    631c:	04054763          	bltz	a0,636a <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    6320:	0014871b          	addiw	a4,s1,1
    6324:	0007049b          	sext.w	s1,a4
    6328:	000a2783          	lw	a5,0(s4)
    632c:	02f4d763          	bge	s1,a5,635a <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    6330:	40e7873b          	subw	a4,a5,a4
    6334:	fff7079b          	addiw	a5,a4,-1
    6338:	000b2683          	lw	a3,0(s6)
    633c:	00f915bb          	sllw	a1,s2,a5
    6340:	8df5                	and	a1,a1,a3
    6342:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    6346:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    634a:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
    634e:	9fb9                	addw	a5,a5,a4
    6350:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    6352:	fafadee3          	bge	s5,a5,630e <tournament_release+0x64>
    6356:	557d                	li	a0,-1
    6358:	a811                	j	636c <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
    635a:	4501                	li	a0,0
    635c:	a801                	j	636c <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    635e:	557d                	li	a0,-1
    6360:	8082                	ret
    6362:	557d                	li	a0,-1
    ...
    6370:	74a2                	ld	s1,40(sp)
    6372:	7902                	ld	s2,32(sp)
    6374:	69e2                	ld	s3,24(sp)
    6376:	6a42                	ld	s4,16(sp)
    6378:	6aa2                	ld	s5,8(sp)
    637a:	6b02                	ld	s6,0(sp)
    637c:	6121                	addi	sp,sp,64
    637e:	8082                	ret
