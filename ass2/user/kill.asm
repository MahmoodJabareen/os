...
int tournament_create(int processes) {
 ...
 836:	fff5071b          	addiw	a4,a0,-1
 83a:	47bd                	li	a5,15
 83c:	00e7ee63          	bltu	a5,a4,858 <tournament_create+0x32>
 840:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 842:	8a3a                	mv	s4,a4
 844:	00e574b3          	and	s1,a0,a4
 848:	c0b9                	beqz	s1,88e <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 84a:	54fd                	li	s1,-1
 84c:	a809                	j	85e <tournament_create+0x38>
 ...
 852:	7a97ad23          	sw	s1,1978(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 856:	a021                	j	85e <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 858:	54fd                	li	s1,-1
 85a:	a011                	j	85e <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 86e:	8082                	ret
            return -1 ;
 870:	54fd                	li	s1,-1
 872:	b7f5                	j	85e <tournament_create+0x38>
   num_levels = log2(processes) ;
 874:	00000797          	auipc	a5,0x0
 878:	7807ae23          	sw	zero,1948(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 87c:	00000797          	auipc	a5,0x0
 880:	7807a623          	sw	zero,1932(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 884:	00000497          	auipc	s1,0x0
 888:	7844a483          	lw	s1,1924(s1) # 1008 <trnmnt_idx>
 88c:	bfc9                	j	85e <tournament_create+0x38>
   num_processes = processes ;
 88e:	00000797          	auipc	a5,0x0
 892:	76a7af23          	sw	a0,1918(a5) # 100c <num_processes>
  if (n <= 1) 
 896:	4785                	li	a5,1
 898:	fca7dee3          	bge	a5,a0,874 <tournament_create+0x4e>
  int l = 0;
 89c:	8726                	mv	a4,s1
 89e:	87aa                	mv	a5,a0
  while (n > 1) {
 8a0:	458d                	li	a1,3
    n /= 2;
 8a2:	86be                	mv	a3,a5
 8a4:	01f7d61b          	srliw	a2,a5,0x1f
 8a8:	9fb1                	addw	a5,a5,a2
 8aa:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 8ae:	2705                	addiw	a4,a4,1
  while (n > 1) {
 8b0:	fed5c9e3          	blt	a1,a3,8a2 <tournament_create+0x7c>
   num_levels = log2(processes) ;
 8b4:	00000797          	auipc	a5,0x0
 8b8:	74e7ae23          	sw	a4,1884(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 8bc:	00000917          	auipc	s2,0x0
 8c0:	77490913          	addi	s2,s2,1908 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 8c4:	00000097          	auipc	ra,0x0
 8c8:	ac8080e7          	jalr	-1336(ra) # 38c <peterson_create>
 8cc:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 8d0:	f80546e3          	bltz	a0,85c <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 8d4:	2485                	addiw	s1,s1,1
 8d6:	0911                	addi	s2,s2,4
 8d8:	ff44c6e3          	blt	s1,s4,8c4 <tournament_create+0x9e>
   trnmnt_idx = 0;
 8dc:	00000797          	auipc	a5,0x0
 8e0:	7207a623          	sw	zero,1836(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 8e4:	4785                	li	a5,1
 8e6:	f937dfe3          	bge	a5,s3,884 <tournament_create+0x5e>
 8ea:	4485                	li	s1,1
        int pid = fork() ;
 8ec:	00000097          	auipc	ra,0x0
 8f0:	9f8080e7          	jalr	-1544(ra) # 2e4 <fork>
        if(pid < 0)
 8f4:	f6054ee3          	bltz	a0,870 <tournament_create+0x4a>
        if(pid == 0){
 8f8:	d939                	beqz	a0,84e <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 8fa:	2485                	addiw	s1,s1,1
 8fc:	fe9998e3          	bne	s3,s1,8ec <tournament_create+0xc6>
 900:	b751                	j	884 <tournament_create+0x5e>

0000000000000902 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 902:	00000797          	auipc	a5,0x0
 906:	7067a783          	lw	a5,1798(a5) # 1008 <trnmnt_idx>
 90a:	0a07cd63          	bltz	a5,9c4 <tournament_acquire+0xc2>
 90e:	00000717          	auipc	a4,0x0
 912:	70272703          	lw	a4,1794(a4) # 1010 <num_levels>
 916:	0ae05963          	blez	a4,9c8 <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 91a:	fff7069b          	addiw	a3,a4,-1
 91e:	4585                	li	a1,1
 920:	00d595bb          	sllw	a1,a1,a3
 924:	8dfd                	and	a1,a1,a5
 926:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 92a:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 92e:	4739                	li	a4,14
 930:	08f74e63          	blt	a4,a5,9cc <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 94a:	00000a17          	auipc	s4,0x0
 94e:	6e6a0a13          	addi	s4,s4,1766 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 952:	00000997          	auipc	s3,0x0
 956:	6be98993          	addi	s3,s3,1726 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 95a:	00000b17          	auipc	s6,0x0
 95e:	6aeb0b13          	addi	s6,s6,1710 # 1008 <trnmnt_idx>
 962:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 964:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 966:	078a                	slli	a5,a5,0x2
 968:	97d2                	add	a5,a5,s4
 96a:	4388                	lw	a0,0(a5)
 96c:	00000097          	auipc	ra,0x0
 970:	a28080e7          	jalr	-1496(ra) # 394 <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 974:	0014871b          	addiw	a4,s1,1
 978:	0007049b          	sext.w	s1,a4
 97c:	0009a783          	lw	a5,0(s3)
 980:	02f4d763          	bge	s1,a5,9ae <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 984:	40e7873b          	subw	a4,a5,a4
 988:	fff7079b          	addiw	a5,a4,-1
 98c:	000b2683          	lw	a3,0(s6)
 990:	00f915bb          	sllw	a1,s2,a5
 994:	8df5                	and	a1,a1,a3
 996:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 99a:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 99e:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 9a2:	9fb9                	addw	a5,a5,a4
 9a4:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9a6:	fcfad0e3          	bge	s5,a5,966 <tournament_acquire+0x64>
 9aa:	557d                	li	a0,-1
 9ac:	a011                	j	9b0 <tournament_acquire+0xae>
...
int tournament_release(void) {
 ...
 9d8:	0a07cf63          	bltz	a5,a96 <tournament_release+0xc6>
int tournament_release(void) {
 9dc:	715d                	addi	sp,sp,-80
 9de:	e486                	sd	ra,72(sp)
 9e0:	e0a2                	sd	s0,64(sp)
 9e2:	fc26                	sd	s1,56(sp)
 9e4:	f84a                	sd	s2,48(sp)
 9e6:	f44e                	sd	s3,40(sp)
 9e8:	f052                	sd	s4,32(sp)
 9ea:	ec56                	sd	s5,24(sp)
 9ec:	e85a                	sd	s6,16(sp)
 9ee:	e45e                	sd	s7,8(sp)
 9f0:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9f2:	00000497          	auipc	s1,0x0
 9f6:	61e4a483          	lw	s1,1566(s1) # 1010 <num_levels>
 9fa:	0a905063          	blez	s1,a9a <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 9fe:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a00:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a04:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 a08:	4705                	li	a4,1
 a0a:	0097173b          	sllw	a4,a4,s1
 a0e:	9fb9                	addw	a5,a5,a4
 a10:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a12:	4739                	li	a4,14
 a14:	08f74563          	blt	a4,a5,a9e <tournament_release+0xce>
 ...
 a20:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a22:	00000b97          	auipc	s7,0x0
 a26:	5eeb8b93          	addi	s7,s7,1518 # 1010 <num_levels>
 a2a:	00000b17          	auipc	s6,0x0
 a2e:	5deb0b13          	addi	s6,s6,1502 # 1008 <trnmnt_idx>
 a32:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a34:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 a36:	078a                	slli	a5,a5,0x2
 a38:	97d2                	add	a5,a5,s4
 a3a:	4388                	lw	a0,0(a5)
 a3c:	00000097          	auipc	ra,0x0
 a40:	960080e7          	jalr	-1696(ra) # 39c <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a44:	fff4869b          	addiw	a3,s1,-1
 a48:	0006849b          	sext.w	s1,a3
 a4c:	03348963          	beq	s1,s3,a7e <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a50:	000ba703          	lw	a4,0(s7)
 a54:	40d706bb          	subw	a3,a4,a3
 a58:	fff6879b          	addiw	a5,a3,-1
 a5c:	000b2703          	lw	a4,0(s6)
 a60:	00f915bb          	sllw	a1,s2,a5
 a64:	8df9                	and	a1,a1,a4
 a66:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a6a:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a6e:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a72:	9fb9                	addw	a5,a5,a4
 a74:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a76:	fcfad0e3          	bge	s5,a5,a36 <tournament_release+0x66>
 a7a:	557d                	li	a0,-1
 a7c:	a011                	j	a80 <tournament_release+0xb0>
...
return 0 ;
 ...
 a98:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a9a:	557d                	li	a0,-1
 a9c:	b7d5                	j	a80 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a9e:	557d                	li	a0,-1
 aa0:	b7c5                	j	a80 <tournament_release+0xb0>
