...
00000000000001de <main>:
{
 ...
 252:	a9258593          	addi	a1,a1,-1390 # ce0 <tournament_release+0xd6>
 256:	4509                	li	a0,2
 ...
 288:	a7c50513          	addi	a0,a0,-1412 # d00 <tournament_release+0xf6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 62e:	6f650513          	addi	a0,a0,1782 # d20 <digits>
 632:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fa:	62ab8b93          	addi	s7,s7,1578 # d20 <digits>
 ...
 83a:	4e290913          	addi	s2,s2,1250 # d18 <tournament_release+0x10e>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 a60:	fff5071b          	addiw	a4,a0,-1
 a64:	47bd                	li	a5,15
 a66:	08e7eb63          	bltu	a5,a4,afc <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 a7a:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 a7c:	8a3a                	mv	s4,a4
 a7e:	00e574b3          	and	s1,a0,a4
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 a82:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 a84:	ecbd                	bnez	s1,b02 <tournament_create+0xa2>
  if (n <= 1) 
 a86:	4785                	li	a5,1
 a88:	0937d763          	bge	a5,s3,b16 <tournament_create+0xb6>
  int l = 0;
 a8c:	8726                	mv	a4,s1
 a8e:	87ce                	mv	a5,s3
  while (n > 1) {
 a90:	458d                	li	a1,3
    n /= 2;
 a92:	86be                	mv	a3,a5
 a94:	01f7d61b          	srliw	a2,a5,0x1f
 a98:	9fb1                	addw	a5,a5,a2
 a9a:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 a9e:	2705                	addiw	a4,a4,1
  while (n > 1) {
 aa0:	fed5c9e3          	blt	a1,a3,a92 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 aa4:	00000797          	auipc	a5,0x0
 aa8:	56e7a423          	sw	a4,1384(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 aac:	00001917          	auipc	s2,0x1
 ab0:	97490913          	addi	s2,s2,-1676 # 1420 <lock_ids>
    lock_ids[i]= peterson_create() ;
 ab4:	00000097          	auipc	ra,0x0
 ab8:	b12080e7          	jalr	-1262(ra) # 5c6 <peterson_create>
 abc:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 ac0:	04054063          	bltz	a0,b00 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 ac4:	2485                	addiw	s1,s1,1
 ac6:	0911                	addi	s2,s2,4
 ac8:	ff44c6e3          	blt	s1,s4,ab4 <tournament_create+0x54>
 ...
 ad0:	5207ae23          	sw	zero,1340(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 ad4:	4785                	li	a5,1
 ad6:	0537d863          	bge	a5,s3,b26 <tournament_create+0xc6>
 ada:	4485                	li	s1,1
        int pid = fork() ;
 adc:	00000097          	auipc	ra,0x0
 ae0:	a42080e7          	jalr	-1470(ra) # 51e <fork>
        if(pid < 0)
 ae4:	02054763          	bltz	a0,b12 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 ae8:	c509                	beqz	a0,af2 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 aea:	2485                	addiw	s1,s1,1
 aec:	fe9998e3          	bne	s3,s1,adc <tournament_create+0x7c>
 af0:	a81d                	j	b26 <tournament_create+0xc6>
            trnmnt_idx = i ;
 af2:	00000797          	auipc	a5,0x0
 af6:	5097ab23          	sw	s1,1302(a5) # 1008 <trnmnt_idx>
            break ;
 afa:	a035                	j	b26 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 afc:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 b0a:	69a2                	ld	s3,8(sp)
 b0c:	6a02                	ld	s4,0(sp)
 b0e:	6145                	addi	sp,sp,48
 b10:	8082                	ret
            return -1 ;
 b12:	557d                	li	a0,-1
 b14:	b7fd                	j	b02 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 b16:	00000797          	auipc	a5,0x0
 b1a:	4e07ab23          	sw	zero,1270(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 b1e:	00000797          	auipc	a5,0x0
 b22:	4e07a523          	sw	zero,1258(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 b26:	00000517          	auipc	a0,0x0
 b2a:	4e252503          	lw	a0,1250(a0) # 1008 <trnmnt_idx>
 b2e:	bfd1                	j	b02 <tournament_create+0xa2>

0000000000000b30 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b30:	00000797          	auipc	a5,0x0
 b34:	4d87a783          	lw	a5,1240(a5) # 1008 <trnmnt_idx>
 b38:	0a07c763          	bltz	a5,be6 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 b3c:	715d                	addi	sp,sp,-80
 b3e:	e486                	sd	ra,72(sp)
 b40:	e0a2                	sd	s0,64(sp)
 b42:	fc26                	sd	s1,56(sp)
 b44:	f84a                	sd	s2,48(sp)
 b46:	f44e                	sd	s3,40(sp)
 b48:	f052                	sd	s4,32(sp)
 b4a:	ec56                	sd	s5,24(sp)
 b4c:	e85a                	sd	s6,16(sp)
 b4e:	e45e                	sd	s7,8(sp)
 b50:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b52:	00000497          	auipc	s1,0x0
 b56:	4ba4a483          	lw	s1,1210(s1) # 100c <num_levels>
 b5a:	08905863          	blez	s1,bea <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 b5e:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b60:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b64:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 b68:	4705                	li	a4,1
 b6a:	0097173b          	sllw	a4,a4,s1
 b6e:	9fb9                	addw	a5,a5,a4
 b70:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b72:	4739                	li	a4,14
 b74:	06f74d63          	blt	a4,a5,bee <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 b78:	00001997          	auipc	s3,0x1
 b7c:	8a898993          	addi	s3,s3,-1880 # 1420 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 b80:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b82:	00000b97          	auipc	s7,0x0
 b86:	48ab8b93          	addi	s7,s7,1162 # 100c <num_levels>
 b8a:	00000b17          	auipc	s6,0x0
 b8e:	47eb0b13          	addi	s6,s6,1150 # 1008 <trnmnt_idx>
 b92:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b94:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 b96:	078a                	slli	a5,a5,0x2
 b98:	97ce                	add	a5,a5,s3
 b9a:	4388                	lw	a0,0(a5)
 b9c:	00000097          	auipc	ra,0x0
 ba0:	a32080e7          	jalr	-1486(ra) # 5ce <peterson_acquire>
 ba4:	04054763          	bltz	a0,bf2 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 ba8:	fff4869b          	addiw	a3,s1,-1
 bac:	0006849b          	sext.w	s1,a3
 bb0:	03448963          	beq	s1,s4,be2 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 bb4:	000ba703          	lw	a4,0(s7)
 bb8:	40d706bb          	subw	a3,a4,a3
 bbc:	fff6879b          	addiw	a5,a3,-1
 bc0:	000b2703          	lw	a4,0(s6)
 bc4:	00f915bb          	sllw	a1,s2,a5
 bc8:	8df9                	and	a1,a1,a4
 bca:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 bce:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 bd2:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 bd6:	9fb9                	addw	a5,a5,a4
 bd8:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 bda:	fafadee3          	bge	s5,a5,b96 <tournament_acquire+0x66>
 bde:	557d                	li	a0,-1
 be0:	a811                	j	bf4 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 be2:	4501                	li	a0,0
 be4:	a801                	j	bf4 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 be6:	557d                	li	a0,-1
}
 be8:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 bea:	557d                	li	a0,-1
 bec:	a021                	j	bf4 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 bee:	557d                	li	a0,-1
 bf0:	a011                	j	bf4 <tournament_acquire+0xc4>
        return -1;
 bf2:	557d                	li	a0,-1
}
 bf4:	60a6                	ld	ra,72(sp)
 bf6:	6406                	ld	s0,64(sp)
 bf8:	74e2                	ld	s1,56(sp)
 bfa:	7942                	ld	s2,48(sp)
 bfc:	79a2                	ld	s3,40(sp)
 bfe:	7a02                	ld	s4,32(sp)
 c00:	6ae2                	ld	s5,24(sp)
 c02:	6b42                	ld	s6,16(sp)
 c04:	6ba2                	ld	s7,8(sp)
 c06:	6161                	addi	sp,sp,80
 c08:	8082                	ret

0000000000000c0a <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 c0a:	00000797          	auipc	a5,0x0
 c0e:	3fe7a783          	lw	a5,1022(a5) # 1008 <trnmnt_idx>
 c12:	0a07c663          	bltz	a5,cbe <tournament_release+0xb4>
 c16:	00000717          	auipc	a4,0x0
 c1a:	3f672703          	lw	a4,1014(a4) # 100c <num_levels>
 c1e:	0ae05263          	blez	a4,cc2 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c22:	fff7069b          	addiw	a3,a4,-1
 c26:	4585                	li	a1,1
 c28:	00d595bb          	sllw	a1,a1,a3
 c2c:	8dfd                	and	a1,a1,a5
 c2e:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 c32:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 c36:	4739                	li	a4,14
 c38:	08f74763          	blt	a4,a5,cc6 <tournament_release+0xbc>
int tournament_release(void) {
 ...
 c4a:	e456                	sd	s5,8(sp)
 c4c:	e05a                	sd	s6,0(sp)
 c4e:	0080                	addi	s0,sp,64
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 c50:	4481                	li	s1,0

        if (peterson_release(lock_ids[lockidx] , role) < 0)
 c52:	00000997          	auipc	s3,0x0
 c56:	7ce98993          	addi	s3,s3,1998 # 1420 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 c5a:	00000a17          	auipc	s4,0x0
 c5e:	3b2a0a13          	addi	s4,s4,946 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c62:	00000b17          	auipc	s6,0x0
 c66:	3a6b0b13          	addi	s6,s6,934 # 1008 <trnmnt_idx>
 c6a:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 c6c:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 c6e:	078a                	slli	a5,a5,0x2
 c70:	97ce                	add	a5,a5,s3
 c72:	4388                	lw	a0,0(a5)
 c74:	00000097          	auipc	ra,0x0
 c78:	962080e7          	jalr	-1694(ra) # 5d6 <peterson_release>
 c7c:	04054763          	bltz	a0,cca <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 c80:	0014871b          	addiw	a4,s1,1
 c84:	0007049b          	sext.w	s1,a4
 c88:	000a2783          	lw	a5,0(s4)
 c8c:	02f4d763          	bge	s1,a5,cba <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c90:	40e7873b          	subw	a4,a5,a4
 c94:	fff7079b          	addiw	a5,a4,-1
 c98:	000b2683          	lw	a3,0(s6)
 c9c:	00f915bb          	sllw	a1,s2,a5
 ca0:	8df5                	and	a1,a1,a3
 ca2:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 ca6:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 caa:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 cae:	9fb9                	addw	a5,a5,a4
 cb0:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 cb2:	fafadee3          	bge	s5,a5,c6e <tournament_release+0x64>
 cb6:	557d                	li	a0,-1
 cb8:	a811                	j	ccc <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 cba:	4501                	li	a0,0
 cbc:	a801                	j	ccc <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 cbe:	557d                	li	a0,-1
 cc0:	8082                	ret
 cc2:	557d                	li	a0,-1
 ...
 cd4:	69e2                	ld	s3,24(sp)
 cd6:	6a42                	ld	s4,16(sp)
 cd8:	6aa2                	ld	s5,8(sp)
 cda:	6b02                	ld	s6,0(sp)
 cdc:	6121                	addi	sp,sp,64
 cde:	8082                	ret
