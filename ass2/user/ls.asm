...
int tournament_create(int processes) {
 ...
 a9a:	fff5071b          	addiw	a4,a0,-1
 a9e:	47bd                	li	a5,15
 aa0:	08e7eb63          	bltu	a5,a4,b36 <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 abc:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 abe:	ecbd                	bnez	s1,b3c <tournament_create+0xa2>
  if (n <= 1) 
 ac0:	4785                	li	a5,1
 ac2:	0937d763          	bge	a5,s3,b50 <tournament_create+0xb6>
  int l = 0;
 ac6:	8726                	mv	a4,s1
 ac8:	87ce                	mv	a5,s3
  while (n > 1) {
 aca:	458d                	li	a1,3
    n /= 2;
 acc:	86be                	mv	a3,a5
 ace:	01f7d61b          	srliw	a2,a5,0x1f
 ad2:	9fb1                	addw	a5,a5,a2
 ad4:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 ad8:	2705                	addiw	a4,a4,1
  while (n > 1) {
 ada:	fed5c9e3          	blt	a1,a3,acc <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 ade:	00000797          	auipc	a5,0x0
 ae2:	52e7a723          	sw	a4,1326(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 ae6:	00000917          	auipc	s2,0x0
 aea:	54a90913          	addi	s2,s2,1354 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 aee:	00000097          	auipc	ra,0x0
 af2:	b12080e7          	jalr	-1262(ra) # 600 <peterson_create>
 af6:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 afa:	04054063          	bltz	a0,b3a <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 afe:	2485                	addiw	s1,s1,1
 b00:	0911                	addi	s2,s2,4
 b02:	ff44c6e3          	blt	s1,s4,aee <tournament_create+0x54>
 ...
 b0a:	5007a123          	sw	zero,1282(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 b0e:	4785                	li	a5,1
 b10:	0537d863          	bge	a5,s3,b60 <tournament_create+0xc6>
 b14:	4485                	li	s1,1
        int pid = fork() ;
 b16:	00000097          	auipc	ra,0x0
 b1a:	a42080e7          	jalr	-1470(ra) # 558 <fork>
        if(pid < 0)
 b1e:	02054763          	bltz	a0,b4c <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 b22:	c509                	beqz	a0,b2c <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 b24:	2485                	addiw	s1,s1,1
 b26:	fe9998e3          	bne	s3,s1,b16 <tournament_create+0x7c>
 b2a:	a81d                	j	b60 <tournament_create+0xc6>
            trnmnt_idx = i ;
 b2c:	00000797          	auipc	a5,0x0
 b30:	4c97ae23          	sw	s1,1244(a5) # 1008 <trnmnt_idx>
            break ;
 b34:	a035                	j	b60 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 b36:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 b44:	69a2                	ld	s3,8(sp)
 b46:	6a02                	ld	s4,0(sp)
 b48:	6145                	addi	sp,sp,48
 b4a:	8082                	ret
            return -1 ;
 b4c:	557d                	li	a0,-1
 b4e:	b7fd                	j	b3c <tournament_create+0xa2>
   num_levels = log2(processes) ;
 b50:	00000797          	auipc	a5,0x0
 b54:	4a07ae23          	sw	zero,1212(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 b58:	00000797          	auipc	a5,0x0
 b5c:	4a07a823          	sw	zero,1200(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 b60:	00000517          	auipc	a0,0x0
 b64:	4a852503          	lw	a0,1192(a0) # 1008 <trnmnt_idx>
 b68:	bfd1                	j	b3c <tournament_create+0xa2>

0000000000000b6a <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b6a:	00000797          	auipc	a5,0x0
 b6e:	49e7a783          	lw	a5,1182(a5) # 1008 <trnmnt_idx>
 b72:	0a07c763          	bltz	a5,c20 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 b76:	715d                	addi	sp,sp,-80
 b78:	e486                	sd	ra,72(sp)
 b7a:	e0a2                	sd	s0,64(sp)
 b7c:	fc26                	sd	s1,56(sp)
 b7e:	f84a                	sd	s2,48(sp)
 b80:	f44e                	sd	s3,40(sp)
 b82:	f052                	sd	s4,32(sp)
 b84:	ec56                	sd	s5,24(sp)
 b86:	e85a                	sd	s6,16(sp)
 b88:	e45e                	sd	s7,8(sp)
 b8a:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b8c:	00000497          	auipc	s1,0x0
 b90:	4804a483          	lw	s1,1152(s1) # 100c <num_levels>
 b94:	08905863          	blez	s1,c24 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 b98:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b9a:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b9e:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 ba2:	4705                	li	a4,1
 ba4:	0097173b          	sllw	a4,a4,s1
 ba8:	9fb9                	addw	a5,a5,a4
 baa:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 bac:	4739                	li	a4,14
 bae:	06f74d63          	blt	a4,a5,c28 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 bb2:	00000997          	auipc	s3,0x0
 bb6:	47e98993          	addi	s3,s3,1150 # 1030 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 bba:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 bbc:	00000b97          	auipc	s7,0x0
 bc0:	450b8b93          	addi	s7,s7,1104 # 100c <num_levels>
 bc4:	00000b17          	auipc	s6,0x0
 bc8:	444b0b13          	addi	s6,s6,1092 # 1008 <trnmnt_idx>
 bcc:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 bce:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 bd0:	078a                	slli	a5,a5,0x2
 bd2:	97ce                	add	a5,a5,s3
 bd4:	4388                	lw	a0,0(a5)
 bd6:	00000097          	auipc	ra,0x0
 bda:	a32080e7          	jalr	-1486(ra) # 608 <peterson_acquire>
 bde:	04054763          	bltz	a0,c2c <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 be2:	fff4869b          	addiw	a3,s1,-1
 be6:	0006849b          	sext.w	s1,a3
 bea:	03448963          	beq	s1,s4,c1c <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 bee:	000ba703          	lw	a4,0(s7)
 bf2:	40d706bb          	subw	a3,a4,a3
 bf6:	fff6879b          	addiw	a5,a3,-1
 bfa:	000b2703          	lw	a4,0(s6)
 bfe:	00f915bb          	sllw	a1,s2,a5
 c02:	8df9                	and	a1,a1,a4
 c04:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 c08:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 c0c:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 c10:	9fb9                	addw	a5,a5,a4
 c12:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 c14:	fafadee3          	bge	s5,a5,bd0 <tournament_acquire+0x66>
 c18:	557d                	li	a0,-1
 c1a:	a811                	j	c2e <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 c1c:	4501                	li	a0,0
 c1e:	a801                	j	c2e <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 c20:	557d                	li	a0,-1
}
 c22:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 c24:	557d                	li	a0,-1
 c26:	a021                	j	c2e <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 c28:	557d                	li	a0,-1
 c2a:	a011                	j	c2e <tournament_acquire+0xc4>
        return -1;
 c2c:	557d                	li	a0,-1
}
 c2e:	60a6                	ld	ra,72(sp)
 c30:	6406                	ld	s0,64(sp)
 c32:	74e2                	ld	s1,56(sp)
 c34:	7942                	ld	s2,48(sp)
 c36:	79a2                	ld	s3,40(sp)
 c38:	7a02                	ld	s4,32(sp)
 c3a:	6ae2                	ld	s5,24(sp)
 c3c:	6b42                	ld	s6,16(sp)
 c3e:	6ba2                	ld	s7,8(sp)
 c40:	6161                	addi	sp,sp,80
 c42:	8082                	ret
...
int tournament_release(void) {
 ...
 c4c:	0a07c663          	bltz	a5,cf8 <tournament_release+0xb4>
 c50:	00000717          	auipc	a4,0x0
 c54:	3bc72703          	lw	a4,956(a4) # 100c <num_levels>
 c58:	0ae05263          	blez	a4,cfc <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c5c:	fff7069b          	addiw	a3,a4,-1
 c60:	4585                	li	a1,1
 c62:	00d595bb          	sllw	a1,a1,a3
 c66:	8dfd                	and	a1,a1,a5
 c68:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 c6c:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 c70:	4739                	li	a4,14
 c72:	08f74763          	blt	a4,a5,d00 <tournament_release+0xbc>
int tournament_release(void) {
 ...
 c90:	3a498993          	addi	s3,s3,932 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 c94:	00000a17          	auipc	s4,0x0
 c98:	378a0a13          	addi	s4,s4,888 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c9c:	00000b17          	auipc	s6,0x0
 ca0:	36cb0b13          	addi	s6,s6,876 # 1008 <trnmnt_idx>
 ca4:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ca6:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 ca8:	078a                	slli	a5,a5,0x2
 caa:	97ce                	add	a5,a5,s3
 cac:	4388                	lw	a0,0(a5)
 cae:	00000097          	auipc	ra,0x0
 cb2:	962080e7          	jalr	-1694(ra) # 610 <peterson_release>
 cb6:	04054763          	bltz	a0,d04 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 cba:	0014871b          	addiw	a4,s1,1
 cbe:	0007049b          	sext.w	s1,a4
 cc2:	000a2783          	lw	a5,0(s4)
 cc6:	02f4d763          	bge	s1,a5,cf4 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 cca:	40e7873b          	subw	a4,a5,a4
 cce:	fff7079b          	addiw	a5,a4,-1
 cd2:	000b2683          	lw	a3,0(s6)
 cd6:	00f915bb          	sllw	a1,s2,a5
 cda:	8df5                	and	a1,a1,a3
 cdc:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 ce0:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ce4:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 ce8:	9fb9                	addw	a5,a5,a4
 cea:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 cec:	fafadee3          	bge	s5,a5,ca8 <tournament_release+0x64>
 cf0:	557d                	li	a0,-1
 cf2:	a811                	j	d06 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 cf4:	4501                	li	a0,0
 cf6:	a801                	j	d06 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 cf8:	557d                	li	a0,-1
 cfa:	8082                	ret
 cfc:	557d                	li	a0,-1
