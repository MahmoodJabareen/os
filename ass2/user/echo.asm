...
main(int argc, char *argv[])
{
  ...
  2e:	aa6a0a13          	addi	s4,s4,-1370 # ad0 <tournament_release+0xe0>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	a7058593          	addi	a1,a1,-1424 # ad8 <tournament_release+0xe8>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 414:	6d850513          	addi	a0,a0,1752 # ae8 <digits>
 418:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e0:	60cb8b93          	addi	s7,s7,1548 # ae8 <digits>
 ...
 620:	4c490913          	addi	s2,s2,1220 # ae0 <tournament_release+0xf0>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 846:	fff5071b          	addiw	a4,a0,-1
 84a:	47bd                	li	a5,15
 84c:	08e7eb63          	bltu	a5,a4,8e2 <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 860:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 862:	8a3a                	mv	s4,a4
 864:	00e574b3          	and	s1,a0,a4
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 868:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 86a:	ecbd                	bnez	s1,8e8 <tournament_create+0xa2>
  if (n <= 1) 
 86c:	4785                	li	a5,1
 86e:	0937d763          	bge	a5,s3,8fc <tournament_create+0xb6>
  int l = 0;
 872:	8726                	mv	a4,s1
 874:	87ce                	mv	a5,s3
  while (n > 1) {
 876:	458d                	li	a1,3
    n /= 2;
 878:	86be                	mv	a3,a5
 87a:	01f7d61b          	srliw	a2,a5,0x1f
 87e:	9fb1                	addw	a5,a5,a2
 880:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 884:	2705                	addiw	a4,a4,1
  while (n > 1) {
 886:	fed5c9e3          	blt	a1,a3,878 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 88a:	00000797          	auipc	a5,0x0
 88e:	78e7a123          	sw	a4,1922(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 892:	00000917          	auipc	s2,0x0
 896:	78e90913          	addi	s2,s2,1934 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 89a:	00000097          	auipc	ra,0x0
 89e:	b12080e7          	jalr	-1262(ra) # 3ac <peterson_create>
 8a2:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 8a6:	04054063          	bltz	a0,8e6 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 8aa:	2485                	addiw	s1,s1,1
 8ac:	0911                	addi	s2,s2,4
 8ae:	ff44c6e3          	blt	s1,s4,89a <tournament_create+0x54>
 ...
 8b6:	7407ab23          	sw	zero,1878(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 8ba:	4785                	li	a5,1
 8bc:	0537d863          	bge	a5,s3,90c <tournament_create+0xc6>
 8c0:	4485                	li	s1,1
        int pid = fork() ;
 8c2:	00000097          	auipc	ra,0x0
 8c6:	a42080e7          	jalr	-1470(ra) # 304 <fork>
        if(pid < 0)
 8ca:	02054763          	bltz	a0,8f8 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 8ce:	c509                	beqz	a0,8d8 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 8d0:	2485                	addiw	s1,s1,1
 8d2:	fe9998e3          	bne	s3,s1,8c2 <tournament_create+0x7c>
 8d6:	a81d                	j	90c <tournament_create+0xc6>
            trnmnt_idx = i ;
 8d8:	00000797          	auipc	a5,0x0
 8dc:	7297a823          	sw	s1,1840(a5) # 1008 <trnmnt_idx>
            break ;
 8e0:	a035                	j	90c <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 8e2:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 8f6:	8082                	ret
            return -1 ;
 8f8:	557d                	li	a0,-1
 8fa:	b7fd                	j	8e8 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 8fc:	00000797          	auipc	a5,0x0
 900:	7007a823          	sw	zero,1808(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 904:	00000797          	auipc	a5,0x0
 908:	7007a223          	sw	zero,1796(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 90c:	00000517          	auipc	a0,0x0
 910:	6fc52503          	lw	a0,1788(a0) # 1008 <trnmnt_idx>
 914:	bfd1                	j	8e8 <tournament_create+0xa2>

0000000000000916 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 916:	00000797          	auipc	a5,0x0
 91a:	6f27a783          	lw	a5,1778(a5) # 1008 <trnmnt_idx>
 91e:	0a07c763          	bltz	a5,9cc <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 922:	715d                	addi	sp,sp,-80
 924:	e486                	sd	ra,72(sp)
 926:	e0a2                	sd	s0,64(sp)
 928:	fc26                	sd	s1,56(sp)
 92a:	f84a                	sd	s2,48(sp)
 92c:	f44e                	sd	s3,40(sp)
 92e:	f052                	sd	s4,32(sp)
 930:	ec56                	sd	s5,24(sp)
 932:	e85a                	sd	s6,16(sp)
 934:	e45e                	sd	s7,8(sp)
 936:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 938:	00000497          	auipc	s1,0x0
 93c:	6d44a483          	lw	s1,1748(s1) # 100c <num_levels>
 940:	08905863          	blez	s1,9d0 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 944:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 946:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 94a:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 94e:	4705                	li	a4,1
 950:	0097173b          	sllw	a4,a4,s1
 954:	9fb9                	addw	a5,a5,a4
 956:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 958:	4739                	li	a4,14
 95a:	06f74d63          	blt	a4,a5,9d4 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 95e:	00000997          	auipc	s3,0x0
 962:	6c298993          	addi	s3,s3,1730 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 966:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 968:	00000b97          	auipc	s7,0x0
 96c:	6a4b8b93          	addi	s7,s7,1700 # 100c <num_levels>
 970:	00000b17          	auipc	s6,0x0
 974:	698b0b13          	addi	s6,s6,1688 # 1008 <trnmnt_idx>
 978:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 97a:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 97c:	078a                	slli	a5,a5,0x2
 97e:	97ce                	add	a5,a5,s3
 980:	4388                	lw	a0,0(a5)
 982:	00000097          	auipc	ra,0x0
 986:	a32080e7          	jalr	-1486(ra) # 3b4 <peterson_acquire>
 98a:	04054763          	bltz	a0,9d8 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 98e:	fff4869b          	addiw	a3,s1,-1
 992:	0006849b          	sext.w	s1,a3
 996:	03448963          	beq	s1,s4,9c8 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 99a:	000ba703          	lw	a4,0(s7)
 99e:	40d706bb          	subw	a3,a4,a3
 9a2:	fff6879b          	addiw	a5,a3,-1
 9a6:	000b2703          	lw	a4,0(s6)
 9aa:	00f915bb          	sllw	a1,s2,a5
 9ae:	8df9                	and	a1,a1,a4
 9b0:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 9b4:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9b8:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 9bc:	9fb9                	addw	a5,a5,a4
 9be:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9c0:	fafadee3          	bge	s5,a5,97c <tournament_acquire+0x66>
 9c4:	557d                	li	a0,-1
 9c6:	a811                	j	9da <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 9c8:	4501                	li	a0,0
 9ca:	a801                	j	9da <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9cc:	557d                	li	a0,-1
}
 9ce:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9d0:	557d                	li	a0,-1
 9d2:	a021                	j	9da <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 9d4:	557d                	li	a0,-1
 9d6:	a011                	j	9da <tournament_acquire+0xc4>
        return -1;
 9d8:	557d                	li	a0,-1
}
...
00000000000009f0 <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9f0:	00000797          	auipc	a5,0x0
 9f4:	6187a783          	lw	a5,1560(a5) # 1008 <trnmnt_idx>
 9f8:	0a07c663          	bltz	a5,aa4 <tournament_release+0xb4>
 9fc:	00000717          	auipc	a4,0x0
 a00:	61072703          	lw	a4,1552(a4) # 100c <num_levels>
 a04:	0ae05263          	blez	a4,aa8 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a08:	fff7069b          	addiw	a3,a4,-1
 a0c:	4585                	li	a1,1
 a0e:	00d595bb          	sllw	a1,a1,a3
 a12:	8dfd                	and	a1,a1,a5
 a14:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a18:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 a1c:	4739                	li	a4,14
 a1e:	08f74763          	blt	a4,a5,aac <tournament_release+0xbc>
int tournament_release(void) {
 ...
 a38:	00000997          	auipc	s3,0x0
 a3c:	5e898993          	addi	s3,s3,1512 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a40:	00000a17          	auipc	s4,0x0
 a44:	5cca0a13          	addi	s4,s4,1484 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a48:	00000b17          	auipc	s6,0x0
 a4c:	5c0b0b13          	addi	s6,s6,1472 # 1008 <trnmnt_idx>
 a50:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a52:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 a54:	078a                	slli	a5,a5,0x2
 a56:	97ce                	add	a5,a5,s3
 a58:	4388                	lw	a0,0(a5)
 a5a:	00000097          	auipc	ra,0x0
 a5e:	962080e7          	jalr	-1694(ra) # 3bc <peterson_release>
 a62:	04054763          	bltz	a0,ab0 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a66:	0014871b          	addiw	a4,s1,1
 a6a:	0007049b          	sext.w	s1,a4
 a6e:	000a2783          	lw	a5,0(s4)
 a72:	02f4d763          	bge	s1,a5,aa0 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a76:	40e7873b          	subw	a4,a5,a4
 a7a:	fff7079b          	addiw	a5,a4,-1
 a7e:	000b2683          	lw	a3,0(s6)
 a82:	00f915bb          	sllw	a1,s2,a5
 a86:	8df5                	and	a1,a1,a3
 a88:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a8c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a90:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 a94:	9fb9                	addw	a5,a5,a4
 a96:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a98:	fafadee3          	bge	s5,a5,a54 <tournament_release+0x64>
 a9c:	557d                	li	a0,-1
 a9e:	a811                	j	ab2 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 aa0:	4501                	li	a0,0
 aa2:	a801                	j	ab2 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 aa4:	557d                	li	a0,-1
 aa6:	8082                	ret
 aa8:	557d                	li	a0,-1
