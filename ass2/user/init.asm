...
main(void)
{
  ...
  12:	b3250513          	addi	a0,a0,-1230 # b40 <tournament_release+0xdc>
  ...
  3a:	b1290913          	addi	s2,s2,-1262 # b48 <tournament_release+0xe4>
  3e:	854a                	mv	a0,s2
  ...
  6e:	b2e50513          	addi	a0,a0,-1234 # b98 <tournament_release+0x134>
  ...
  8c:	ab850513          	addi	a0,a0,-1352 # b40 <tournament_release+0xdc>
  90:	00000097          	auipc	ra,0x0
  94:	338080e7          	jalr	824(ra) # 3c8 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	aa650513          	addi	a0,a0,-1370 # b40 <tournament_release+0xdc>
  a2:	00000097          	auipc	ra,0x0
  a6:	31e080e7          	jalr	798(ra) # 3c0 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	ab450513          	addi	a0,a0,-1356 # b60 <tournament_release+0xfc>
  ...
  d2:	aaa50513          	addi	a0,a0,-1366 # b78 <tournament_release+0x114>
  d6:	00000097          	auipc	ra,0x0
  da:	2e2080e7          	jalr	738(ra) # 3b8 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	aa250513          	addi	a0,a0,-1374 # b80 <tournament_release+0x11c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 488:	73c50513          	addi	a0,a0,1852 # bc0 <digits>
 48c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 554:	670b8b93          	addi	s7,s7,1648 # bc0 <digits>
 ...
 694:	52890913          	addi	s2,s2,1320 # bb8 <tournament_release+0x154>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 8ba:	fff5071b          	addiw	a4,a0,-1
 8be:	47bd                	li	a5,15
 8c0:	08e7eb63          	bltu	a5,a4,956 <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 8d4:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 8d6:	8a3a                	mv	s4,a4
 8d8:	00e574b3          	and	s1,a0,a4
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 8dc:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 8de:	ecbd                	bnez	s1,95c <tournament_create+0xa2>
  if (n <= 1) 
 8e0:	4785                	li	a5,1
 8e2:	0937d763          	bge	a5,s3,970 <tournament_create+0xb6>
  int l = 0;
 8e6:	8726                	mv	a4,s1
 8e8:	87ce                	mv	a5,s3
  while (n > 1) {
 8ea:	458d                	li	a1,3
    n /= 2;
 8ec:	86be                	mv	a3,a5
 8ee:	01f7d61b          	srliw	a2,a5,0x1f
 8f2:	9fb1                	addw	a5,a5,a2
 8f4:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 8f8:	2705                	addiw	a4,a4,1
  while (n > 1) {
 8fa:	fed5c9e3          	blt	a1,a3,8ec <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 8fe:	00000797          	auipc	a5,0x0
 902:	70e7af23          	sw	a4,1822(a5) # 101c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 906:	00000917          	auipc	s2,0x0
 90a:	72a90913          	addi	s2,s2,1834 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 90e:	00000097          	auipc	ra,0x0
 912:	b12080e7          	jalr	-1262(ra) # 420 <peterson_create>
 916:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 91a:	04054063          	bltz	a0,95a <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 91e:	2485                	addiw	s1,s1,1
 920:	0911                	addi	s2,s2,4
 922:	ff44c6e3          	blt	s1,s4,90e <tournament_create+0x54>
 ...
 92a:	6e07a923          	sw	zero,1778(a5) # 1018 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 92e:	4785                	li	a5,1
 930:	0537d863          	bge	a5,s3,980 <tournament_create+0xc6>
 934:	4485                	li	s1,1
        int pid = fork() ;
 936:	00000097          	auipc	ra,0x0
 93a:	a42080e7          	jalr	-1470(ra) # 378 <fork>
        if(pid < 0)
 93e:	02054763          	bltz	a0,96c <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 942:	c509                	beqz	a0,94c <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 944:	2485                	addiw	s1,s1,1
 946:	fe9998e3          	bne	s3,s1,936 <tournament_create+0x7c>
 94a:	a81d                	j	980 <tournament_create+0xc6>
            trnmnt_idx = i ;
 94c:	00000797          	auipc	a5,0x0
 950:	6c97a623          	sw	s1,1740(a5) # 1018 <trnmnt_idx>
            break ;
 954:	a035                	j	980 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 956:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 96a:	8082                	ret
            return -1 ;
 96c:	557d                	li	a0,-1
 96e:	b7fd                	j	95c <tournament_create+0xa2>
   num_levels = log2(processes) ;
 970:	00000797          	auipc	a5,0x0
 974:	6a07a623          	sw	zero,1708(a5) # 101c <num_levels>
   trnmnt_idx = 0;
 978:	00000797          	auipc	a5,0x0
 97c:	6a07a023          	sw	zero,1696(a5) # 1018 <trnmnt_idx>
return trnmnt_idx ;
 980:	00000517          	auipc	a0,0x0
 984:	69852503          	lw	a0,1688(a0) # 1018 <trnmnt_idx>
 988:	bfd1                	j	95c <tournament_create+0xa2>

000000000000098a <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 98a:	00000797          	auipc	a5,0x0
 98e:	68e7a783          	lw	a5,1678(a5) # 1018 <trnmnt_idx>
 992:	0a07c763          	bltz	a5,a40 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 ...
 9b0:	6704a483          	lw	s1,1648(s1) # 101c <num_levels>
 9b4:	08905863          	blez	s1,a44 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9b8:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9ba:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9be:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 9c2:	4705                	li	a4,1
 9c4:	0097173b          	sllw	a4,a4,s1
 9c8:	9fb9                	addw	a5,a5,a4
 9ca:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9cc:	4739                	li	a4,14
 9ce:	06f74d63          	blt	a4,a5,a48 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 9d2:	00000997          	auipc	s3,0x0
 9d6:	65e98993          	addi	s3,s3,1630 # 1030 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9da:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9dc:	00000b97          	auipc	s7,0x0
 9e0:	640b8b93          	addi	s7,s7,1600 # 101c <num_levels>
 9e4:	00000b17          	auipc	s6,0x0
 9e8:	634b0b13          	addi	s6,s6,1588 # 1018 <trnmnt_idx>
 9ec:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9ee:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 9f0:	078a                	slli	a5,a5,0x2
 9f2:	97ce                	add	a5,a5,s3
 9f4:	4388                	lw	a0,0(a5)
 9f6:	00000097          	auipc	ra,0x0
 9fa:	a32080e7          	jalr	-1486(ra) # 428 <peterson_acquire>
 9fe:	04054763          	bltz	a0,a4c <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a02:	fff4869b          	addiw	a3,s1,-1
 a06:	0006849b          	sext.w	s1,a3
 a0a:	03448963          	beq	s1,s4,a3c <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a0e:	000ba703          	lw	a4,0(s7)
 a12:	40d706bb          	subw	a3,a4,a3
 a16:	fff6879b          	addiw	a5,a3,-1
 a1a:	000b2703          	lw	a4,0(s6)
 a1e:	00f915bb          	sllw	a1,s2,a5
 a22:	8df9                	and	a1,a1,a4
 a24:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a28:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a2c:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a30:	9fb9                	addw	a5,a5,a4
 a32:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a34:	fafadee3          	bge	s5,a5,9f0 <tournament_acquire+0x66>
 a38:	557d                	li	a0,-1
 a3a:	a811                	j	a4e <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 a3c:	4501                	li	a0,0
 a3e:	a801                	j	a4e <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a40:	557d                	li	a0,-1
}
 a42:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a44:	557d                	li	a0,-1
 a46:	a021                	j	a4e <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a48:	557d                	li	a0,-1
 a4a:	a011                	j	a4e <tournament_acquire+0xc4>
        return -1;
 a4c:	557d                	li	a0,-1
}
 a4e:	60a6                	ld	ra,72(sp)
 a50:	6406                	ld	s0,64(sp)
 a52:	74e2                	ld	s1,56(sp)
 a54:	7942                	ld	s2,48(sp)
 a56:	79a2                	ld	s3,40(sp)
 a58:	7a02                	ld	s4,32(sp)
 a5a:	6ae2                	ld	s5,24(sp)
 a5c:	6b42                	ld	s6,16(sp)
 a5e:	6ba2                	ld	s7,8(sp)
 a60:	6161                	addi	sp,sp,80
 a62:	8082                	ret

0000000000000a64 <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a64:	00000797          	auipc	a5,0x0
 a68:	5b47a783          	lw	a5,1460(a5) # 1018 <trnmnt_idx>
 a6c:	0a07c663          	bltz	a5,b18 <tournament_release+0xb4>
 a70:	00000717          	auipc	a4,0x0
 a74:	5ac72703          	lw	a4,1452(a4) # 101c <num_levels>
 a78:	0ae05263          	blez	a4,b1c <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a7c:	fff7069b          	addiw	a3,a4,-1
 a80:	4585                	li	a1,1
 a82:	00d595bb          	sllw	a1,a1,a3
 a86:	8dfd                	and	a1,a1,a5
 a88:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a8c:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 a90:	4739                	li	a4,14
 a92:	08f74763          	blt	a4,a5,b20 <tournament_release+0xbc>
int tournament_release(void) {
 ...
 aac:	00000997          	auipc	s3,0x0
 ab0:	58498993          	addi	s3,s3,1412 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 ab4:	00000a17          	auipc	s4,0x0
 ab8:	568a0a13          	addi	s4,s4,1384 # 101c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 abc:	00000b17          	auipc	s6,0x0
 ac0:	55cb0b13          	addi	s6,s6,1372 # 1018 <trnmnt_idx>
 ac4:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ac6:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 ac8:	078a                	slli	a5,a5,0x2
 aca:	97ce                	add	a5,a5,s3
 acc:	4388                	lw	a0,0(a5)
 ace:	00000097          	auipc	ra,0x0
 ad2:	962080e7          	jalr	-1694(ra) # 430 <peterson_release>
 ad6:	04054763          	bltz	a0,b24 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 ada:	0014871b          	addiw	a4,s1,1
 ade:	0007049b          	sext.w	s1,a4
 ae2:	000a2783          	lw	a5,0(s4)
 ae6:	02f4d763          	bge	s1,a5,b14 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 aea:	40e7873b          	subw	a4,a5,a4
 aee:	fff7079b          	addiw	a5,a4,-1
 af2:	000b2683          	lw	a3,0(s6)
 af6:	00f915bb          	sllw	a1,s2,a5
 afa:	8df5                	and	a1,a1,a3
 afc:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b00:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b04:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 b08:	9fb9                	addw	a5,a5,a4
 b0a:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b0c:	fafadee3          	bge	s5,a5,ac8 <tournament_release+0x64>
 b10:	557d                	li	a0,-1
 b12:	a811                	j	b26 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 b14:	4501                	li	a0,0
 b16:	a801                	j	b26 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b18:	557d                	li	a0,-1
 b1a:	8082                	ret
 b1c:	557d                	li	a0,-1
