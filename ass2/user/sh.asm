...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	58e58593          	addi	a1,a1,1422 # 15a0 <tournament_release+0xde>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	54858593          	addi	a1,a1,1352 # 15a8 <tournament_release+0xe6>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	51650513          	addi	a0,a0,1302 # 15b0 <tournament_release+0xee>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	5ea70713          	addi	a4,a4,1514 # 16b0 <tournament_release+0x1ee>
    ...
    panic("runcmd");
      ...
      e4:	4d850513          	addi	a0,a0,1240 # 15b8 <tournament_release+0xf6>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	4be58593          	addi	a1,a1,1214 # 15c0 <tournament_release+0xfe>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	48258593          	addi	a1,a1,1154 # 15d0 <tournament_release+0x10e>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	3fc50513          	addi	a0,a0,1020 # 15e0 <tournament_release+0x11e>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	064b8b93          	addi	s7,s7,100 # 1608 <tournament_release+0x146>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	03250513          	addi	a0,a0,50 # 15e8 <tournament_release+0x126>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	f7260613          	addi	a2,a2,-142 # 1610 <tournament_release+0x14e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	f62b0b13          	addi	s6,s6,-158 # 1630 <tournament_release+0x16e>
  ...
  return ret;
     ...
     70c:	f1050513          	addi	a0,a0,-240 # 1618 <tournament_release+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	eb650513          	addi	a0,a0,-330 # 1620 <tournament_release+0x15e>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	e9460613          	addi	a2,a2,-364 # 1638 <tournament_release+0x176>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	e2ca0a13          	addi	s4,s4,-468 # 1640 <tournament_release+0x17e>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	dfe60613          	addi	a2,a2,-514 # 1648 <tournament_release+0x186>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	d6060613          	addi	a2,a2,-672 # 1610 <tournament_release+0x14e>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	d8060613          	addi	a2,a2,-640 # 1660 <tournament_release+0x19e>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	d2e50513          	addi	a0,a0,-722 # 1650 <tournament_release+0x18e>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	d3650513          	addi	a0,a0,-714 # 1668 <tournament_release+0x1a6>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	d6a70713          	addi	a4,a4,-662 # 16c8 <tournament_release+0x206>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	c7660613          	addi	a2,a2,-906 # 1680 <tournament_release+0x1be>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	c4858593          	addi	a1,a1,-952 # 1688 <tournament_release+0x1c6>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	6fe080e7          	jalr	1790(ra) # 1148 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	bc650513          	addi	a0,a0,-1082 # 1618 <tournament_release+0x156>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	c2448493          	addi	s1,s1,-988 # 1698 <tournament_release+0x1d6>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	beea8a93          	addi	s5,s5,-1042 # 16a0 <tournament_release+0x1de>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee6:	80650513          	addi	a0,a0,-2042 # 16e8 <digits>
     eea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fb2:	73ab8b93          	addi	s7,s7,1850 # 16e8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10f2:	5f290913          	addi	s2,s2,1522 # 16e0 <tournament_release+0x21e>
        while(*s != 0){
...
int tournament_create(int processes) {
    1318:	7179                	addi	sp,sp,-48
    131a:	f406                	sd	ra,40(sp)
    131c:	f022                	sd	s0,32(sp)
    131e:	ec26                	sd	s1,24(sp)
    1320:	e84a                	sd	s2,16(sp)
    1322:	e44e                	sd	s3,8(sp)
    1324:	e052                	sd	s4,0(sp)
    1326:	1800                	addi	s0,sp,48
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    1328:	fff5071b          	addiw	a4,a0,-1
    132c:	47bd                	li	a5,15
    132e:	00e7ee63          	bltu	a5,a4,134a <tournament_create+0x32>
    1332:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
    1334:	8a3a                	mv	s4,a4
    1336:	00e574b3          	and	s1,a0,a4
    133a:	c0b9                	beqz	s1,1380 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    133c:	54fd                	li	s1,-1
    133e:	a809                	j	1350 <tournament_create+0x38>
   for(int i = 1; i < processes  ; i++){
    ...
    1344:	cc97ac23          	sw	s1,-808(a5) # 2018 <trnmnt_idx>
            return trnmnt_idx ;
    1348:	a021                	j	1350 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    134a:	54fd                	li	s1,-1
    134c:	a011                	j	1350 <tournament_create+0x38>
...
return trnmnt_idx ;
    ...
    1356:	64e2                	ld	s1,24(sp)
    1358:	6942                	ld	s2,16(sp)
    135a:	69a2                	ld	s3,8(sp)
    135c:	6a02                	ld	s4,0(sp)
    135e:	6145                	addi	sp,sp,48
    1360:	8082                	ret
            return -1 ;
    1362:	54fd                	li	s1,-1
    1364:	b7f5                	j	1350 <tournament_create+0x38>
   num_levels = log2(processes) ;
    1366:	00001797          	auipc	a5,0x1
    136a:	ca07ad23          	sw	zero,-838(a5) # 2020 <num_levels>
   trnmnt_idx = 0;
    136e:	00001797          	auipc	a5,0x1
    1372:	ca07a523          	sw	zero,-854(a5) # 2018 <trnmnt_idx>
return trnmnt_idx ;
    1376:	00001497          	auipc	s1,0x1
    137a:	ca24a483          	lw	s1,-862(s1) # 2018 <trnmnt_idx>
    137e:	bfc9                	j	1350 <tournament_create+0x38>
   num_processes = processes ;
    1380:	00001797          	auipc	a5,0x1
    1384:	c8a7ae23          	sw	a0,-868(a5) # 201c <num_processes>
  if (n <= 1) 
    1388:	4785                	li	a5,1
    138a:	fca7dee3          	bge	a5,a0,1366 <tournament_create+0x4e>
  int l = 0;
    138e:	8726                	mv	a4,s1
    1390:	87aa                	mv	a5,a0
  while (n > 1) {
    ...
    n /= 2;
    1394:	86be                	mv	a3,a5
    1396:	01f7d61b          	srliw	a2,a5,0x1f
    139a:	9fb1                	addw	a5,a5,a2
    139c:	4017d79b          	sraiw	a5,a5,0x1
    l++;
    13a0:	2705                	addiw	a4,a4,1
  while (n > 1) {
    13a2:	fed5c9e3          	blt	a1,a3,1394 <tournament_create+0x7c>
   num_levels = log2(processes) ;
    13a6:	00001797          	auipc	a5,0x1
    13aa:	c6e7ad23          	sw	a4,-902(a5) # 2020 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
    13ae:	00001917          	auipc	s2,0x1
    13b2:	cfa90913          	addi	s2,s2,-774 # 20a8 <lock_ids>
    lock_ids[i]= peterson_create() ;
    13b6:	00000097          	auipc	ra,0x0
    13ba:	ac8080e7          	jalr	-1336(ra) # e7e <peterson_create>
    13be:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
    13c2:	f80546e3          	bltz	a0,134e <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
    13c6:	2485                	addiw	s1,s1,1
    13c8:	0911                	addi	s2,s2,4
    13ca:	ff44c6e3          	blt	s1,s4,13b6 <tournament_create+0x9e>
   trnmnt_idx = 0;
    13ce:	00001797          	auipc	a5,0x1
    13d2:	c407a523          	sw	zero,-950(a5) # 2018 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
    13d6:	4785                	li	a5,1
    13d8:	f937dfe3          	bge	a5,s3,1376 <tournament_create+0x5e>
    13dc:	4485                	li	s1,1
        int pid = fork() ;
    13de:	00000097          	auipc	ra,0x0
    13e2:	9f8080e7          	jalr	-1544(ra) # dd6 <fork>
        if(pid < 0)
    13e6:	f6054ee3          	bltz	a0,1362 <tournament_create+0x4a>
        if(pid == 0){
    13ea:	d939                	beqz	a0,1340 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
    13ec:	2485                	addiw	s1,s1,1
    13ee:	fe9998e3          	bne	s3,s1,13de <tournament_create+0xc6>
    13f2:	b751                	j	1376 <tournament_create+0x5e>

00000000000013f4 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    13f4:	00001797          	auipc	a5,0x1
    13f8:	c247a783          	lw	a5,-988(a5) # 2018 <trnmnt_idx>
    13fc:	0a07cd63          	bltz	a5,14b6 <tournament_acquire+0xc2>
    1400:	00001717          	auipc	a4,0x1
    1404:	c2072703          	lw	a4,-992(a4) # 2020 <num_levels>
    1408:	0ae05963          	blez	a4,14ba <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    140c:	fff7069b          	addiw	a3,a4,-1
    1410:	4585                	li	a1,1
    1412:	00d595bb          	sllw	a1,a1,a3
    1416:	8dfd                	and	a1,a1,a5
    1418:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    141c:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
    1420:	4739                	li	a4,14
    1422:	08f74e63          	blt	a4,a5,14be <tournament_acquire+0xca>
int tournament_acquire(void){ 
    1426:	7139                	addi	sp,sp,-64
    1428:	fc06                	sd	ra,56(sp)
    142a:	f822                	sd	s0,48(sp)
    142c:	f426                	sd	s1,40(sp)
    142e:	f04a                	sd	s2,32(sp)
    1430:	ec4e                	sd	s3,24(sp)
    1432:	e852                	sd	s4,16(sp)
    1434:	e456                	sd	s5,8(sp)
    1436:	e05a                	sd	s6,0(sp)
    1438:	0080                	addi	s0,sp,64
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
    143a:	4481                	li	s1,0

        peterson_acquire(lock_ids[lockidx] , role) ;
    143c:	00001a17          	auipc	s4,0x1
    1440:	c6ca0a13          	addi	s4,s4,-916 # 20a8 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
    1444:	00001997          	auipc	s3,0x1
    1448:	bdc98993          	addi	s3,s3,-1060 # 2020 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    144c:	00001b17          	auipc	s6,0x1
    1450:	bccb0b13          	addi	s6,s6,-1076 # 2018 <trnmnt_idx>
    1454:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1456:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
    1458:	078a                	slli	a5,a5,0x2
    145a:	97d2                	add	a5,a5,s4
    145c:	4388                	lw	a0,0(a5)
    145e:	00000097          	auipc	ra,0x0
    1462:	a28080e7          	jalr	-1496(ra) # e86 <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
    1466:	0014871b          	addiw	a4,s1,1
    146a:	0007049b          	sext.w	s1,a4
    146e:	0009a783          	lw	a5,0(s3)
    1472:	02f4d763          	bge	s1,a5,14a0 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    1476:	40e7873b          	subw	a4,a5,a4
    147a:	fff7079b          	addiw	a5,a4,-1
    147e:	000b2683          	lw	a3,0(s6)
    1482:	00f915bb          	sllw	a1,s2,a5
    1486:	8df5                	and	a1,a1,a3
    1488:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    148c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    1490:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
    1494:	9fb9                	addw	a5,a5,a4
    1496:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1498:	fcfad0e3          	bge	s5,a5,1458 <tournament_acquire+0x64>
    149c:	557d                	li	a0,-1
    149e:	a011                	j	14a2 <tournament_acquire+0xae>
...
return 0 ;
    ...
    14ac:	6a42                	ld	s4,16(sp)
    14ae:	6aa2                	ld	s5,8(sp)
    14b0:	6b02                	ld	s6,0(sp)
    14b2:	6121                	addi	sp,sp,64
    14b4:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    14b6:	557d                	li	a0,-1
    14b8:	8082                	ret
...
00000000000014c2 <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    14c2:	00001797          	auipc	a5,0x1
    14c6:	b567a783          	lw	a5,-1194(a5) # 2018 <trnmnt_idx>
    14ca:	0a07cf63          	bltz	a5,1588 <tournament_release+0xc6>
int tournament_release(void) {
    14ce:	715d                	addi	sp,sp,-80
    14d0:	e486                	sd	ra,72(sp)
    14d2:	e0a2                	sd	s0,64(sp)
    14d4:	fc26                	sd	s1,56(sp)
    14d6:	f84a                	sd	s2,48(sp)
    14d8:	f44e                	sd	s3,40(sp)
    14da:	f052                	sd	s4,32(sp)
    14dc:	ec56                	sd	s5,24(sp)
    14de:	e85a                	sd	s6,16(sp)
    14e0:	e45e                	sd	s7,8(sp)
    14e2:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    14e4:	00001497          	auipc	s1,0x1
    14e8:	b3c4a483          	lw	s1,-1220(s1) # 2020 <num_levels>
    14ec:	0a905063          	blez	s1,158c <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
    14f0:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    14f2:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    14f6:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
    14fa:	4705                	li	a4,1
    14fc:	0097173b          	sllw	a4,a4,s1
    1500:	9fb9                	addw	a5,a5,a4
    1502:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1504:	4739                	li	a4,14
    1506:	08f74563          	blt	a4,a5,1590 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
    150a:	00001a17          	auipc	s4,0x1
    150e:	b9ea0a13          	addi	s4,s4,-1122 # 20a8 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
    1512:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    1514:	00001b97          	auipc	s7,0x1
    1518:	b0cb8b93          	addi	s7,s7,-1268 # 2020 <num_levels>
    151c:	00001b17          	auipc	s6,0x1
    1520:	afcb0b13          	addi	s6,s6,-1284 # 2018 <trnmnt_idx>
    1524:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1526:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
    1528:	078a                	slli	a5,a5,0x2
    152a:	97d2                	add	a5,a5,s4
    152c:	4388                	lw	a0,0(a5)
    152e:	00000097          	auipc	ra,0x0
    1532:	960080e7          	jalr	-1696(ra) # e8e <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
    1536:	fff4869b          	addiw	a3,s1,-1
    153a:	0006849b          	sext.w	s1,a3
    153e:	03348963          	beq	s1,s3,1570 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    1542:	000ba703          	lw	a4,0(s7)
    1546:	40d706bb          	subw	a3,a4,a3
    154a:	fff6879b          	addiw	a5,a3,-1
    154e:	000b2703          	lw	a4,0(s6)
    1552:	00f915bb          	sllw	a1,s2,a5
    1556:	8df9                	and	a1,a1,a4
    1558:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    155c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    1560:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
    1564:	9fb9                	addw	a5,a5,a4
    1566:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1568:	fcfad0e3          	bge	s5,a5,1528 <tournament_release+0x66>
    156c:	557d                	li	a0,-1
    156e:	a011                	j	1572 <tournament_release+0xb0>
...
return 0 ;
    ...
    1572:	60a6                	ld	ra,72(sp)
    1574:	6406                	ld	s0,64(sp)
    1576:	74e2                	ld	s1,56(sp)
    1578:	7942                	ld	s2,48(sp)
    157a:	79a2                	ld	s3,40(sp)
    157c:	7a02                	ld	s4,32(sp)
    157e:	6ae2                	ld	s5,24(sp)
    1580:	6b42                	ld	s6,16(sp)
    1582:	6ba2                	ld	s7,8(sp)
    1584:	6161                	addi	sp,sp,80
    1586:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    1588:	557d                	li	a0,-1
}
    ...
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    158c:	557d                	li	a0,-1
    158e:	b7d5                	j	1572 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
    1590:	557d                	li	a0,-1
    1592:	b7c5                	j	1572 <tournament_release+0xb0>
