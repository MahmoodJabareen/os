...
main(int argc, char **argv)
{
  ...
  4c:	a6858593          	addi	a1,a1,-1432 # ab0 <tournament_release+0xe0>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	6e050513          	addi	a0,a0,1760 # ad0 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	614b8b93          	addi	s7,s7,1556 # ad0 <digits>
 ...
 600:	4cc90913          	addi	s2,s2,1228 # ac8 <tournament_release+0xf8>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 826:	fff5071b          	addiw	a4,a0,-1
 82a:	47bd                	li	a5,15
 82c:	08e7eb63          	bltu	a5,a4,8c2 <tournament_create+0x9c>
int tournament_create(int processes) {
 830:	7179                	addi	sp,sp,-48
 832:	f406                	sd	ra,40(sp)
 834:	f022                	sd	s0,32(sp)
 836:	ec26                	sd	s1,24(sp)
 ...
 840:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 842:	8a3a                	mv	s4,a4
 844:	00e574b3          	and	s1,a0,a4
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 848:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 84a:	ecbd                	bnez	s1,8c8 <tournament_create+0xa2>
  if (n <= 1) 
 84c:	4785                	li	a5,1
 84e:	0937d763          	bge	a5,s3,8dc <tournament_create+0xb6>
  int l = 0;
 852:	8726                	mv	a4,s1
 854:	87ce                	mv	a5,s3
  while (n > 1) {
 856:	458d                	li	a1,3
    n /= 2;
 858:	86be                	mv	a3,a5
 85a:	01f7d61b          	srliw	a2,a5,0x1f
 85e:	9fb1                	addw	a5,a5,a2
 860:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 864:	2705                	addiw	a4,a4,1
  while (n > 1) {
 866:	fed5c9e3          	blt	a1,a3,858 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 86a:	00000797          	auipc	a5,0x0
 86e:	7ae7a123          	sw	a4,1954(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 872:	00000917          	auipc	s2,0x0
 876:	7ae90913          	addi	s2,s2,1966 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 87a:	00000097          	auipc	ra,0x0
 87e:	b12080e7          	jalr	-1262(ra) # 38c <peterson_create>
 882:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 886:	04054063          	bltz	a0,8c6 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 88a:	2485                	addiw	s1,s1,1
 88c:	0911                	addi	s2,s2,4
 88e:	ff44c6e3          	blt	s1,s4,87a <tournament_create+0x54>
 ...
 896:	7607ab23          	sw	zero,1910(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 89a:	4785                	li	a5,1
 89c:	0537d863          	bge	a5,s3,8ec <tournament_create+0xc6>
 8a0:	4485                	li	s1,1
        int pid = fork() ;
 8a2:	00000097          	auipc	ra,0x0
 8a6:	a42080e7          	jalr	-1470(ra) # 2e4 <fork>
        if(pid < 0)
 8aa:	02054763          	bltz	a0,8d8 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 8ae:	c509                	beqz	a0,8b8 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 8b0:	2485                	addiw	s1,s1,1
 8b2:	fe9998e3          	bne	s3,s1,8a2 <tournament_create+0x7c>
 8b6:	a81d                	j	8ec <tournament_create+0xc6>
            trnmnt_idx = i ;
 8b8:	00000797          	auipc	a5,0x0
 8bc:	7497a823          	sw	s1,1872(a5) # 1008 <trnmnt_idx>
            break ;
 8c0:	a035                	j	8ec <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 8c2:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 8c8:	70a2                	ld	ra,40(sp)
 8ca:	7402                	ld	s0,32(sp)
 8cc:	64e2                	ld	s1,24(sp)
 ...
 8d6:	8082                	ret
            return -1 ;
 8d8:	557d                	li	a0,-1
 8da:	b7fd                	j	8c8 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 8dc:	00000797          	auipc	a5,0x0
 8e0:	7207a823          	sw	zero,1840(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 8e4:	00000797          	auipc	a5,0x0
 8e8:	7207a223          	sw	zero,1828(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 8ec:	00000517          	auipc	a0,0x0
 8f0:	71c52503          	lw	a0,1820(a0) # 1008 <trnmnt_idx>
 8f4:	bfd1                	j	8c8 <tournament_create+0xa2>

00000000000008f6 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 8f6:	00000797          	auipc	a5,0x0
 8fa:	7127a783          	lw	a5,1810(a5) # 1008 <trnmnt_idx>
 8fe:	0a07c763          	bltz	a5,9ac <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 902:	715d                	addi	sp,sp,-80
 904:	e486                	sd	ra,72(sp)
 906:	e0a2                	sd	s0,64(sp)
 908:	fc26                	sd	s1,56(sp)
 90a:	f84a                	sd	s2,48(sp)
 90c:	f44e                	sd	s3,40(sp)
 90e:	f052                	sd	s4,32(sp)
 910:	ec56                	sd	s5,24(sp)
 912:	e85a                	sd	s6,16(sp)
 914:	e45e                	sd	s7,8(sp)
 916:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 918:	00000497          	auipc	s1,0x0
 91c:	6f44a483          	lw	s1,1780(s1) # 100c <num_levels>
 920:	08905863          	blez	s1,9b0 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 924:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 926:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 92a:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 92e:	4705                	li	a4,1
 930:	0097173b          	sllw	a4,a4,s1
 934:	9fb9                	addw	a5,a5,a4
 936:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 938:	4739                	li	a4,14
 93a:	06f74d63          	blt	a4,a5,9b4 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 93e:	00000997          	auipc	s3,0x0
 942:	6e298993          	addi	s3,s3,1762 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 946:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 948:	00000b97          	auipc	s7,0x0
 94c:	6c4b8b93          	addi	s7,s7,1732 # 100c <num_levels>
 950:	00000b17          	auipc	s6,0x0
 954:	6b8b0b13          	addi	s6,s6,1720 # 1008 <trnmnt_idx>
 958:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 95a:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 95c:	078a                	slli	a5,a5,0x2
 95e:	97ce                	add	a5,a5,s3
 960:	4388                	lw	a0,0(a5)
 962:	00000097          	auipc	ra,0x0
 966:	a32080e7          	jalr	-1486(ra) # 394 <peterson_acquire>
 96a:	04054763          	bltz	a0,9b8 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 96e:	fff4869b          	addiw	a3,s1,-1
 972:	0006849b          	sext.w	s1,a3
 976:	03448963          	beq	s1,s4,9a8 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 97a:	000ba703          	lw	a4,0(s7)
 97e:	40d706bb          	subw	a3,a4,a3
 982:	fff6879b          	addiw	a5,a3,-1
 986:	000b2703          	lw	a4,0(s6)
 98a:	00f915bb          	sllw	a1,s2,a5
 98e:	8df9                	and	a1,a1,a4
 990:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 994:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 998:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 99c:	9fb9                	addw	a5,a5,a4
 99e:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9a0:	fafadee3          	bge	s5,a5,95c <tournament_acquire+0x66>
 9a4:	557d                	li	a0,-1
 9a6:	a811                	j	9ba <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 9a8:	4501                	li	a0,0
 9aa:	a801                	j	9ba <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9ac:	557d                	li	a0,-1
}
 9ae:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9b0:	557d                	li	a0,-1
 9b2:	a021                	j	9ba <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 9b4:	557d                	li	a0,-1
 9b6:	a011                	j	9ba <tournament_acquire+0xc4>
        return -1;
 9b8:	557d                	li	a0,-1
}
 9ba:	60a6                	ld	ra,72(sp)
 9bc:	6406                	ld	s0,64(sp)
 9be:	74e2                	ld	s1,56(sp)
 9c0:	7942                	ld	s2,48(sp)
 9c2:	79a2                	ld	s3,40(sp)
 9c4:	7a02                	ld	s4,32(sp)
 9c6:	6ae2                	ld	s5,24(sp)
 9c8:	6b42                	ld	s6,16(sp)
 9ca:	6ba2                	ld	s7,8(sp)
 9cc:	6161                	addi	sp,sp,80
 9ce:	8082                	ret

00000000000009d0 <tournament_release>:
...
int tournament_release(void) {
 ...
 9d8:	0a07c663          	bltz	a5,a84 <tournament_release+0xb4>
 9dc:	00000717          	auipc	a4,0x0
 9e0:	63072703          	lw	a4,1584(a4) # 100c <num_levels>
 9e4:	0ae05263          	blez	a4,a88 <tournament_release+0xb8>
 ...
 9f8:	40e7d7bb          	sraw	a5,a5,a4
        ...
        if(lockidx>=MAX_LOCKS) return -1 ;
 9fc:	4739                	li	a4,14
 9fe:	08f74763          	blt	a4,a5,a8c <tournament_release+0xbc>
int tournament_release(void) {
 ...
 a1c:	60898993          	addi	s3,s3,1544 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a20:	00000a17          	auipc	s4,0x0
 a24:	5eca0a13          	addi	s4,s4,1516 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ...
 a36:	97ce                	add	a5,a5,s3
 a38:	4388                	lw	a0,0(a5)
 a3a:	00000097          	auipc	ra,0x0
 a3e:	962080e7          	jalr	-1694(ra) # 39c <peterson_release>
 a42:	04054763          	bltz	a0,a90 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a46:	0014871b          	addiw	a4,s1,1
 a4a:	0007049b          	sext.w	s1,a4
 a4e:	000a2783          	lw	a5,0(s4)
 a52:	02f4d763          	bge	s1,a5,a80 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a56:	40e7873b          	subw	a4,a5,a4
 a5a:	fff7079b          	addiw	a5,a4,-1
 a5e:	000b2683          	lw	a3,0(s6)
 a62:	00f915bb          	sllw	a1,s2,a5
 a66:	8df5                	and	a1,a1,a3
 a68:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a6c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a70:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 a74:	9fb9                	addw	a5,a5,a4
 a76:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a78:	fafadee3          	bge	s5,a5,a34 <tournament_release+0x64>
 a7c:	557d                	li	a0,-1
 a7e:	a811                	j	a92 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 a80:	4501                	li	a0,0
 a82:	a801                	j	a92 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a84:	557d                	li	a0,-1
 a86:	8082                	ret
 a88:	557d                	li	a0,-1
