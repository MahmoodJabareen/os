...
main(int argc, char *argv[])
{
  ...
  1a:	b6a78793          	addi	a5,a5,-1174 # b80 <tournament_release+0x108>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	b2450513          	addi	a0,a0,-1244 # b50 <tournament_release+0xd8>
  ...
  6c:	b0050513          	addi	a0,a0,-1280 # b68 <tournament_release+0xf0>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	ac250513          	addi	a0,a0,-1342 # b78 <tournament_release+0x100>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49c:	70050513          	addi	a0,a0,1792 # b98 <digits>
 4a0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 568:	634b8b93          	addi	s7,s7,1588 # b98 <digits>
 ...
 6a8:	4ec90913          	addi	s2,s2,1260 # b90 <tournament_release+0x118>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 8de:	fff5071b          	addiw	a4,a0,-1
 8e2:	47bd                	li	a5,15
 8e4:	00e7ee63          	bltu	a5,a4,900 <tournament_create+0x32>
 8e8:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 8ea:	8a3a                	mv	s4,a4
 8ec:	00e574b3          	and	s1,a0,a4
 8f0:	c0b9                	beqz	s1,936 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 8f2:	54fd                	li	s1,-1
 8f4:	a809                	j	906 <tournament_create+0x38>
 ...
 8fa:	7097a923          	sw	s1,1810(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 8fe:	a021                	j	906 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 900:	54fd                	li	s1,-1
 902:	a011                	j	906 <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 916:	8082                	ret
            return -1 ;
 918:	54fd                	li	s1,-1
 91a:	b7f5                	j	906 <tournament_create+0x38>
   num_levels = log2(processes) ;
 91c:	00000797          	auipc	a5,0x0
 920:	6e07aa23          	sw	zero,1780(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 924:	00000797          	auipc	a5,0x0
 928:	6e07a223          	sw	zero,1764(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 92c:	00000497          	auipc	s1,0x0
 930:	6dc4a483          	lw	s1,1756(s1) # 1008 <trnmnt_idx>
 934:	bfc9                	j	906 <tournament_create+0x38>
   num_processes = processes ;
 936:	00000797          	auipc	a5,0x0
 93a:	6ca7ab23          	sw	a0,1750(a5) # 100c <num_processes>
  if (n <= 1) 
 93e:	4785                	li	a5,1
 940:	fca7dee3          	bge	a5,a0,91c <tournament_create+0x4e>
  int l = 0;
 944:	8726                	mv	a4,s1
 946:	87aa                	mv	a5,a0
  while (n > 1) {
 948:	458d                	li	a1,3
    n /= 2;
 94a:	86be                	mv	a3,a5
 94c:	01f7d61b          	srliw	a2,a5,0x1f
 950:	9fb1                	addw	a5,a5,a2
 952:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 956:	2705                	addiw	a4,a4,1
  while (n > 1) {
 958:	fed5c9e3          	blt	a1,a3,94a <tournament_create+0x7c>
   num_levels = log2(processes) ;
 95c:	00000797          	auipc	a5,0x0
 960:	6ae7aa23          	sw	a4,1716(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 964:	00000917          	auipc	s2,0x0
 968:	6cc90913          	addi	s2,s2,1740 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 96c:	00000097          	auipc	ra,0x0
 970:	ac8080e7          	jalr	-1336(ra) # 434 <peterson_create>
 974:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 978:	f80546e3          	bltz	a0,904 <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 97c:	2485                	addiw	s1,s1,1
 97e:	0911                	addi	s2,s2,4
 980:	ff44c6e3          	blt	s1,s4,96c <tournament_create+0x9e>
   trnmnt_idx = 0;
 984:	00000797          	auipc	a5,0x0
 988:	6807a223          	sw	zero,1668(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 98c:	4785                	li	a5,1
 98e:	f937dfe3          	bge	a5,s3,92c <tournament_create+0x5e>
 992:	4485                	li	s1,1
        int pid = fork() ;
 994:	00000097          	auipc	ra,0x0
 998:	9f8080e7          	jalr	-1544(ra) # 38c <fork>
        if(pid < 0)
 99c:	f6054ee3          	bltz	a0,918 <tournament_create+0x4a>
        if(pid == 0){
 9a0:	d939                	beqz	a0,8f6 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 9a2:	2485                	addiw	s1,s1,1
 9a4:	fe9998e3          	bne	s3,s1,994 <tournament_create+0xc6>
 9a8:	b751                	j	92c <tournament_create+0x5e>

00000000000009aa <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9aa:	00000797          	auipc	a5,0x0
 9ae:	65e7a783          	lw	a5,1630(a5) # 1008 <trnmnt_idx>
 9b2:	0a07cd63          	bltz	a5,a6c <tournament_acquire+0xc2>
 9b6:	00000717          	auipc	a4,0x0
 9ba:	65a72703          	lw	a4,1626(a4) # 1010 <num_levels>
 9be:	0ae05963          	blez	a4,a70 <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9c2:	fff7069b          	addiw	a3,a4,-1
 9c6:	4585                	li	a1,1
 9c8:	00d595bb          	sllw	a1,a1,a3
 9cc:	8dfd                	and	a1,a1,a5
 9ce:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9d2:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 9d6:	4739                	li	a4,14
 9d8:	08f74e63          	blt	a4,a5,a74 <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 9f2:	00000a17          	auipc	s4,0x0
 9f6:	63ea0a13          	addi	s4,s4,1598 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 9fa:	00000997          	auipc	s3,0x0
 9fe:	61698993          	addi	s3,s3,1558 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a02:	00000b17          	auipc	s6,0x0
 a06:	606b0b13          	addi	s6,s6,1542 # 1008 <trnmnt_idx>
 a0a:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a0c:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 a0e:	078a                	slli	a5,a5,0x2
 a10:	97d2                	add	a5,a5,s4
 a12:	4388                	lw	a0,0(a5)
 a14:	00000097          	auipc	ra,0x0
 a18:	a28080e7          	jalr	-1496(ra) # 43c <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 a1c:	0014871b          	addiw	a4,s1,1
 a20:	0007049b          	sext.w	s1,a4
 a24:	0009a783          	lw	a5,0(s3)
 a28:	02f4d763          	bge	s1,a5,a56 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a2c:	40e7873b          	subw	a4,a5,a4
 a30:	fff7079b          	addiw	a5,a4,-1
 a34:	000b2683          	lw	a3,0(s6)
 a38:	00f915bb          	sllw	a1,s2,a5
 a3c:	8df5                	and	a1,a1,a3
 a3e:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a42:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a46:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 a4a:	9fb9                	addw	a5,a5,a4
 a4c:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a4e:	fcfad0e3          	bge	s5,a5,a0e <tournament_acquire+0x64>
 a52:	557d                	li	a0,-1
 a54:	a011                	j	a58 <tournament_acquire+0xae>
...
int tournament_release(void) {
 ...
 a7c:	5907a783          	lw	a5,1424(a5) # 1008 <trnmnt_idx>
 a80:	0a07cf63          	bltz	a5,b3e <tournament_release+0xc6>
int tournament_release(void) {
 ...
 a96:	e45e                	sd	s7,8(sp)
 a98:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a9a:	00000497          	auipc	s1,0x0
 a9e:	5764a483          	lw	s1,1398(s1) # 1010 <num_levels>
 aa2:	0a905063          	blez	s1,b42 <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 aa6:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 aa8:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 aac:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 ab0:	4705                	li	a4,1
 ab2:	0097173b          	sllw	a4,a4,s1
 ab6:	9fb9                	addw	a5,a5,a4
 ab8:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 aba:	4739                	li	a4,14
 abc:	08f74563          	blt	a4,a5,b46 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 ac0:	00000a17          	auipc	s4,0x0
 ac4:	570a0a13          	addi	s4,s4,1392 # 1030 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 ac8:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 aca:	00000b97          	auipc	s7,0x0
 ace:	546b8b93          	addi	s7,s7,1350 # 1010 <num_levels>
 ad2:	00000b17          	auipc	s6,0x0
 ad6:	536b0b13          	addi	s6,s6,1334 # 1008 <trnmnt_idx>
 ada:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 adc:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 ade:	078a                	slli	a5,a5,0x2
 ae0:	97d2                	add	a5,a5,s4
 ae2:	4388                	lw	a0,0(a5)
 ae4:	00000097          	auipc	ra,0x0
 ae8:	960080e7          	jalr	-1696(ra) # 444 <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 aec:	fff4869b          	addiw	a3,s1,-1
 af0:	0006849b          	sext.w	s1,a3
 af4:	03348963          	beq	s1,s3,b26 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 af8:	000ba703          	lw	a4,0(s7)
 afc:	40d706bb          	subw	a3,a4,a3
 b00:	fff6879b          	addiw	a5,a3,-1
 b04:	000b2703          	lw	a4,0(s6)
 b08:	00f915bb          	sllw	a1,s2,a5
 b0c:	8df9                	and	a1,a1,a4
 b0e:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b12:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b16:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 b1a:	9fb9                	addw	a5,a5,a4
 b1c:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b1e:	fcfad0e3          	bge	s5,a5,ade <tournament_release+0x66>
 b22:	557d                	li	a0,-1
 b24:	a011                	j	b28 <tournament_release+0xb0>
...
return 0 ;
 ...
 b40:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b42:	557d                	li	a0,-1
 b44:	b7d5                	j	b28 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 b46:	557d                	li	a0,-1
 b48:	b7c5                	j	b28 <tournament_release+0xb0>
