...
int tournament_create(int processes) {
 ...
 a70:	fff5071b          	addiw	a4,a0,-1
 a74:	47bd                	li	a5,15
 a76:	00e7ee63          	bltu	a5,a4,a92 <tournament_create+0x32>
 a7a:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 a7c:	8a3a                	mv	s4,a4
 a7e:	00e574b3          	and	s1,a0,a4
 a82:	c0b9                	beqz	s1,ac8 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 a84:	54fd                	li	s1,-1
 a86:	a809                	j	a98 <tournament_create+0x38>
 ...
 a8c:	5897a023          	sw	s1,1408(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 a90:	a021                	j	a98 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 a92:	54fd                	li	s1,-1
 a94:	a011                	j	a98 <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 aa8:	8082                	ret
            return -1 ;
 aaa:	54fd                	li	s1,-1
 aac:	b7f5                	j	a98 <tournament_create+0x38>
   num_levels = log2(processes) ;
 aae:	00000797          	auipc	a5,0x0
 ab2:	5607a123          	sw	zero,1378(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 ab6:	00000797          	auipc	a5,0x0
 aba:	5407a923          	sw	zero,1362(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 abe:	00000497          	auipc	s1,0x0
 ac2:	54a4a483          	lw	s1,1354(s1) # 1008 <trnmnt_idx>
 ac6:	bfc9                	j	a98 <tournament_create+0x38>
   num_processes = processes ;
 ac8:	00000797          	auipc	a5,0x0
 acc:	54a7a223          	sw	a0,1348(a5) # 100c <num_processes>
  if (n <= 1) 
 ad0:	4785                	li	a5,1
 ad2:	fca7dee3          	bge	a5,a0,aae <tournament_create+0x4e>
  int l = 0;
 ad6:	8726                	mv	a4,s1
 ad8:	87aa                	mv	a5,a0
  while (n > 1) {
 ada:	458d                	li	a1,3
    n /= 2;
 adc:	86be                	mv	a3,a5
 ade:	01f7d61b          	srliw	a2,a5,0x1f
 ae2:	9fb1                	addw	a5,a5,a2
 ae4:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 ae8:	2705                	addiw	a4,a4,1
  while (n > 1) {
 aea:	fed5c9e3          	blt	a1,a3,adc <tournament_create+0x7c>
   num_levels = log2(processes) ;
 aee:	00000797          	auipc	a5,0x0
 af2:	52e7a123          	sw	a4,1314(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 af6:	00001917          	auipc	s2,0x1
 afa:	93a90913          	addi	s2,s2,-1734 # 1430 <lock_ids>
    lock_ids[i]= peterson_create() ;
 afe:	00000097          	auipc	ra,0x0
 b02:	ac8080e7          	jalr	-1336(ra) # 5c6 <peterson_create>
 b06:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 b0a:	f80546e3          	bltz	a0,a96 <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 b0e:	2485                	addiw	s1,s1,1
 b10:	0911                	addi	s2,s2,4
 b12:	ff44c6e3          	blt	s1,s4,afe <tournament_create+0x9e>
   trnmnt_idx = 0;
 b16:	00000797          	auipc	a5,0x0
 b1a:	4e07a923          	sw	zero,1266(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 b1e:	4785                	li	a5,1
 b20:	f937dfe3          	bge	a5,s3,abe <tournament_create+0x5e>
 b24:	4485                	li	s1,1
        int pid = fork() ;
 b26:	00000097          	auipc	ra,0x0
 b2a:	9f8080e7          	jalr	-1544(ra) # 51e <fork>
        if(pid < 0)
 b2e:	f6054ee3          	bltz	a0,aaa <tournament_create+0x4a>
        if(pid == 0){
 b32:	d939                	beqz	a0,a88 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 b34:	2485                	addiw	s1,s1,1
 b36:	fe9998e3          	bne	s3,s1,b26 <tournament_create+0xc6>
 b3a:	b751                	j	abe <tournament_create+0x5e>

0000000000000b3c <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b3c:	00000797          	auipc	a5,0x0
 b40:	4cc7a783          	lw	a5,1228(a5) # 1008 <trnmnt_idx>
 b44:	0a07cd63          	bltz	a5,bfe <tournament_acquire+0xc2>
 b48:	00000717          	auipc	a4,0x0
 b4c:	4c872703          	lw	a4,1224(a4) # 1010 <num_levels>
 b50:	0ae05963          	blez	a4,c02 <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b54:	fff7069b          	addiw	a3,a4,-1
 b58:	4585                	li	a1,1
 b5a:	00d595bb          	sllw	a1,a1,a3
 b5e:	8dfd                	and	a1,a1,a5
 b60:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b64:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 b68:	4739                	li	a4,14
 b6a:	08f74e63          	blt	a4,a5,c06 <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 b84:	00001a17          	auipc	s4,0x1
 b88:	8aca0a13          	addi	s4,s4,-1876 # 1430 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 b8c:	00000997          	auipc	s3,0x0
 b90:	48498993          	addi	s3,s3,1156 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b94:	00000b17          	auipc	s6,0x0
 b98:	474b0b13          	addi	s6,s6,1140 # 1008 <trnmnt_idx>
 b9c:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b9e:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 ba0:	078a                	slli	a5,a5,0x2
 ba2:	97d2                	add	a5,a5,s4
 ba4:	4388                	lw	a0,0(a5)
 ba6:	00000097          	auipc	ra,0x0
 baa:	a28080e7          	jalr	-1496(ra) # 5ce <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 bae:	0014871b          	addiw	a4,s1,1
 bb2:	0007049b          	sext.w	s1,a4
 bb6:	0009a783          	lw	a5,0(s3)
 bba:	02f4d763          	bge	s1,a5,be8 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 bbe:	40e7873b          	subw	a4,a5,a4
 bc2:	fff7079b          	addiw	a5,a4,-1
 bc6:	000b2683          	lw	a3,0(s6)
 bca:	00f915bb          	sllw	a1,s2,a5
 bce:	8df5                	and	a1,a1,a3
 bd0:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 bd4:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 bd8:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 bdc:	9fb9                	addw	a5,a5,a4
 bde:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 be0:	fcfad0e3          	bge	s5,a5,ba0 <tournament_acquire+0x64>
 be4:	557d                	li	a0,-1
 be6:	a011                	j	bea <tournament_acquire+0xae>
...
int tournament_release(void) {
 ...
 c12:	0a07cf63          	bltz	a5,cd0 <tournament_release+0xc6>
int tournament_release(void) {
 c16:	715d                	addi	sp,sp,-80
 c18:	e486                	sd	ra,72(sp)
 c1a:	e0a2                	sd	s0,64(sp)
 c1c:	fc26                	sd	s1,56(sp)
 c1e:	f84a                	sd	s2,48(sp)
 c20:	f44e                	sd	s3,40(sp)
 c22:	f052                	sd	s4,32(sp)
 c24:	ec56                	sd	s5,24(sp)
 c26:	e85a                	sd	s6,16(sp)
 c28:	e45e                	sd	s7,8(sp)
 c2a:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 c2c:	00000497          	auipc	s1,0x0
 c30:	3e44a483          	lw	s1,996(s1) # 1010 <num_levels>
 c34:	0a905063          	blez	s1,cd4 <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 c38:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c3a:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 c3e:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 c42:	4705                	li	a4,1
 c44:	0097173b          	sllw	a4,a4,s1
 c48:	9fb9                	addw	a5,a5,a4
 c4a:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 c4c:	4739                	li	a4,14
 c4e:	08f74563          	blt	a4,a5,cd8 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 c52:	00000a17          	auipc	s4,0x0
 c56:	7dea0a13          	addi	s4,s4,2014 # 1430 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 c5a:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c5c:	00000b97          	auipc	s7,0x0
 c60:	3b4b8b93          	addi	s7,s7,948 # 1010 <num_levels>
 c64:	00000b17          	auipc	s6,0x0
 c68:	3a4b0b13          	addi	s6,s6,932 # 1008 <trnmnt_idx>
 c6c:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 c6e:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 c70:	078a                	slli	a5,a5,0x2
 c72:	97d2                	add	a5,a5,s4
 c74:	4388                	lw	a0,0(a5)
 c76:	00000097          	auipc	ra,0x0
 c7a:	960080e7          	jalr	-1696(ra) # 5d6 <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 c7e:	fff4869b          	addiw	a3,s1,-1
 c82:	0006849b          	sext.w	s1,a3
 c86:	03348963          	beq	s1,s3,cb8 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c8a:	000ba703          	lw	a4,0(s7)
 c8e:	40d706bb          	subw	a3,a4,a3
 c92:	fff6879b          	addiw	a5,a3,-1
 c96:	000b2703          	lw	a4,0(s6)
 c9a:	00f915bb          	sllw	a1,s2,a5
 c9e:	8df9                	and	a1,a1,a4
 ca0:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 ca4:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ca8:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 cac:	9fb9                	addw	a5,a5,a4
 cae:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 cb0:	fcfad0e3          	bge	s5,a5,c70 <tournament_release+0x66>
 cb4:	557d                	li	a0,-1
 cb6:	a011                	j	cba <tournament_release+0xb0>
...
return 0 ;
 ...
 cc0:	7942                	ld	s2,48(sp)
 cc2:	79a2                	ld	s3,40(sp)
 cc4:	7a02                	ld	s4,32(sp)
 cc6:	6ae2                	ld	s5,24(sp)
 cc8:	6b42                	ld	s6,16(sp)
 cca:	6ba2                	ld	s7,8(sp)
 ...
 cd2:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 cd4:	557d                	li	a0,-1
 cd6:	b7d5                	j	cba <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 cd8:	557d                	li	a0,-1
 cda:	b7c5                	j	cba <tournament_release+0xb0>
