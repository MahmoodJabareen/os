...
int tournament_create(int processes) {
 ...
 958:	fff5071b          	addiw	a4,a0,-1
 95c:	47bd                	li	a5,15
 95e:	08e7eb63          	bltu	a5,a4,9f4 <tournament_create+0x9c>
int tournament_create(int processes) {
 962:	7179                	addi	sp,sp,-48
 964:	f406                	sd	ra,40(sp)
 966:	f022                	sd	s0,32(sp)
 968:	ec26                	sd	s1,24(sp)
 ...
 97a:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 97c:	ecbd                	bnez	s1,9fa <tournament_create+0xa2>
  if (n <= 1) 
 97e:	4785                	li	a5,1
 980:	0937d763          	bge	a5,s3,a0e <tournament_create+0xb6>
  int l = 0;
 984:	8726                	mv	a4,s1
 986:	87ce                	mv	a5,s3
  while (n > 1) {
 988:	458d                	li	a1,3
    n /= 2;
 98a:	86be                	mv	a3,a5
 98c:	01f7d61b          	srliw	a2,a5,0x1f
 990:	9fb1                	addw	a5,a5,a2
 992:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 996:	2705                	addiw	a4,a4,1
  while (n > 1) {
 998:	fed5c9e3          	blt	a1,a3,98a <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 99c:	00000797          	auipc	a5,0x0
 9a0:	66e7a823          	sw	a4,1648(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 9a4:	00001917          	auipc	s2,0x1
 9a8:	87c90913          	addi	s2,s2,-1924 # 1220 <lock_ids>
    lock_ids[i]= peterson_create() ;
 9ac:	00000097          	auipc	ra,0x0
 9b0:	b12080e7          	jalr	-1262(ra) # 4be <peterson_create>
 9b4:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 9b8:	04054063          	bltz	a0,9f8 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 9bc:	2485                	addiw	s1,s1,1
 9be:	0911                	addi	s2,s2,4
 9c0:	ff44c6e3          	blt	s1,s4,9ac <tournament_create+0x54>
 ...
 9c8:	6407a223          	sw	zero,1604(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 9cc:	4785                	li	a5,1
 9ce:	0537d863          	bge	a5,s3,a1e <tournament_create+0xc6>
 9d2:	4485                	li	s1,1
        int pid = fork() ;
 9d4:	00000097          	auipc	ra,0x0
 9d8:	a42080e7          	jalr	-1470(ra) # 416 <fork>
        if(pid < 0)
 9dc:	02054763          	bltz	a0,a0a <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 9e0:	c509                	beqz	a0,9ea <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 9e2:	2485                	addiw	s1,s1,1
 9e4:	fe9998e3          	bne	s3,s1,9d4 <tournament_create+0x7c>
 9e8:	a81d                	j	a1e <tournament_create+0xc6>
            trnmnt_idx = i ;
 9ea:	00000797          	auipc	a5,0x0
 9ee:	6097af23          	sw	s1,1566(a5) # 1008 <trnmnt_idx>
            break ;
 9f2:	a035                	j	a1e <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 9f4:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 a08:	8082                	ret
            return -1 ;
 a0a:	557d                	li	a0,-1
 a0c:	b7fd                	j	9fa <tournament_create+0xa2>
   num_levels = log2(processes) ;
 a0e:	00000797          	auipc	a5,0x0
 a12:	5e07af23          	sw	zero,1534(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 a16:	00000797          	auipc	a5,0x0
 a1a:	5e07a923          	sw	zero,1522(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 a1e:	00000517          	auipc	a0,0x0
 a22:	5ea52503          	lw	a0,1514(a0) # 1008 <trnmnt_idx>
 a26:	bfd1                	j	9fa <tournament_create+0xa2>

0000000000000a28 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a28:	00000797          	auipc	a5,0x0
 a2c:	5e07a783          	lw	a5,1504(a5) # 1008 <trnmnt_idx>
 a30:	0a07c763          	bltz	a5,ade <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 a34:	715d                	addi	sp,sp,-80
 a36:	e486                	sd	ra,72(sp)
 a38:	e0a2                	sd	s0,64(sp)
 a3a:	fc26                	sd	s1,56(sp)
 a3c:	f84a                	sd	s2,48(sp)
 a3e:	f44e                	sd	s3,40(sp)
 a40:	f052                	sd	s4,32(sp)
 a42:	ec56                	sd	s5,24(sp)
 a44:	e85a                	sd	s6,16(sp)
 a46:	e45e                	sd	s7,8(sp)
 a48:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a4a:	00000497          	auipc	s1,0x0
 a4e:	5c24a483          	lw	s1,1474(s1) # 100c <num_levels>
 a52:	08905863          	blez	s1,ae2 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a56:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a58:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a5c:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 a60:	4705                	li	a4,1
 a62:	0097173b          	sllw	a4,a4,s1
 a66:	9fb9                	addw	a5,a5,a4
 a68:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a6a:	4739                	li	a4,14
 a6c:	06f74d63          	blt	a4,a5,ae6 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a70:	00000997          	auipc	s3,0x0
 a74:	7b098993          	addi	s3,s3,1968 # 1220 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a78:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a7a:	00000b97          	auipc	s7,0x0
 a7e:	592b8b93          	addi	s7,s7,1426 # 100c <num_levels>
 a82:	00000b17          	auipc	s6,0x0
 a86:	586b0b13          	addi	s6,s6,1414 # 1008 <trnmnt_idx>
 a8a:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a8c:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a8e:	078a                	slli	a5,a5,0x2
 a90:	97ce                	add	a5,a5,s3
 a92:	4388                	lw	a0,0(a5)
 a94:	00000097          	auipc	ra,0x0
 a98:	a32080e7          	jalr	-1486(ra) # 4c6 <peterson_acquire>
 a9c:	04054763          	bltz	a0,aea <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 aa0:	fff4869b          	addiw	a3,s1,-1
 aa4:	0006849b          	sext.w	s1,a3
 aa8:	03448963          	beq	s1,s4,ada <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 aac:	000ba703          	lw	a4,0(s7)
 ab0:	40d706bb          	subw	a3,a4,a3
 ab4:	fff6879b          	addiw	a5,a3,-1
 ab8:	000b2703          	lw	a4,0(s6)
 abc:	00f915bb          	sllw	a1,s2,a5
 ac0:	8df9                	and	a1,a1,a4
 ac2:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 ac6:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 aca:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 ace:	9fb9                	addw	a5,a5,a4
 ad0:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ad2:	fafadee3          	bge	s5,a5,a8e <tournament_acquire+0x66>
 ad6:	557d                	li	a0,-1
 ad8:	a811                	j	aec <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 ada:	4501                	li	a0,0
 adc:	a801                	j	aec <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 ade:	557d                	li	a0,-1
}
 ae0:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 ae2:	557d                	li	a0,-1
 ae4:	a021                	j	aec <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 ae6:	557d                	li	a0,-1
 ae8:	a011                	j	aec <tournament_acquire+0xc4>
        return -1;
 aea:	557d                	li	a0,-1
}
...
int tournament_release(void) {
 ...
 b0a:	0a07c663          	bltz	a5,bb6 <tournament_release+0xb4>
 b0e:	00000717          	auipc	a4,0x0
 b12:	4fe72703          	lw	a4,1278(a4) # 100c <num_levels>
 b16:	0ae05263          	blez	a4,bba <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b1a:	fff7069b          	addiw	a3,a4,-1
 b1e:	4585                	li	a1,1
 b20:	00d595bb          	sllw	a1,a1,a3
 b24:	8dfd                	and	a1,a1,a5
 b26:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b2a:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 b2e:	4739                	li	a4,14
 b30:	08f74763          	blt	a4,a5,bbe <tournament_release+0xbc>
int tournament_release(void) {
 ...
 b42:	e456                	sd	s5,8(sp)
 b44:	e05a                	sd	s6,0(sp)
 b46:	0080                	addi	s0,sp,64
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 b48:	4481                	li	s1,0

        if (peterson_release(lock_ids[lockidx] , role) < 0)
 b4a:	00000997          	auipc	s3,0x0
 b4e:	6d698993          	addi	s3,s3,1750 # 1220 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 b52:	00000a17          	auipc	s4,0x0
 b56:	4baa0a13          	addi	s4,s4,1210 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b5a:	00000b17          	auipc	s6,0x0
 b5e:	4aeb0b13          	addi	s6,s6,1198 # 1008 <trnmnt_idx>
 b62:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b64:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 b66:	078a                	slli	a5,a5,0x2
 b68:	97ce                	add	a5,a5,s3
 b6a:	4388                	lw	a0,0(a5)
 b6c:	00000097          	auipc	ra,0x0
 b70:	962080e7          	jalr	-1694(ra) # 4ce <peterson_release>
 b74:	04054763          	bltz	a0,bc2 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 b78:	0014871b          	addiw	a4,s1,1
 b7c:	0007049b          	sext.w	s1,a4
 b80:	000a2783          	lw	a5,0(s4)
 b84:	02f4d763          	bge	s1,a5,bb2 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b88:	40e7873b          	subw	a4,a5,a4
 b8c:	fff7079b          	addiw	a5,a4,-1
 b90:	000b2683          	lw	a3,0(s6)
 b94:	00f915bb          	sllw	a1,s2,a5
 b98:	8df5                	and	a1,a1,a3
 b9a:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b9e:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ba2:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 ba6:	9fb9                	addw	a5,a5,a4
 ba8:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 baa:	fafadee3          	bge	s5,a5,b66 <tournament_release+0x64>
 bae:	557d                	li	a0,-1
 bb0:	a811                	j	bc4 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 bb2:	4501                	li	a0,0
 bb4:	a801                	j	bc4 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 bb6:	557d                	li	a0,-1
 bb8:	8082                	ret
 bba:	557d                	li	a0,-1
 ...
 bc0:	8082                	ret
        return -1; 
 bc2:	557d                	li	a0,-1
 bc4:	70e2                	ld	ra,56(sp)
 bc6:	7442                	ld	s0,48(sp)
 bc8:	74a2                	ld	s1,40(sp)
 bca:	7902                	ld	s2,32(sp)
 bcc:	69e2                	ld	s3,24(sp)
