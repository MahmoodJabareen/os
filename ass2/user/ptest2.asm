...
int tournament_create(int processes) {
 ...
 8d6:	fff5071b          	addiw	a4,a0,-1
 8da:	47bd                	li	a5,15
 8dc:	08e7eb63          	bltu	a5,a4,972 <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 8f8:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 8fa:	ecbd                	bnez	s1,978 <tournament_create+0xa2>
  if (n <= 1) 
 8fc:	4785                	li	a5,1
 8fe:	0937d763          	bge	a5,s3,98c <tournament_create+0xb6>
  int l = 0;
 902:	8726                	mv	a4,s1
 904:	87ce                	mv	a5,s3
  while (n > 1) {
 906:	458d                	li	a1,3
    n /= 2;
 908:	86be                	mv	a3,a5
 90a:	01f7d61b          	srliw	a2,a5,0x1f
 90e:	9fb1                	addw	a5,a5,a2
 910:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 914:	2705                	addiw	a4,a4,1
  while (n > 1) {
 916:	fed5c9e3          	blt	a1,a3,908 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 91a:	00000797          	auipc	a5,0x0
 91e:	6ee7a923          	sw	a4,1778(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 922:	00000917          	auipc	s2,0x0
 926:	6fe90913          	addi	s2,s2,1790 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 92a:	00000097          	auipc	ra,0x0
 92e:	b12080e7          	jalr	-1262(ra) # 43c <peterson_create>
 932:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 936:	04054063          	bltz	a0,976 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 93a:	2485                	addiw	s1,s1,1
 93c:	0911                	addi	s2,s2,4
 93e:	ff44c6e3          	blt	s1,s4,92a <tournament_create+0x54>
 ...
 946:	6c07a323          	sw	zero,1734(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 94a:	4785                	li	a5,1
 94c:	0537d863          	bge	a5,s3,99c <tournament_create+0xc6>
 950:	4485                	li	s1,1
        int pid = fork() ;
 952:	00000097          	auipc	ra,0x0
 956:	a42080e7          	jalr	-1470(ra) # 394 <fork>
        if(pid < 0)
 95a:	02054763          	bltz	a0,988 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 95e:	c509                	beqz	a0,968 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 960:	2485                	addiw	s1,s1,1
 962:	fe9998e3          	bne	s3,s1,952 <tournament_create+0x7c>
 966:	a81d                	j	99c <tournament_create+0xc6>
            trnmnt_idx = i ;
 968:	00000797          	auipc	a5,0x0
 96c:	6a97a023          	sw	s1,1696(a5) # 1008 <trnmnt_idx>
            break ;
 970:	a035                	j	99c <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 972:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 986:	8082                	ret
            return -1 ;
 988:	557d                	li	a0,-1
 98a:	b7fd                	j	978 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 98c:	00000797          	auipc	a5,0x0
 990:	6807a023          	sw	zero,1664(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 994:	00000797          	auipc	a5,0x0
 998:	6607aa23          	sw	zero,1652(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 99c:	00000517          	auipc	a0,0x0
 9a0:	66c52503          	lw	a0,1644(a0) # 1008 <trnmnt_idx>
 9a4:	bfd1                	j	978 <tournament_create+0xa2>

00000000000009a6 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9a6:	00000797          	auipc	a5,0x0
 9aa:	6627a783          	lw	a5,1634(a5) # 1008 <trnmnt_idx>
 9ae:	0a07c763          	bltz	a5,a5c <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 9b2:	715d                	addi	sp,sp,-80
 9b4:	e486                	sd	ra,72(sp)
 9b6:	e0a2                	sd	s0,64(sp)
 9b8:	fc26                	sd	s1,56(sp)
 9ba:	f84a                	sd	s2,48(sp)
 9bc:	f44e                	sd	s3,40(sp)
 9be:	f052                	sd	s4,32(sp)
 9c0:	ec56                	sd	s5,24(sp)
 9c2:	e85a                	sd	s6,16(sp)
 9c4:	e45e                	sd	s7,8(sp)
 9c6:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9c8:	00000497          	auipc	s1,0x0
 9cc:	6444a483          	lw	s1,1604(s1) # 100c <num_levels>
 9d0:	08905863          	blez	s1,a60 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9d4:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9d6:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9da:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 9de:	4705                	li	a4,1
 9e0:	0097173b          	sllw	a4,a4,s1
 9e4:	9fb9                	addw	a5,a5,a4
 9e6:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9e8:	4739                	li	a4,14
 9ea:	06f74d63          	blt	a4,a5,a64 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 9ee:	00000997          	auipc	s3,0x0
 9f2:	63298993          	addi	s3,s3,1586 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9f6:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9f8:	00000b97          	auipc	s7,0x0
 9fc:	614b8b93          	addi	s7,s7,1556 # 100c <num_levels>
 a00:	00000b17          	auipc	s6,0x0
 a04:	608b0b13          	addi	s6,s6,1544 # 1008 <trnmnt_idx>
 a08:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a0a:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a0c:	078a                	slli	a5,a5,0x2
 a0e:	97ce                	add	a5,a5,s3
 a10:	4388                	lw	a0,0(a5)
 a12:	00000097          	auipc	ra,0x0
 a16:	a32080e7          	jalr	-1486(ra) # 444 <peterson_acquire>
 a1a:	04054763          	bltz	a0,a68 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a1e:	fff4869b          	addiw	a3,s1,-1
 a22:	0006849b          	sext.w	s1,a3
 a26:	03448963          	beq	s1,s4,a58 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a2a:	000ba703          	lw	a4,0(s7)
 a2e:	40d706bb          	subw	a3,a4,a3
 a32:	fff6879b          	addiw	a5,a3,-1
 a36:	000b2703          	lw	a4,0(s6)
 a3a:	00f915bb          	sllw	a1,s2,a5
 a3e:	8df9                	and	a1,a1,a4
 a40:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a44:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a48:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a4c:	9fb9                	addw	a5,a5,a4
 a4e:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a50:	fafadee3          	bge	s5,a5,a0c <tournament_acquire+0x66>
 a54:	557d                	li	a0,-1
 a56:	a811                	j	a6a <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 a58:	4501                	li	a0,0
 a5a:	a801                	j	a6a <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a5c:	557d                	li	a0,-1
}
 a5e:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a60:	557d                	li	a0,-1
 a62:	a021                	j	a6a <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a64:	557d                	li	a0,-1
 a66:	a011                	j	a6a <tournament_acquire+0xc4>
        return -1;
 a68:	557d                	li	a0,-1
}
...
int tournament_release(void) {
 ...
 a88:	0a07c663          	bltz	a5,b34 <tournament_release+0xb4>
 a8c:	00000717          	auipc	a4,0x0
 a90:	58072703          	lw	a4,1408(a4) # 100c <num_levels>
 a94:	0ae05263          	blez	a4,b38 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a98:	fff7069b          	addiw	a3,a4,-1
 a9c:	4585                	li	a1,1
 a9e:	00d595bb          	sllw	a1,a1,a3
 aa2:	8dfd                	and	a1,a1,a5
 aa4:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 aa8:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 aac:	4739                	li	a4,14
 aae:	08f74763          	blt	a4,a5,b3c <tournament_release+0xbc>
int tournament_release(void) {
 ...
 acc:	55898993          	addi	s3,s3,1368 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 ad0:	00000a17          	auipc	s4,0x0
 ad4:	53ca0a13          	addi	s4,s4,1340 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ad8:	00000b17          	auipc	s6,0x0
 adc:	530b0b13          	addi	s6,s6,1328 # 1008 <trnmnt_idx>
 ae0:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ae2:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 ae4:	078a                	slli	a5,a5,0x2
 ae6:	97ce                	add	a5,a5,s3
 ae8:	4388                	lw	a0,0(a5)
 aea:	00000097          	auipc	ra,0x0
 aee:	962080e7          	jalr	-1694(ra) # 44c <peterson_release>
 af2:	04054763          	bltz	a0,b40 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 af6:	0014871b          	addiw	a4,s1,1
 afa:	0007049b          	sext.w	s1,a4
 afe:	000a2783          	lw	a5,0(s4)
 b02:	02f4d763          	bge	s1,a5,b30 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b06:	40e7873b          	subw	a4,a5,a4
 b0a:	fff7079b          	addiw	a5,a4,-1
 b0e:	000b2683          	lw	a3,0(s6)
 b12:	00f915bb          	sllw	a1,s2,a5
 b16:	8df5                	and	a1,a1,a3
 b18:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b1c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b20:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 b24:	9fb9                	addw	a5,a5,a4
 b26:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b28:	fafadee3          	bge	s5,a5,ae4 <tournament_release+0x64>
 b2c:	557d                	li	a0,-1
 b2e:	a811                	j	b42 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 b30:	4501                	li	a0,0
 b32:	a801                	j	b42 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b34:	557d                	li	a0,-1
 b36:	8082                	ret
 b38:	557d                	li	a0,-1
