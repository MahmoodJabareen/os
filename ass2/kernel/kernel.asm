...
000000008000008e <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000009c:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdc97f>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a02:	48278793          	addi	a5,a5,1154 # 80021e80 <end>
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  ustack[argc] = 0;
    ...
    80004d70:	f007b023          	sd	zero,-256(a5) # ffffffffffffef00 <end+0xffffffff7ffdd080>
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80005004:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffdd1c4>
...
0000000080005ce8 <virtio_disk_init>:
{
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005d64:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc8df>
...
void petersoninit(void) {
    ...
    800061ce:	cb668693          	addi	a3,a3,-842 # 80021e80 <end>
    ...
    800061de:	0007a623          	sw	zero,12(a5)
    for(int i = 0 ; i < NPETERSONLOCKS ; i++) {
    800061e2:	07c1                	addi	a5,a5,16
    800061e4:	fed798e3          	bne	a5,a3,800061d4 <petersoninit+0x18>
    }
}
...
00000000800061ee <peterson_create>:
...
int peterson_create(void) {
    ...
    800061f8:	b9878793          	addi	a5,a5,-1128 # 80021d8c <petersonlocks+0xc>
    800061fc:	4501                	li	a0,0
        if (__sync_lock_test_and_set(&petersonlocks[i].used, 1) == 0) {
    800061fe:	4685                	li	a3,1
    for (int i = 0 ; i < NPETERSONLOCKS ; i++) {
    80006200:	4641                	li	a2,16
        if (__sync_lock_test_and_set(&petersonlocks[i].used, 1) == 0) {
    80006202:	8736                	mv	a4,a3
    80006204:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)
    80006208:	2701                	sext.w	a4,a4
    8000620a:	cb09                	beqz	a4,8000621c <peterson_create+0x2e>
    for (int i = 0 ; i < NPETERSONLOCKS ; i++) {
    8000620c:	2505                	addiw	a0,a0,1
    8000620e:	07c1                	addi	a5,a5,16
    80006210:	fec519e3          	bne	a0,a2,80006202 <peterson_create+0x14>
            petersonlocks[i].turn = -1;
    ...
    80006216:	6422                	ld	s0,8(sp)
    80006218:	0141                	addi	sp,sp,16
    8000621a:	8082                	ret
            petersonlocks[i].flag[0] = 0 ;
    8000621c:	00451713          	slli	a4,a0,0x4
    80006220:	0001c797          	auipc	a5,0x1c
    80006224:	b6078793          	addi	a5,a5,-1184 # 80021d80 <petersonlocks>
    80006228:	97ba                	add	a5,a5,a4
    8000622a:	0007a023          	sw	zero,0(a5)
            petersonlocks[i].flag[1] = 0 ; 
    8000622e:	0007a223          	sw	zero,4(a5)
            petersonlocks[i].turn = -1;
    80006232:	577d                	li	a4,-1
    80006234:	c798                	sw	a4,8(a5)
            __sync_synchronize() ; //ensures that the operations above are not interrupted 
    80006236:	0ff0000f          	fence
            return i ; // return the lockid if found 
    8000623a:	bff1                	j	80006216 <peterson_create+0x28>

000000008000623c <peterson_acquire>:
int peterson_acquire(int lock_id , int role) {
    if(lock_id >= NPETERSONLOCKS || lock_id < 0 || (role !=0 && role !=1) ) 
    8000623c:	473d                	li	a4,15
    8000623e:	08a76363          	bltu	a4,a0,800062c4 <peterson_acquire+0x88>
    80006242:	87aa                	mv	a5,a0
    80006244:	0005871b          	sext.w	a4,a1
    80006248:	4685                	li	a3,1
    8000624a:	06e6ef63          	bltu	a3,a4,800062c8 <peterson_acquire+0x8c>
int peterson_acquire(int lock_id , int role) {
    ...
    int other = 1 - role ;
    8000625c:	4605                	li	a2,1
    8000625e:	40b6053b          	subw	a0,a2,a1
    80006262:	0005091b          	sext.w	s2,a0

    __sync_lock_test_and_set(&plock->flag[role], 1);
    80006266:	0001c697          	auipc	a3,0x1c
    8000626a:	b1a68693          	addi	a3,a3,-1254 # 80021d80 <petersonlocks>
    8000626e:	00279713          	slli	a4,a5,0x2
    80006272:	95ba                	add	a1,a1,a4
    80006274:	058a                	slli	a1,a1,0x2
    80006276:	95b6                	add	a1,a1,a3
    80006278:	0cc5a62f          	amoswap.w.aq	a2,a2,(a1)
    __sync_synchronize() ;
    8000627c:	0ff0000f          	fence

    plock->turn = other ;
    80006280:	00479613          	slli	a2,a5,0x4
    80006284:	9636                	add	a2,a2,a3
    80006286:	c608                	sw	a0,8(a2)
    __sync_synchronize() ; 
    80006288:	0ff0000f          	fence

    while(plock->flag[other] && plock->turn == other){
    8000628c:	974a                	add	a4,a4,s2
    8000628e:	070a                	slli	a4,a4,0x2
    80006290:	9736                	add	a4,a4,a3
    80006292:	4308                	lw	a0,0(a4)
    80006294:	c10d                	beqz	a0,800062b6 <peterson_acquire+0x7a>
    80006296:	89b2                	mv	s3,a2
    80006298:	84ba                	mv	s1,a4
    8000629a:	0089a783          	lw	a5,8(s3)
    8000629e:	01279b63          	bne	a5,s2,800062b4 <peterson_acquire+0x78>
        yield();
    800062a2:	ffffc097          	auipc	ra,0xffffc
    800062a6:	d7e080e7          	jalr	-642(ra) # 80002020 <yield>
        __sync_synchronize() ;
    800062aa:	0ff0000f          	fence
    while(plock->flag[other] && plock->turn == other){
    800062ae:	4088                	lw	a0,0(s1)
    800062b0:	f56d                	bnez	a0,8000629a <peterson_acquire+0x5e>
    800062b2:	a011                	j	800062b6 <peterson_acquire+0x7a>
    }
    return 0 ; 
...
00000000800062cc <peterson_release>:
int peterson_release(int lock_id , int role){
    800062cc:	1141                	addi	sp,sp,-16
    800062ce:	e422                	sd	s0,8(sp)
    800062d0:	0800                	addi	s0,sp,16
    

    if(lock_id >= NPETERSONLOCKS || lock_id < 0 || (role !=0 && role !=1) ) 
    800062d2:	473d                	li	a4,15
    800062d4:	04a76563          	bltu	a4,a0,8000631e <peterson_release+0x52>
    800062d8:	0005871b          	sext.w	a4,a1
    800062dc:	4685                	li	a3,1
    800062de:	04e6e263          	bltu	a3,a4,80006322 <peterson_release+0x56>
        return -1 ;  //invalid lockid or role
    
    
    struct petersonlock* plock = &petersonlocks[lock_id] ;
    if (plock->used == 0)
    800062e2:	00451693          	slli	a3,a0,0x4
    800062e6:	0001c717          	auipc	a4,0x1c
    800062ea:	a9a70713          	addi	a4,a4,-1382 # 80021d80 <petersonlocks>
    800062ee:	9736                	add	a4,a4,a3
    800062f0:	4758                	lw	a4,12(a4)
    800062f2:	cb15                	beqz	a4,80006326 <peterson_release+0x5a>
        return -1;
    ...
    800062f8:	00251793          	slli	a5,a0,0x2
    800062fc:	97ae                	add	a5,a5,a1
    800062fe:	078a                	slli	a5,a5,0x2
    80006300:	0001c717          	auipc	a4,0x1c
    80006304:	a8070713          	addi	a4,a4,-1408 # 80021d80 <petersonlocks>
    80006308:	97ba                	add	a5,a5,a4
    8000630a:	0f50000f          	fence	iorw,ow
    8000630e:	0807a02f          	amoswap.w	zero,zero,(a5)
    __sync_synchronize() ;
    ...
    80006320:	bfe5                	j	80006318 <peterson_release+0x4c>
    80006322:	557d                	li	a0,-1
    80006324:	bfd5                	j	80006318 <peterson_release+0x4c>
        return -1;
    80006326:	557d                	li	a0,-1
    80006328:	bfc5                	j	80006318 <peterson_release+0x4c>

000000008000632a <peterson_destroy>:
int peterson_destroy(int lock_id){
    ...
    80006330:	473d                	li	a4,15
    80006332:	02a76663          	bltu	a4,a0,8000635e <peterson_destroy+0x34>
        return -1 ;  //invalid lockid or role
    ...
    8000633e:	0001c717          	auipc	a4,0x1c
    80006342:	a4270713          	addi	a4,a4,-1470 # 80021d80 <petersonlocks>
    80006346:	97ba                	add	a5,a5,a4
    80006348:	07b1                	addi	a5,a5,12
    8000634a:	0f50000f          	fence	iorw,ow
    8000634e:	0807a02f          	amoswap.w	zero,zero,(a5)
    __sync_synchronize() ;
    ...
    80006360:	bfe5                	j	80006358 <peterson_destroy+0x2e>

0000000080006362 <sys_peterson_create>:
#include "spinlock.h"
#include "proc.h"
...
uint64 sys_peterson_create(void){
   ...
   return  peterson_create() ;
    ...
    8000636e:	e84080e7          	jalr	-380(ra) # 800061ee <peterson_create>
}
...
000000008000637a <sys_peterson_acquire>:
uint64 sys_peterson_acquire(void){
    ...
    int lock_id ,  role ; 
    argint(0 , &lock_id) ;
    80006382:	fec40593          	addi	a1,s0,-20
    80006386:	4501                	li	a0,0
    80006388:	ffffc097          	auipc	ra,0xffffc
    8000638c:	740080e7          	jalr	1856(ra) # 80002ac8 <argint>
    argint(1 , &role) ;
    80006390:	fe840593          	addi	a1,s0,-24
    80006394:	4505                	li	a0,1
    80006396:	ffffc097          	auipc	ra,0xffffc
    8000639a:	732080e7          	jalr	1842(ra) # 80002ac8 <argint>

    return peterson_acquire(lock_id , role) ;
    8000639e:	fe842583          	lw	a1,-24(s0)
    800063a2:	fec42503          	lw	a0,-20(s0)
    800063a6:	00000097          	auipc	ra,0x0
    800063aa:	e96080e7          	jalr	-362(ra) # 8000623c <peterson_acquire>
}
...
00000000800063b6 <sys_peterson_release>:
uint64 sys_peterson_release(void){
    ...
    int lock_id ,  role ; 
    argint(0 , &lock_id) ;
    800063be:	fec40593          	addi	a1,s0,-20
    800063c2:	4501                	li	a0,0
    800063c4:	ffffc097          	auipc	ra,0xffffc
    800063c8:	704080e7          	jalr	1796(ra) # 80002ac8 <argint>
    argint(1 , &role) ;
    800063cc:	fe840593          	addi	a1,s0,-24
    800063d0:	4505                	li	a0,1
    800063d2:	ffffc097          	auipc	ra,0xffffc
    800063d6:	6f6080e7          	jalr	1782(ra) # 80002ac8 <argint>

    return peterson_release(lock_id , role) ;
    800063da:	fe842583          	lw	a1,-24(s0)
    800063de:	fec42503          	lw	a0,-20(s0)
    800063e2:	00000097          	auipc	ra,0x0
    800063e6:	eea080e7          	jalr	-278(ra) # 800062cc <peterson_release>
}
...
00000000800063f2 <sys_peterson_destroy>:
uint64 sys_peterson_destroy(void){
    ...
    int lock_id  ; 
    argint(0 , &lock_id) ;
    800063fa:	fec40593          	addi	a1,s0,-20
    800063fe:	4501                	li	a0,0
    80006400:	ffffc097          	auipc	ra,0xffffc
    80006404:	6c8080e7          	jalr	1736(ra) # 80002ac8 <argint>
    return peterson_destroy(lock_id) ;
    80006408:	fec42503          	lw	a0,-20(s0)
    8000640c:	00000097          	auipc	ra,0x0
    80006410:	f1e080e7          	jalr	-226(ra) # 8000632a <peterson_destroy>
}
