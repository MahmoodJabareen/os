...
int tournament_create(int processes) {
 ...
 8d2:	47bd                	li	a5,15
 8d4:	08e7eb63          	bltu	a5,a4,96a <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 8f0:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 8f2:	ecbd                	bnez	s1,970 <tournament_create+0xa2>
  if (n <= 1) 
 8f4:	4785                	li	a5,1
 8f6:	0937d763          	bge	a5,s3,984 <tournament_create+0xb6>
  int l = 0;
 8fa:	8726                	mv	a4,s1
 8fc:	87ce                	mv	a5,s3
  while (n > 1) {
 8fe:	458d                	li	a1,3
    n /= 2;
 900:	86be                	mv	a3,a5
 902:	01f7d61b          	srliw	a2,a5,0x1f
 906:	9fb1                	addw	a5,a5,a2
 908:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 90c:	2705                	addiw	a4,a4,1
  while (n > 1) {
 90e:	fed5c9e3          	blt	a1,a3,900 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 912:	00000797          	auipc	a5,0x0
 916:	6ee7ad23          	sw	a4,1786(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 91a:	00000917          	auipc	s2,0x0
 91e:	70690913          	addi	s2,s2,1798 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 922:	00000097          	auipc	ra,0x0
 926:	b12080e7          	jalr	-1262(ra) # 434 <peterson_create>
 92a:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 92e:	04054063          	bltz	a0,96e <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 932:	2485                	addiw	s1,s1,1
 934:	0911                	addi	s2,s2,4
 936:	ff44c6e3          	blt	s1,s4,922 <tournament_create+0x54>
 ...
 93e:	6c07a723          	sw	zero,1742(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 942:	4785                	li	a5,1
 944:	0537d863          	bge	a5,s3,994 <tournament_create+0xc6>
 948:	4485                	li	s1,1
        int pid = fork() ;
 94a:	00000097          	auipc	ra,0x0
 94e:	a42080e7          	jalr	-1470(ra) # 38c <fork>
        if(pid < 0)
 952:	02054763          	bltz	a0,980 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 956:	c509                	beqz	a0,960 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 958:	2485                	addiw	s1,s1,1
 95a:	fe9998e3          	bne	s3,s1,94a <tournament_create+0x7c>
 95e:	a81d                	j	994 <tournament_create+0xc6>
            trnmnt_idx = i ;
 960:	00000797          	auipc	a5,0x0
 964:	6a97a423          	sw	s1,1704(a5) # 1008 <trnmnt_idx>
            break ;
 968:	a035                	j	994 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 96a:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 97e:	8082                	ret
            return -1 ;
 980:	557d                	li	a0,-1
 982:	b7fd                	j	970 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 984:	00000797          	auipc	a5,0x0
 988:	6807a423          	sw	zero,1672(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 98c:	00000797          	auipc	a5,0x0
 990:	6607ae23          	sw	zero,1660(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 994:	00000517          	auipc	a0,0x0
 998:	67452503          	lw	a0,1652(a0) # 1008 <trnmnt_idx>
 99c:	bfd1                	j	970 <tournament_create+0xa2>

000000000000099e <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 99e:	00000797          	auipc	a5,0x0
 9a2:	66a7a783          	lw	a5,1642(a5) # 1008 <trnmnt_idx>
 9a6:	0a07c763          	bltz	a5,a54 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 ...
 9bc:	e45e                	sd	s7,8(sp)
 9be:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9c0:	00000497          	auipc	s1,0x0
 9c4:	64c4a483          	lw	s1,1612(s1) # 100c <num_levels>
 9c8:	08905863          	blez	s1,a58 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9cc:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9ce:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9d2:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 9d6:	4705                	li	a4,1
 9d8:	0097173b          	sllw	a4,a4,s1
 9dc:	9fb9                	addw	a5,a5,a4
 9de:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9e0:	4739                	li	a4,14
 9e2:	06f74d63          	blt	a4,a5,a5c <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 9e6:	00000997          	auipc	s3,0x0
 9ea:	63a98993          	addi	s3,s3,1594 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9ee:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9f0:	00000b97          	auipc	s7,0x0
 9f4:	61cb8b93          	addi	s7,s7,1564 # 100c <num_levels>
 9f8:	00000b17          	auipc	s6,0x0
 9fc:	610b0b13          	addi	s6,s6,1552 # 1008 <trnmnt_idx>
 a00:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a02:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a04:	078a                	slli	a5,a5,0x2
 a06:	97ce                	add	a5,a5,s3
 a08:	4388                	lw	a0,0(a5)
 a0a:	00000097          	auipc	ra,0x0
 a0e:	a32080e7          	jalr	-1486(ra) # 43c <peterson_acquire>
 a12:	04054763          	bltz	a0,a60 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a16:	fff4869b          	addiw	a3,s1,-1
 a1a:	0006849b          	sext.w	s1,a3
 a1e:	03448963          	beq	s1,s4,a50 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a22:	000ba703          	lw	a4,0(s7)
 a26:	40d706bb          	subw	a3,a4,a3
 a2a:	fff6879b          	addiw	a5,a3,-1
 a2e:	000b2703          	lw	a4,0(s6)
 a32:	00f915bb          	sllw	a1,s2,a5
 a36:	8df9                	and	a1,a1,a4
 a38:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a3c:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a40:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a44:	9fb9                	addw	a5,a5,a4
 a46:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a48:	fafadee3          	bge	s5,a5,a04 <tournament_acquire+0x66>
 a4c:	557d                	li	a0,-1
 a4e:	a811                	j	a62 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 a50:	4501                	li	a0,0
 a52:	a801                	j	a62 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a54:	557d                	li	a0,-1
}
 a56:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a58:	557d                	li	a0,-1
 a5a:	a021                	j	a62 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a5c:	557d                	li	a0,-1
 a5e:	a011                	j	a62 <tournament_acquire+0xc4>
        return -1;
 a60:	557d                	li	a0,-1
}
...
int tournament_release(void) {
 ...
 a80:	0a07c663          	bltz	a5,b2c <tournament_release+0xb4>
 a84:	00000717          	auipc	a4,0x0
 a88:	58872703          	lw	a4,1416(a4) # 100c <num_levels>
 a8c:	0ae05263          	blez	a4,b30 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a90:	fff7069b          	addiw	a3,a4,-1
 a94:	4585                	li	a1,1
 a96:	00d595bb          	sllw	a1,a1,a3
 a9a:	8dfd                	and	a1,a1,a5
 a9c:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 aa0:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 aa4:	4739                	li	a4,14
 aa6:	08f74763          	blt	a4,a5,b34 <tournament_release+0xbc>
int tournament_release(void) {
 ...
 ac0:	00000997          	auipc	s3,0x0
 ac4:	56098993          	addi	s3,s3,1376 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 ac8:	00000a17          	auipc	s4,0x0
 acc:	544a0a13          	addi	s4,s4,1348 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ad0:	00000b17          	auipc	s6,0x0
 ad4:	538b0b13          	addi	s6,s6,1336 # 1008 <trnmnt_idx>
 ad8:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ada:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 adc:	078a                	slli	a5,a5,0x2
 ade:	97ce                	add	a5,a5,s3
 ae0:	4388                	lw	a0,0(a5)
 ae2:	00000097          	auipc	ra,0x0
 ae6:	962080e7          	jalr	-1694(ra) # 444 <peterson_release>
 aea:	04054763          	bltz	a0,b38 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 aee:	0014871b          	addiw	a4,s1,1
 af2:	0007049b          	sext.w	s1,a4
 af6:	000a2783          	lw	a5,0(s4)
 afa:	02f4d763          	bge	s1,a5,b28 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 afe:	40e7873b          	subw	a4,a5,a4
 b02:	fff7079b          	addiw	a5,a4,-1
 b06:	000b2683          	lw	a3,0(s6)
 b0a:	00f915bb          	sllw	a1,s2,a5
 b0e:	8df5                	and	a1,a1,a3
 b10:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b14:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b18:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 b1c:	9fb9                	addw	a5,a5,a4
 b1e:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b20:	fafadee3          	bge	s5,a5,adc <tournament_release+0x64>
 b24:	557d                	li	a0,-1
 b26:	a811                	j	b3a <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 b28:	4501                	li	a0,0
 b2a:	a801                	j	b3a <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b2c:	557d                	li	a0,-1
 b2e:	8082                	ret
 b30:	557d                	li	a0,-1
