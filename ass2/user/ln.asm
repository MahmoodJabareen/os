...
main(int argc, char *argv[])
{
  ...
  14:	8c058593          	addi	a1,a1,-1856 # 8d0 <tournament_release+0x1a>
  18:	4509                	li	a0,2
  ...
  50:	89c58593          	addi	a1,a1,-1892 # 8e8 <tournament_release+0x32>
  54:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	450b8b93          	addi	s7,s7,1104 # 908 <digits>
 ...
 5fc:	30890913          	addi	s2,s2,776 # 900 <tournament_release+0x4a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 766:	8ae53503          	ld	a0,-1874(a0) # 1010 <freep>
 ...
 79a:	89a78793          	addi	a5,a5,-1894 # 1030 <base>
...
static int is_power_of_two(int x) {
 ...
 826:	47bd                	li	a5,15
 828:	00e7eb63          	bltu	a5,a4,83e <tournament_create+0x1c>
 82c:	fff5079b          	addiw	a5,a0,-1
 830:	8fe9                	and	a5,a5,a0
 832:	2781                	sext.w	a5,a5
 834:	c799                	beqz	a5,842 <tournament_create+0x20>
}
 ...
 838:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 83a:	557d                	li	a0,-1
 83c:	a095                	j	8a0 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 83e:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 84e:	7ca7ab23          	sw	a0,2006(a5) # 1020 <num_processes>
   while(temp >>=1)
 852:	4015551b          	sraiw	a0,a0,0x1
 856:	c105                	beqz	a0,876 <tournament_create+0x54>
 858:	00000797          	auipc	a5,0x0
 85c:	7cc7a783          	lw	a5,1996(a5) # 1024 <num_levels>
 860:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 862:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 866:	4015551b          	sraiw	a0,a0,0x1
 86a:	2785                	addiw	a5,a5,1
 86c:	f97d                	bnez	a0,862 <tournament_create+0x40>
 86e:	00000797          	auipc	a5,0x0
 872:	7ae7ab23          	sw	a4,1974(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 876:	00000797          	auipc	a5,0x0
 87a:	7ae7a783          	lw	a5,1966(a5) # 1024 <num_levels>
 87e:	4505                	li	a0,1
 880:	00f5153b          	sllw	a0,a0,a5
 884:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 886:	0025151b          	slliw	a0,a0,0x2
 88a:	00000097          	auipc	ra,0x0
 88e:	eb4080e7          	jalr	-332(ra) # 73e <malloc>
 892:	87aa                	mv	a5,a0
 894:	00000717          	auipc	a4,0x0
 898:	78a73223          	sd	a0,1924(a4) # 1018 <lock_ids>
    return 1 ;    
 89c:	4505                	li	a0,1
    if (!lock_ids)
 89e:	dfd1                	beqz	a5,83a <tournament_create+0x18>
}
 8a0:	60a2                	ld	ra,8(sp)
 8a2:	6402                	ld	s0,0(sp)
...
00000000000008a8 <tournament_acquire>:
...
00000000000008b6 <tournament_release>:
