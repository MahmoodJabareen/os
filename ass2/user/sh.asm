...
int tournament_create(int processes) {
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    1318:	fff5071b          	addiw	a4,a0,-1
    131c:	47bd                	li	a5,15
    131e:	08e7eb63          	bltu	a5,a4,13b4 <tournament_create+0x9c>
int tournament_create(int processes) {
    1322:	7179                	addi	sp,sp,-48
    1324:	f406                	sd	ra,40(sp)
    1326:	f022                	sd	s0,32(sp)
    1328:	ec26                	sd	s1,24(sp)
    132a:	e84a                	sd	s2,16(sp)
    132c:	e44e                	sd	s3,8(sp)
    132e:	e052                	sd	s4,0(sp)
   ...
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    133a:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
    133c:	ecbd                	bnez	s1,13ba <tournament_create+0xa2>
  if (n <= 1) 
    133e:	4785                	li	a5,1
    1340:	0937d763          	bge	a5,s3,13ce <tournament_create+0xb6>
  int l = 0;
    1344:	8726                	mv	a4,s1
    1346:	87ce                	mv	a5,s3
  while (n > 1) {
    ...
    n /= 2;
    134a:	86be                	mv	a3,a5
    134c:	01f7d61b          	srliw	a2,a5,0x1f
    1350:	9fb1                	addw	a5,a5,a2
    1352:	4017d79b          	sraiw	a5,a5,0x1
    l++;
    1356:	2705                	addiw	a4,a4,1
  while (n > 1) {
    1358:	fed5c9e3          	blt	a1,a3,134a <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
    135c:	00001797          	auipc	a5,0x1
    1360:	cce7a023          	sw	a4,-832(a5) # 201c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
    1364:	00001917          	auipc	s2,0x1
    1368:	d3490913          	addi	s2,s2,-716 # 2098 <lock_ids>
    lock_ids[i]= peterson_create() ;
    136c:	00000097          	auipc	ra,0x0
    1370:	b12080e7          	jalr	-1262(ra) # e7e <peterson_create>
    1374:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
    1378:	04054063          	bltz	a0,13b8 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
    137c:	2485                	addiw	s1,s1,1
    137e:	0911                	addi	s2,s2,4
    1380:	ff44c6e3          	blt	s1,s4,136c <tournament_create+0x54>
   ...
   trnmnt_idx = 0;
    ...
    1388:	c807aa23          	sw	zero,-876(a5) # 2018 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
    138c:	4785                	li	a5,1
    138e:	0537d863          	bge	a5,s3,13de <tournament_create+0xc6>
    1392:	4485                	li	s1,1
        int pid = fork() ;
    1394:	00000097          	auipc	ra,0x0
    1398:	a42080e7          	jalr	-1470(ra) # dd6 <fork>
        if(pid < 0)
    139c:	02054763          	bltz	a0,13ca <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
    13a0:	c509                	beqz	a0,13aa <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
    13a2:	2485                	addiw	s1,s1,1
    13a4:	fe9998e3          	bne	s3,s1,1394 <tournament_create+0x7c>
    13a8:	a81d                	j	13de <tournament_create+0xc6>
            trnmnt_idx = i ;
    13aa:	00001797          	auipc	a5,0x1
    13ae:	c697a723          	sw	s1,-914(a5) # 2018 <trnmnt_idx>
            break ;
    13b2:	a035                	j	13de <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    13b4:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
    ...
    13ba:	70a2                	ld	ra,40(sp)
    13bc:	7402                	ld	s0,32(sp)
    13be:	64e2                	ld	s1,24(sp)
    13c0:	6942                	ld	s2,16(sp)
    13c2:	69a2                	ld	s3,8(sp)
    13c4:	6a02                	ld	s4,0(sp)
    13c6:	6145                	addi	sp,sp,48
    13c8:	8082                	ret
            return -1 ;
    13ca:	557d                	li	a0,-1
    13cc:	b7fd                	j	13ba <tournament_create+0xa2>
   num_levels = log2(processes) ;
    13ce:	00001797          	auipc	a5,0x1
    13d2:	c407a723          	sw	zero,-946(a5) # 201c <num_levels>
   trnmnt_idx = 0;
    13d6:	00001797          	auipc	a5,0x1
    13da:	c407a123          	sw	zero,-958(a5) # 2018 <trnmnt_idx>
return trnmnt_idx ;
    13de:	00001517          	auipc	a0,0x1
    13e2:	c3a52503          	lw	a0,-966(a0) # 2018 <trnmnt_idx>
    13e6:	bfd1                	j	13ba <tournament_create+0xa2>

00000000000013e8 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    13e8:	00001797          	auipc	a5,0x1
    13ec:	c307a783          	lw	a5,-976(a5) # 2018 <trnmnt_idx>
    13f0:	0a07c763          	bltz	a5,149e <tournament_acquire+0xb6>
int tournament_acquire(void){ 
    13f4:	715d                	addi	sp,sp,-80
    13f6:	e486                	sd	ra,72(sp)
    13f8:	e0a2                	sd	s0,64(sp)
    13fa:	fc26                	sd	s1,56(sp)
    13fc:	f84a                	sd	s2,48(sp)
    13fe:	f44e                	sd	s3,40(sp)
    1400:	f052                	sd	s4,32(sp)
    1402:	ec56                	sd	s5,24(sp)
    1404:	e85a                	sd	s6,16(sp)
    1406:	e45e                	sd	s7,8(sp)
    1408:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    140a:	00001497          	auipc	s1,0x1
    140e:	c124a483          	lw	s1,-1006(s1) # 201c <num_levels>
    1412:	08905863          	blez	s1,14a2 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    1416:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    1418:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    141c:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
    1420:	4705                	li	a4,1
    1422:	0097173b          	sllw	a4,a4,s1
    1426:	9fb9                	addw	a5,a5,a4
    1428:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    142a:	4739                	li	a4,14
    142c:	06f74d63          	blt	a4,a5,14a6 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
    1430:	00001997          	auipc	s3,0x1
    1434:	c6898993          	addi	s3,s3,-920 # 2098 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    1438:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    143a:	00001b97          	auipc	s7,0x1
    143e:	be2b8b93          	addi	s7,s7,-1054 # 201c <num_levels>
    1442:	00001b17          	auipc	s6,0x1
    1446:	bd6b0b13          	addi	s6,s6,-1066 # 2018 <trnmnt_idx>
    144a:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    144c:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
    144e:	078a                	slli	a5,a5,0x2
    1450:	97ce                	add	a5,a5,s3
    1452:	4388                	lw	a0,0(a5)
    1454:	00000097          	auipc	ra,0x0
    1458:	a32080e7          	jalr	-1486(ra) # e86 <peterson_acquire>
    145c:	04054763          	bltz	a0,14aa <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
    1460:	fff4869b          	addiw	a3,s1,-1
    1464:	0006849b          	sext.w	s1,a3
    1468:	03448963          	beq	s1,s4,149a <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    146c:	000ba703          	lw	a4,0(s7)
    1470:	40d706bb          	subw	a3,a4,a3
    1474:	fff6879b          	addiw	a5,a3,-1
    1478:	000b2703          	lw	a4,0(s6)
    147c:	00f915bb          	sllw	a1,s2,a5
    1480:	8df9                	and	a1,a1,a4
    1482:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    1486:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    148a:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
    148e:	9fb9                	addw	a5,a5,a4
    1490:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1492:	fafadee3          	bge	s5,a5,144e <tournament_acquire+0x66>
    1496:	557d                	li	a0,-1
    1498:	a811                	j	14ac <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
    149a:	4501                	li	a0,0
    149c:	a801                	j	14ac <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    149e:	557d                	li	a0,-1
}
    14a0:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    14a2:	557d                	li	a0,-1
    14a4:	a021                	j	14ac <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
    14a6:	557d                	li	a0,-1
    14a8:	a011                	j	14ac <tournament_acquire+0xc4>
        return -1;
    14aa:	557d                	li	a0,-1
}
    14ac:	60a6                	ld	ra,72(sp)
    14ae:	6406                	ld	s0,64(sp)
    14b0:	74e2                	ld	s1,56(sp)
    14b2:	7942                	ld	s2,48(sp)
    14b4:	79a2                	ld	s3,40(sp)
    14b6:	7a02                	ld	s4,32(sp)
    14b8:	6ae2                	ld	s5,24(sp)
    14ba:	6b42                	ld	s6,16(sp)
    14bc:	6ba2                	ld	s7,8(sp)
    14be:	6161                	addi	sp,sp,80
    14c0:	8082                	ret
...
int tournament_release(void) {
    ...
    14ca:	0a07c663          	bltz	a5,1576 <tournament_release+0xb4>
    14ce:	00001717          	auipc	a4,0x1
    14d2:	b4e72703          	lw	a4,-1202(a4) # 201c <num_levels>
    14d6:	0ae05263          	blez	a4,157a <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    14da:	fff7069b          	addiw	a3,a4,-1
    14de:	4585                	li	a1,1
    14e0:	00d595bb          	sllw	a1,a1,a3
    14e4:	8dfd                	and	a1,a1,a5
    14e6:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    14ea:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
    14ee:	4739                	li	a4,14
    14f0:	08f74763          	blt	a4,a5,157e <tournament_release+0xbc>
int tournament_release(void) {
    ...
    1506:	0080                	addi	s0,sp,64
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    1508:	4481                	li	s1,0

        if (peterson_release(lock_ids[lockidx] , role) < 0)
    150a:	00001997          	auipc	s3,0x1
    150e:	b8e98993          	addi	s3,s3,-1138 # 2098 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    1512:	00001a17          	auipc	s4,0x1
    1516:	b0aa0a13          	addi	s4,s4,-1270 # 201c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    151a:	00001b17          	auipc	s6,0x1
    151e:	afeb0b13          	addi	s6,s6,-1282 # 2018 <trnmnt_idx>
    1522:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    1524:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
    1526:	078a                	slli	a5,a5,0x2
    1528:	97ce                	add	a5,a5,s3
    152a:	4388                	lw	a0,0(a5)
    152c:	00000097          	auipc	ra,0x0
    1530:	962080e7          	jalr	-1694(ra) # e8e <peterson_release>
    1534:	04054763          	bltz	a0,1582 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
    1538:	0014871b          	addiw	a4,s1,1
    153c:	0007049b          	sext.w	s1,a4
    1540:	000a2783          	lw	a5,0(s4)
    1544:	02f4d763          	bge	s1,a5,1572 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    1548:	40e7873b          	subw	a4,a5,a4
    154c:	fff7079b          	addiw	a5,a4,-1
    1550:	000b2683          	lw	a3,0(s6)
    1554:	00f915bb          	sllw	a1,s2,a5
    1558:	8df5                	and	a1,a1,a3
    155a:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    155e:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    1562:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
    1566:	9fb9                	addw	a5,a5,a4
    1568:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    156a:	fafadee3          	bge	s5,a5,1526 <tournament_release+0x64>
    156e:	557d                	li	a0,-1
    1570:	a811                	j	1584 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
    1572:	4501                	li	a0,0
    1574:	a801                	j	1584 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    1576:	557d                	li	a0,-1
    1578:	8082                	ret
    157a:	557d                	li	a0,-1
    ...
    1588:	74a2                	ld	s1,40(sp)
    158a:	7902                	ld	s2,32(sp)
    158c:	69e2                	ld	s3,24(sp)
    158e:	6a42                	ld	s4,16(sp)
    1590:	6aa2                	ld	s5,8(sp)
    1592:	6b02                	ld	s6,0(sp)
