...
ls(char *path)
{
 ...
 12c:	a4850513          	addi	a0,a0,-1464 # b70 <tournament_release+0x42>
 ...
 16a:	9da58593          	addi	a1,a1,-1574 # b40 <tournament_release+0x12>
 16e:	4509                	li	a0,2
 ...
 180:	9dc58593          	addi	a1,a1,-1572 # b58 <tournament_release+0x2a>
 184:	4509                	li	a0,2
 ...
 1b2:	9d250513          	addi	a0,a0,-1582 # b80 <tournament_release+0x52>
 ...
 1f8:	9a4a0a13          	addi	s4,s4,-1628 # b98 <tournament_release+0x6a>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	95ca8a93          	addi	s5,s5,-1700 # b58 <tournament_release+0x2a>
...
main(int argc, char *argv[])
{
 ...
 2c2:	8ea50513          	addi	a0,a0,-1814 # ba8 <tournament_release+0x7a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 668:	55450513          	addi	a0,a0,1364 # bb8 <digits>
 66c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 734:	488b8b93          	addi	s7,s7,1160 # bb8 <digits>
 ...
 874:	34090913          	addi	s2,s2,832 # bb0 <tournament_release+0x82>
        while(*s != 0){
 ...
 96a:	00e6ea63          	bltu	a3,a4,97e <free+0x50>
{
 ...
 9ac:	66f73423          	sd	a5,1640(a4) # 1010 <freep>
}
 9b0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a06:	60e90913          	addi	s2,s2,1550 # 1010 <freep>
  if(p == (char*)-1)
 a0a:	5afd                	li	s5,-1
 a0c:	a88d                	j	a7e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a0e:	00000797          	auipc	a5,0x0
 a12:	63278793          	addi	a5,a5,1586 # 1040 <base>
 ...
 a40:	5ca73a23          	sd	a0,1492(a4) # 1010 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 a9e:	47bd                	li	a5,15
 aa0:	00e7eb63          	bltu	a5,a4,ab6 <tournament_create+0x1c>
 aa4:	fff5079b          	addiw	a5,a0,-1
 aa8:	8fe9                	and	a5,a5,a0
 aaa:	2781                	sext.w	a5,a5
 aac:	c799                	beqz	a5,aba <tournament_create+0x20>
}
 ...
 ab0:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 ab2:	557d                	li	a0,-1
 ab4:	a095                	j	b18 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 ab6:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 ac6:	54a7af23          	sw	a0,1374(a5) # 1020 <num_processes>
   while(temp >>=1)
 aca:	4015551b          	sraiw	a0,a0,0x1
 ace:	c105                	beqz	a0,aee <tournament_create+0x54>
 ad0:	00000797          	auipc	a5,0x0
 ad4:	5547a783          	lw	a5,1364(a5) # 1024 <num_levels>
 ad8:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 ada:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 ade:	4015551b          	sraiw	a0,a0,0x1
 ae2:	2785                	addiw	a5,a5,1
 ae4:	f97d                	bnez	a0,ada <tournament_create+0x40>
 ae6:	00000797          	auipc	a5,0x0
 aea:	52e7af23          	sw	a4,1342(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 aee:	00000797          	auipc	a5,0x0
 af2:	5367a783          	lw	a5,1334(a5) # 1024 <num_levels>
 af6:	4505                	li	a0,1
 af8:	00f5153b          	sllw	a0,a0,a5
 afc:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 afe:	0025151b          	slliw	a0,a0,0x2
 b02:	00000097          	auipc	ra,0x0
 b06:	eb4080e7          	jalr	-332(ra) # 9b6 <malloc>
 b0a:	87aa                	mv	a5,a0
 b0c:	00000717          	auipc	a4,0x0
 b10:	50a73623          	sd	a0,1292(a4) # 1018 <lock_ids>
    return 1 ;    
 b14:	4505                	li	a0,1
    if (!lock_ids)
 b16:	dfd1                	beqz	a5,ab2 <tournament_create+0x18>
}
 b18:	60a2                	ld	ra,8(sp)
 b1a:	6402                	ld	s0,0(sp)
...
0000000000000b20 <tournament_acquire>:
...
0000000000000b2e <tournament_release>:
