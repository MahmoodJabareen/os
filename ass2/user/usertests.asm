...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	36250513          	addi	a0,a0,866 # 63a0 <tournament_release+0xf6>
      ...
      74:	8082                	ret
{
      ...
      84:	34050513          	addi	a0,a0,832 # 63c0 <tournament_release+0x116>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	33050513          	addi	a0,a0,816 # 63d8 <tournament_release+0x12e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	33250513          	addi	a0,a0,818 # 63f8 <tournament_release+0x14e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	2fa50513          	addi	a0,a0,762 # 63e0 <tournament_release+0x136>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	30650513          	addi	a0,a0,774 # 6408 <tournament_release+0x15e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	30450513          	addi	a0,a0,772 # 6430 <tournament_release+0x186>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	2f050513          	addi	a0,a0,752 # 6430 <tournament_release+0x186>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	2ec58593          	addi	a1,a1,748 # 6440 <tournament_release+0x196>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	2c850513          	addi	a0,a0,712 # 6430 <tournament_release+0x186>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	2cc58593          	addi	a1,a1,716 # 6448 <tournament_release+0x19e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	29c50513          	addi	a0,a0,668 # 6430 <tournament_release+0x186>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	28650513          	addi	a0,a0,646 # 6450 <tournament_release+0x1a6>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	1fc50513          	addi	a0,a0,508 # 6478 <tournament_release+0x1ce>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	1e8a8a93          	addi	s5,s5,488 # 6478 <tournament_release+0x1ce>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	17650513          	addi	a0,a0,374 # 6488 <tournament_release+0x1de>
     ...
     33a:	17250513          	addi	a0,a0,370 # 64a8 <tournament_release+0x1fe>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	16050513          	addi	a0,a0,352 # 64c0 <tournament_release+0x216>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	14c98993          	addi	s3,s3,332 # 64c0 <tournament_release+0x216>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	10050513          	addi	a0,a0,256 # 64c0 <tournament_release+0x216>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	07058593          	addi	a1,a1,112 # 6448 <tournament_release+0x19e>
    ...
    printf("write failed\n");
     ...
     3f2:	0f250513          	addi	a0,a0,242 # 64e0 <tournament_release+0x236>
    ...
    exit(1);
     ...
     40c:	0c050513          	addi	a0,a0,192 # 64c8 <tournament_release+0x21e>
    ...
    printf("open junk failed\n");
     ...
     426:	0a650513          	addi	a0,a0,166 # 64c8 <tournament_release+0x21e>
  ...
  unlink("junk");
     ...
     44a:	07a50513          	addi	a0,a0,122 # 64c0 <tournament_release+0x216>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	f9ea0a13          	addi	s4,s4,-98 # 64f0 <tournament_release+0x246>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	efa50513          	addi	a0,a0,-262 # 64f8 <tournament_release+0x24e>
     ...
     620:	ef450513          	addi	a0,a0,-268 # 6510 <tournament_release+0x266>
     ...
     63e:	f0650513          	addi	a0,a0,-250 # 6540 <tournament_release+0x296>
     ...
     658:	f1c50513          	addi	a0,a0,-228 # 6570 <tournament_release+0x2c6>
     ...
     676:	f0e50513          	addi	a0,a0,-242 # 6580 <tournament_release+0x2d6>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	f00a0a13          	addi	s4,s4,-256 # 65b0 <tournament_release+0x306>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	d90a8a93          	addi	s5,s5,-624 # 6448 <tournament_release+0x19e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	e5a50513          	addi	a0,a0,-422 # 65b8 <tournament_release+0x30e>
     ...
     780:	e5450513          	addi	a0,a0,-428 # 65d0 <tournament_release+0x326>
     ...
     79a:	dda50513          	addi	a0,a0,-550 # 6570 <tournament_release+0x2c6>
     ...
     7b4:	e5050513          	addi	a0,a0,-432 # 6600 <tournament_release+0x356>
     ...
     7d2:	e4a50513          	addi	a0,a0,-438 # 6618 <tournament_release+0x36e>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	c1c58593          	addi	a1,a1,-996 # 6440 <tournament_release+0x196>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	bf050513          	addi	a0,a0,-1040 # 6430 <tournament_release+0x186>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	bc450513          	addi	a0,a0,-1084 # 6430 <tournament_release+0x186>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	bb050513          	addi	a0,a0,-1104 # 6430 <tournament_release+0x186>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	dea58593          	addi	a1,a1,-534 # 66a8 <tournament_release+0x3fe>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	b3050513          	addi	a0,a0,-1232 # 6430 <tournament_release+0x186>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	d0450513          	addi	a0,a0,-764 # 6648 <tournament_release+0x39e>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	d0850513          	addi	a0,a0,-760 # 6668 <tournament_release+0x3be>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	d0450513          	addi	a0,a0,-764 # 6678 <tournament_release+0x3ce>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	d0850513          	addi	a0,a0,-760 # 6698 <tournament_release+0x3ee>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	cd450513          	addi	a0,a0,-812 # 6678 <tournament_release+0x3ce>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	cee50513          	addi	a0,a0,-786 # 66b0 <tournament_release+0x406>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	cf050513          	addi	a0,a0,-784 # 66d0 <tournament_release+0x426>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	cdc50513          	addi	a0,a0,-804 # 66f0 <tournament_release+0x446>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	cec98993          	addi	s3,s3,-788 # 6718 <tournament_release+0x46e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	d1ca8a93          	addi	s5,s5,-740 # 6750 <tournament_release+0x4a6>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	c7650513          	addi	a0,a0,-906 # 66f0 <tournament_release+0x446>
  ...
  if(unlink("small") < 0){
     ...
     aba:	c3a50513          	addi	a0,a0,-966 # 66f0 <tournament_release+0x446>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	c1850513          	addi	a0,a0,-1000 # 66f8 <tournament_release+0x44e>
    ...
    exit(1);
     ...
     b02:	c2a50513          	addi	a0,a0,-982 # 6728 <tournament_release+0x47e>
     ...
     b20:	c4450513          	addi	a0,a0,-956 # 6760 <tournament_release+0x4b6>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	c5050513          	addi	a0,a0,-944 # 6788 <tournament_release+0x4de>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	c5450513          	addi	a0,a0,-940 # 67a8 <tournament_release+0x4fe>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	c5050513          	addi	a0,a0,-944 # 67c0 <tournament_release+0x516>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	c3e50513          	addi	a0,a0,-962 # 67e0 <tournament_release+0x536>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	bec50513          	addi	a0,a0,-1044 # 67e0 <tournament_release+0x536>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	bac50513          	addi	a0,a0,-1108 # 67e8 <tournament_release+0x53e>
    ...
    exit(1);
     ...
     c5e:	bae50513          	addi	a0,a0,-1106 # 6808 <tournament_release+0x55e>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	bba50513          	addi	a0,a0,-1094 # 6830 <tournament_release+0x586>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	b3e50513          	addi	a0,a0,-1218 # 67e0 <tournament_release+0x536>
     ...
     cd2:	b8250513          	addi	a0,a0,-1150 # 6850 <tournament_release+0x5a6>
     ...
     cf0:	b8c50513          	addi	a0,a0,-1140 # 6878 <tournament_release+0x5ce>
     ...
     d0e:	b8650513          	addi	a0,a0,-1146 # 6890 <tournament_release+0x5e6>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	b9250513          	addi	a0,a0,-1134 # 68b8 <tournament_release+0x60e>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	b7c50513          	addi	a0,a0,-1156 # 68d0 <tournament_release+0x626>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	b9458593          	addi	a1,a1,-1132 # 6900 <tournament_release+0x656>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	b4850513          	addi	a0,a0,-1208 # 68d0 <tournament_release+0x626>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	b3250513          	addi	a0,a0,-1230 # 68d0 <tournament_release+0x626>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	b1c50513          	addi	a0,a0,-1252 # 68d0 <tournament_release+0x626>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	b8058593          	addi	a1,a1,-1152 # 6948 <tournament_release+0x69e>
  ...
  unlink("unlinkread");
     ...
     e34:	aa050513          	addi	a0,a0,-1376 # 68d0 <tournament_release+0x626>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	a9050513          	addi	a0,a0,-1392 # 68e0 <tournament_release+0x636>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	a9c50513          	addi	a0,a0,-1380 # 6908 <tournament_release+0x65e>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	aa050513          	addi	a0,a0,-1376 # 6928 <tournament_release+0x67e>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	aac50513          	addi	a0,a0,-1364 # 6950 <tournament_release+0x6a6>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	ab050513          	addi	a0,a0,-1360 # 6970 <tournament_release+0x6c6>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	ab450513          	addi	a0,a0,-1356 # 6990 <tournament_release+0x6e6>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	9c058593          	addi	a1,a1,-1600 # 6900 <tournament_release+0x656>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	a5858593          	addi	a1,a1,-1448 # 69b8 <tournament_release+0x70e>
     f68:	00006517          	auipc	a0,0x6
     f6c:	a4850513          	addi	a0,a0,-1464 # 69b0 <tournament_release+0x706>
  ...
  unlink("lf1");
     ...
     f80:	a3450513          	addi	a0,a0,-1484 # 69b0 <tournament_release+0x706>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00006517          	auipc	a0,0x6
     f92:	a2250513          	addi	a0,a0,-1502 # 69b0 <tournament_release+0x706>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	a1450513          	addi	a0,a0,-1516 # 69b8 <tournament_release+0x70e>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	9dc58593          	addi	a1,a1,-1572 # 69b8 <tournament_release+0x70e>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	9c650513          	addi	a0,a0,-1594 # 69b8 <tournament_release+0x70e>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00006597          	auipc	a1,0x6
    1006:	9ae58593          	addi	a1,a1,-1618 # 69b0 <tournament_release+0x706>
    100a:	00006517          	auipc	a0,0x6
    100e:	9ae50513          	addi	a0,a0,-1618 # 69b8 <tournament_release+0x70e>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	99258593          	addi	a1,a1,-1646 # 69b0 <tournament_release+0x706>
    1026:	00006517          	auipc	a0,0x6
    102a:	a9a50513          	addi	a0,a0,-1382 # 6ac0 <tournament_release+0x816>
    ...
    104c:	97850513          	addi	a0,a0,-1672 # 69c0 <tournament_release+0x716>
    ...
    1068:	97450513          	addi	a0,a0,-1676 # 69d8 <tournament_release+0x72e>
    ...
    1084:	97050513          	addi	a0,a0,-1680 # 69f0 <tournament_release+0x746>
    ...
    10a0:	97450513          	addi	a0,a0,-1676 # 6a10 <tournament_release+0x766>
    ...
    10bc:	98850513          	addi	a0,a0,-1656 # 6a40 <tournament_release+0x796>
    ...
    10d8:	98450513          	addi	a0,a0,-1660 # 6a58 <tournament_release+0x7ae>
    ...
    10f4:	98050513          	addi	a0,a0,-1664 # 6a70 <tournament_release+0x7c6>
    ...
    1110:	98c50513          	addi	a0,a0,-1652 # 6a98 <tournament_release+0x7ee>
    ...
    112c:	9a050513          	addi	a0,a0,-1632 # 6ac8 <tournament_release+0x81e>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	98e98993          	addi	s3,s3,-1650 # 6ae8 <tournament_release+0x83e>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	96250513          	addi	a0,a0,-1694 # 6af8 <tournament_release+0x84e>
...
00000000000011b0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    11ca:	95250513          	addi	a0,a0,-1710 # 6b18 <tournament_release+0x86e>
    11ce:	00005097          	auipc	ra,0x5
    11d2:	a48080e7          	jalr	-1464(ra) # 5c16 <unlink>
  fd = open("bd", O_CREATE);
    11d6:	20000593          	li	a1,512
    11da:	00006517          	auipc	a0,0x6
    11de:	93e50513          	addi	a0,a0,-1730 # 6b18 <tournament_release+0x86e>
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	91ca0a13          	addi	s4,s4,-1764 # 6b18 <tournament_release+0x86e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	8ca50513          	addi	a0,a0,-1846 # 6b18 <tournament_release+0x86e>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	86250513          	addi	a0,a0,-1950 # 6b20 <tournament_release+0x876>
    ...
    12e2:	86250513          	addi	a0,a0,-1950 # 6b40 <tournament_release+0x896>
    ...
    12fe:	86650513          	addi	a0,a0,-1946 # 6b60 <tournament_release+0x8b6>
...
000000000000134c <badarg>:
{
    ...
    136a:	07298993          	addi	s3,s3,114 # 63d8 <tournament_release+0x12e>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	9c878793          	addi	a5,a5,-1592 # 7db8 <tournament_release+0x1b0e>
  ...
  if(pid == 0){
    ...
    1450:	38c78793          	addi	a5,a5,908 # 87d8 <tournament_release+0x252e>
    ...
    1474:	f6850513          	addi	a0,a0,-152 # 63d8 <tournament_release+0x12e>
    ...
    148c:	78050513          	addi	a0,a0,1920 # 6c08 <tournament_release+0x95e>
    ...
    14ac:	6d850513          	addi	a0,a0,1752 # 6b80 <tournament_release+0x8d6>
    ...
    14cc:	6d850513          	addi	a0,a0,1752 # 6ba0 <tournament_release+0x8f6>
    ...
    14ee:	6d650513          	addi	a0,a0,1750 # 6bc0 <tournament_release+0x916>
    ...
    150e:	6de50513          	addi	a0,a0,1758 # 6be8 <tournament_release+0x93e>
    ...
    1528:	b4450513          	addi	a0,a0,-1212 # 7068 <tournament_release+0xdbe>
  ...
  if(st != 747){
    ...
    1572:	6c250513          	addi	a0,a0,1730 # 6c30 <tournament_release+0x986>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	e9050513          	addi	a0,a0,-368 # 6430 <tournament_release+0x186>
  ...
  if(pid == 0){
    ...
    15ce:	e66a0a13          	addi	s4,s4,-410 # 6430 <tournament_release+0x186>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	6bea8a93          	addi	s5,s5,1726 # 6c90 <tournament_release+0x9e6>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	61e50513          	addi	a0,a0,1566 # 6c60 <tournament_release+0x9b6>
    ...
    1662:	61a50513          	addi	a0,a0,1562 # 6c78 <tournament_release+0x9ce>
    ...
    1680:	62450513          	addi	a0,a0,1572 # 6ca0 <tournament_release+0x9f6>
    ...
    169e:	d96a0a13          	addi	s4,s4,-618 # 6430 <tournament_release+0x186>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	61ea8a93          	addi	s5,s5,1566 # 6cc0 <tournament_release+0xa16>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	d4450513          	addi	a0,a0,-700 # 6430 <tournament_release+0x186>
  ...
  exit(xstatus);
    ...
    170e:	56e50513          	addi	a0,a0,1390 # 6c78 <tournament_release+0x9ce>
    ...
    172c:	5a050513          	addi	a0,a0,1440 # 6cc8 <tournament_release+0xa1e>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	c8878793          	addi	a5,a5,-888 # 63d8 <tournament_release+0x12e>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	58c78793          	addi	a5,a5,1420 # 6ce8 <tournament_release+0xa3e>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	58450513          	addi	a0,a0,1412 # 6cf0 <tournament_release+0xa46>
  ...
  if(pid == 0) {
    ...
    179e:	55650513          	addi	a0,a0,1366 # 6cf0 <tournament_release+0xa46>
    ...
    17ba:	55a50513          	addi	a0,a0,1370 # 6d10 <tournament_release+0xa66>
    ...
    17d6:	48e50513          	addi	a0,a0,1166 # 6c60 <tournament_release+0x9b6>
    ...
    17f2:	50a50513          	addi	a0,a0,1290 # 6cf8 <tournament_release+0xa4e>
    ...
    1810:	bcc50513          	addi	a0,a0,-1076 # 63d8 <tournament_release+0x12e>
  ...
  if(xstatus != 0)
    ...
    1844:	4e050513          	addi	a0,a0,1248 # 6d20 <tournament_release+0xa76>
    ...
    1860:	4dc50513          	addi	a0,a0,1244 # 6d38 <tournament_release+0xa8e>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	48050513          	addi	a0,a0,1152 # 6cf0 <tournament_release+0xa46>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	f0e50513          	addi	a0,a0,-242 # 67a8 <tournament_release+0x4fe>
    ...
    18ba:	3c250513          	addi	a0,a0,962 # 6c78 <tournament_release+0x9ce>
  ...
  unlink("echo-ok");
    ...
    18d4:	42050513          	addi	a0,a0,1056 # 6cf0 <tournament_release+0xa46>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	45650513          	addi	a0,a0,1110 # 6d50 <tournament_release+0xaa6>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	3ac50513          	addi	a0,a0,940 # 6d68 <tournament_release+0xabe>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	33e50513          	addi	a0,a0,830 # 6d80 <tournament_release+0xad6>
    ...
    1a62:	33a50513          	addi	a0,a0,826 # 6d98 <tournament_release+0xaee>
    ...
    1a94:	32050513          	addi	a0,a0,800 # 6db0 <tournament_release+0xb06>
    ...
    1ad4:	30050513          	addi	a0,a0,768 # 6dd0 <tournament_release+0xb26>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	11e50513          	addi	a0,a0,286 # 6c60 <tournament_release+0x9b6>
    ...
    1b62:	28a50513          	addi	a0,a0,650 # 6de8 <tournament_release+0xb3e>
    ...
    1b7e:	28650513          	addi	a0,a0,646 # 6e00 <tournament_release+0xb56>
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	06e50513          	addi	a0,a0,110 # 6c60 <tournament_release+0x9b6>
    ...
    1c1a:	04a50513          	addi	a0,a0,74 # 6c60 <tournament_release+0x9b6>
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	19050513          	addi	a0,a0,400 # 6e20 <tournament_release+0xb76>
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	14850513          	addi	a0,a0,328 # 6e30 <tournament_release+0xb86>
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	33250513          	addi	a0,a0,818 # 7068 <tournament_release+0xdbe>
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	29450513          	addi	a0,a0,660 # 7068 <tournament_release+0xdbe>
    ...
    1e04:	ef850513          	addi	a0,a0,-264 # 6cf8 <tournament_release+0xa4e>
    ...
    1e76:	fde50513          	addi	a0,a0,-34 # 6e50 <tournament_release+0xba6>
    ...
    1eaa:	fc250513          	addi	a0,a0,-62 # 6e68 <tournament_release+0xbbe>
    ...
    1f10:	f8450513          	addi	a0,a0,-124 # 6e90 <tournament_release+0xbe6>
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	49c50513          	addi	a0,a0,1180 # 6448 <tournament_release+0x19e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	460a8a93          	addi	s5,s5,1120 # 6448 <tournament_release+0x19e>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	ec8b8b93          	addi	s7,s7,-312 # 6eb8 <tournament_release+0xc0e>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	c6450513          	addi	a0,a0,-924 # 6c60 <tournament_release+0x9b6>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	e1a50513          	addi	a0,a0,-486 # 6ed8 <tournament_release+0xc2e>
  ...
  if(wait(0) != -1){
    ...
    2124:	da050513          	addi	a0,a0,-608 # 6ec0 <tournament_release+0xc16>
    ...
    2140:	dc450513          	addi	a0,a0,-572 # 6f00 <tournament_release+0xc56>
    ...
    215c:	dc050513          	addi	a0,a0,-576 # 6f18 <tournament_release+0xc6e>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2198:	48090913          	addi	s2,s2,1152 # 1003d480 <lock_ids+0x1002d7e8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	a8850513          	addi	a0,a0,-1400 # 6c60 <tournament_release+0x9b6>
    ...
    21fe:	d3650513          	addi	a0,a0,-714 # 6f30 <tournament_release+0xc86>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	9e450513          	addi	a0,a0,-1564 # 6c60 <tournament_release+0x9b6>
    ...
    22ac:	ca850513          	addi	a0,a0,-856 # 6f50 <tournament_release+0xca6>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	c9050513          	addi	a0,a0,-880 # 6f68 <tournament_release+0xcbe>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	c5e50513          	addi	a0,a0,-930 # 6f68 <tournament_release+0xcbe>
  ...
  close(fd);
    ...
    2344:	c3870713          	addi	a4,a4,-968 # 6f78 <tournament_release+0xcce>
    ...
    2360:	07c50513          	addi	a0,a0,124 # 63d8 <tournament_release+0x12e>
    2364:	00004097          	auipc	ra,0x4
    2368:	89a080e7          	jalr	-1894(ra) # 5bfe <exec>
    fd = open("bigarg-ok", O_CREATE);
    236c:	20000593          	li	a1,512
    2370:	00005517          	auipc	a0,0x5
    2374:	bf850513          	addi	a0,a0,-1032 # 6f68 <tournament_release+0xcbe>
    ...
    2398:	cc450513          	addi	a0,a0,-828 # 7058 <tournament_release+0xdae>
    ...
    23bc:	cc050513          	addi	a0,a0,-832 # 7078 <tournament_release+0xdce>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2410:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <lock_ids+0xfffffffffffef368>
    2414:	85a6                	mv	a1,s1
    2416:	00005517          	auipc	a0,0x5
    241a:	c8250513          	addi	a0,a0,-894 # 7098 <tournament_release+0xdee>
    ...
    2436:	82e50513          	addi	a0,a0,-2002 # 6c60 <tournament_release+0x9b6>
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	7c050513          	addi	a0,a0,1984 # 6c60 <tournament_release+0x9b6>
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	b4c50513          	addi	a0,a0,-1204 # 7068 <tournament_release+0xdbe>
    ...
    25d0:	af450513          	addi	a0,a0,-1292 # 70c0 <tournament_release+0xe16>
    ...
    25f0:	ebc50513          	addi	a0,a0,-324 # 64a8 <tournament_release+0x1fe>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	73478793          	addi	a5,a5,1844 # 7db8 <tournament_release+0x1b0e>
  ...
  if(ret != -1){
    ...
    26ca:	a1250513          	addi	a0,a0,-1518 # 70d8 <tournament_release+0xe2e>
    ...
    26e8:	49c50513          	addi	a0,a0,1180 # 6b80 <tournament_release+0x8d6>
    ...
    2706:	49e50513          	addi	a0,a0,1182 # 6ba0 <tournament_release+0x8f6>
    ...
    2726:	49e50513          	addi	a0,a0,1182 # 6bc0 <tournament_release+0x916>
    ...
    2744:	4a850513          	addi	a0,a0,1192 # 6be8 <tournament_release+0x93e>
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	98c50513          	addi	a0,a0,-1652 # 7118 <tournament_release+0xe6e>
  ...
  if(n >= 0){
    ...
    27c2:	97a50513          	addi	a0,a0,-1670 # 7138 <tournament_release+0xe8e>
    ...
    27dc:	90850513          	addi	a0,a0,-1784 # 70e0 <tournament_release+0xe36>
    ...
    27f6:	90650513          	addi	a0,a0,-1786 # 70f8 <tournament_release+0xe4e>
    ...
    2810:	91450513          	addi	a0,a0,-1772 # 7120 <tournament_release+0xe76>
  ...
  unlink("rwsbrk");
    ...
    2834:	8e850513          	addi	a0,a0,-1816 # 7118 <tournament_release+0xe6e>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	d6e50513          	addi	a0,a0,-658 # 65b0 <tournament_release+0x306>
  ...
  if(n >= 0){
    ...
    2870:	8fc50513          	addi	a0,a0,-1796 # 7168 <tournament_release+0xebe>
    ...
    288a:	89a50513          	addi	a0,a0,-1894 # 7120 <tournament_release+0xe76>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28f0:	6705                	lui	a4,0x1
      *b = 99;
    28f2:	00d50023          	sb	a3,0(a0) # 40000000 <lock_ids+0x3fff0368>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    290a:	88a50513          	addi	a0,a0,-1910 # 7190 <tournament_release+0xee6>
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	85850513          	addi	a0,a0,-1960 # 71b0 <tournament_release+0xf06>
  ...
  if(c != a + 1){
    ...
    29c0:	85450513          	addi	a0,a0,-1964 # 7210 <tournament_release+0xf66>
    ...
    29e2:	7f250513          	addi	a0,a0,2034 # 71d0 <tournament_release+0xf26>
    ...
    29fe:	7f650513          	addi	a0,a0,2038 # 71f0 <tournament_release+0xf46>
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2a9c:	fee78fa3          	sb	a4,-1(a5) # 63fffff <lock_ids+0x63f0367>
  a = sbrk(0);
    2aa0:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2b00:	fff7c703          	lbu	a4,-1(a5) # 63fffff <lock_ids+0x63f0367>
  ...
  if(c != a){
    ...
    2b48:	6ec50513          	addi	a0,a0,1772 # 7230 <tournament_release+0xf86>
    ...
    2b64:	71850513          	addi	a0,a0,1816 # 7278 <tournament_release+0xfce>
    ...
    2b84:	71850513          	addi	a0,a0,1816 # 7298 <tournament_release+0xfee>
    ...
    2ba4:	73850513          	addi	a0,a0,1848 # 72d8 <tournament_release+0x102e>
    ...
    2bc0:	74c50513          	addi	a0,a0,1868 # 7308 <tournament_release+0x105e>
    ...
    2be0:	76450513          	addi	a0,a0,1892 # 7340 <tournament_release+0x1096>
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	75250513          	addi	a0,a0,1874 # 7368 <tournament_release+0x10be>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	74050513          	addi	a0,a0,1856 # 7368 <tournament_release+0x10be>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	6f450513          	addi	a0,a0,1780 # 7370 <tournament_release+0x10c6>
    ...
    2c9c:	6f050513          	addi	a0,a0,1776 # 7388 <tournament_release+0x10de>
    ...
    2cb8:	0b450513          	addi	a0,a0,180 # 6d68 <tournament_release+0xabe>
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	6c250513          	addi	a0,a0,1730 # 73a0 <tournament_release+0x10f6>
  ...
  close(fd);
    ...
    2d2a:	f5250513          	addi	a0,a0,-174 # 6c78 <tournament_release+0x9ce>
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	2f450513          	addi	a0,a0,756 # 7068 <tournament_release+0xdbe>
  ...
  if(pid == 0){
    ...
    2dce:	29e50513          	addi	a0,a0,670 # 7068 <tournament_release+0xdbe>
  ...
  if(pid == 0){
    ...
    2e2e:	23e50513          	addi	a0,a0,574 # 7068 <tournament_release+0xdbe>
...
0000000000002f2a <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2f4a:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <lock_ids+0xffffffff7fff0367>
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	0ca50513          	addi	a0,a0,202 # 7068 <tournament_release+0xdbe>
    ...
    2ff6:	3e650513          	addi	a0,a0,998 # 63d8 <tournament_release+0x12e>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	44a78793          	addi	a5,a5,1098 # 6448 <tournament_release+0x19e>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	54850513          	addi	a0,a0,1352 # 7578 <tournament_release+0x12ce>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	38e50513          	addi	a0,a0,910 # 73d0 <tournament_release+0x1126>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	3d050513          	addi	a0,a0,976 # 7428 <tournament_release+0x117e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	42a50513          	addi	a0,a0,1066 # 74a0 <tournament_release+0x11f6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	47e50513          	addi	a0,a0,1150 # 7510 <tournament_release+0x1266>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	4c450513          	addi	a0,a0,1220 # 7568 <tournament_release+0x12be>
  ...
  unlink("12345678901234");
    ...
    3126:	28650513          	addi	a0,a0,646 # 73a8 <tournament_release+0x10fe>
    ...
    3142:	2b250513          	addi	a0,a0,690 # 73f0 <tournament_release+0x1146>
    ...
    315e:	2fe50513          	addi	a0,a0,766 # 7458 <tournament_release+0x11ae>
    ...
    317a:	35a50513          	addi	a0,a0,858 # 74d0 <tournament_release+0x1226>
    ...
    3196:	39e50513          	addi	a0,a0,926 # 7530 <tournament_release+0x1286>
    ...
    31b2:	3da50513          	addi	a0,a0,986 # 7588 <tournament_release+0x12de>
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	3c650513          	addi	a0,a0,966 # 75c0 <tournament_release+0x1316>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	3ac50513          	addi	a0,a0,940 # 75d0 <tournament_release+0x1326>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	30c50513          	addi	a0,a0,780 # 75c0 <tournament_release+0x1316>
  ...
  unlink("diskfulldir");
    ...
    32cc:	2f850513          	addi	a0,a0,760 # 75c0 <tournament_release+0x1316>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	1fa50513          	addi	a0,a0,506 # 75f0 <tournament_release+0x1346>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	20c50513          	addi	a0,a0,524 # 7620 <tournament_release+0x1376>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	1f850513          	addi	a0,a0,504 # 7620 <tournament_release+0x1376>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	22450513          	addi	a0,a0,548 # 7660 <tournament_release+0x13b6>
  ...
  if(chdir("/") < 0){
    ...
    3454:	24050513          	addi	a0,a0,576 # 7690 <tournament_release+0x13e6>
    ...
    3474:	1b850513          	addi	a0,a0,440 # 7628 <tournament_release+0x137e>
    ...
    3490:	1b450513          	addi	a0,a0,436 # 7640 <tournament_release+0x1396>
    ...
    34ac:	1c850513          	addi	a0,a0,456 # 7670 <tournament_release+0x13c6>
    ...
    34c8:	1d450513          	addi	a0,a0,468 # 7698 <tournament_release+0x13ee>
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	12850513          	addi	a0,a0,296 # 7620 <tournament_release+0x1376>
    ...
    3510:	11450513          	addi	a0,a0,276 # 7620 <tournament_release+0x1376>
    ...
    3524:	14050513          	addi	a0,a0,320 # 7660 <tournament_release+0x13b6>
    ...
    3544:	72050513          	addi	a0,a0,1824 # 6c60 <tournament_release+0x9b6>
    ...
    3560:	0cc50513          	addi	a0,a0,204 # 7628 <tournament_release+0x137e>
    ...
    357c:	13850513          	addi	a0,a0,312 # 76b0 <tournament_release+0x1406>
    ...
    3598:	0dc50513          	addi	a0,a0,220 # 7670 <tournament_release+0x13c6>
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	0f650513          	addi	a0,a0,246 # 76c8 <tournament_release+0x141e>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	0e250513          	addi	a0,a0,226 # 76c8 <tournament_release+0x141e>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	0ee50513          	addi	a0,a0,238 # 76e8 <tournament_release+0x143e>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	0ba50513          	addi	a0,a0,186 # 76c8 <tournament_release+0x141e>
    ...
    3632:	ffa50513          	addi	a0,a0,-6 # 7628 <tournament_release+0x137e>
    ...
    364e:	08650513          	addi	a0,a0,134 # 76d0 <tournament_release+0x1426>
    ...
    366a:	08a50513          	addi	a0,a0,138 # 76f0 <tournament_release+0x1446>
    ...
    3686:	08650513          	addi	a0,a0,134 # 7708 <tournament_release+0x145e>
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	1a650513          	addi	a0,a0,422 # 7850 <tournament_release+0x15a6>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	06650513          	addi	a0,a0,102 # 7720 <tournament_release+0x1476>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	06e50513          	addi	a0,a0,110 # 7740 <tournament_release+0x1496>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	16658593          	addi	a1,a1,358 # 7850 <tournament_release+0x15a6>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	01c50513          	addi	a0,a0,28 # 7720 <tournament_release+0x1476>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	08050513          	addi	a0,a0,128 # 7798 <tournament_release+0x14ee>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	09050513          	addi	a0,a0,144 # 77c0 <tournament_release+0x1516>
  ...
  write(fd, "FF", 2);
    ...
    374c:	0a858593          	addi	a1,a1,168 # 77f0 <tournament_release+0x1546>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	09450513          	addi	a0,a0,148 # 77f8 <tournament_release+0x154e>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	09c58593          	addi	a1,a1,156 # 7848 <tournament_release+0x159e>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	00c50513          	addi	a0,a0,12 # 77c0 <tournament_release+0x1516>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	ff850513          	addi	a0,a0,-8 # 77c0 <tournament_release+0x1516>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	fe250513          	addi	a0,a0,-30 # 77c0 <tournament_release+0x1516>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	f2e50513          	addi	a0,a0,-210 # 7720 <tournament_release+0x1476>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	0da50513          	addi	a0,a0,218 # 78e0 <tournament_release+0x1636>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	0f650513          	addi	a0,a0,246 # 7910 <tournament_release+0x1666>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	11250513          	addi	a0,a0,274 # 7940 <tournament_release+0x1696>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	00450513          	addi	a0,a0,4 # 7848 <tournament_release+0x159e>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	f4250513          	addi	a0,a0,-190 # 77c0 <tournament_release+0x1516>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	13a50513          	addi	a0,a0,314 # 79d0 <tournament_release+0x1726>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	15250513          	addi	a0,a0,338 # 7a00 <tournament_release+0x1756>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	e5a50513          	addi	a0,a0,-422 # 7720 <tournament_release+0x1476>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	e4450513          	addi	a0,a0,-444 # 7720 <tournament_release+0x1476>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	e2e50513          	addi	a0,a0,-466 # 7720 <tournament_release+0x1476>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	18a58593          	addi	a1,a1,394 # 7a90 <tournament_release+0x17e6>
    390e:	00004517          	auipc	a0,0x4
    3912:	0c250513          	addi	a0,a0,194 # 79d0 <tournament_release+0x1726>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	16e58593          	addi	a1,a1,366 # 7a90 <tournament_release+0x17e6>
    392a:	00004517          	auipc	a0,0x4
    392e:	0d650513          	addi	a0,a0,214 # 7a00 <tournament_release+0x1756>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	f0a58593          	addi	a1,a1,-246 # 7848 <tournament_release+0x159e>
    3946:	00004517          	auipc	a0,0x4
    394a:	dfa50513          	addi	a0,a0,-518 # 7740 <tournament_release+0x1496>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	07650513          	addi	a0,a0,118 # 79d0 <tournament_release+0x1726>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	09250513          	addi	a0,a0,146 # 7a00 <tournament_release+0x1756>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	ec650513          	addi	a0,a0,-314 # 7848 <tournament_release+0x159e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	06a50513          	addi	a0,a0,106 # 7a00 <tournament_release+0x1756>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	02650513          	addi	a0,a0,38 # 79d0 <tournament_release+0x1726>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	d8250513          	addi	a0,a0,-638 # 7740 <tournament_release+0x1496>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	20e50513          	addi	a0,a0,526 # 7be0 <tournament_release+0x1936>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	e6250513          	addi	a0,a0,-414 # 7848 <tournament_release+0x159e>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	d4650513          	addi	a0,a0,-698 # 7740 <tournament_release+0x1496>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	d1250513          	addi	a0,a0,-750 # 7720 <tournament_release+0x1476>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	22e50513          	addi	a0,a0,558 # 7c50 <tournament_release+0x19a6>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	cea50513          	addi	a0,a0,-790 # 7720 <tournament_release+0x1476>
    ...
    3a5c:	cd050513          	addi	a0,a0,-816 # 7728 <tournament_release+0x147e>
    ...
    3a78:	cd450513          	addi	a0,a0,-812 # 7748 <tournament_release+0x149e>
    ...
    3a94:	cd850513          	addi	a0,a0,-808 # 7768 <tournament_release+0x14be>
    ...
    3ab0:	cf450513          	addi	a0,a0,-780 # 77a0 <tournament_release+0x14f6>
    ...
    3acc:	d0850513          	addi	a0,a0,-760 # 77d0 <tournament_release+0x1526>
    ...
    3ae8:	d2450513          	addi	a0,a0,-732 # 7808 <tournament_release+0x155e>
    ...
    3b04:	d2850513          	addi	a0,a0,-728 # 7828 <tournament_release+0x157e>
    ...
    3b20:	d3c50513          	addi	a0,a0,-708 # 7858 <tournament_release+0x15ae>
    ...
    3b3c:	d4850513          	addi	a0,a0,-696 # 7880 <tournament_release+0x15d6>
    ...
    3b58:	d4c50513          	addi	a0,a0,-692 # 78a0 <tournament_release+0x15f6>
    ...
    3b74:	d5850513          	addi	a0,a0,-680 # 78c8 <tournament_release+0x161e>
    ...
    3b90:	d6450513          	addi	a0,a0,-668 # 78f0 <tournament_release+0x1646>
    ...
    3bac:	d7850513          	addi	a0,a0,-648 # 7920 <tournament_release+0x1676>
    ...
    3bc8:	d8450513          	addi	a0,a0,-636 # 7948 <tournament_release+0x169e>
    ...
    3be4:	d8050513          	addi	a0,a0,-640 # 7960 <tournament_release+0x16b6>
    ...
    3c00:	d8450513          	addi	a0,a0,-636 # 7980 <tournament_release+0x16d6>
    ...
    3c1c:	d8850513          	addi	a0,a0,-632 # 79a0 <tournament_release+0x16f6>
    ...
    3c38:	dac50513          	addi	a0,a0,-596 # 79e0 <tournament_release+0x1736>
    ...
    3c54:	dc050513          	addi	a0,a0,-576 # 7a10 <tournament_release+0x1766>
    ...
    3c70:	dc450513          	addi	a0,a0,-572 # 7a30 <tournament_release+0x1786>
    ...
    3c8c:	dc850513          	addi	a0,a0,-568 # 7a50 <tournament_release+0x17a6>
    ...
    3ca8:	dcc50513          	addi	a0,a0,-564 # 7a70 <tournament_release+0x17c6>
    ...
    3cc4:	de050513          	addi	a0,a0,-544 # 7aa0 <tournament_release+0x17f6>
    ...
    3ce0:	dec50513          	addi	a0,a0,-532 # 7ac8 <tournament_release+0x181e>
    ...
    3cfc:	df850513          	addi	a0,a0,-520 # 7af0 <tournament_release+0x1846>
    ...
    3d18:	e0450513          	addi	a0,a0,-508 # 7b18 <tournament_release+0x186e>
    ...
    3d34:	e0850513          	addi	a0,a0,-504 # 7b38 <tournament_release+0x188e>
    ...
    3d50:	e0c50513          	addi	a0,a0,-500 # 7b58 <tournament_release+0x18ae>
    ...
    3d6c:	e1850513          	addi	a0,a0,-488 # 7b80 <tournament_release+0x18d6>
    ...
    3d88:	e1c50513          	addi	a0,a0,-484 # 7ba0 <tournament_release+0x18f6>
    ...
    3da4:	e2050513          	addi	a0,a0,-480 # 7bc0 <tournament_release+0x1916>
    ...
    3dc0:	e2c50513          	addi	a0,a0,-468 # 7be8 <tournament_release+0x193e>
    ...
    3ddc:	aa850513          	addi	a0,a0,-1368 # 7880 <tournament_release+0x15d6>
    ...
    3df8:	e1450513          	addi	a0,a0,-492 # 7c08 <tournament_release+0x195e>
    ...
    3e14:	e1850513          	addi	a0,a0,-488 # 7c28 <tournament_release+0x197e>
    ...
    3e30:	e2c50513          	addi	a0,a0,-468 # 7c58 <tournament_release+0x19ae>
    ...
    3e4c:	e3050513          	addi	a0,a0,-464 # 7c78 <tournament_release+0x19ce>
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	e2250513          	addi	a0,a0,-478 # 7c90 <tournament_release+0x19e6>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	e1050513          	addi	a0,a0,-496 # 7c90 <tournament_release+0x19e6>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	c2e50513          	addi	a0,a0,-978 # 6ac0 <tournament_release+0x816>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	84450513          	addi	a0,a0,-1980 # 76e8 <tournament_release+0x143e>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	7da50513          	addi	a0,a0,2010 # 7690 <tournament_release+0x13e6>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	e3050513          	addi	a0,a0,-464 # 7cf8 <tournament_release+0x1a4e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	e4650513          	addi	a0,a0,-442 # 7d20 <tournament_release+0x1a76>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	da450513          	addi	a0,a0,-604 # 7c90 <tournament_release+0x19e6>
    ...
    3f0e:	d8e50513          	addi	a0,a0,-626 # 7c98 <tournament_release+0x19ee>
    ...
    3f2a:	d8a50513          	addi	a0,a0,-630 # 7cb0 <tournament_release+0x1a06>
    ...
    3f46:	d8650513          	addi	a0,a0,-634 # 7cc8 <tournament_release+0x1a1e>
    ...
    3f62:	d8250513          	addi	a0,a0,-638 # 7ce0 <tournament_release+0x1a36>
    ...
    3f7e:	71e50513          	addi	a0,a0,1822 # 7698 <tournament_release+0x13ee>
    ...
    3f9a:	d6a50513          	addi	a0,a0,-662 # 7d00 <tournament_release+0x1a56>
    ...
    3fb6:	d7650513          	addi	a0,a0,-650 # 7d28 <tournament_release+0x1a7e>
    ...
    3fd2:	d7a50513          	addi	a0,a0,-646 # 7d48 <tournament_release+0x1a9e>
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	d6e50513          	addi	a0,a0,-658 # 7d68 <tournament_release+0x1abe>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	d5250513          	addi	a0,a0,-686 # 7d68 <tournament_release+0x1abe>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	d8650513          	addi	a0,a0,-634 # 7db0 <tournament_release+0x1b06>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	d6e50513          	addi	a0,a0,-658 # 7db0 <tournament_release+0x1b06>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	d5a50513          	addi	a0,a0,-678 # 7db0 <tournament_release+0x1b06>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	d4650513          	addi	a0,a0,-698 # 7db0 <tournament_release+0x1b06>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	d3258593          	addi	a1,a1,-718 # 7db0 <tournament_release+0x1b06>
    4086:	00002517          	auipc	a0,0x2
    408a:	52a50513          	addi	a0,a0,1322 # 65b0 <tournament_release+0x306>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	cce50513          	addi	a0,a0,-818 # 7d68 <tournament_release+0x1abe>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	a1050513          	addi	a0,a0,-1520 # 6ac0 <tournament_release+0x816>
  ...
  fd = open(".", 0);
    ...
    40ca:	9fa50513          	addi	a0,a0,-1542 # 6ac0 <tournament_release+0x816>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	36e58593          	addi	a1,a1,878 # 6448 <tournament_release+0x19e>
  ...
  close(fd);
    ...
    410a:	c6a50513          	addi	a0,a0,-918 # 7d70 <tournament_release+0x1ac6>
    ...
    4126:	c6e50513          	addi	a0,a0,-914 # 7d90 <tournament_release+0x1ae6>
    ...
    4142:	c8250513          	addi	a0,a0,-894 # 7dc0 <tournament_release+0x1b16>
    ...
    415e:	c6650513          	addi	a0,a0,-922 # 7dc0 <tournament_release+0x1b16>
    ...
    417a:	c7250513          	addi	a0,a0,-910 # 7de8 <tournament_release+0x1b3e>
    ...
    4196:	c7e50513          	addi	a0,a0,-898 # 7e10 <tournament_release+0x1b66>
    ...
    41b2:	c8a50513          	addi	a0,a0,-886 # 7e38 <tournament_release+0x1b8e>
    ...
    41ce:	c9650513          	addi	a0,a0,-874 # 7e60 <tournament_release+0x1bb6>
    ...
    41ea:	c9a50513          	addi	a0,a0,-870 # 7e80 <tournament_release+0x1bd6>
    ...
    4206:	ca650513          	addi	a0,a0,-858 # 7ea8 <tournament_release+0x1bfe>
...
000000000000421c <iref>:
{
    ...
    423a:	c8aa0a13          	addi	s4,s4,-886 # 7ec0 <tournament_release+0x1c16>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	78a48493          	addi	s1,s1,1930 # 79c8 <tournament_release+0x171e>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	36aa8a93          	addi	s5,s5,874 # 65b0 <tournament_release+0x306>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	b6a98993          	addi	s3,s3,-1174 # 7db8 <tournament_release+0x1b0e>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	c6e50513          	addi	a0,a0,-914 # 7ec8 <tournament_release+0x1c1e>
    ...
    427a:	c6a50513          	addi	a0,a0,-918 # 7ee0 <tournament_release+0x1c36>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	3de98993          	addi	s3,s3,990 # 76e8 <tournament_release+0x143e>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	bae90913          	addi	s2,s2,-1106 # 7ec0 <tournament_release+0x1c16>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	35e50513          	addi	a0,a0,862 # 7690 <tournament_release+0x13e6>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	b9650513          	addi	a0,a0,-1130 # 7ef8 <tournament_release+0x1c4e>
  ...
  if(pid == 0){
    ...
    438a:	b7250513          	addi	a0,a0,-1166 # 7ef8 <tournament_release+0x1c4e>
    ...
    43a0:	b7c50513          	addi	a0,a0,-1156 # 7f18 <tournament_release+0x1c6e>
    ...
    43bc:	b4850513          	addi	a0,a0,-1208 # 7f00 <tournament_release+0x1c56>
    ...
    43d8:	88c50513          	addi	a0,a0,-1908 # 6c60 <tournament_release+0x9b6>
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	af650513          	addi	a0,a0,-1290 # 7ef8 <tournament_release+0x1c4e>
    ...
    441a:	a3a50513          	addi	a0,a0,-1478 # 6e50 <tournament_release+0xba6>
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	aec50513          	addi	a0,a0,-1300 # 7f40 <tournament_release+0x1c96>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	ac050513          	addi	a0,a0,-1344 # 7f40 <tournament_release+0x1c96>
  ...
  sleep(10); // one second
    ...
    44bc:	96850513          	addi	a0,a0,-1688 # 6e20 <tournament_release+0xb76>
    ...
    44d6:	a6e48493          	addi	s1,s1,-1426 # 7f40 <tournament_release+0x1c96>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	6e650513          	addi	a0,a0,1766 # 6c60 <tournament_release+0x9b6>
    ...
    45a4:	9b050513          	addi	a0,a0,-1616 # 7f50 <tournament_release+0x1ca6>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	84050513          	addi	a0,a0,-1984 # 6e20 <tournament_release+0xb76>
  ...
  if(pid2 == 0)
    ...
    4612:	65250513          	addi	a0,a0,1618 # 6c60 <tournament_release+0x9b6>
  ...
  if(pid3 == 0){
    ...
    4656:	df658593          	addi	a1,a1,-522 # 6448 <tournament_release+0x19e>
    ...
    4680:	5e450513          	addi	a0,a0,1508 # 6c60 <tournament_release+0x9b6>
    ...
    469c:	8d850513          	addi	a0,a0,-1832 # 7f70 <tournament_release+0x1cc6>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	8b450513          	addi	a0,a0,-1868 # 7f88 <tournament_release+0x1cde>
  ...
  printf("kill... ");
    ...
    4704:	8a050513          	addi	a0,a0,-1888 # 7fa0 <tournament_release+0x1cf6>
  ...
  printf("wait... ");
    ...
    4732:	88250513          	addi	a0,a0,-1918 # 7fb0 <tournament_release+0x1d06>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	4b250513          	addi	a0,a0,1202 # 6c60 <tournament_release+0x9b6>
    ...
    47ce:	61e50513          	addi	a0,a0,1566 # 6de8 <tournament_release+0xb3e>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	52850513          	addi	a0,a0,1320 # 6d68 <tournament_release+0xabe>
    ...
    4878:	bd458593          	addi	a1,a1,-1068 # 6448 <tournament_release+0x19e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	68850513          	addi	a0,a0,1672 # 7fc0 <tournament_release+0x1d16>
    ...
    4958:	30c50513          	addi	a0,a0,780 # 6c60 <tournament_release+0x9b6>
    ...
    498e:	6705                	lui	a4,0x1
      n += *(a+i);
    4990:	0007c683          	lbu	a3,0(a5) # 6400000 <lock_ids+0x63f0368>
    ...
    49a4:	64050513          	addi	a0,a0,1600 # 7fe0 <tournament_release+0x1d36>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	5cc50513          	addi	a0,a0,1484 # 8010 <tournament_release+0x1d66>
...
0000000000004a68 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4a84:	5b050513          	addi	a0,a0,1456 # 8030 <tournament_release+0x1d86>
    4a88:	00001097          	auipc	ra,0x1
    4a8c:	18e080e7          	jalr	398(ra) # 5c16 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    4a90:	20200593          	li	a1,514
    4a94:	00003517          	auipc	a0,0x3
    4a98:	59c50513          	addi	a0,a0,1436 # 8030 <tournament_release+0x1d86>
  ...
  if(pid == 0) {
    ...
    4afe:	54650513          	addi	a0,a0,1350 # 8040 <tournament_release+0x1d96>
    ...
    4b1a:	55250513          	addi	a0,a0,1362 # 8068 <tournament_release+0x1dbe>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	4d650513          	addi	a0,a0,1238 # 8030 <tournament_release+0x1d86>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	4ee50513          	addi	a0,a0,1262 # 8088 <tournament_release+0x1dde>
  ...
  unlink("sharedfd");
    ...
    4bda:	45a50513          	addi	a0,a0,1114 # 8030 <tournament_release+0x1d86>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	4b450513          	addi	a0,a0,1204 # 80b0 <tournament_release+0x1e06>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	73e78793          	addi	a5,a5,1854 # 6380 <tournament_release+0xd6>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	73a78793          	addi	a5,a5,1850 # 6388 <tournament_release+0xde>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	73678793          	addi	a5,a5,1846 # 6390 <tournament_release+0xe6>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	73278793          	addi	a5,a5,1842 # 6398 <tournament_release+0xee>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	38a50513          	addi	a0,a0,906 # 7068 <tournament_release+0xdbe>
    ...
    4d5e:	36e50513          	addi	a0,a0,878 # 80c8 <tournament_release+0x1e1e>
    ...
    4d78:	36450513          	addi	a0,a0,868 # 80d8 <tournament_release+0x1e2e>
    ...
    4da0:	35450513          	addi	a0,a0,852 # 80f0 <tournament_release+0x1e46>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	2d650513          	addi	a0,a0,726 # 8100 <tournament_release+0x1e56>
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	28cb8b93          	addi	s7,s7,652 # 8118 <tournament_release+0x1e6e>
  for(i = 0; i < N; i++){
    ...
    4ed2:	25250513          	addi	a0,a0,594 # 8120 <tournament_release+0x1e76>
    ...
    4ef0:	22c50513          	addi	a0,a0,556 # 8118 <tournament_release+0x1e6e>
  ...
  fd = open(".", 0);
    ...
    4f28:	b9c50513          	addi	a0,a0,-1124 # 6ac0 <tournament_release+0x816>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	1a650513          	addi	a0,a0,422 # 8140 <tournament_release+0x1e96>
    ...
    4fbe:	1a650513          	addi	a0,a0,422 # 8160 <tournament_release+0x1eb6>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	19650513          	addi	a0,a0,406 # 8188 <tournament_release+0x1ede>
    ...
    5012:	c5250513          	addi	a0,a0,-942 # 6c60 <tournament_release+0x9b6>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	f8050513          	addi	a0,a0,-128 # 81c0 <tournament_release+0x1f16>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	f2c50513          	addi	a0,a0,-212 # 81d0 <tournament_release+0x1f26>
    ...
    52c4:	f3050513          	addi	a0,a0,-208 # 81f0 <tournament_release+0x1f46>
    ...
    52e0:	f3450513          	addi	a0,a0,-204 # 8210 <tournament_release+0x1f66>
    ...
    52fc:	f3850513          	addi	a0,a0,-200 # 8230 <tournament_release+0x1f86>
    ...
    5318:	f3c50513          	addi	a0,a0,-196 # 8250 <tournament_release+0x1fa6>
    ...
    5334:	f3850513          	addi	a0,a0,-200 # 8268 <tournament_release+0x1fbe>
  ...
  unlink("bigfile.dat");
    ...
    5362:	e6250513          	addi	a0,a0,-414 # 81c0 <tournament_release+0x1f16>
    ...
    5386:	f0650513          	addi	a0,a0,-250 # 8288 <tournament_release+0x1fde>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	eee50513          	addi	a0,a0,-274 # 82a8 <tournament_release+0x1ffe>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	edec8c93          	addi	s9,s9,-290 # 82b8 <tournament_release+0x200e>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	e7450513          	addi	a0,a0,-396 # 82c8 <tournament_release+0x201e>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	e1e50513          	addi	a0,a0,-482 # 82e8 <tournament_release+0x203e>
    ...
    551e:	dbe50513          	addi	a0,a0,-578 # 82d8 <tournament_release+0x202e>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	db450513          	addi	a0,a0,-588 # 8300 <tournament_release+0x2056>
  ...
  if(pid == 0) {
    ...
    5580:	dac50513          	addi	a0,a0,-596 # 8328 <tournament_release+0x207e>
    ...
    55a4:	d7050513          	addi	a0,a0,-656 # 8310 <tournament_release+0x2066>
    ...
    55cc:	d6850513          	addi	a0,a0,-664 # 8330 <tournament_release+0x2086>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	d2050513          	addi	a0,a0,-736 # 8338 <tournament_release+0x208e>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	dd698993          	addi	s3,s3,-554 # 6448 <tournament_release+0x19e>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	cec50513          	addi	a0,a0,-788 # 8390 <tournament_release+0x20e6>
    ...
    56c2:	c9250513          	addi	a0,a0,-878 # 8350 <tournament_release+0x20a6>
    ...
    56dc:	c9850513          	addi	a0,a0,-872 # 8370 <tournament_release+0x20c6>
  ...
  while(1){
    ...
    572a:	c8a50513          	addi	a0,a0,-886 # 83b0 <tournament_release+0x2106>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	c48b8b93          	addi	s7,s7,-952 # 83d0 <tournament_release+0x2126>
    int free0 = countfree();
    int free1 = 0;
    ...
    579e:	c6ec8c93          	addi	s9,s9,-914 # 8408 <tournament_release+0x215e>
      if (runtests(slowtests, justone)) {
    57a2:	00004c17          	auipc	s8,0x4
    57a6:	c3ec0c13          	addi	s8,s8,-962 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57aa:	00003d17          	auipc	s10,0x3
    57ae:	c3ed0d13          	addi	s10,s10,-962 # 83e8 <tournament_release+0x213e>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	b9858593          	addi	a1,a1,-1128 # 8438 <tournament_release+0x218e>
    ...
    58ba:	bda58593          	addi	a1,a1,-1062 # 8490 <tournament_release+0x21e6>
    ...
    58d0:	bbc58593          	addi	a1,a1,-1092 # 8488 <tournament_release+0x21de>
  ...
  int continuous = 0;
    ...
    58fc:	b4850513          	addi	a0,a0,-1208 # 8440 <tournament_release+0x2196>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	b4c50513          	addi	a0,a0,-1204 # 8470 <tournament_release+0x21c6>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cce:	b3650513          	addi	a0,a0,-1226 # 8800 <digits>
    5cd2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d9a:	a6ab8b93          	addi	s7,s7,-1430 # 8800 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eda:	92290913          	addi	s2,s2,-1758 # 87f8 <tournament_release+0x254e>
        while(*s != 0){
...
int tournament_create(int processes) {
    6100:	7179                	addi	sp,sp,-48
    6102:	f406                	sd	ra,40(sp)
    6104:	f022                	sd	s0,32(sp)
    6106:	ec26                	sd	s1,24(sp)
    6108:	e84a                	sd	s2,16(sp)
    610a:	e44e                	sd	s3,8(sp)
    610c:	e052                	sd	s4,0(sp)
    610e:	1800                	addi	s0,sp,48
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    6110:	fff5071b          	addiw	a4,a0,-1
    6114:	47bd                	li	a5,15
    6116:	00e7ee63          	bltu	a5,a4,6132 <tournament_create+0x32>
    611a:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
    611c:	8a3a                	mv	s4,a4
    611e:	00e574b3          	and	s1,a0,a4
    6122:	c0b9                	beqz	s1,6168 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    6124:	54fd                	li	s1,-1
    6126:	a809                	j	6138 <tournament_create+0x38>
   for(int i = 1; i < processes  ; i++){
        ...
        if(pid == 0){
            trnmnt_idx = i ;
    6128:	00003797          	auipc	a5,0x3
    612c:	3297a823          	sw	s1,816(a5) # 9458 <trnmnt_idx>
            return trnmnt_idx ;
    6130:	a021                	j	6138 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
    6132:	54fd                	li	s1,-1
    6134:	a011                	j	6138 <tournament_create+0x38>
...
return trnmnt_idx ;
    ...
    6138:	8526                	mv	a0,s1
    613a:	70a2                	ld	ra,40(sp)
    613c:	7402                	ld	s0,32(sp)
    613e:	64e2                	ld	s1,24(sp)
    6140:	6942                	ld	s2,16(sp)
    6142:	69a2                	ld	s3,8(sp)
    6144:	6a02                	ld	s4,0(sp)
    6146:	6145                	addi	sp,sp,48
    6148:	8082                	ret
            return -1 ;
    614a:	54fd                	li	s1,-1
    614c:	b7f5                	j	6138 <tournament_create+0x38>
   num_levels = log2(processes) ;
    614e:	00003797          	auipc	a5,0x3
    6152:	3007a923          	sw	zero,786(a5) # 9460 <num_levels>
   trnmnt_idx = 0;
    6156:	00003797          	auipc	a5,0x3
    615a:	3007a123          	sw	zero,770(a5) # 9458 <trnmnt_idx>
return trnmnt_idx ;
    615e:	00003497          	auipc	s1,0x3
    6162:	2fa4a483          	lw	s1,762(s1) # 9458 <trnmnt_idx>
    6166:	bfc9                	j	6138 <tournament_create+0x38>
   num_processes = processes ;
    6168:	00003797          	auipc	a5,0x3
    616c:	2ea7aa23          	sw	a0,756(a5) # 945c <num_processes>
  if (n <= 1) 
    6170:	4785                	li	a5,1
    6172:	fca7dee3          	bge	a5,a0,614e <tournament_create+0x4e>
  int l = 0;
    6176:	8726                	mv	a4,s1
    6178:	87aa                	mv	a5,a0
  while (n > 1) {
    ...
    n /= 2;
    617c:	86be                	mv	a3,a5
    617e:	01f7d61b          	srliw	a2,a5,0x1f
    6182:	9fb1                	addw	a5,a5,a2
    6184:	4017d79b          	sraiw	a5,a5,0x1
    l++;
    6188:	2705                	addiw	a4,a4,1
  while (n > 1) {
    618a:	fed5c9e3          	blt	a1,a3,617c <tournament_create+0x7c>
   num_levels = log2(processes) ;
    618e:	00003797          	auipc	a5,0x3
    6192:	2ce7a923          	sw	a4,722(a5) # 9460 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
    6196:	0000a917          	auipc	s2,0xa
    619a:	b0290913          	addi	s2,s2,-1278 # fc98 <lock_ids>
    lock_ids[i]= peterson_create() ;
    619e:	00000097          	auipc	ra,0x0
    61a2:	ac8080e7          	jalr	-1336(ra) # 5c66 <peterson_create>
    61a6:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
    61aa:	f80546e3          	bltz	a0,6136 <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
    61ae:	2485                	addiw	s1,s1,1
    61b0:	0911                	addi	s2,s2,4
    61b2:	ff44c6e3          	blt	s1,s4,619e <tournament_create+0x9e>
   trnmnt_idx = 0;
    61b6:	00003797          	auipc	a5,0x3
    61ba:	2a07a123          	sw	zero,674(a5) # 9458 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
    61be:	4785                	li	a5,1
    61c0:	f937dfe3          	bge	a5,s3,615e <tournament_create+0x5e>
    61c4:	4485                	li	s1,1
        int pid = fork() ;
    61c6:	00000097          	auipc	ra,0x0
    61ca:	9f8080e7          	jalr	-1544(ra) # 5bbe <fork>
        if(pid < 0)
    61ce:	f6054ee3          	bltz	a0,614a <tournament_create+0x4a>
        if(pid == 0){
    61d2:	d939                	beqz	a0,6128 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
    61d4:	2485                	addiw	s1,s1,1
    61d6:	fe9998e3          	bne	s3,s1,61c6 <tournament_create+0xc6>
    61da:	b751                	j	615e <tournament_create+0x5e>

00000000000061dc <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    61dc:	00003797          	auipc	a5,0x3
    61e0:	27c7a783          	lw	a5,636(a5) # 9458 <trnmnt_idx>
    61e4:	0a07cd63          	bltz	a5,629e <tournament_acquire+0xc2>
    61e8:	00003717          	auipc	a4,0x3
    61ec:	27872703          	lw	a4,632(a4) # 9460 <num_levels>
    61f0:	0ae05963          	blez	a4,62a2 <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    61f4:	fff7069b          	addiw	a3,a4,-1
    61f8:	4585                	li	a1,1
    61fa:	00d595bb          	sllw	a1,a1,a3
    61fe:	8dfd                	and	a1,a1,a5
    6200:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    6204:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
    6208:	4739                	li	a4,14
    620a:	08f74e63          	blt	a4,a5,62a6 <tournament_acquire+0xca>
int tournament_acquire(void){ 
    620e:	7139                	addi	sp,sp,-64
    6210:	fc06                	sd	ra,56(sp)
    6212:	f822                	sd	s0,48(sp)
    6214:	f426                	sd	s1,40(sp)
    6216:	f04a                	sd	s2,32(sp)
    6218:	ec4e                	sd	s3,24(sp)
    621a:	e852                	sd	s4,16(sp)
    621c:	e456                	sd	s5,8(sp)
    621e:	e05a                	sd	s6,0(sp)
    6220:	0080                	addi	s0,sp,64
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
    6222:	4481                	li	s1,0

        peterson_acquire(lock_ids[lockidx] , role) ;
    6224:	0000aa17          	auipc	s4,0xa
    6228:	a74a0a13          	addi	s4,s4,-1420 # fc98 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
    622c:	00003997          	auipc	s3,0x3
    6230:	23498993          	addi	s3,s3,564 # 9460 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    6234:	00003b17          	auipc	s6,0x3
    6238:	224b0b13          	addi	s6,s6,548 # 9458 <trnmnt_idx>
    623c:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    623e:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
    6240:	078a                	slli	a5,a5,0x2
    6242:	97d2                	add	a5,a5,s4
    6244:	4388                	lw	a0,0(a5)
    6246:	00000097          	auipc	ra,0x0
    624a:	a28080e7          	jalr	-1496(ra) # 5c6e <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
    624e:	0014871b          	addiw	a4,s1,1
    6252:	0007049b          	sext.w	s1,a4
    6256:	0009a783          	lw	a5,0(s3)
    625a:	02f4d763          	bge	s1,a5,6288 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    625e:	40e7873b          	subw	a4,a5,a4
    6262:	fff7079b          	addiw	a5,a4,-1
    6266:	000b2683          	lw	a3,0(s6)
    626a:	00f915bb          	sllw	a1,s2,a5
    626e:	8df5                	and	a1,a1,a3
    6270:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    6274:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    6278:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
    627c:	9fb9                	addw	a5,a5,a4
    627e:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    6280:	fcfad0e3          	bge	s5,a5,6240 <tournament_acquire+0x64>
    6284:	557d                	li	a0,-1
    6286:	a011                	j	628a <tournament_acquire+0xae>

    }
return 0 ;
    6288:	4501                	li	a0,0
}
    628a:	70e2                	ld	ra,56(sp)
    628c:	7442                	ld	s0,48(sp)
    628e:	74a2                	ld	s1,40(sp)
    6290:	7902                	ld	s2,32(sp)
    6292:	69e2                	ld	s3,24(sp)
    6294:	6a42                	ld	s4,16(sp)
    6296:	6aa2                	ld	s5,8(sp)
    6298:	6b02                	ld	s6,0(sp)
    629a:	6121                	addi	sp,sp,64
    629c:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    629e:	557d                	li	a0,-1
    62a0:	8082                	ret
...
00000000000062aa <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    62aa:	00003797          	auipc	a5,0x3
    62ae:	1ae7a783          	lw	a5,430(a5) # 9458 <trnmnt_idx>
    62b2:	0a07cf63          	bltz	a5,6370 <tournament_release+0xc6>
int tournament_release(void) {
    62b6:	715d                	addi	sp,sp,-80
    62b8:	e486                	sd	ra,72(sp)
    62ba:	e0a2                	sd	s0,64(sp)
    62bc:	fc26                	sd	s1,56(sp)
    62be:	f84a                	sd	s2,48(sp)
    62c0:	f44e                	sd	s3,40(sp)
    62c2:	f052                	sd	s4,32(sp)
    62c4:	ec56                	sd	s5,24(sp)
    62c6:	e85a                	sd	s6,16(sp)
    62c8:	e45e                	sd	s7,8(sp)
    62ca:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    62cc:	00003497          	auipc	s1,0x3
    62d0:	1944a483          	lw	s1,404(s1) # 9460 <num_levels>
    62d4:	0a905063          	blez	s1,6374 <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
    62d8:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    62da:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    62de:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
    62e2:	4705                	li	a4,1
    62e4:	0097173b          	sllw	a4,a4,s1
    62e8:	9fb9                	addw	a5,a5,a4
    62ea:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    62ec:	4739                	li	a4,14
    62ee:	08f74563          	blt	a4,a5,6378 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
    62f2:	0000aa17          	auipc	s4,0xa
    62f6:	9a6a0a13          	addi	s4,s4,-1626 # fc98 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
    62fa:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    62fc:	00003b97          	auipc	s7,0x3
    6300:	164b8b93          	addi	s7,s7,356 # 9460 <num_levels>
    6304:	00003b17          	auipc	s6,0x3
    6308:	154b0b13          	addi	s6,s6,340 # 9458 <trnmnt_idx>
    630c:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
    630e:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
    6310:	078a                	slli	a5,a5,0x2
    6312:	97d2                	add	a5,a5,s4
    6314:	4388                	lw	a0,0(a5)
    6316:	00000097          	auipc	ra,0x0
    631a:	960080e7          	jalr	-1696(ra) # 5c76 <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
    631e:	fff4869b          	addiw	a3,s1,-1
    6322:	0006849b          	sext.w	s1,a3
    6326:	03348963          	beq	s1,s3,6358 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
    632a:	000ba703          	lw	a4,0(s7)
    632e:	40d706bb          	subw	a3,a4,a3
    6332:	fff6879b          	addiw	a5,a3,-1
    6336:	000b2703          	lw	a4,0(s6)
    633a:	00f915bb          	sllw	a1,s2,a5
    633e:	8df9                	and	a1,a1,a4
    6340:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
    6344:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
    6348:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
    634c:	9fb9                	addw	a5,a5,a4
    634e:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
    6350:	fcfad0e3          	bge	s5,a5,6310 <tournament_release+0x66>
    6354:	557d                	li	a0,-1
    6356:	a011                	j	635a <tournament_release+0xb0>
...
return 0 ;
    ...
    635a:	60a6                	ld	ra,72(sp)
    635c:	6406                	ld	s0,64(sp)
    635e:	74e2                	ld	s1,56(sp)
    6360:	7942                	ld	s2,48(sp)
    6362:	79a2                	ld	s3,40(sp)
    6364:	7a02                	ld	s4,32(sp)
    6366:	6ae2                	ld	s5,24(sp)
    6368:	6b42                	ld	s6,16(sp)
    636a:	6ba2                	ld	s7,8(sp)
    636c:	6161                	addi	sp,sp,80
    636e:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    6370:	557d                	li	a0,-1
}
    ...
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
    6374:	557d                	li	a0,-1
    6376:	b7d5                	j	635a <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
    6378:	557d                	li	a0,-1
    637a:	b7c5                	j	635a <tournament_release+0xb0>
