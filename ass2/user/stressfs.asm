...
main(int argc, char *argv[])
{
  ...
  1a:	98a78793          	addi	a5,a5,-1654 # 9a0 <tournament_release+0x3e>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	94450513          	addi	a0,a0,-1724 # 970 <tournament_release+0xe>
  ...
  6c:	92050513          	addi	a0,a0,-1760 # 988 <tournament_release+0x26>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8e250513          	addi	a0,a0,-1822 # 998 <tournament_release+0x36>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49c:	52050513          	addi	a0,a0,1312 # 9b8 <digits>
 4a0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 568:	454b8b93          	addi	s7,s7,1108 # 9b8 <digits>
 ...
 6a8:	30c90913          	addi	s2,s2,780 # 9b0 <tournament_release+0x4e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 846:	7ee78793          	addi	a5,a5,2030 # 1030 <base>
...
static int is_power_of_two(int x) {
 ...
 8d2:	47bd                	li	a5,15
 8d4:	00e7eb63          	bltu	a5,a4,8ea <tournament_create+0x1c>
 8d8:	fff5079b          	addiw	a5,a0,-1
 8dc:	8fe9                	and	a5,a5,a0
 8de:	2781                	sext.w	a5,a5
 8e0:	c799                	beqz	a5,8ee <tournament_create+0x20>
}
 ...
 8e4:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 8e6:	557d                	li	a0,-1
 8e8:	a095                	j	94c <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 8ea:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 8fa:	72a7a523          	sw	a0,1834(a5) # 1020 <num_processes>
   while(temp >>=1)
 8fe:	4015551b          	sraiw	a0,a0,0x1
 902:	c105                	beqz	a0,922 <tournament_create+0x54>
 904:	00000797          	auipc	a5,0x0
 908:	7207a783          	lw	a5,1824(a5) # 1024 <num_levels>
 90c:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 90e:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 912:	4015551b          	sraiw	a0,a0,0x1
 916:	2785                	addiw	a5,a5,1
 918:	f97d                	bnez	a0,90e <tournament_create+0x40>
 91a:	00000797          	auipc	a5,0x0
 91e:	70e7a523          	sw	a4,1802(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 922:	00000797          	auipc	a5,0x0
 926:	7027a783          	lw	a5,1794(a5) # 1024 <num_levels>
 92a:	4505                	li	a0,1
 92c:	00f5153b          	sllw	a0,a0,a5
 930:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 932:	0025151b          	slliw	a0,a0,0x2
 936:	00000097          	auipc	ra,0x0
 93a:	eb4080e7          	jalr	-332(ra) # 7ea <malloc>
 93e:	87aa                	mv	a5,a0
 940:	00000717          	auipc	a4,0x0
 944:	6ca73c23          	sd	a0,1752(a4) # 1018 <lock_ids>
    return 1 ;    
 948:	4505                	li	a0,1
    if (!lock_ids)
 94a:	dfd1                	beqz	a5,8e6 <tournament_create+0x18>
}
 94c:	60a2                	ld	ra,8(sp)
 94e:	6402                	ld	s0,0(sp)
...
0000000000000954 <tournament_acquire>:
...
0000000000000962 <tournament_release>:
