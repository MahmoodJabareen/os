...
int main() {
  ...
  82:	90250513          	addi	a0,a0,-1790 # 980 <tournament_release+0x16>
  ...
  a6:	8fe50513          	addi	a0,a0,-1794 # 9a0 <tournament_release+0x36>
  ...
  ca:	90250513          	addi	a0,a0,-1790 # 9c8 <tournament_release+0x5e>
  ...
  f2:	90250513          	addi	a0,a0,-1790 # 9f0 <tournament_release+0x86>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a4:	58050513          	addi	a0,a0,1408 # a20 <digits>
 4a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 570:	4b4b8b93          	addi	s7,s7,1204 # a20 <digits>
 ...
 6b0:	36c90913          	addi	s2,s2,876 # a18 <tournament_release+0xae>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 84e:	7e678793          	addi	a5,a5,2022 # 1030 <base>
...
static int is_power_of_two(int x) {
 ...
 8da:	47bd                	li	a5,15
 8dc:	00e7eb63          	bltu	a5,a4,8f2 <tournament_create+0x1c>
 8e0:	fff5079b          	addiw	a5,a0,-1
 8e4:	8fe9                	and	a5,a5,a0
 8e6:	2781                	sext.w	a5,a5
 8e8:	c799                	beqz	a5,8f6 <tournament_create+0x20>
}
 ...
 8ec:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 8ee:	557d                	li	a0,-1
 8f0:	a095                	j	954 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 8f2:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 902:	72a7a123          	sw	a0,1826(a5) # 1020 <num_processes>
   while(temp >>=1)
 906:	4015551b          	sraiw	a0,a0,0x1
 90a:	c105                	beqz	a0,92a <tournament_create+0x54>
 90c:	00000797          	auipc	a5,0x0
 910:	7187a783          	lw	a5,1816(a5) # 1024 <num_levels>
 914:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 916:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 91a:	4015551b          	sraiw	a0,a0,0x1
 91e:	2785                	addiw	a5,a5,1
 920:	f97d                	bnez	a0,916 <tournament_create+0x40>
 922:	00000797          	auipc	a5,0x0
 926:	70e7a123          	sw	a4,1794(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 92a:	00000797          	auipc	a5,0x0
 92e:	6fa7a783          	lw	a5,1786(a5) # 1024 <num_levels>
 932:	4505                	li	a0,1
 934:	00f5153b          	sllw	a0,a0,a5
 938:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 93a:	0025151b          	slliw	a0,a0,0x2
 93e:	00000097          	auipc	ra,0x0
 942:	eb4080e7          	jalr	-332(ra) # 7f2 <malloc>
 946:	87aa                	mv	a5,a0
 948:	00000717          	auipc	a4,0x0
 94c:	6ca73823          	sd	a0,1744(a4) # 1018 <lock_ids>
    return 1 ;    
 950:	4505                	li	a0,1
    if (!lock_ids)
 952:	dfd1                	beqz	a5,8ee <tournament_create+0x18>
}
 954:	60a2                	ld	ra,8(sp)
 956:	6402                	ld	s0,0(sp)
...
000000000000095c <tournament_acquire>:
...
000000000000096a <tournament_release>:
