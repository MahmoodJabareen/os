...
int tournament_create(int processes) {
 ...
 8e0:	fff5071b          	addiw	a4,a0,-1
 8e4:	47bd                	li	a5,15
 8e6:	08e7eb63          	bltu	a5,a4,97c <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 902:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 904:	ecbd                	bnez	s1,982 <tournament_create+0xa2>
  if (n <= 1) 
 906:	4785                	li	a5,1
 908:	0937d763          	bge	a5,s3,996 <tournament_create+0xb6>
  int l = 0;
 90c:	8726                	mv	a4,s1
 90e:	87ce                	mv	a5,s3
  while (n > 1) {
 910:	458d                	li	a1,3
    n /= 2;
 912:	86be                	mv	a3,a5
 914:	01f7d61b          	srliw	a2,a5,0x1f
 918:	9fb1                	addw	a5,a5,a2
 91a:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 91e:	2705                	addiw	a4,a4,1
  while (n > 1) {
 920:	fed5c9e3          	blt	a1,a3,912 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 924:	00000797          	auipc	a5,0x0
 928:	6ee7a423          	sw	a4,1768(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 92c:	00001917          	auipc	s2,0x1
 930:	8f490913          	addi	s2,s2,-1804 # 1220 <lock_ids>
    lock_ids[i]= peterson_create() ;
 934:	00000097          	auipc	ra,0x0
 938:	b12080e7          	jalr	-1262(ra) # 446 <peterson_create>
 93c:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 940:	04054063          	bltz	a0,980 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 944:	2485                	addiw	s1,s1,1
 946:	0911                	addi	s2,s2,4
 948:	ff44c6e3          	blt	s1,s4,934 <tournament_create+0x54>
 ...
 950:	6a07ae23          	sw	zero,1724(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 954:	4785                	li	a5,1
 956:	0537d863          	bge	a5,s3,9a6 <tournament_create+0xc6>
 95a:	4485                	li	s1,1
        int pid = fork() ;
 95c:	00000097          	auipc	ra,0x0
 960:	a42080e7          	jalr	-1470(ra) # 39e <fork>
        if(pid < 0)
 964:	02054763          	bltz	a0,992 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 968:	c509                	beqz	a0,972 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 96a:	2485                	addiw	s1,s1,1
 96c:	fe9998e3          	bne	s3,s1,95c <tournament_create+0x7c>
 970:	a81d                	j	9a6 <tournament_create+0xc6>
            trnmnt_idx = i ;
 972:	00000797          	auipc	a5,0x0
 976:	6897ab23          	sw	s1,1686(a5) # 1008 <trnmnt_idx>
            break ;
 97a:	a035                	j	9a6 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 97c:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 990:	8082                	ret
            return -1 ;
 992:	557d                	li	a0,-1
 994:	b7fd                	j	982 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 996:	00000797          	auipc	a5,0x0
 99a:	6607ab23          	sw	zero,1654(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 99e:	00000797          	auipc	a5,0x0
 9a2:	6607a523          	sw	zero,1642(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 9a6:	00000517          	auipc	a0,0x0
 9aa:	66252503          	lw	a0,1634(a0) # 1008 <trnmnt_idx>
 9ae:	bfd1                	j	982 <tournament_create+0xa2>
...
int tournament_acquire(void){ 
 ...
 9b4:	6587a783          	lw	a5,1624(a5) # 1008 <trnmnt_idx>
 9b8:	0a07c763          	bltz	a5,a66 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 9bc:	715d                	addi	sp,sp,-80
 9be:	e486                	sd	ra,72(sp)
 9c0:	e0a2                	sd	s0,64(sp)
 9c2:	fc26                	sd	s1,56(sp)
 9c4:	f84a                	sd	s2,48(sp)
 9c6:	f44e                	sd	s3,40(sp)
 9c8:	f052                	sd	s4,32(sp)
 9ca:	ec56                	sd	s5,24(sp)
 9cc:	e85a                	sd	s6,16(sp)
 9ce:	e45e                	sd	s7,8(sp)
 9d0:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9d2:	00000497          	auipc	s1,0x0
 9d6:	63a4a483          	lw	s1,1594(s1) # 100c <num_levels>
 9da:	08905863          	blez	s1,a6a <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 9de:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9e0:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9e4:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 9e8:	4705                	li	a4,1
 9ea:	0097173b          	sllw	a4,a4,s1
 9ee:	9fb9                	addw	a5,a5,a4
 9f0:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9f2:	4739                	li	a4,14
 9f4:	06f74d63          	blt	a4,a5,a6e <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 9f8:	00001997          	auipc	s3,0x1
 9fc:	82898993          	addi	s3,s3,-2008 # 1220 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a00:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a02:	00000b97          	auipc	s7,0x0
 a06:	60ab8b93          	addi	s7,s7,1546 # 100c <num_levels>
 ...
 a18:	97ce                	add	a5,a5,s3
 a1a:	4388                	lw	a0,0(a5)
 a1c:	00000097          	auipc	ra,0x0
 a20:	a32080e7          	jalr	-1486(ra) # 44e <peterson_acquire>
 a24:	04054763          	bltz	a0,a72 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a28:	fff4869b          	addiw	a3,s1,-1
 a2c:	0006849b          	sext.w	s1,a3
 a30:	03448963          	beq	s1,s4,a62 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a34:	000ba703          	lw	a4,0(s7)
 a38:	40d706bb          	subw	a3,a4,a3
 a3c:	fff6879b          	addiw	a5,a3,-1
 a40:	000b2703          	lw	a4,0(s6)
 a44:	00f915bb          	sllw	a1,s2,a5
 a48:	8df9                	and	a1,a1,a4
 a4a:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a4e:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a52:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a56:	9fb9                	addw	a5,a5,a4
 a58:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a5a:	fafadee3          	bge	s5,a5,a16 <tournament_acquire+0x66>
 a5e:	557d                	li	a0,-1
 a60:	a811                	j	a74 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 a62:	4501                	li	a0,0
 a64:	a801                	j	a74 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a66:	557d                	li	a0,-1
}
 a68:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a6a:	557d                	li	a0,-1
 a6c:	a021                	j	a74 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 a6e:	557d                	li	a0,-1
 a70:	a011                	j	a74 <tournament_acquire+0xc4>
        return -1;
 a72:	557d                	li	a0,-1
}
 a74:	60a6                	ld	ra,72(sp)
 a76:	6406                	ld	s0,64(sp)
 a78:	74e2                	ld	s1,56(sp)
 a7a:	7942                	ld	s2,48(sp)
 a7c:	79a2                	ld	s3,40(sp)
 a7e:	7a02                	ld	s4,32(sp)
 a80:	6ae2                	ld	s5,24(sp)
 a82:	6b42                	ld	s6,16(sp)
 a84:	6ba2                	ld	s7,8(sp)
...
int tournament_release(void) {
 ...
 a92:	0a07c663          	bltz	a5,b3e <tournament_release+0xb4>
 a96:	00000717          	auipc	a4,0x0
 a9a:	57672703          	lw	a4,1398(a4) # 100c <num_levels>
 a9e:	0ae05263          	blez	a4,b42 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 aa2:	fff7069b          	addiw	a3,a4,-1
 aa6:	4585                	li	a1,1
 aa8:	00d595bb          	sllw	a1,a1,a3
 aac:	8dfd                	and	a1,a1,a5
 aae:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ab2:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 ab6:	4739                	li	a4,14
 ab8:	08f74763          	blt	a4,a5,b46 <tournament_release+0xbc>
int tournament_release(void) {
 abc:	7139                	addi	sp,sp,-64
 abe:	fc06                	sd	ra,56(sp)
 ac0:	f822                	sd	s0,48(sp)
 ac2:	f426                	sd	s1,40(sp)
 ...
 ad2:	00000997          	auipc	s3,0x0
 ad6:	74e98993          	addi	s3,s3,1870 # 1220 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 ada:	00000a17          	auipc	s4,0x0
 ade:	532a0a13          	addi	s4,s4,1330 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ae2:	00000b17          	auipc	s6,0x0
 ae6:	526b0b13          	addi	s6,s6,1318 # 1008 <trnmnt_idx>
 aea:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 aec:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 aee:	078a                	slli	a5,a5,0x2
 af0:	97ce                	add	a5,a5,s3
 af2:	4388                	lw	a0,0(a5)
 af4:	00000097          	auipc	ra,0x0
 af8:	962080e7          	jalr	-1694(ra) # 456 <peterson_release>
 afc:	04054763          	bltz	a0,b4a <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 b00:	0014871b          	addiw	a4,s1,1
 b04:	0007049b          	sext.w	s1,a4
 b08:	000a2783          	lw	a5,0(s4)
 b0c:	02f4d763          	bge	s1,a5,b3a <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b10:	40e7873b          	subw	a4,a5,a4
 b14:	fff7079b          	addiw	a5,a4,-1
 b18:	000b2683          	lw	a3,0(s6)
 b1c:	00f915bb          	sllw	a1,s2,a5
 b20:	8df5                	and	a1,a1,a3
 b22:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b26:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b2a:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 b2e:	9fb9                	addw	a5,a5,a4
 b30:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b32:	fafadee3          	bge	s5,a5,aee <tournament_release+0x64>
 b36:	557d                	li	a0,-1
 b38:	a811                	j	b4c <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 b3a:	4501                	li	a0,0
 b3c:	a801                	j	b4c <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b3e:	557d                	li	a0,-1
 b40:	8082                	ret
 b42:	557d                	li	a0,-1
