...
main(int argc, char *argv[])
{
  ...
  2e:	8c6a0a13          	addi	s4,s4,-1850 # 8f0 <tournament_release+0x16>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	89058593          	addi	a1,a1,-1904 # 8f8 <tournament_release+0x1e>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 414:	4f850513          	addi	a0,a0,1272 # 908 <digits>
 418:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e0:	42cb8b93          	addi	s7,s7,1068 # 908 <digits>
 ...
 620:	2e490913          	addi	s2,s2,740 # 900 <tournament_release+0x26>
        while(*s != 0){
 ...
 716:	00e6ea63          	bltu	a3,a4,72a <free+0x50>
{
 ...
 758:	8af73e23          	sd	a5,-1860(a4) # 1010 <freep>
}
 75c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 78a:	88a53503          	ld	a0,-1910(a0) # 1010 <freep>
 ...
 7b2:	86290913          	addi	s2,s2,-1950 # 1010 <freep>
  if(p == (char*)-1)
 7b6:	5afd                	li	s5,-1
 7b8:	a88d                	j	82a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ba:	00001797          	auipc	a5,0x1
 7be:	87678793          	addi	a5,a5,-1930 # 1030 <base>
 ...
 7ec:	82a73423          	sd	a0,-2008(a4) # 1010 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 84a:	47bd                	li	a5,15
 84c:	00e7eb63          	bltu	a5,a4,862 <tournament_create+0x1c>
 850:	fff5079b          	addiw	a5,a0,-1
 854:	8fe9                	and	a5,a5,a0
 856:	2781                	sext.w	a5,a5
 858:	c799                	beqz	a5,866 <tournament_create+0x20>
}
 ...
 85c:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 85e:	557d                	li	a0,-1
 860:	a095                	j	8c4 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 862:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 872:	7aa7a923          	sw	a0,1970(a5) # 1020 <num_processes>
   while(temp >>=1)
 876:	4015551b          	sraiw	a0,a0,0x1
 87a:	c105                	beqz	a0,89a <tournament_create+0x54>
 87c:	00000797          	auipc	a5,0x0
 880:	7a87a783          	lw	a5,1960(a5) # 1024 <num_levels>
 884:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 886:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 88a:	4015551b          	sraiw	a0,a0,0x1
 88e:	2785                	addiw	a5,a5,1
 890:	f97d                	bnez	a0,886 <tournament_create+0x40>
 892:	00000797          	auipc	a5,0x0
 896:	78e7a923          	sw	a4,1938(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 89a:	00000797          	auipc	a5,0x0
 89e:	78a7a783          	lw	a5,1930(a5) # 1024 <num_levels>
 8a2:	4505                	li	a0,1
 8a4:	00f5153b          	sllw	a0,a0,a5
 8a8:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 8aa:	0025151b          	slliw	a0,a0,0x2
 8ae:	00000097          	auipc	ra,0x0
 8b2:	eb4080e7          	jalr	-332(ra) # 762 <malloc>
 8b6:	87aa                	mv	a5,a0
 8b8:	00000717          	auipc	a4,0x0
 8bc:	76a73023          	sd	a0,1888(a4) # 1018 <lock_ids>
    return 1 ;    
 8c0:	4505                	li	a0,1
    if (!lock_ids)
 8c2:	dfd1                	beqz	a5,85e <tournament_create+0x18>
}
 8c4:	60a2                	ld	ra,8(sp)
 8c6:	6402                	ld	s0,0(sp)
...
00000000000008cc <tournament_acquire>:
...
00000000000008da <tournament_release>:
