...
int tournament_create(int processes) {
 ...
 7ec:	fff5071b          	addiw	a4,a0,-1
 7f0:	47bd                	li	a5,15
 7f2:	08e7eb63          	bltu	a5,a4,888 <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 80e:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 810:	ecbd                	bnez	s1,88e <tournament_create+0xa2>
  if (n <= 1) 
 812:	4785                	li	a5,1
 814:	0937d763          	bge	a5,s3,8a2 <tournament_create+0xb6>
  int l = 0;
 818:	8726                	mv	a4,s1
 81a:	87ce                	mv	a5,s3
  while (n > 1) {
 81c:	458d                	li	a1,3
    n /= 2;
 81e:	86be                	mv	a3,a5
 820:	01f7d61b          	srliw	a2,a5,0x1f
 824:	9fb1                	addw	a5,a5,a2
 826:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 82a:	2705                	addiw	a4,a4,1
  while (n > 1) {
 82c:	fed5c9e3          	blt	a1,a3,81e <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 830:	00000797          	auipc	a5,0x0
 834:	7ce7ae23          	sw	a4,2012(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 838:	00000917          	auipc	s2,0x0
 83c:	7e890913          	addi	s2,s2,2024 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 840:	00000097          	auipc	ra,0x0
 844:	b12080e7          	jalr	-1262(ra) # 352 <peterson_create>
 848:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 84c:	04054063          	bltz	a0,88c <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 850:	2485                	addiw	s1,s1,1
 852:	0911                	addi	s2,s2,4
 854:	ff44c6e3          	blt	s1,s4,840 <tournament_create+0x54>
 ...
 85c:	7a07a823          	sw	zero,1968(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 860:	4785                	li	a5,1
 862:	0537d863          	bge	a5,s3,8b2 <tournament_create+0xc6>
 866:	4485                	li	s1,1
        int pid = fork() ;
 868:	00000097          	auipc	ra,0x0
 86c:	a42080e7          	jalr	-1470(ra) # 2aa <fork>
        if(pid < 0)
 870:	02054763          	bltz	a0,89e <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 874:	c509                	beqz	a0,87e <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 876:	2485                	addiw	s1,s1,1
 878:	fe9998e3          	bne	s3,s1,868 <tournament_create+0x7c>
 87c:	a81d                	j	8b2 <tournament_create+0xc6>
            trnmnt_idx = i ;
 87e:	00000797          	auipc	a5,0x0
 882:	7897a523          	sw	s1,1930(a5) # 1008 <trnmnt_idx>
            break ;
 886:	a035                	j	8b2 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 888:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 89c:	8082                	ret
            return -1 ;
 89e:	557d                	li	a0,-1
 8a0:	b7fd                	j	88e <tournament_create+0xa2>
   num_levels = log2(processes) ;
 8a2:	00000797          	auipc	a5,0x0
 8a6:	7607a523          	sw	zero,1898(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 8aa:	00000797          	auipc	a5,0x0
 8ae:	7407af23          	sw	zero,1886(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 8b2:	00000517          	auipc	a0,0x0
 8b6:	75652503          	lw	a0,1878(a0) # 1008 <trnmnt_idx>
 8ba:	bfd1                	j	88e <tournament_create+0xa2>

00000000000008bc <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 8bc:	00000797          	auipc	a5,0x0
 8c0:	74c7a783          	lw	a5,1868(a5) # 1008 <trnmnt_idx>
 8c4:	0a07c763          	bltz	a5,972 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 ...
 8e2:	72e4a483          	lw	s1,1838(s1) # 100c <num_levels>
 8e6:	08905863          	blez	s1,976 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 8ea:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 8ec:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 8f0:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 8f4:	4705                	li	a4,1
 8f6:	0097173b          	sllw	a4,a4,s1
 8fa:	9fb9                	addw	a5,a5,a4
 8fc:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 8fe:	4739                	li	a4,14
 900:	06f74d63          	blt	a4,a5,97a <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 904:	00000997          	auipc	s3,0x0
 908:	71c98993          	addi	s3,s3,1820 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 90c:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 90e:	00000b97          	auipc	s7,0x0
 912:	6feb8b93          	addi	s7,s7,1790 # 100c <num_levels>
 916:	00000b17          	auipc	s6,0x0
 91a:	6f2b0b13          	addi	s6,s6,1778 # 1008 <trnmnt_idx>
 91e:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 920:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 922:	078a                	slli	a5,a5,0x2
 924:	97ce                	add	a5,a5,s3
 926:	4388                	lw	a0,0(a5)
 928:	00000097          	auipc	ra,0x0
 92c:	a32080e7          	jalr	-1486(ra) # 35a <peterson_acquire>
 930:	04054763          	bltz	a0,97e <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 934:	fff4869b          	addiw	a3,s1,-1
 938:	0006849b          	sext.w	s1,a3
 93c:	03448963          	beq	s1,s4,96e <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 940:	000ba703          	lw	a4,0(s7)
 944:	40d706bb          	subw	a3,a4,a3
 948:	fff6879b          	addiw	a5,a3,-1
 94c:	000b2703          	lw	a4,0(s6)
 950:	00f915bb          	sllw	a1,s2,a5
 954:	8df9                	and	a1,a1,a4
 956:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 95a:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 95e:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 962:	9fb9                	addw	a5,a5,a4
 964:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 966:	fafadee3          	bge	s5,a5,922 <tournament_acquire+0x66>
 96a:	557d                	li	a0,-1
 96c:	a811                	j	980 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 96e:	4501                	li	a0,0
 970:	a801                	j	980 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 972:	557d                	li	a0,-1
}
 974:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 976:	557d                	li	a0,-1
 978:	a021                	j	980 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 97a:	557d                	li	a0,-1
 97c:	a011                	j	980 <tournament_acquire+0xc4>
        return -1;
 97e:	557d                	li	a0,-1
}
 980:	60a6                	ld	ra,72(sp)
 982:	6406                	ld	s0,64(sp)
 984:	74e2                	ld	s1,56(sp)
 986:	7942                	ld	s2,48(sp)
 988:	79a2                	ld	s3,40(sp)
 98a:	7a02                	ld	s4,32(sp)
 98c:	6ae2                	ld	s5,24(sp)
 98e:	6b42                	ld	s6,16(sp)
 990:	6ba2                	ld	s7,8(sp)
...
int tournament_release(void) {
 ...
 99e:	0a07c663          	bltz	a5,a4a <tournament_release+0xb4>
 9a2:	00000717          	auipc	a4,0x0
 9a6:	66a72703          	lw	a4,1642(a4) # 100c <num_levels>
 9aa:	0ae05263          	blez	a4,a4e <tournament_release+0xb8>
 ...
 9be:	40e7d7bb          	sraw	a5,a5,a4
        ...
        if(lockidx>=MAX_LOCKS) return -1 ;
 9c2:	4739                	li	a4,14
 9c4:	08f74763          	blt	a4,a5,a52 <tournament_release+0xbc>
int tournament_release(void) {
 ...
 9de:	00000997          	auipc	s3,0x0
 9e2:	64298993          	addi	s3,s3,1602 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 9e6:	00000a17          	auipc	s4,0x0
 9ea:	626a0a13          	addi	s4,s4,1574 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9ee:	00000b17          	auipc	s6,0x0
 9f2:	61ab0b13          	addi	s6,s6,1562 # 1008 <trnmnt_idx>
 9f6:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9f8:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 9fa:	078a                	slli	a5,a5,0x2
 9fc:	97ce                	add	a5,a5,s3
 9fe:	4388                	lw	a0,0(a5)
 a00:	00000097          	auipc	ra,0x0
 a04:	962080e7          	jalr	-1694(ra) # 362 <peterson_release>
 a08:	04054763          	bltz	a0,a56 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a0c:	0014871b          	addiw	a4,s1,1
 a10:	0007049b          	sext.w	s1,a4
 a14:	000a2783          	lw	a5,0(s4)
 a18:	02f4d763          	bge	s1,a5,a46 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 ...
 a3c:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a3e:	fafadee3          	bge	s5,a5,9fa <tournament_release+0x64>
 a42:	557d                	li	a0,-1
 a44:	a811                	j	a58 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 a46:	4501                	li	a0,0
 a48:	a801                	j	a58 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a4a:	557d                	li	a0,-1
 a4c:	8082                	ret
 a4e:	557d                	li	a0,-1
