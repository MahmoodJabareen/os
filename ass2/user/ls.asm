...
ls(char *path)
{
 ...
 12c:	c2850513          	addi	a0,a0,-984 # d50 <tournament_release+0x10c>
 ...
 16a:	bba58593          	addi	a1,a1,-1094 # d20 <tournament_release+0xdc>
 16e:	4509                	li	a0,2
 ...
 180:	bbc58593          	addi	a1,a1,-1092 # d38 <tournament_release+0xf4>
 184:	4509                	li	a0,2
 ...
 1b2:	bb250513          	addi	a0,a0,-1102 # d60 <tournament_release+0x11c>
 ...
 1f8:	b84a0a13          	addi	s4,s4,-1148 # d78 <tournament_release+0x134>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	b3ca8a93          	addi	s5,s5,-1220 # d38 <tournament_release+0xf4>
...
main(int argc, char *argv[])
{
 ...
 2c2:	aca50513          	addi	a0,a0,-1334 # d88 <tournament_release+0x144>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 668:	73450513          	addi	a0,a0,1844 # d98 <digits>
 66c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 734:	668b8b93          	addi	s7,s7,1640 # d98 <digits>
 ...
 874:	52090913          	addi	s2,s2,1312 # d90 <tournament_release+0x14c>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 aa2:	e84a                	sd	s2,16(sp)
 aa4:	e44e                	sd	s3,8(sp)
 aa6:	e052                	sd	s4,0(sp)
 aa8:	1800                	addi	s0,sp,48
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 aaa:	fff5071b          	addiw	a4,a0,-1
 aae:	47bd                	li	a5,15
 ab0:	00e7ee63          	bltu	a5,a4,acc <tournament_create+0x32>
 ab4:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 ab6:	8a3a                	mv	s4,a4
 ab8:	00e574b3          	and	s1,a0,a4
 abc:	c0b9                	beqz	s1,b02 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 abe:	54fd                	li	s1,-1
 ac0:	a809                	j	ad2 <tournament_create+0x38>
 ...
 ac6:	5497a323          	sw	s1,1350(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 aca:	a021                	j	ad2 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 acc:	54fd                	li	s1,-1
 ace:	a011                	j	ad2 <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 ae2:	8082                	ret
            return -1 ;
 ae4:	54fd                	li	s1,-1
 ae6:	b7f5                	j	ad2 <tournament_create+0x38>
   num_levels = log2(processes) ;
 ae8:	00000797          	auipc	a5,0x0
 aec:	5207a423          	sw	zero,1320(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 af0:	00000797          	auipc	a5,0x0
 af4:	5007ac23          	sw	zero,1304(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 af8:	00000497          	auipc	s1,0x0
 afc:	5104a483          	lw	s1,1296(s1) # 1008 <trnmnt_idx>
 b00:	bfc9                	j	ad2 <tournament_create+0x38>
   num_processes = processes ;
 b02:	00000797          	auipc	a5,0x0
 b06:	50a7a523          	sw	a0,1290(a5) # 100c <num_processes>
  if (n <= 1) 
 b0a:	4785                	li	a5,1
 b0c:	fca7dee3          	bge	a5,a0,ae8 <tournament_create+0x4e>
  int l = 0;
 b10:	8726                	mv	a4,s1
 b12:	87aa                	mv	a5,a0
  while (n > 1) {
 b14:	458d                	li	a1,3
    n /= 2;
 b16:	86be                	mv	a3,a5
 b18:	01f7d61b          	srliw	a2,a5,0x1f
 b1c:	9fb1                	addw	a5,a5,a2
 b1e:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 b22:	2705                	addiw	a4,a4,1
  while (n > 1) {
 b24:	fed5c9e3          	blt	a1,a3,b16 <tournament_create+0x7c>
   num_levels = log2(processes) ;
 b28:	00000797          	auipc	a5,0x0
 b2c:	4ee7a423          	sw	a4,1256(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 b30:	00000917          	auipc	s2,0x0
 b34:	51090913          	addi	s2,s2,1296 # 1040 <lock_ids>
    lock_ids[i]= peterson_create() ;
 b38:	00000097          	auipc	ra,0x0
 b3c:	ac8080e7          	jalr	-1336(ra) # 600 <peterson_create>
 b40:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 b44:	f80546e3          	bltz	a0,ad0 <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 b48:	2485                	addiw	s1,s1,1
 b4a:	0911                	addi	s2,s2,4
 b4c:	ff44c6e3          	blt	s1,s4,b38 <tournament_create+0x9e>
   trnmnt_idx = 0;
 b50:	00000797          	auipc	a5,0x0
 b54:	4a07ac23          	sw	zero,1208(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 b58:	4785                	li	a5,1
 b5a:	f937dfe3          	bge	a5,s3,af8 <tournament_create+0x5e>
 b5e:	4485                	li	s1,1
        int pid = fork() ;
 b60:	00000097          	auipc	ra,0x0
 b64:	9f8080e7          	jalr	-1544(ra) # 558 <fork>
        if(pid < 0)
 b68:	f6054ee3          	bltz	a0,ae4 <tournament_create+0x4a>
        if(pid == 0){
 b6c:	d939                	beqz	a0,ac2 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 b6e:	2485                	addiw	s1,s1,1
 b70:	fe9998e3          	bne	s3,s1,b60 <tournament_create+0xc6>
 b74:	b751                	j	af8 <tournament_create+0x5e>

0000000000000b76 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 b76:	00000797          	auipc	a5,0x0
 b7a:	4927a783          	lw	a5,1170(a5) # 1008 <trnmnt_idx>
 b7e:	0a07cd63          	bltz	a5,c38 <tournament_acquire+0xc2>
 b82:	00000717          	auipc	a4,0x0
 b86:	48e72703          	lw	a4,1166(a4) # 1010 <num_levels>
 b8a:	0ae05963          	blez	a4,c3c <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b8e:	fff7069b          	addiw	a3,a4,-1
 b92:	4585                	li	a1,1
 b94:	00d595bb          	sllw	a1,a1,a3
 b98:	8dfd                	and	a1,a1,a5
 b9a:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b9e:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 ba2:	4739                	li	a4,14
 ba4:	08f74e63          	blt	a4,a5,c40 <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 bbe:	00000a17          	auipc	s4,0x0
 bc2:	482a0a13          	addi	s4,s4,1154 # 1040 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 bc6:	00000997          	auipc	s3,0x0
 bca:	44a98993          	addi	s3,s3,1098 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 bce:	00000b17          	auipc	s6,0x0
 bd2:	43ab0b13          	addi	s6,s6,1082 # 1008 <trnmnt_idx>
 bd6:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 bd8:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 bda:	078a                	slli	a5,a5,0x2
 bdc:	97d2                	add	a5,a5,s4
 bde:	4388                	lw	a0,0(a5)
 be0:	00000097          	auipc	ra,0x0
 be4:	a28080e7          	jalr	-1496(ra) # 608 <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 be8:	0014871b          	addiw	a4,s1,1
 bec:	0007049b          	sext.w	s1,a4
 bf0:	0009a783          	lw	a5,0(s3)
 bf4:	02f4d763          	bge	s1,a5,c22 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 bf8:	40e7873b          	subw	a4,a5,a4
 bfc:	fff7079b          	addiw	a5,a4,-1
 c00:	000b2683          	lw	a3,0(s6)
 c04:	00f915bb          	sllw	a1,s2,a5
 c08:	8df5                	and	a1,a1,a3
 c0a:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 c0e:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 c12:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 c16:	9fb9                	addw	a5,a5,a4
 c18:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 c1a:	fcfad0e3          	bge	s5,a5,bda <tournament_acquire+0x64>
 c1e:	557d                	li	a0,-1
 c20:	a011                	j	c24 <tournament_acquire+0xae>
...
0000000000000c44 <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 c44:	00000797          	auipc	a5,0x0
 c48:	3c47a783          	lw	a5,964(a5) # 1008 <trnmnt_idx>
 c4c:	0a07cf63          	bltz	a5,d0a <tournament_release+0xc6>
int tournament_release(void) {
 c50:	715d                	addi	sp,sp,-80
 c52:	e486                	sd	ra,72(sp)
 c54:	e0a2                	sd	s0,64(sp)
 c56:	fc26                	sd	s1,56(sp)
 c58:	f84a                	sd	s2,48(sp)
 c5a:	f44e                	sd	s3,40(sp)
 c5c:	f052                	sd	s4,32(sp)
 c5e:	ec56                	sd	s5,24(sp)
 c60:	e85a                	sd	s6,16(sp)
 c62:	e45e                	sd	s7,8(sp)
 c64:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 c66:	00000497          	auipc	s1,0x0
 c6a:	3aa4a483          	lw	s1,938(s1) # 1010 <num_levels>
 c6e:	0a905063          	blez	s1,d0e <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 c72:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c74:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 c78:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 c7c:	4705                	li	a4,1
 c7e:	0097173b          	sllw	a4,a4,s1
 c82:	9fb9                	addw	a5,a5,a4
 c84:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 c86:	4739                	li	a4,14
 c88:	08f74563          	blt	a4,a5,d12 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 c8c:	00000a17          	auipc	s4,0x0
 c90:	3b4a0a13          	addi	s4,s4,948 # 1040 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 c94:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 c96:	00000b97          	auipc	s7,0x0
 c9a:	37ab8b93          	addi	s7,s7,890 # 1010 <num_levels>
 c9e:	00000b17          	auipc	s6,0x0
 ca2:	36ab0b13          	addi	s6,s6,874 # 1008 <trnmnt_idx>
 ca6:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 ca8:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 caa:	078a                	slli	a5,a5,0x2
 cac:	97d2                	add	a5,a5,s4
 cae:	4388                	lw	a0,0(a5)
 cb0:	00000097          	auipc	ra,0x0
 cb4:	960080e7          	jalr	-1696(ra) # 610 <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 cb8:	fff4869b          	addiw	a3,s1,-1
 cbc:	0006849b          	sext.w	s1,a3
 cc0:	03348963          	beq	s1,s3,cf2 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 cc4:	000ba703          	lw	a4,0(s7)
 cc8:	40d706bb          	subw	a3,a4,a3
 ccc:	fff6879b          	addiw	a5,a3,-1
 cd0:	000b2703          	lw	a4,0(s6)
 cd4:	00f915bb          	sllw	a1,s2,a5
 cd8:	8df9                	and	a1,a1,a4
 cda:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 cde:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ce2:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 ce6:	9fb9                	addw	a5,a5,a4
 ce8:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 cea:	fcfad0e3          	bge	s5,a5,caa <tournament_release+0x66>
 cee:	557d                	li	a0,-1
 cf0:	a011                	j	cf4 <tournament_release+0xb0>
...
return 0 ;
 ...
 cf4:	60a6                	ld	ra,72(sp)
 cf6:	6406                	ld	s0,64(sp)
 cf8:	74e2                	ld	s1,56(sp)
 cfa:	7942                	ld	s2,48(sp)
 cfc:	79a2                	ld	s3,40(sp)
 cfe:	7a02                	ld	s4,32(sp)
 d00:	6ae2                	ld	s5,24(sp)
 d02:	6b42                	ld	s6,16(sp)
 d04:	6ba2                	ld	s7,8(sp)
 d06:	6161                	addi	sp,sp,80
 d08:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 d0a:	557d                	li	a0,-1
}
 d0c:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 d0e:	557d                	li	a0,-1
 d10:	b7d5                	j	cf4 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 d12:	557d                	li	a0,-1
 d14:	b7c5                	j	cf4 <tournament_release+0xb0>
