...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	3ae58593          	addi	a1,a1,942 # 13c0 <tournament_release+0x14>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	36858593          	addi	a1,a1,872 # 13c8 <tournament_release+0x1c>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	33650513          	addi	a0,a0,822 # 13d0 <tournament_release+0x24>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	40a70713          	addi	a4,a4,1034 # 14d0 <tournament_release+0x124>
    ...
    panic("runcmd");
      ...
      e4:	2f850513          	addi	a0,a0,760 # 13d8 <tournament_release+0x2c>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	2de58593          	addi	a1,a1,734 # 13e0 <tournament_release+0x34>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	2a258593          	addi	a1,a1,674 # 13f0 <tournament_release+0x44>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	21c50513          	addi	a0,a0,540 # 1400 <tournament_release+0x54>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	e84b8b93          	addi	s7,s7,-380 # 1428 <tournament_release+0x7c>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	e5250513          	addi	a0,a0,-430 # 1408 <tournament_release+0x5c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	d9260613          	addi	a2,a2,-622 # 1430 <tournament_release+0x84>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	d82b0b13          	addi	s6,s6,-638 # 1450 <tournament_release+0xa4>
  ...
  return ret;
     ...
     70c:	d3050513          	addi	a0,a0,-720 # 1438 <tournament_release+0x8c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	cd650513          	addi	a0,a0,-810 # 1440 <tournament_release+0x94>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	cb460613          	addi	a2,a2,-844 # 1458 <tournament_release+0xac>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	c4ca0a13          	addi	s4,s4,-948 # 1460 <tournament_release+0xb4>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	c1e60613          	addi	a2,a2,-994 # 1468 <tournament_release+0xbc>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	b8060613          	addi	a2,a2,-1152 # 1430 <tournament_release+0x84>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	ba060613          	addi	a2,a2,-1120 # 1480 <tournament_release+0xd4>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	b4e50513          	addi	a0,a0,-1202 # 1470 <tournament_release+0xc4>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	b5650513          	addi	a0,a0,-1194 # 1488 <tournament_release+0xdc>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	b8a70713          	addi	a4,a4,-1142 # 14e8 <tournament_release+0x13c>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	a9660613          	addi	a2,a2,-1386 # 14a0 <tournament_release+0xf4>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	a6858593          	addi	a1,a1,-1432 # 14a8 <tournament_release+0xfc>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	6fe080e7          	jalr	1790(ra) # 1148 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	9e650513          	addi	a0,a0,-1562 # 1438 <tournament_release+0x8c>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	a4448493          	addi	s1,s1,-1468 # 14b8 <tournament_release+0x10c>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9e:	5a648493          	addi	s1,s1,1446 # 2040 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa2:	06300913          	li	s2,99
     aa6:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aaa:	00001a17          	auipc	s4,0x1
     aae:	599a0a13          	addi	s4,s4,1433 # 2043 <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab2:	00001a97          	auipc	s5,0x1
     ab6:	a0ea8a93          	addi	s5,s5,-1522 # 14c0 <tournament_release+0x114>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	50c50513          	addi	a0,a0,1292 # 2040 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee6:	62650513          	addi	a0,a0,1574 # 1508 <digits>
     eea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fb2:	55ab8b93          	addi	s7,s7,1370 # 1508 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10f2:	41290913          	addi	s2,s2,1042 # 1500 <tournament_release+0x154>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11ba:	e6a7b783          	ld	a5,-406(a5) # 2020 <freep>
    ...
    11e8:	00e6ea63          	bltu	a3,a4,11fc <free+0x50>
{
  ...
  freep = p;
    ...
    122a:	def73d23          	sd	a5,-518(a4) # 2020 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    125c:	dc853503          	ld	a0,-568(a0) # 2020 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1284:	da090913          	addi	s2,s2,-608 # 2020 <freep>
  if(p == (char*)-1)
    1288:	5afd                	li	s5,-1
    128a:	a88d                	j	12fc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    128c:	00001797          	auipc	a5,0x1
    1290:	e1c78793          	addi	a5,a5,-484 # 20a8 <base>
    1294:	00001717          	auipc	a4,0x1
    1298:	d8f73623          	sd	a5,-628(a4) # 2020 <freep>
    ...
    12be:	d6a73323          	sd	a0,-666(a4) # 2020 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
    ...
    131c:	47bd                	li	a5,15
    131e:	00e7eb63          	bltu	a5,a4,1334 <tournament_create+0x1c>
    1322:	fff5079b          	addiw	a5,a0,-1
    1326:	8fe9                	and	a5,a5,a0
    1328:	2781                	sext.w	a5,a5
    132a:	c799                	beqz	a5,1338 <tournament_create+0x20>
}
...
int tournament_create(int processes) {
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
    1330:	557d                	li	a0,-1
    1332:	a095                	j	1396 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
    1334:	557d                	li	a0,-1
...
int tournament_create(int processes) {
   ...
   num_processes = processes ;
    ...
    1344:	cea7a823          	sw	a0,-784(a5) # 2030 <num_processes>
   while(temp >>=1)
    1348:	4015551b          	sraiw	a0,a0,0x1
    134c:	c105                	beqz	a0,136c <tournament_create+0x54>
    134e:	00001797          	auipc	a5,0x1
    1352:	ce67a783          	lw	a5,-794(a5) # 2034 <num_levels>
    1356:	2785                	addiw	a5,a5,1
        num_levels ++ ;
    1358:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
    135c:	4015551b          	sraiw	a0,a0,0x1
    1360:	2785                	addiw	a5,a5,1
    1362:	f97d                	bnez	a0,1358 <tournament_create+0x40>
    1364:	00001797          	auipc	a5,0x1
    1368:	cce7a823          	sw	a4,-816(a5) # 2034 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
    136c:	00001797          	auipc	a5,0x1
    1370:	cc87a783          	lw	a5,-824(a5) # 2034 <num_levels>
    1374:	4505                	li	a0,1
    1376:	00f5153b          	sllw	a0,a0,a5
    137a:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
    137c:	0025151b          	slliw	a0,a0,0x2
    1380:	00000097          	auipc	ra,0x0
    1384:	eb4080e7          	jalr	-332(ra) # 1234 <malloc>
    1388:	87aa                	mv	a5,a0
    138a:	00001717          	auipc	a4,0x1
    138e:	c8a73f23          	sd	a0,-866(a4) # 2028 <lock_ids>
    return 1 ;    
    1392:	4505                	li	a0,1
    if (!lock_ids)
    1394:	dfd1                	beqz	a5,1330 <tournament_create+0x18>
}
    1396:	60a2                	ld	ra,8(sp)
    1398:	6402                	ld	s0,0(sp)
    139a:	0141                	addi	sp,sp,16
    139c:	8082                	ret

000000000000139e <tournament_acquire>:

int tournament_acquire(void) { return 0;}
    139e:	1141                	addi	sp,sp,-16
    13a0:	e422                	sd	s0,8(sp)
    13a2:	0800                	addi	s0,sp,16
    13a4:	4501                	li	a0,0
    13a6:	6422                	ld	s0,8(sp)
    13a8:	0141                	addi	sp,sp,16
    13aa:	8082                	ret

00000000000013ac <tournament_release>:

int tournament_release(void){ return 0;}
    13ac:	1141                	addi	sp,sp,-16
    13ae:	e422                	sd	s0,8(sp)
    13b0:	0800                	addi	s0,sp,16
    13b2:	4501                	li	a0,0
    13b4:	6422                	ld	s0,8(sp)
    13b6:	0141                	addi	sp,sp,16
    13b8:	8082                	ret
