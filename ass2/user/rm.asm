...
main(int argc, char *argv[])
{
  ...
  42:	8a258593          	addi	a1,a1,-1886 # 8e0 <tournament_release+0x12>
  46:	4509                	li	a0,2
  ...
  60:	89c58593          	addi	a1,a1,-1892 # 8f8 <tournament_release+0x2a>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 408:	51c50513          	addi	a0,a0,1308 # 920 <digits>
 40c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	450b8b93          	addi	s7,s7,1104 # 920 <digits>
 ...
 614:	30890913          	addi	s2,s2,776 # 918 <tournament_release+0x4a>
        while(*s != 0){
 ...
 70a:	00e6ea63          	bltu	a3,a4,71e <free+0x50>
{
 ...
 74c:	8cf73423          	sd	a5,-1848(a4) # 1010 <freep>
}
 750:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 77e:	89653503          	ld	a0,-1898(a0) # 1010 <freep>
 ...
 7a6:	86e90913          	addi	s2,s2,-1938 # 1010 <freep>
  if(p == (char*)-1)
 7aa:	5afd                	li	s5,-1
 7ac:	a88d                	j	81e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ae:	00001797          	auipc	a5,0x1
 7b2:	88278793          	addi	a5,a5,-1918 # 1030 <base>
 ...
 7e0:	82a73a23          	sd	a0,-1996(a4) # 1010 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 83e:	47bd                	li	a5,15
 840:	00e7eb63          	bltu	a5,a4,856 <tournament_create+0x1c>
 844:	fff5079b          	addiw	a5,a0,-1
 848:	8fe9                	and	a5,a5,a0
 84a:	2781                	sext.w	a5,a5
 84c:	c799                	beqz	a5,85a <tournament_create+0x20>
}
 ...
 850:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 852:	557d                	li	a0,-1
 854:	a095                	j	8b8 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 856:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 866:	7aa7af23          	sw	a0,1982(a5) # 1020 <num_processes>
   while(temp >>=1)
 86a:	4015551b          	sraiw	a0,a0,0x1
 86e:	c105                	beqz	a0,88e <tournament_create+0x54>
 870:	00000797          	auipc	a5,0x0
 874:	7b47a783          	lw	a5,1972(a5) # 1024 <num_levels>
 878:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 87a:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 87e:	4015551b          	sraiw	a0,a0,0x1
 882:	2785                	addiw	a5,a5,1
 884:	f97d                	bnez	a0,87a <tournament_create+0x40>
 886:	00000797          	auipc	a5,0x0
 88a:	78e7af23          	sw	a4,1950(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 88e:	00000797          	auipc	a5,0x0
 892:	7967a783          	lw	a5,1942(a5) # 1024 <num_levels>
 896:	4505                	li	a0,1
 898:	00f5153b          	sllw	a0,a0,a5
 89c:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 89e:	0025151b          	slliw	a0,a0,0x2
 8a2:	00000097          	auipc	ra,0x0
 8a6:	eb4080e7          	jalr	-332(ra) # 756 <malloc>
 8aa:	87aa                	mv	a5,a0
 8ac:	00000717          	auipc	a4,0x0
 8b0:	76a73623          	sd	a0,1900(a4) # 1018 <lock_ids>
    return 1 ;    
 8b4:	4505                	li	a0,1
    if (!lock_ids)
 8b6:	dfd1                	beqz	a5,852 <tournament_create+0x18>
}
 8b8:	60a2                	ld	ra,8(sp)
 8ba:	6402                	ld	s0,0(sp)
...
00000000000008c0 <tournament_acquire>:
...
00000000000008ce <tournament_release>:
