...
main(int argc, char *argv[])
{
  ...
  72:	b92a8a93          	addi	s5,s5,-1134 # c00 <tournament_release+0x112>
    simple_delay(1); // waste a little time
    printf("<<< [Role %d] end iteration %d\n", role, i);
  76:	00001a17          	auipc	s4,0x1
  7a:	bb2a0a13          	addi	s4,s4,-1102 # c28 <tournament_release+0x13a>
  ...
  8a:	b4a50513          	addi	a0,a0,-1206 # bd0 <tournament_release+0xe2>
  ...
  a4:	b4850513          	addi	a0,a0,-1208 # be8 <tournament_release+0xfa>
  ...
  be:	b8e50513          	addi	a0,a0,-1138 # c48 <tournament_release+0x15a>
 ...
 144:	b2050513          	addi	a0,a0,-1248 # c60 <tournament_release+0x172>
 ...
 16c:	b1850513          	addi	a0,a0,-1256 # c80 <tournament_release+0x192>
...
strcpy(char *s, const char *t)
{
 ...
 1ac:	fee78fa3          	sb	a4,-1(a5) # 1fff <lock_ids+0xfdf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 512:	79250513          	addi	a0,a0,1938 # ca0 <digits>
 516:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5de:	6c6b8b93          	addi	s7,s7,1734 # ca0 <digits>
 ...
 71e:	57e90913          	addi	s2,s2,1406 # c98 <tournament_release+0x1aa>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 944:	fff5071b          	addiw	a4,a0,-1
 948:	47bd                	li	a5,15
 94a:	08e7eb63          	bltu	a5,a4,9e0 <tournament_create+0x9c>
int tournament_create(int processes) {
 94e:	7179                	addi	sp,sp,-48
 ...
 966:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 968:	ecbd                	bnez	s1,9e6 <tournament_create+0xa2>
  if (n <= 1) 
 96a:	4785                	li	a5,1
 96c:	0937d763          	bge	a5,s3,9fa <tournament_create+0xb6>
  int l = 0;
 970:	8726                	mv	a4,s1
 972:	87ce                	mv	a5,s3
  while (n > 1) {
 974:	458d                	li	a1,3
    n /= 2;
 976:	86be                	mv	a3,a5
 978:	01f7d61b          	srliw	a2,a5,0x1f
 97c:	9fb1                	addw	a5,a5,a2
 97e:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 982:	2705                	addiw	a4,a4,1
  while (n > 1) {
 984:	fed5c9e3          	blt	a1,a3,976 <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 988:	00000797          	auipc	a5,0x0
 98c:	68e7a223          	sw	a4,1668(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 990:	00000917          	auipc	s2,0x0
 994:	69090913          	addi	s2,s2,1680 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 998:	00000097          	auipc	ra,0x0
 99c:	b12080e7          	jalr	-1262(ra) # 4aa <peterson_create>
 9a0:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 9a4:	04054063          	bltz	a0,9e4 <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 9a8:	2485                	addiw	s1,s1,1
 9aa:	0911                	addi	s2,s2,4
 9ac:	ff44c6e3          	blt	s1,s4,998 <tournament_create+0x54>
 ...
 9b4:	6407ac23          	sw	zero,1624(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 9b8:	4785                	li	a5,1
 9ba:	0537d863          	bge	a5,s3,a0a <tournament_create+0xc6>
 9be:	4485                	li	s1,1
        int pid = fork() ;
 9c0:	00000097          	auipc	ra,0x0
 9c4:	a42080e7          	jalr	-1470(ra) # 402 <fork>
        if(pid < 0)
 9c8:	02054763          	bltz	a0,9f6 <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 9cc:	c509                	beqz	a0,9d6 <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 9ce:	2485                	addiw	s1,s1,1
 9d0:	fe9998e3          	bne	s3,s1,9c0 <tournament_create+0x7c>
 9d4:	a81d                	j	a0a <tournament_create+0xc6>
            trnmnt_idx = i ;
 9d6:	00000797          	auipc	a5,0x0
 9da:	6297a923          	sw	s1,1586(a5) # 1008 <trnmnt_idx>
            break ;
 9de:	a035                	j	a0a <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 9e0:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 9e6:	70a2                	ld	ra,40(sp)
 9e8:	7402                	ld	s0,32(sp)
 9ea:	64e2                	ld	s1,24(sp)
 ...
 9f4:	8082                	ret
            return -1 ;
 9f6:	557d                	li	a0,-1
 9f8:	b7fd                	j	9e6 <tournament_create+0xa2>
   num_levels = log2(processes) ;
 9fa:	00000797          	auipc	a5,0x0
 9fe:	6007a923          	sw	zero,1554(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 a02:	00000797          	auipc	a5,0x0
 a06:	6007a323          	sw	zero,1542(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 a0a:	00000517          	auipc	a0,0x0
 a0e:	5fe52503          	lw	a0,1534(a0) # 1008 <trnmnt_idx>
 a12:	bfd1                	j	9e6 <tournament_create+0xa2>

0000000000000a14 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a14:	00000797          	auipc	a5,0x0
 a18:	5f47a783          	lw	a5,1524(a5) # 1008 <trnmnt_idx>
 a1c:	0a07c763          	bltz	a5,aca <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 a20:	715d                	addi	sp,sp,-80
 a22:	e486                	sd	ra,72(sp)
 a24:	e0a2                	sd	s0,64(sp)
 a26:	fc26                	sd	s1,56(sp)
 a28:	f84a                	sd	s2,48(sp)
 a2a:	f44e                	sd	s3,40(sp)
 a2c:	f052                	sd	s4,32(sp)
 a2e:	ec56                	sd	s5,24(sp)
 a30:	e85a                	sd	s6,16(sp)
 a32:	e45e                	sd	s7,8(sp)
 a34:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a36:	00000497          	auipc	s1,0x0
 a3a:	5d64a483          	lw	s1,1494(s1) # 100c <num_levels>
 a3e:	08905863          	blez	s1,ace <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a42:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a44:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a48:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 a4c:	4705                	li	a4,1
 a4e:	0097173b          	sllw	a4,a4,s1
 a52:	9fb9                	addw	a5,a5,a4
 a54:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a56:	4739                	li	a4,14
 a58:	06f74d63          	blt	a4,a5,ad2 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a5c:	00000997          	auipc	s3,0x0
 a60:	5c498993          	addi	s3,s3,1476 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a64:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a66:	00000b97          	auipc	s7,0x0
 a6a:	5a6b8b93          	addi	s7,s7,1446 # 100c <num_levels>
 a6e:	00000b17          	auipc	s6,0x0
 a72:	59ab0b13          	addi	s6,s6,1434 # 1008 <trnmnt_idx>
 a76:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a78:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 a7a:	078a                	slli	a5,a5,0x2
 a7c:	97ce                	add	a5,a5,s3
 a7e:	4388                	lw	a0,0(a5)
 a80:	00000097          	auipc	ra,0x0
 a84:	a32080e7          	jalr	-1486(ra) # 4b2 <peterson_acquire>
 a88:	04054763          	bltz	a0,ad6 <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 a8c:	fff4869b          	addiw	a3,s1,-1
 a90:	0006849b          	sext.w	s1,a3
 a94:	03448963          	beq	s1,s4,ac6 <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a98:	000ba703          	lw	a4,0(s7)
 a9c:	40d706bb          	subw	a3,a4,a3
 aa0:	fff6879b          	addiw	a5,a3,-1
 aa4:	000b2703          	lw	a4,0(s6)
 aa8:	00f915bb          	sllw	a1,s2,a5
 aac:	8df9                	and	a1,a1,a4
 aae:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 ab2:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 ab6:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 aba:	9fb9                	addw	a5,a5,a4
 abc:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 abe:	fafadee3          	bge	s5,a5,a7a <tournament_acquire+0x66>
 ac2:	557d                	li	a0,-1
 ac4:	a811                	j	ad8 <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 ac6:	4501                	li	a0,0
 ac8:	a801                	j	ad8 <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 aca:	557d                	li	a0,-1
}
 acc:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 ace:	557d                	li	a0,-1
 ad0:	a021                	j	ad8 <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 ad2:	557d                	li	a0,-1
 ad4:	a011                	j	ad8 <tournament_acquire+0xc4>
        return -1;
 ad6:	557d                	li	a0,-1
}
...
int tournament_release(void) {
 ...
 af6:	0a07c663          	bltz	a5,ba2 <tournament_release+0xb4>
 afa:	00000717          	auipc	a4,0x0
 afe:	51272703          	lw	a4,1298(a4) # 100c <num_levels>
 b02:	0ae05263          	blez	a4,ba6 <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b06:	fff7069b          	addiw	a3,a4,-1
 b0a:	4585                	li	a1,1
 b0c:	00d595bb          	sllw	a1,a1,a3
 b10:	8dfd                	and	a1,a1,a5
 b12:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b16:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 b1a:	4739                	li	a4,14
 b1c:	08f74763          	blt	a4,a5,baa <tournament_release+0xbc>
int tournament_release(void) {
 ...
 b36:	00000997          	auipc	s3,0x0
 b3a:	4ea98993          	addi	s3,s3,1258 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 b3e:	00000a17          	auipc	s4,0x0
 b42:	4cea0a13          	addi	s4,s4,1230 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b46:	00000b17          	auipc	s6,0x0
 b4a:	4c2b0b13          	addi	s6,s6,1218 # 1008 <trnmnt_idx>
 b4e:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b50:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 b52:	078a                	slli	a5,a5,0x2
 b54:	97ce                	add	a5,a5,s3
 b56:	4388                	lw	a0,0(a5)
 b58:	00000097          	auipc	ra,0x0
 b5c:	962080e7          	jalr	-1694(ra) # 4ba <peterson_release>
 b60:	04054763          	bltz	a0,bae <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 b64:	0014871b          	addiw	a4,s1,1
 b68:	0007049b          	sext.w	s1,a4
 b6c:	000a2783          	lw	a5,0(s4)
 b70:	02f4d763          	bge	s1,a5,b9e <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 b74:	40e7873b          	subw	a4,a5,a4
 b78:	fff7079b          	addiw	a5,a4,-1
 b7c:	000b2683          	lw	a3,0(s6)
 b80:	00f915bb          	sllw	a1,s2,a5
 b84:	8df5                	and	a1,a1,a3
 b86:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 b8a:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 b8e:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 b92:	9fb9                	addw	a5,a5,a4
 b94:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 b96:	fafadee3          	bge	s5,a5,b52 <tournament_release+0x64>
 b9a:	557d                	li	a0,-1
 b9c:	a811                	j	bb0 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 b9e:	4501                	li	a0,0
 ba0:	a801                	j	bb0 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 ba2:	557d                	li	a0,-1
 ba4:	8082                	ret
 ba6:	557d                	li	a0,-1
