...
main(int argc, char *argv[])
{
  ...
  42:	a8258593          	addi	a1,a1,-1406 # ac0 <tournament_release+0xdc>
  46:	4509                	li	a0,2
  ...
  60:	a7c58593          	addi	a1,a1,-1412 # ad8 <tournament_release+0xf4>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 408:	6fc50513          	addi	a0,a0,1788 # b00 <digits>
 40c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d4:	630b8b93          	addi	s7,s7,1584 # b00 <digits>
 ...
 614:	4e890913          	addi	s2,s2,1256 # af8 <tournament_release+0x114>
        while(*s != 0){
...
int tournament_create(int processes) {
 ...
 83a:	fff5071b          	addiw	a4,a0,-1
 83e:	47bd                	li	a5,15
 840:	08e7eb63          	bltu	a5,a4,8d6 <tournament_create+0x9c>
int tournament_create(int processes) {
 ...
 854:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 856:	8a3a                	mv	s4,a4
 858:	00e574b3          	and	s1,a0,a4
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 85c:	557d                	li	a0,-1
    return x > 0 && (x & (x - 1)) == 0;
 85e:	ecbd                	bnez	s1,8dc <tournament_create+0xa2>
  if (n <= 1) 
 860:	4785                	li	a5,1
 862:	0937d763          	bge	a5,s3,8f0 <tournament_create+0xb6>
  int l = 0;
 866:	8726                	mv	a4,s1
 868:	87ce                	mv	a5,s3
  while (n > 1) {
 86a:	458d                	li	a1,3
    n /= 2;
 86c:	86be                	mv	a3,a5
 86e:	01f7d61b          	srliw	a2,a5,0x1f
 872:	9fb1                	addw	a5,a5,a2
 874:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 878:	2705                	addiw	a4,a4,1
  while (n > 1) {
 87a:	fed5c9e3          	blt	a1,a3,86c <tournament_create+0x32>

   num_processes = processes ;
   num_levels = log2(processes) ;
 87e:	00000797          	auipc	a5,0x0
 882:	78e7a723          	sw	a4,1934(a5) # 100c <num_levels>

   for(int i = 0; i < (processes -1) ; i++){
 886:	00000917          	auipc	s2,0x0
 88a:	79a90913          	addi	s2,s2,1946 # 1020 <lock_ids>
    lock_ids[i]= peterson_create() ;
 88e:	00000097          	auipc	ra,0x0
 892:	b12080e7          	jalr	-1262(ra) # 3a0 <peterson_create>
 896:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 89a:	04054063          	bltz	a0,8da <tournament_create+0xa0>
   for(int i = 0; i < (processes -1) ; i++){
 89e:	2485                	addiw	s1,s1,1
 8a0:	0911                	addi	s2,s2,4
 8a2:	ff44c6e3          	blt	s1,s4,88e <tournament_create+0x54>
 ...
 8aa:	7607a123          	sw	zero,1890(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 8ae:	4785                	li	a5,1
 8b0:	0537d863          	bge	a5,s3,900 <tournament_create+0xc6>
 8b4:	4485                	li	s1,1
        int pid = fork() ;
 8b6:	00000097          	auipc	ra,0x0
 8ba:	a42080e7          	jalr	-1470(ra) # 2f8 <fork>
        if(pid < 0)
 8be:	02054763          	bltz	a0,8ec <tournament_create+0xb2>
            return -1 ;
        if(pid == 0){
 8c2:	c509                	beqz	a0,8cc <tournament_create+0x92>
   for(int i = 1; i < processes  ; i++){
 8c4:	2485                	addiw	s1,s1,1
 8c6:	fe9998e3          	bne	s3,s1,8b6 <tournament_create+0x7c>
 8ca:	a81d                	j	900 <tournament_create+0xc6>
            trnmnt_idx = i ;
 8cc:	00000797          	auipc	a5,0x0
 8d0:	7297ae23          	sw	s1,1852(a5) # 1008 <trnmnt_idx>
            break ;
 8d4:	a035                	j	900 <tournament_create+0xc6>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 8d6:	557d                	li	a0,-1
        }
   }
return trnmnt_idx ;
 ...
 8ea:	8082                	ret
            return -1 ;
 8ec:	557d                	li	a0,-1
 8ee:	b7fd                	j	8dc <tournament_create+0xa2>
   num_levels = log2(processes) ;
 8f0:	00000797          	auipc	a5,0x0
 8f4:	7007ae23          	sw	zero,1820(a5) # 100c <num_levels>
   trnmnt_idx = 0;
 8f8:	00000797          	auipc	a5,0x0
 8fc:	7007a823          	sw	zero,1808(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 900:	00000517          	auipc	a0,0x0
 904:	70852503          	lw	a0,1800(a0) # 1008 <trnmnt_idx>
 908:	bfd1                	j	8dc <tournament_create+0xa2>

000000000000090a <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 90a:	00000797          	auipc	a5,0x0
 90e:	6fe7a783          	lw	a5,1790(a5) # 1008 <trnmnt_idx>
 912:	0a07c763          	bltz	a5,9c0 <tournament_acquire+0xb6>
int tournament_acquire(void){ 
 916:	715d                	addi	sp,sp,-80
 918:	e486                	sd	ra,72(sp)
 91a:	e0a2                	sd	s0,64(sp)
 91c:	fc26                	sd	s1,56(sp)
 91e:	f84a                	sd	s2,48(sp)
 920:	f44e                	sd	s3,40(sp)
 922:	f052                	sd	s4,32(sp)
 924:	ec56                	sd	s5,24(sp)
 926:	e85a                	sd	s6,16(sp)
 928:	e45e                	sd	s7,8(sp)
 92a:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 92c:	00000497          	auipc	s1,0x0
 930:	6e04a483          	lw	s1,1760(s1) # 100c <num_levels>
 934:	08905863          	blez	s1,9c4 <tournament_acquire+0xba>

    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 938:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 93a:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 93e:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 942:	4705                	li	a4,1
 944:	0097173b          	sllw	a4,a4,s1
 948:	9fb9                	addw	a5,a5,a4
 94a:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 94c:	4739                	li	a4,14
 94e:	06f74d63          	blt	a4,a5,9c8 <tournament_acquire+0xbe>

        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 952:	00000997          	auipc	s3,0x0
 956:	6ce98993          	addi	s3,s3,1742 # 1020 <lock_ids>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 95a:	5a7d                	li	s4,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 95c:	00000b97          	auipc	s7,0x0
 960:	6b0b8b93          	addi	s7,s7,1712 # 100c <num_levels>
 964:	00000b17          	auipc	s6,0x0
 968:	6a4b0b13          	addi	s6,s6,1700 # 1008 <trnmnt_idx>
 96c:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 96e:	4ab9                	li	s5,14
        if(peterson_acquire(lock_ids[lockidx] , role) < 0)
 970:	078a                	slli	a5,a5,0x2
 972:	97ce                	add	a5,a5,s3
 974:	4388                	lw	a0,0(a5)
 976:	00000097          	auipc	ra,0x0
 97a:	a32080e7          	jalr	-1486(ra) # 3a8 <peterson_acquire>
 97e:	04054763          	bltz	a0,9cc <tournament_acquire+0xc2>
    for(int lvl = (num_levels -1) ; lvl >= 0 ; lvl--){
 982:	fff4869b          	addiw	a3,s1,-1
 986:	0006849b          	sext.w	s1,a3
 98a:	03448963          	beq	s1,s4,9bc <tournament_acquire+0xb2>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 98e:	000ba703          	lw	a4,0(s7)
 992:	40d706bb          	subw	a3,a4,a3
 996:	fff6879b          	addiw	a5,a3,-1
 99a:	000b2703          	lw	a4,0(s6)
 99e:	00f915bb          	sllw	a1,s2,a5
 9a2:	8df9                	and	a1,a1,a4
 9a4:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 9a8:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9ac:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 9b0:	9fb9                	addw	a5,a5,a4
 9b2:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9b4:	fafadee3          	bge	s5,a5,970 <tournament_acquire+0x66>
 9b8:	557d                	li	a0,-1
 9ba:	a811                	j	9ce <tournament_acquire+0xc4>
        return -1;

    }
return 0 ;
 9bc:	4501                	li	a0,0
 9be:	a801                	j	9ce <tournament_acquire+0xc4>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9c0:	557d                	li	a0,-1
}
 9c2:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9c4:	557d                	li	a0,-1
 9c6:	a021                	j	9ce <tournament_acquire+0xc4>
        if(lockidx>=MAX_LOCKS) return -1 ;
 9c8:	557d                	li	a0,-1
 9ca:	a011                	j	9ce <tournament_acquire+0xc4>
        return -1;
 9cc:	557d                	li	a0,-1
}
 9ce:	60a6                	ld	ra,72(sp)
 9d0:	6406                	ld	s0,64(sp)
 9d2:	74e2                	ld	s1,56(sp)
 9d4:	7942                	ld	s2,48(sp)
 9d6:	79a2                	ld	s3,40(sp)
 9d8:	7a02                	ld	s4,32(sp)
 9da:	6ae2                	ld	s5,24(sp)
 9dc:	6b42                	ld	s6,16(sp)
 9de:	6ba2                	ld	s7,8(sp)
 9e0:	6161                	addi	sp,sp,80
 9e2:	8082                	ret

00000000000009e4 <tournament_release>:

int tournament_release(void) {

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 9e4:	00000797          	auipc	a5,0x0
 9e8:	6247a783          	lw	a5,1572(a5) # 1008 <trnmnt_idx>
 9ec:	0a07c663          	bltz	a5,a98 <tournament_release+0xb4>
 9f0:	00000717          	auipc	a4,0x0
 9f4:	61c72703          	lw	a4,1564(a4) # 100c <num_levels>
 9f8:	0ae05263          	blez	a4,a9c <tournament_release+0xb8>

    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9fc:	fff7069b          	addiw	a3,a4,-1
 a00:	4585                	li	a1,1
 a02:	00d595bb          	sllw	a1,a1,a3
 a06:	8dfd                	and	a1,a1,a5
 a08:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a0c:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 a10:	4739                	li	a4,14
 a12:	08f74763          	blt	a4,a5,aa0 <tournament_release+0xbc>
int tournament_release(void) {
 ...
 a30:	5f498993          	addi	s3,s3,1524 # 1020 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a34:	00000a17          	auipc	s4,0x0
 a38:	5d8a0a13          	addi	s4,s4,1496 # 100c <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a3c:	00000b17          	auipc	s6,0x0
 a40:	5ccb0b13          	addi	s6,s6,1484 # 1008 <trnmnt_idx>
 a44:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a46:	4ab9                	li	s5,14
        if (peterson_release(lock_ids[lockidx] , role) < 0)
 a48:	078a                	slli	a5,a5,0x2
 a4a:	97ce                	add	a5,a5,s3
 a4c:	4388                	lw	a0,0(a5)
 a4e:	00000097          	auipc	ra,0x0
 a52:	962080e7          	jalr	-1694(ra) # 3b0 <peterson_release>
 a56:	04054763          	bltz	a0,aa4 <tournament_release+0xc0>
    for(int lvl = 0 ; lvl < num_levels  ; lvl++){
 a5a:	0014871b          	addiw	a4,s1,1
 a5e:	0007049b          	sext.w	s1,a4
 a62:	000a2783          	lw	a5,0(s4)
 a66:	02f4d763          	bge	s1,a5,a94 <tournament_release+0xb0>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a6a:	40e7873b          	subw	a4,a5,a4
 a6e:	fff7079b          	addiw	a5,a4,-1
 a72:	000b2683          	lw	a3,0(s6)
 a76:	00f915bb          	sllw	a1,s2,a5
 a7a:	8df5                	and	a1,a1,a3
 a7c:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a80:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a84:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 a88:	9fb9                	addw	a5,a5,a4
 a8a:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a8c:	fafadee3          	bge	s5,a5,a48 <tournament_release+0x64>
 a90:	557d                	li	a0,-1
 a92:	a811                	j	aa6 <tournament_release+0xc2>
        return -1; 

    }
return 0 ;
 a94:	4501                	li	a0,0
 a96:	a801                	j	aa6 <tournament_release+0xc2>
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a98:	557d                	li	a0,-1
 a9a:	8082                	ret
 a9c:	557d                	li	a0,-1
