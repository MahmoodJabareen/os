...
int peterson_create(void) {
    ...
    80006204:	463d                	li	a2,15
        if (__sync_lock_test_and_set(&petersonlocks[i].used, 1) == 0) {
    80006206:	8736                	mv	a4,a3
    80006208:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)
    8000620c:	2701                	sext.w	a4,a4
    8000620e:	cb09                	beqz	a4,80006220 <peterson_create+0x2e>
    for (int i = 0 ; i < NPETERSONLOCKS ; i++) {
    80006210:	2505                	addiw	a0,a0,1
    80006212:	07e1                	addi	a5,a5,24
    80006214:	fec519e3          	bne	a0,a2,80006206 <peterson_create+0x14>
    ...
    8000621e:	8082                	ret
            petersonlocks[i].flag[0] = 0 ;
    80006220:	00151793          	slli	a5,a0,0x1
    80006224:	97aa                	add	a5,a5,a0
    80006226:	00379713          	slli	a4,a5,0x3
    8000622a:	0001c797          	auipc	a5,0x1c
    8000622e:	b5678793          	addi	a5,a5,-1194 # 80021d80 <petersonlocks>
    80006232:	97ba                	add	a5,a5,a4
    80006234:	0007a023          	sw	zero,0(a5)
            petersonlocks[i].flag[1] = 0 ; 
    80006238:	0007a223          	sw	zero,4(a5)
            petersonlocks[i].turn = -1;
    8000623c:	577d                	li	a4,-1
    8000623e:	c798                	sw	a4,8(a5)
            petersonlocks[i].pid[0] = -1 ;
    80006240:	cb98                	sw	a4,16(a5)
            petersonlocks[i].pid[1] = -1 ;
    80006242:	cbd8                	sw	a4,20(a5)
            __sync_synchronize() ; //ensures that the operations above are not interrupted 
    80006244:	0ff0000f          	fence
            return i ; // return the lockid if found 
    80006248:	bfc9                	j	8000621a <peterson_create+0x28>

000000008000624a <peterson_acquire>:
int peterson_acquire(int lock_id , int role) {
   

    if(lock_id >= NPETERSONLOCKS || lock_id < 0 || (role !=0 && role !=1) ) 
    8000624a:	47b9                	li	a5,14
    8000624c:	0ea7e663          	bltu	a5,a0,80006338 <peterson_acquire+0xee>
int peterson_acquire(int lock_id , int role) {
    80006250:	7179                	addi	sp,sp,-48
    80006252:	f406                	sd	ra,40(sp)
    80006254:	f022                	sd	s0,32(sp)
    80006256:	ec26                	sd	s1,24(sp)
    80006258:	e84a                	sd	s2,16(sp)
    8000625a:	e44e                	sd	s3,8(sp)
    8000625c:	e052                	sd	s4,0(sp)
    8000625e:	1800                	addi	s0,sp,48
    80006260:	84ae                	mv	s1,a1
    80006262:	892a                	mv	s2,a0
    if(lock_id >= NPETERSONLOCKS || lock_id < 0 || (role !=0 && role !=1) ) 
    80006264:	0005879b          	sext.w	a5,a1
    80006268:	4705                	li	a4,1
    8000626a:	0cf76963          	bltu	a4,a5,8000633c <peterson_acquire+0xf2>
    ...
    80006272:	746080e7          	jalr	1862(ra) # 800019b4 <myproc>

    // if(plock->pid[role] != p->pid)
    //     return -1 ;
    if (plock->pid[role] == -1) {
    80006276:	00191793          	slli	a5,s2,0x1
    8000627a:	97ca                	add	a5,a5,s2
    8000627c:	0786                	slli	a5,a5,0x1
    8000627e:	97a6                	add	a5,a5,s1
    80006280:	0791                	addi	a5,a5,4
    80006282:	078a                	slli	a5,a5,0x2
    80006284:	0001c717          	auipc	a4,0x1c
    80006288:	afc70713          	addi	a4,a4,-1284 # 80021d80 <petersonlocks>
    8000628c:	97ba                	add	a5,a5,a4
    8000628e:	439c                	lw	a5,0(a5)
    80006290:	577d                	li	a4,-1
    80006292:	06e78b63          	beq	a5,a4,80006308 <peterson_acquire+0xbe>
        plock->pid[role] = p->pid;
    } else if (plock->pid[role] != p->pid) {
    80006296:	5918                	lw	a4,48(a0)
    80006298:	0af71463          	bne	a4,a5,80006340 <peterson_acquire+0xf6>
        return -1;
    }
    
    int other = 1 - role ;
    8000629c:	4605                	li	a2,1
    8000629e:	9e05                	subw	a2,a2,s1
    800062a0:	0006099b          	sext.w	s3,a2

    plock->flag[role] = 1 ; // the process is interested 
    800062a4:	0001c697          	auipc	a3,0x1c
    800062a8:	adc68693          	addi	a3,a3,-1316 # 80021d80 <petersonlocks>
    800062ac:	00191793          	slli	a5,s2,0x1
    800062b0:	01278733          	add	a4,a5,s2
    800062b4:	0706                	slli	a4,a4,0x1
    800062b6:	9726                	add	a4,a4,s1
    800062b8:	070a                	slli	a4,a4,0x2
    800062ba:	9736                	add	a4,a4,a3
    800062bc:	4585                	li	a1,1
    800062be:	c30c                	sw	a1,0(a4)
    __sync_synchronize() ;
    800062c0:	0ff0000f          	fence

    plock->turn = other ;
    800062c4:	01278733          	add	a4,a5,s2
    800062c8:	070e                	slli	a4,a4,0x3
    800062ca:	9736                	add	a4,a4,a3
    800062cc:	c710                	sw	a2,8(a4)
    __sync_synchronize() ; 
    ...
    800062d6:	97ce                	add	a5,a5,s3
    800062d8:	078a                	slli	a5,a5,0x2
    800062da:	97b6                	add	a5,a5,a3
    800062dc:	4388                	lw	a0,0(a5)
    800062de:	c529                	beqz	a0,80006328 <peterson_acquire+0xde>
    800062e0:	00191793          	slli	a5,s2,0x1
    800062e4:	993e                	add	s2,s2,a5
    800062e6:	8a3a                	mv	s4,a4
    800062e8:	0906                	slli	s2,s2,0x1
    800062ea:	994e                	add	s2,s2,s3
    800062ec:	090a                	slli	s2,s2,0x2
    800062ee:	012684b3          	add	s1,a3,s2
    800062f2:	008a2783          	lw	a5,8(s4)
    800062f6:	03379863          	bne	a5,s3,80006326 <peterson_acquire+0xdc>
        yield();
    800062fa:	ffffc097          	auipc	ra,0xffffc
    800062fe:	d26080e7          	jalr	-730(ra) # 80002020 <yield>
    while(plock->flag[other] && plock->turn == other){
    80006302:	4088                	lw	a0,0(s1)
    80006304:	f57d                	bnez	a0,800062f2 <peterson_acquire+0xa8>
    80006306:	a00d                	j	80006328 <peterson_acquire+0xde>
        plock->pid[role] = p->pid;
    80006308:	5914                	lw	a3,48(a0)
    8000630a:	00191793          	slli	a5,s2,0x1
    8000630e:	97ca                	add	a5,a5,s2
    80006310:	0786                	slli	a5,a5,0x1
    80006312:	97a6                	add	a5,a5,s1
    80006314:	0791                	addi	a5,a5,4
    80006316:	078a                	slli	a5,a5,0x2
    80006318:	0001c717          	auipc	a4,0x1c
    8000631c:	a6870713          	addi	a4,a4,-1432 # 80021d80 <petersonlocks>
    80006320:	97ba                	add	a5,a5,a4
    80006322:	c394                	sw	a3,0(a5)
    80006324:	bfa5                	j	8000629c <peterson_acquire+0x52>
    }
    return 0 ; 
    80006326:	4501                	li	a0,0
}
    80006328:	70a2                	ld	ra,40(sp)
    8000632a:	7402                	ld	s0,32(sp)
    8000632c:	64e2                	ld	s1,24(sp)
    8000632e:	6942                	ld	s2,16(sp)
    80006330:	69a2                	ld	s3,8(sp)
    80006332:	6a02                	ld	s4,0(sp)
    80006334:	6145                	addi	sp,sp,48
    80006336:	8082                	ret
        return -1 ;  //invalid lockid or role
    ...
    8000633e:	b7ed                	j	80006328 <peterson_acquire+0xde>
        return -1;
    80006340:	557d                	li	a0,-1
    80006342:	b7dd                	j	80006328 <peterson_acquire+0xde>

0000000080006344 <peterson_release>:

int peterson_release(int lock_id , int role){
    

    if(lock_id >= NPETERSONLOCKS || lock_id < 0 || (role !=0 && role !=1) ) 
    80006344:	47b9                	li	a5,14
    80006346:	08a7e263          	bltu	a5,a0,800063ca <peterson_release+0x86>
int peterson_release(int lock_id , int role){
    ...
    80006356:	84ae                	mv	s1,a1
    80006358:	892a                	mv	s2,a0
    if(lock_id >= NPETERSONLOCKS || lock_id < 0 || (role !=0 && role !=1) ) 
    8000635a:	0005879b          	sext.w	a5,a1
    8000635e:	4705                	li	a4,1
    80006360:	06f76763          	bltu	a4,a5,800063ce <peterson_release+0x8a>
        return -1 ;  //invalid lockid or role
    ...
    80006368:	650080e7          	jalr	1616(ra) # 800019b4 <myproc>
    ...
    80006372:	0786                	slli	a5,a5,0x1
    80006374:	97a6                	add	a5,a5,s1
    80006376:	0791                	addi	a5,a5,4
    80006378:	078a                	slli	a5,a5,0x2
    8000637a:	0001c717          	auipc	a4,0x1c
    8000637e:	a0670713          	addi	a4,a4,-1530 # 80021d80 <petersonlocks>
    80006382:	97ba                	add	a5,a5,a4
    80006384:	4398                	lw	a4,0(a5)
    80006386:	591c                	lw	a5,48(a0)
    80006388:	04f71563          	bne	a4,a5,800063d2 <peterson_release+0x8e>
    8000638c:	00191793          	slli	a5,s2,0x1
    80006390:	97ca                	add	a5,a5,s2
    80006392:	0786                	slli	a5,a5,0x1
    80006394:	97a6                	add	a5,a5,s1
    80006396:	078a                	slli	a5,a5,0x2
    80006398:	0001c717          	auipc	a4,0x1c
    8000639c:	9e870713          	addi	a4,a4,-1560 # 80021d80 <petersonlocks>
    800063a0:	97ba                	add	a5,a5,a4
    800063a2:	439c                	lw	a5,0(a5)
    800063a4:	cb8d                	beqz	a5,800063d6 <peterson_release+0x92>
        return -1 ;


    __sync_lock_release(&plock->flag[role]) ; // atomically set the flag to 0
    800063a6:	00191793          	slli	a5,s2,0x1
    800063aa:	993e                	add	s2,s2,a5
    800063ac:	0906                	slli	s2,s2,0x1
    800063ae:	94ca                	add	s1,s1,s2
    800063b0:	048a                	slli	s1,s1,0x2
    800063b2:	94ba                	add	s1,s1,a4
    ...
    800063d0:	b7fd                	j	800063be <peterson_release+0x7a>
        return -1 ;
    800063d2:	557d                	li	a0,-1
    800063d4:	b7ed                	j	800063be <peterson_release+0x7a>
    800063d6:	557d                	li	a0,-1
    800063d8:	b7dd                	j	800063be <peterson_release+0x7a>

00000000800063da <peterson_destroy>:
int peterson_destroy(int lock_id){
    ...
    800063e0:	47b9                	li	a5,14
    800063e2:	02a7e463          	bltu	a5,a0,8000640a <peterson_destroy+0x30>
        return -1 ;  //invalid lockid or role
    
    struct petersonlock* plock = &petersonlocks[lock_id] ;
    
    __sync_lock_release(&plock->used) ;
    800063e6:	00151793          	slli	a5,a0,0x1
    800063ea:	97aa                	add	a5,a5,a0
    800063ec:	078e                	slli	a5,a5,0x3
    800063ee:	0001c717          	auipc	a4,0x1c
    800063f2:	99270713          	addi	a4,a4,-1646 # 80021d80 <petersonlocks>
    800063f6:	97ba                	add	a5,a5,a4
    800063f8:	07b1                	addi	a5,a5,12
    800063fa:	0f50000f          	fence	iorw,ow
    800063fe:	0807a02f          	amoswap.w	zero,zero,(a5)
    return 0 ;
    ...
    8000640c:	bfe5                	j	80006404 <peterson_destroy+0x2a>

000000008000640e <sys_peterson_create>:
#include "spinlock.h"
#include "proc.h"
...
uint64 sys_peterson_create(void){
   ...
   return  peterson_create() ;
    ...
    8000641a:	ddc080e7          	jalr	-548(ra) # 800061f2 <peterson_create>
}
...
0000000080006426 <sys_peterson_acquire>:
uint64 sys_peterson_acquire(void){
    ...
    int lock_id ,  role ; 
    argint(0 , &lock_id) ;
    8000642e:	fec40593          	addi	a1,s0,-20
    80006432:	4501                	li	a0,0
    80006434:	ffffc097          	auipc	ra,0xffffc
    80006438:	694080e7          	jalr	1684(ra) # 80002ac8 <argint>
    argint(1 , &role) ;
    8000643c:	fe840593          	addi	a1,s0,-24
    80006440:	4505                	li	a0,1
    80006442:	ffffc097          	auipc	ra,0xffffc
    80006446:	686080e7          	jalr	1670(ra) # 80002ac8 <argint>

    return peterson_acquire(lock_id , role) ;
    8000644a:	fe842583          	lw	a1,-24(s0)
    8000644e:	fec42503          	lw	a0,-20(s0)
    80006452:	00000097          	auipc	ra,0x0
    80006456:	df8080e7          	jalr	-520(ra) # 8000624a <peterson_acquire>
}
...
0000000080006462 <sys_peterson_release>:
uint64 sys_peterson_release(void){
    ...
    int lock_id ,  role ; 
    argint(0 , &lock_id) ;
    8000646a:	fec40593          	addi	a1,s0,-20
    8000646e:	4501                	li	a0,0
    80006470:	ffffc097          	auipc	ra,0xffffc
    80006474:	658080e7          	jalr	1624(ra) # 80002ac8 <argint>
    argint(1 , &role) ;
    80006478:	fe840593          	addi	a1,s0,-24
    8000647c:	4505                	li	a0,1
    8000647e:	ffffc097          	auipc	ra,0xffffc
    80006482:	64a080e7          	jalr	1610(ra) # 80002ac8 <argint>

    return peterson_release(lock_id , role) ;
    80006486:	fe842583          	lw	a1,-24(s0)
    8000648a:	fec42503          	lw	a0,-20(s0)
    8000648e:	00000097          	auipc	ra,0x0
    80006492:	eb6080e7          	jalr	-330(ra) # 80006344 <peterson_release>
}
    80006496:	60e2                	ld	ra,24(sp)
    80006498:	6442                	ld	s0,16(sp)
    8000649a:	6105                	addi	sp,sp,32
    8000649c:	8082                	ret

000000008000649e <sys_peterson_destroy>:
uint64 sys_peterson_destroy(void){
    ...
    int lock_id  ; 
    argint(0 , &lock_id) ;
    800064a6:	fec40593          	addi	a1,s0,-20
    800064aa:	4501                	li	a0,0
    800064ac:	ffffc097          	auipc	ra,0xffffc
    800064b0:	61c080e7          	jalr	1564(ra) # 80002ac8 <argint>
    return peterson_destroy(lock_id) ;
    800064b4:	fec42503          	lw	a0,-20(s0)
    800064b8:	00000097          	auipc	ra,0x0
    800064bc:	f22080e7          	jalr	-222(ra) # 800063da <peterson_destroy>
}
