...
cat(int fd)
{
  ...
  44:	95058593          	addi	a1,a1,-1712 # 990 <tournament_release+0x1c>
  48:	4509                	li	a0,2
  ...
  72:	93a58593          	addi	a1,a1,-1734 # 9a8 <tournament_release+0x34>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	8be58593          	addi	a1,a1,-1858 # 9c0 <tournament_release+0x4c>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ae:	53650513          	addi	a0,a0,1334 # 9e0 <digits>
 4b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 57a:	46ab8b93          	addi	s7,s7,1130 # 9e0 <digits>
 ...
 6ba:	32290913          	addi	s2,s2,802 # 9d8 <tournament_release+0x64>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 858:	9dc78793          	addi	a5,a5,-1572 # 1230 <base>
...
static int is_power_of_two(int x) {
 ...
 8e4:	47bd                	li	a5,15
 8e6:	00e7eb63          	bltu	a5,a4,8fc <tournament_create+0x1c>
 8ea:	fff5079b          	addiw	a5,a0,-1
 8ee:	8fe9                	and	a5,a5,a0
 8f0:	2781                	sext.w	a5,a5
 8f2:	c799                	beqz	a5,900 <tournament_create+0x20>
}
 ...
 8f6:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 8f8:	557d                	li	a0,-1
 8fa:	a095                	j	95e <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 8fc:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 90c:	70a7ac23          	sw	a0,1816(a5) # 1020 <num_processes>
   while(temp >>=1)
 910:	4015551b          	sraiw	a0,a0,0x1
 914:	c105                	beqz	a0,934 <tournament_create+0x54>
 916:	00000797          	auipc	a5,0x0
 91a:	70e7a783          	lw	a5,1806(a5) # 1024 <num_levels>
 ...
 92a:	f97d                	bnez	a0,920 <tournament_create+0x40>
 92c:	00000797          	auipc	a5,0x0
 930:	6ee7ac23          	sw	a4,1784(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 934:	00000797          	auipc	a5,0x0
 938:	6f07a783          	lw	a5,1776(a5) # 1024 <num_levels>
 93c:	4505                	li	a0,1
 93e:	00f5153b          	sllw	a0,a0,a5
 942:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 944:	0025151b          	slliw	a0,a0,0x2
 948:	00000097          	auipc	ra,0x0
 94c:	eb4080e7          	jalr	-332(ra) # 7fc <malloc>
 950:	87aa                	mv	a5,a0
 952:	00000717          	auipc	a4,0x0
 956:	6ca73323          	sd	a0,1734(a4) # 1018 <lock_ids>
    return 1 ;    
 95a:	4505                	li	a0,1
    if (!lock_ids)
 95c:	dfd1                	beqz	a5,8f8 <tournament_create+0x18>
}
 95e:	60a2                	ld	ra,8(sp)
 960:	6402                	ld	s0,0(sp)
...
0000000000000966 <tournament_acquire>:
...
0000000000000974 <tournament_release>:
