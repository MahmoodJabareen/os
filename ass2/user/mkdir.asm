...
int tournament_create(int processes) {
 ...
 84a:	fff5071b          	addiw	a4,a0,-1
 84e:	47bd                	li	a5,15
 850:	00e7ee63          	bltu	a5,a4,86c <tournament_create+0x32>
 854:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 856:	8a3a                	mv	s4,a4
 858:	00e574b3          	and	s1,a0,a4
 85c:	c0b9                	beqz	s1,8a2 <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 85e:	54fd                	li	s1,-1
 860:	a809                	j	872 <tournament_create+0x38>
 ...
 866:	7a97a323          	sw	s1,1958(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 86a:	a021                	j	872 <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 86c:	54fd                	li	s1,-1
 86e:	a011                	j	872 <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 882:	8082                	ret
            return -1 ;
 884:	54fd                	li	s1,-1
 886:	b7f5                	j	872 <tournament_create+0x38>
   num_levels = log2(processes) ;
 888:	00000797          	auipc	a5,0x0
 88c:	7807a423          	sw	zero,1928(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 890:	00000797          	auipc	a5,0x0
 894:	7607ac23          	sw	zero,1912(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 898:	00000497          	auipc	s1,0x0
 89c:	7704a483          	lw	s1,1904(s1) # 1008 <trnmnt_idx>
 8a0:	bfc9                	j	872 <tournament_create+0x38>
   num_processes = processes ;
 8a2:	00000797          	auipc	a5,0x0
 8a6:	76a7a523          	sw	a0,1898(a5) # 100c <num_processes>
  if (n <= 1) 
 8aa:	4785                	li	a5,1
 8ac:	fca7dee3          	bge	a5,a0,888 <tournament_create+0x4e>
  int l = 0;
 8b0:	8726                	mv	a4,s1
 8b2:	87aa                	mv	a5,a0
  while (n > 1) {
 8b4:	458d                	li	a1,3
    n /= 2;
 8b6:	86be                	mv	a3,a5
 8b8:	01f7d61b          	srliw	a2,a5,0x1f
 8bc:	9fb1                	addw	a5,a5,a2
 8be:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 8c2:	2705                	addiw	a4,a4,1
  while (n > 1) {
 8c4:	fed5c9e3          	blt	a1,a3,8b6 <tournament_create+0x7c>
   num_levels = log2(processes) ;
 8c8:	00000797          	auipc	a5,0x0
 8cc:	74e7a423          	sw	a4,1864(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 8d0:	00000917          	auipc	s2,0x0
 8d4:	76090913          	addi	s2,s2,1888 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 8d8:	00000097          	auipc	ra,0x0
 8dc:	ac8080e7          	jalr	-1336(ra) # 3a0 <peterson_create>
 8e0:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 8e4:	f80546e3          	bltz	a0,870 <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 8e8:	2485                	addiw	s1,s1,1
 8ea:	0911                	addi	s2,s2,4
 8ec:	ff44c6e3          	blt	s1,s4,8d8 <tournament_create+0x9e>
   trnmnt_idx = 0;
 8f0:	00000797          	auipc	a5,0x0
 8f4:	7007ac23          	sw	zero,1816(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 8f8:	4785                	li	a5,1
 8fa:	f937dfe3          	bge	a5,s3,898 <tournament_create+0x5e>
 8fe:	4485                	li	s1,1
        int pid = fork() ;
 900:	00000097          	auipc	ra,0x0
 904:	9f8080e7          	jalr	-1544(ra) # 2f8 <fork>
        if(pid < 0)
 908:	f6054ee3          	bltz	a0,884 <tournament_create+0x4a>
        if(pid == 0){
 90c:	d939                	beqz	a0,862 <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 90e:	2485                	addiw	s1,s1,1
 910:	fe9998e3          	bne	s3,s1,900 <tournament_create+0xc6>
 914:	b751                	j	898 <tournament_create+0x5e>
...
int tournament_acquire(void){ 
 ...
 91e:	0a07cd63          	bltz	a5,9d8 <tournament_acquire+0xc2>
 922:	00000717          	auipc	a4,0x0
 926:	6ee72703          	lw	a4,1774(a4) # 1010 <num_levels>
 92a:	0ae05963          	blez	a4,9dc <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 92e:	fff7069b          	addiw	a3,a4,-1
 932:	4585                	li	a1,1
 934:	00d595bb          	sllw	a1,a1,a3
 938:	8dfd                	and	a1,a1,a5
 93a:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 93e:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 942:	4739                	li	a4,14
 944:	08f74e63          	blt	a4,a5,9e0 <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 962:	6d2a0a13          	addi	s4,s4,1746 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 966:	00000997          	auipc	s3,0x0
 96a:	6aa98993          	addi	s3,s3,1706 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 96e:	00000b17          	auipc	s6,0x0
 972:	69ab0b13          	addi	s6,s6,1690 # 1008 <trnmnt_idx>
 976:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 978:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 97a:	078a                	slli	a5,a5,0x2
 97c:	97d2                	add	a5,a5,s4
 97e:	4388                	lw	a0,0(a5)
 980:	00000097          	auipc	ra,0x0
 984:	a28080e7          	jalr	-1496(ra) # 3a8 <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 988:	0014871b          	addiw	a4,s1,1
 98c:	0007049b          	sext.w	s1,a4
 990:	0009a783          	lw	a5,0(s3)
 994:	02f4d763          	bge	s1,a5,9c2 <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 998:	40e7873b          	subw	a4,a5,a4
 99c:	fff7079b          	addiw	a5,a4,-1
 9a0:	000b2683          	lw	a3,0(s6)
 9a4:	00f915bb          	sllw	a1,s2,a5
 9a8:	8df5                	and	a1,a1,a3
 9aa:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 9ae:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9b2:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 9b6:	9fb9                	addw	a5,a5,a4
 9b8:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9ba:	fcfad0e3          	bge	s5,a5,97a <tournament_acquire+0x64>
 9be:	557d                	li	a0,-1
 9c0:	a011                	j	9c4 <tournament_acquire+0xae>
...
int tournament_release(void) {
 ...
 9ec:	0a07cf63          	bltz	a5,aaa <tournament_release+0xc6>
int tournament_release(void) {
 ...
 a0a:	60a4a483          	lw	s1,1546(s1) # 1010 <num_levels>
 a0e:	0a905063          	blez	s1,aae <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a12:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a14:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a18:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 a1c:	4705                	li	a4,1
 a1e:	0097173b          	sllw	a4,a4,s1
 a22:	9fb9                	addw	a5,a5,a4
 a24:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a26:	4739                	li	a4,14
 a28:	08f74563          	blt	a4,a5,ab2 <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 a2c:	00000a17          	auipc	s4,0x0
 a30:	604a0a13          	addi	s4,s4,1540 # 1030 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a34:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a36:	00000b97          	auipc	s7,0x0
 a3a:	5dab8b93          	addi	s7,s7,1498 # 1010 <num_levels>
 a3e:	00000b17          	auipc	s6,0x0
 a42:	5cab0b13          	addi	s6,s6,1482 # 1008 <trnmnt_idx>
 a46:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a48:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 a4a:	078a                	slli	a5,a5,0x2
 a4c:	97d2                	add	a5,a5,s4
 a4e:	4388                	lw	a0,0(a5)
 a50:	00000097          	auipc	ra,0x0
 a54:	960080e7          	jalr	-1696(ra) # 3b0 <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a58:	fff4869b          	addiw	a3,s1,-1
 a5c:	0006849b          	sext.w	s1,a3
 a60:	03348963          	beq	s1,s3,a92 <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a64:	000ba703          	lw	a4,0(s7)
 a68:	40d706bb          	subw	a3,a4,a3
 a6c:	fff6879b          	addiw	a5,a3,-1
 a70:	000b2703          	lw	a4,0(s6)
 a74:	00f915bb          	sllw	a1,s2,a5
 a78:	8df9                	and	a1,a1,a4
 a7a:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a7e:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a82:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a86:	9fb9                	addw	a5,a5,a4
 a88:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a8a:	fcfad0e3          	bge	s5,a5,a4a <tournament_release+0x66>
 a8e:	557d                	li	a0,-1
 a90:	a011                	j	a94 <tournament_release+0xb0>
...
return 0 ;
 ...
 aac:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 aae:	557d                	li	a0,-1
 ab0:	b7d5                	j	a94 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 ab2:	557d                	li	a0,-1
 ab4:	b7c5                	j	a94 <tournament_release+0xb0>
