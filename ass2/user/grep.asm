...
00000000000001de <main>:
{
 ...
 252:	8c258593          	addi	a1,a1,-1854 # b10 <tournament_release+0x1c>
 256:	4509                	li	a0,2
 ...
 288:	8ac50513          	addi	a0,a0,-1876 # b30 <tournament_release+0x3c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 62e:	52650513          	addi	a0,a0,1318 # b50 <digits>
 632:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fa:	45ab8b93          	addi	s7,s7,1114 # b50 <digits>
 ...
 83a:	31290913          	addi	s2,s2,786 # b48 <tournament_release+0x54>
        while(*s != 0){
 ...
 930:	00e6ea63          	bltu	a3,a4,944 <free+0x50>
{
 ...
 972:	6af73123          	sd	a5,1698(a4) # 1010 <freep>
}
 976:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9cc:	64890913          	addi	s2,s2,1608 # 1010 <freep>
  if(p == (char*)-1)
 9d0:	5afd                	li	s5,-1
 9d2:	a88d                	j	a44 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9d4:	00001797          	auipc	a5,0x1
 9d8:	a5c78793          	addi	a5,a5,-1444 # 1430 <base>
 9dc:	00000717          	auipc	a4,0x0
 9e0:	62f73a23          	sd	a5,1588(a4) # 1010 <freep>
 9e4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a06:	60a73723          	sd	a0,1550(a4) # 1010 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 a64:	47bd                	li	a5,15
 a66:	00e7eb63          	bltu	a5,a4,a7c <tournament_create+0x1c>
 a6a:	fff5079b          	addiw	a5,a0,-1
 a6e:	8fe9                	and	a5,a5,a0
 a70:	2781                	sext.w	a5,a5
 a72:	c799                	beqz	a5,a80 <tournament_create+0x20>
}
 ...
 a76:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 a78:	557d                	li	a0,-1
 a7a:	a095                	j	ade <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 a7c:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 a8c:	58a7ac23          	sw	a0,1432(a5) # 1020 <num_processes>
   while(temp >>=1)
 a90:	4015551b          	sraiw	a0,a0,0x1
 a94:	c105                	beqz	a0,ab4 <tournament_create+0x54>
 a96:	00000797          	auipc	a5,0x0
 a9a:	58e7a783          	lw	a5,1422(a5) # 1024 <num_levels>
 a9e:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 aa0:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 aa4:	4015551b          	sraiw	a0,a0,0x1
 aa8:	2785                	addiw	a5,a5,1
 aaa:	f97d                	bnez	a0,aa0 <tournament_create+0x40>
 aac:	00000797          	auipc	a5,0x0
 ab0:	56e7ac23          	sw	a4,1400(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 ab4:	00000797          	auipc	a5,0x0
 ab8:	5707a783          	lw	a5,1392(a5) # 1024 <num_levels>
 abc:	4505                	li	a0,1
 abe:	00f5153b          	sllw	a0,a0,a5
 ac2:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 ac4:	0025151b          	slliw	a0,a0,0x2
 ac8:	00000097          	auipc	ra,0x0
 acc:	eb4080e7          	jalr	-332(ra) # 97c <malloc>
 ad0:	87aa                	mv	a5,a0
 ad2:	00000717          	auipc	a4,0x0
 ad6:	54a73323          	sd	a0,1350(a4) # 1018 <lock_ids>
    return 1 ;    
 ada:	4505                	li	a0,1
    if (!lock_ids)
 adc:	dfd1                	beqz	a5,a78 <tournament_create+0x18>
}
 ade:	60a2                	ld	ra,8(sp)
 ae0:	6402                	ld	s0,0(sp)
...
0000000000000ae6 <tournament_acquire>:
...
0000000000000af4 <tournament_release>:
