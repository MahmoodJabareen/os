...
wc(int fd, char *name)
{
  ...
  3c:	9c8a0a13          	addi	s4,s4,-1592 # a00 <tournament_release+0x14>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	96250513          	addi	a0,a0,-1694 # a18 <tournament_release+0x2c>
  ...
  e8:	92450513          	addi	a0,a0,-1756 # a08 <tournament_release+0x1c>
...
main(int argc, char *argv[])
{
 ...
 162:	8ca58593          	addi	a1,a1,-1846 # a28 <tournament_release+0x3c>
 166:	4501                	li	a0,0
 ...
 180:	8b450513          	addi	a0,a0,-1868 # a30 <tournament_release+0x44>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 526:	52e50513          	addi	a0,a0,1326 # a50 <digits>
 52a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f2:	462b8b93          	addi	s7,s7,1122 # a50 <digits>
 ...
 732:	31a90913          	addi	s2,s2,794 # a48 <tournament_release+0x5c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8d0:	96478793          	addi	a5,a5,-1692 # 1230 <base>
 ...
 8fe:	70a73b23          	sd	a0,1814(a4) # 1010 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 95c:	47bd                	li	a5,15
 95e:	00e7eb63          	bltu	a5,a4,974 <tournament_create+0x1c>
 962:	fff5079b          	addiw	a5,a0,-1
 966:	8fe9                	and	a5,a5,a0
 968:	2781                	sext.w	a5,a5
 96a:	c799                	beqz	a5,978 <tournament_create+0x20>
}
 ...
 96e:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 970:	557d                	li	a0,-1
 972:	a095                	j	9d6 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 974:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 984:	6aa7a023          	sw	a0,1696(a5) # 1020 <num_processes>
   while(temp >>=1)
 988:	4015551b          	sraiw	a0,a0,0x1
 98c:	c105                	beqz	a0,9ac <tournament_create+0x54>
 98e:	00000797          	auipc	a5,0x0
 992:	6967a783          	lw	a5,1686(a5) # 1024 <num_levels>
 996:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 998:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 99c:	4015551b          	sraiw	a0,a0,0x1
 9a0:	2785                	addiw	a5,a5,1
 9a2:	f97d                	bnez	a0,998 <tournament_create+0x40>
 9a4:	00000797          	auipc	a5,0x0
 9a8:	68e7a023          	sw	a4,1664(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 9ac:	00000797          	auipc	a5,0x0
 9b0:	6787a783          	lw	a5,1656(a5) # 1024 <num_levels>
 9b4:	4505                	li	a0,1
 9b6:	00f5153b          	sllw	a0,a0,a5
 9ba:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 9bc:	0025151b          	slliw	a0,a0,0x2
 9c0:	00000097          	auipc	ra,0x0
 9c4:	eb4080e7          	jalr	-332(ra) # 874 <malloc>
 9c8:	87aa                	mv	a5,a0
 9ca:	00000717          	auipc	a4,0x0
 9ce:	64a73723          	sd	a0,1614(a4) # 1018 <lock_ids>
    return 1 ;    
 9d2:	4505                	li	a0,1
    if (!lock_ids)
 9d4:	dfd1                	beqz	a5,970 <tournament_create+0x18>
}
 9d6:	60a2                	ld	ra,8(sp)
 9d8:	6402                	ld	s0,0(sp)
...
00000000000009de <tournament_acquire>:
...
00000000000009ec <tournament_release>:
