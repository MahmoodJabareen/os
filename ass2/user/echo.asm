...
int tournament_create(int processes) {
 ...
 856:	fff5071b          	addiw	a4,a0,-1
 85a:	47bd                	li	a5,15
 85c:	00e7ee63          	bltu	a5,a4,878 <tournament_create+0x32>
 860:	89aa                	mv	s3,a0
    return x > 0 && (x & (x - 1)) == 0;
 862:	8a3a                	mv	s4,a4
 864:	00e574b3          	and	s1,a0,a4
 868:	c0b9                	beqz	s1,8ae <tournament_create+0x68>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 86a:	54fd                	li	s1,-1
 86c:	a809                	j	87e <tournament_create+0x38>
 ...
 872:	7897ad23          	sw	s1,1946(a5) # 1008 <trnmnt_idx>
            return trnmnt_idx ;
 876:	a021                	j	87e <tournament_create+0x38>
   if(  processes <=0 ||processes > MAX_PROCESSES || !is_power_of_two(processes)) return -1 ;
 878:	54fd                	li	s1,-1
 87a:	a011                	j	87e <tournament_create+0x38>
...
return trnmnt_idx ;
 ...
 88e:	8082                	ret
            return -1 ;
 890:	54fd                	li	s1,-1
 892:	b7f5                	j	87e <tournament_create+0x38>
   num_levels = log2(processes) ;
 894:	00000797          	auipc	a5,0x0
 898:	7607ae23          	sw	zero,1916(a5) # 1010 <num_levels>
   trnmnt_idx = 0;
 89c:	00000797          	auipc	a5,0x0
 8a0:	7607a623          	sw	zero,1900(a5) # 1008 <trnmnt_idx>
return trnmnt_idx ;
 8a4:	00000497          	auipc	s1,0x0
 8a8:	7644a483          	lw	s1,1892(s1) # 1008 <trnmnt_idx>
 8ac:	bfc9                	j	87e <tournament_create+0x38>
   num_processes = processes ;
 8ae:	00000797          	auipc	a5,0x0
 8b2:	74a7af23          	sw	a0,1886(a5) # 100c <num_processes>
  if (n <= 1) 
 8b6:	4785                	li	a5,1
 8b8:	fca7dee3          	bge	a5,a0,894 <tournament_create+0x4e>
  int l = 0;
 8bc:	8726                	mv	a4,s1
 8be:	87aa                	mv	a5,a0
  while (n > 1) {
 8c0:	458d                	li	a1,3
    n /= 2;
 8c2:	86be                	mv	a3,a5
 8c4:	01f7d61b          	srliw	a2,a5,0x1f
 8c8:	9fb1                	addw	a5,a5,a2
 8ca:	4017d79b          	sraiw	a5,a5,0x1
    l++;
 8ce:	2705                	addiw	a4,a4,1
  while (n > 1) {
 8d0:	fed5c9e3          	blt	a1,a3,8c2 <tournament_create+0x7c>
   num_levels = log2(processes) ;
 8d4:	00000797          	auipc	a5,0x0
 8d8:	72e7ae23          	sw	a4,1852(a5) # 1010 <num_levels>
   for(int i = 0; i < processes -1 ; i++){
 8dc:	00000917          	auipc	s2,0x0
 8e0:	75490913          	addi	s2,s2,1876 # 1030 <lock_ids>
    lock_ids[i]= peterson_create() ;
 8e4:	00000097          	auipc	ra,0x0
 8e8:	ac8080e7          	jalr	-1336(ra) # 3ac <peterson_create>
 8ec:	00a92023          	sw	a0,0(s2)
    if(lock_ids[i] <0){
 8f0:	f80546e3          	bltz	a0,87c <tournament_create+0x36>
   for(int i = 0; i < processes -1 ; i++){
 8f4:	2485                	addiw	s1,s1,1
 8f6:	0911                	addi	s2,s2,4
 8f8:	ff44c6e3          	blt	s1,s4,8e4 <tournament_create+0x9e>
   trnmnt_idx = 0;
 8fc:	00000797          	auipc	a5,0x0
 900:	7007a623          	sw	zero,1804(a5) # 1008 <trnmnt_idx>
   for(int i = 1; i < processes  ; i++){
 904:	4785                	li	a5,1
 906:	f937dfe3          	bge	a5,s3,8a4 <tournament_create+0x5e>
 90a:	4485                	li	s1,1
        int pid = fork() ;
 90c:	00000097          	auipc	ra,0x0
 910:	9f8080e7          	jalr	-1544(ra) # 304 <fork>
        if(pid < 0)
 914:	f6054ee3          	bltz	a0,890 <tournament_create+0x4a>
        if(pid == 0){
 918:	d939                	beqz	a0,86e <tournament_create+0x28>
   for(int i = 1; i < processes  ; i++){
 91a:	2485                	addiw	s1,s1,1
 91c:	fe9998e3          	bne	s3,s1,90c <tournament_create+0xc6>
 920:	b751                	j	8a4 <tournament_create+0x5e>

0000000000000922 <tournament_acquire>:

int tournament_acquire(void){ 

    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 922:	00000797          	auipc	a5,0x0
 926:	6e67a783          	lw	a5,1766(a5) # 1008 <trnmnt_idx>
 92a:	0a07cd63          	bltz	a5,9e4 <tournament_acquire+0xc2>
 92e:	00000717          	auipc	a4,0x0
 932:	6e272703          	lw	a4,1762(a4) # 1010 <num_levels>
 936:	0ae05963          	blez	a4,9e8 <tournament_acquire+0xc6>

    for(int lvl = 0 ; lvl < num_levels ; lvl++){
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 93a:	fff7069b          	addiw	a3,a4,-1
 93e:	4585                	li	a1,1
 940:	00d595bb          	sllw	a1,a1,a3
 944:	8dfd                	and	a1,a1,a5
 946:	40d5d5bb          	sraw	a1,a1,a3
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 94a:	40e7d7bb          	sraw	a5,a5,a4
        int lockidx = lockl + (1<<lvl) -1 ;
        if(lockidx>=MAX_LOCKS) return -1 ;
 94e:	4739                	li	a4,14
 950:	08f74e63          	blt	a4,a5,9ec <tournament_acquire+0xca>
int tournament_acquire(void){ 
 ...
 96a:	00000a17          	auipc	s4,0x0
 96e:	6c6a0a13          	addi	s4,s4,1734 # 1030 <lock_ids>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 972:	00000997          	auipc	s3,0x0
 976:	69e98993          	addi	s3,s3,1694 # 1010 <num_levels>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 97a:	00000b17          	auipc	s6,0x0
 97e:	68eb0b13          	addi	s6,s6,1678 # 1008 <trnmnt_idx>
 982:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 984:	4ab9                	li	s5,14
        peterson_acquire(lock_ids[lockidx] , role) ;
 986:	078a                	slli	a5,a5,0x2
 988:	97d2                	add	a5,a5,s4
 98a:	4388                	lw	a0,0(a5)
 98c:	00000097          	auipc	ra,0x0
 990:	a28080e7          	jalr	-1496(ra) # 3b4 <peterson_acquire>
    for(int lvl = 0 ; lvl < num_levels ; lvl++){
 994:	0014871b          	addiw	a4,s1,1
 998:	0007049b          	sext.w	s1,a4
 99c:	0009a783          	lw	a5,0(s3)
 9a0:	02f4d763          	bge	s1,a5,9ce <tournament_acquire+0xac>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 9a4:	40e7873b          	subw	a4,a5,a4
 9a8:	fff7079b          	addiw	a5,a4,-1
 9ac:	000b2683          	lw	a3,0(s6)
 9b0:	00f915bb          	sllw	a1,s2,a5
 9b4:	8df5                	and	a1,a1,a3
 9b6:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 9ba:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 9be:	40e6d73b          	sraw	a4,a3,a4
        int lockidx = lockl + (1<<lvl) -1 ;
 9c2:	9fb9                	addw	a5,a5,a4
 9c4:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 9c6:	fcfad0e3          	bge	s5,a5,986 <tournament_acquire+0x64>
 9ca:	557d                	li	a0,-1
 9cc:	a011                	j	9d0 <tournament_acquire+0xae>
...
int tournament_release(void) {
 ...
 9f8:	0a07cf63          	bltz	a5,ab6 <tournament_release+0xc6>
int tournament_release(void) {
 9fc:	715d                	addi	sp,sp,-80
 9fe:	e486                	sd	ra,72(sp)
 a00:	e0a2                	sd	s0,64(sp)
 a02:	fc26                	sd	s1,56(sp)
 a04:	f84a                	sd	s2,48(sp)
 a06:	f44e                	sd	s3,40(sp)
 a08:	f052                	sd	s4,32(sp)
 a0a:	ec56                	sd	s5,24(sp)
 a0c:	e85a                	sd	s6,16(sp)
 a0e:	e45e                	sd	s7,8(sp)
 a10:	0880                	addi	s0,sp,80
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 a12:	00000497          	auipc	s1,0x0
 a16:	5fe4a483          	lw	s1,1534(s1) # 1010 <num_levels>
 a1a:	0a905063          	blez	s1,aba <tournament_release+0xca>

    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a1e:	34fd                	addiw	s1,s1,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a20:	0017f593          	andi	a1,a5,1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a24:	4017d79b          	sraiw	a5,a5,0x1
        int lockidx = lockl + (1<<lvl) -1 ;
 a28:	4705                	li	a4,1
 a2a:	0097173b          	sllw	a4,a4,s1
 a2e:	9fb9                	addw	a5,a5,a4
 a30:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a32:	4739                	li	a4,14
 a34:	08f74563          	blt	a4,a5,abe <tournament_release+0xce>

        peterson_release(lock_ids[lockidx] , role) ;
 a38:	00000a17          	auipc	s4,0x0
 a3c:	5f8a0a13          	addi	s4,s4,1528 # 1030 <lock_ids>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a40:	59fd                	li	s3,-1
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a42:	00000b97          	auipc	s7,0x0
 a46:	5ceb8b93          	addi	s7,s7,1486 # 1010 <num_levels>
 a4a:	00000b17          	auipc	s6,0x0
 a4e:	5beb0b13          	addi	s6,s6,1470 # 1008 <trnmnt_idx>
 a52:	4905                	li	s2,1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a54:	4ab9                	li	s5,14
        peterson_release(lock_ids[lockidx] , role) ;
 a56:	078a                	slli	a5,a5,0x2
 a58:	97d2                	add	a5,a5,s4
 a5a:	4388                	lw	a0,0(a5)
 a5c:	00000097          	auipc	ra,0x0
 a60:	960080e7          	jalr	-1696(ra) # 3bc <peterson_release>
    for(int lvl = num_levels -1 ; lvl >=0  ; lvl--){
 a64:	fff4869b          	addiw	a3,s1,-1
 a68:	0006849b          	sext.w	s1,a3
 a6c:	03348963          	beq	s1,s3,a9e <tournament_release+0xae>
        int role = (trnmnt_idx&(1<<(num_levels-lvl-1)))>>(num_levels-lvl-1) ;
 a70:	000ba703          	lw	a4,0(s7)
 a74:	40d706bb          	subw	a3,a4,a3
 a78:	fff6879b          	addiw	a5,a3,-1
 a7c:	000b2703          	lw	a4,0(s6)
 a80:	00f915bb          	sllw	a1,s2,a5
 a84:	8df9                	and	a1,a1,a4
 a86:	40f5d5bb          	sraw	a1,a1,a5
        int lockidx = lockl + (1<<lvl) -1 ;
 a8a:	009917bb          	sllw	a5,s2,s1
        int lockl = trnmnt_idx>>(num_levels-lvl) ;
 a8e:	40d7573b          	sraw	a4,a4,a3
        int lockidx = lockl + (1<<lvl) -1 ;
 a92:	9fb9                	addw	a5,a5,a4
 a94:	37fd                	addiw	a5,a5,-1
        if(lockidx>=MAX_LOCKS) return -1 ;
 a96:	fcfad0e3          	bge	s5,a5,a56 <tournament_release+0x66>
 a9a:	557d                	li	a0,-1
 a9c:	a011                	j	aa0 <tournament_release+0xb0>
...
return 0 ;
 ...
 ab8:	8082                	ret
    if(trnmnt_idx < 0 || num_levels <=0) return -1;
 aba:	557d                	li	a0,-1
 abc:	b7d5                	j	aa0 <tournament_release+0xb0>
        if(lockidx>=MAX_LOCKS) return -1 ;
 abe:	557d                	li	a0,-1
 ac0:	b7c5                	j	aa0 <tournament_release+0xb0>
