...
main(int argc, char *argv[])
{
  ...
  72:	9b2a8a93          	addi	s5,s5,-1614 # a20 <tournament_release+0x48>
    simple_delay(1); // waste a little time
    printf("<<< [Role %d] end iteration %d\n", role, i);
  76:	00001a17          	auipc	s4,0x1
  7a:	9d2a0a13          	addi	s4,s4,-1582 # a48 <tournament_release+0x70>
  ...
  8a:	96a50513          	addi	a0,a0,-1686 # 9f0 <tournament_release+0x18>
  ...
  a4:	96850513          	addi	a0,a0,-1688 # a08 <tournament_release+0x30>
  ...
  be:	9ae50513          	addi	a0,a0,-1618 # a68 <tournament_release+0x90>
 ...
 144:	94050513          	addi	a0,a0,-1728 # a80 <tournament_release+0xa8>
 ...
 16c:	93850513          	addi	a0,a0,-1736 # aa0 <tournament_release+0xc8>
...
strcpy(char *s, const char *t)
{
 ...
 1ac:	fee78fa3          	sb	a4,-1(a5) # 1fff <base+0xfcf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 512:	5b250513          	addi	a0,a0,1458 # ac0 <digits>
 516:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5de:	4e6b8b93          	addi	s7,s7,1254 # ac0 <digits>
 ...
 71e:	39e90913          	addi	s2,s2,926 # ab8 <tournament_release+0xe0>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8bc:	77878793          	addi	a5,a5,1912 # 1030 <base>
...
static int is_power_of_two(int x) {
 ...
 948:	47bd                	li	a5,15
 94a:	00e7eb63          	bltu	a5,a4,960 <tournament_create+0x1c>
 94e:	fff5079b          	addiw	a5,a0,-1
 952:	8fe9                	and	a5,a5,a0
 954:	2781                	sext.w	a5,a5
 956:	c799                	beqz	a5,964 <tournament_create+0x20>
}
 ...
 95a:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 95c:	557d                	li	a0,-1
 95e:	a095                	j	9c2 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 960:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 970:	6aa7aa23          	sw	a0,1716(a5) # 1020 <num_processes>
   while(temp >>=1)
 974:	4015551b          	sraiw	a0,a0,0x1
 978:	c105                	beqz	a0,998 <tournament_create+0x54>
 97a:	00000797          	auipc	a5,0x0
 97e:	6aa7a783          	lw	a5,1706(a5) # 1024 <num_levels>
 982:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 984:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 988:	4015551b          	sraiw	a0,a0,0x1
 98c:	2785                	addiw	a5,a5,1
 98e:	f97d                	bnez	a0,984 <tournament_create+0x40>
 990:	00000797          	auipc	a5,0x0
 994:	68e7aa23          	sw	a4,1684(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 998:	00000797          	auipc	a5,0x0
 99c:	68c7a783          	lw	a5,1676(a5) # 1024 <num_levels>
 9a0:	4505                	li	a0,1
 9a2:	00f5153b          	sllw	a0,a0,a5
 9a6:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 9a8:	0025151b          	slliw	a0,a0,0x2
 9ac:	00000097          	auipc	ra,0x0
 9b0:	eb4080e7          	jalr	-332(ra) # 860 <malloc>
 9b4:	87aa                	mv	a5,a0
 9b6:	00000717          	auipc	a4,0x0
 9ba:	66a73123          	sd	a0,1634(a4) # 1018 <lock_ids>
    return 1 ;    
 9be:	4505                	li	a0,1
    if (!lock_ids)
 9c0:	dfd1                	beqz	a5,95c <tournament_create+0x18>
}
 9c2:	60a2                	ld	ra,8(sp)
 9c4:	6402                	ld	s0,0(sp)
...
00000000000009ca <tournament_acquire>:
...
00000000000009d8 <tournament_release>:
