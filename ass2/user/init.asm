...
main(void)
{
  ...
  12:	95250513          	addi	a0,a0,-1710 # 960 <tournament_release+0x12>
  ...
  3a:	93290913          	addi	s2,s2,-1742 # 968 <tournament_release+0x1a>
  3e:	854a                	mv	a0,s2
  ...
  6e:	94e50513          	addi	a0,a0,-1714 # 9b8 <tournament_release+0x6a>
  ...
  8c:	8d850513          	addi	a0,a0,-1832 # 960 <tournament_release+0x12>
  90:	00000097          	auipc	ra,0x0
  94:	338080e7          	jalr	824(ra) # 3c8 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	8c650513          	addi	a0,a0,-1850 # 960 <tournament_release+0x12>
  a2:	00000097          	auipc	ra,0x0
  a6:	31e080e7          	jalr	798(ra) # 3c0 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	8d450513          	addi	a0,a0,-1836 # 980 <tournament_release+0x32>
  ...
  d2:	8ca50513          	addi	a0,a0,-1846 # 998 <tournament_release+0x4a>
  d6:	00000097          	auipc	ra,0x0
  da:	2e2080e7          	jalr	738(ra) # 3b8 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	8c250513          	addi	a0,a0,-1854 # 9a0 <tournament_release+0x52>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 554:	490b8b93          	addi	s7,s7,1168 # 9e0 <digits>
 ...
 694:	34890913          	addi	s2,s2,840 # 9d8 <tournament_release+0x8a>
        while(*s != 0){
 ...
 78a:	00e6ea63          	bltu	a3,a4,79e <free+0x50>
{
 ...
 7cc:	84f73c23          	sd	a5,-1960(a4) # 1020 <freep>
}
 7d0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7fe:	82653503          	ld	a0,-2010(a0) # 1020 <freep>
 ...
 826:	7fe90913          	addi	s2,s2,2046 # 1020 <freep>
  if(p == (char*)-1)
 82a:	5afd                	li	s5,-1
 82c:	a88d                	j	89e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 82e:	00001797          	auipc	a5,0x1
 832:	81278793          	addi	a5,a5,-2030 # 1040 <base>
 836:	00000717          	auipc	a4,0x0
 83a:	7ef73523          	sd	a5,2026(a4) # 1020 <freep>
 83e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 860:	7ca73223          	sd	a0,1988(a4) # 1020 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 8be:	47bd                	li	a5,15
 8c0:	00e7eb63          	bltu	a5,a4,8d6 <tournament_create+0x1c>
 8c4:	fff5079b          	addiw	a5,a0,-1
 8c8:	8fe9                	and	a5,a5,a0
 8ca:	2781                	sext.w	a5,a5
 8cc:	c799                	beqz	a5,8da <tournament_create+0x20>
}
 ...
 8d0:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 8d2:	557d                	li	a0,-1
 8d4:	a095                	j	938 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 8d6:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 8e6:	74a7a723          	sw	a0,1870(a5) # 1030 <num_processes>
   while(temp >>=1)
 8ea:	4015551b          	sraiw	a0,a0,0x1
 8ee:	c105                	beqz	a0,90e <tournament_create+0x54>
 8f0:	00000797          	auipc	a5,0x0
 8f4:	7447a783          	lw	a5,1860(a5) # 1034 <num_levels>
 8f8:	2785                	addiw	a5,a5,1
        num_levels ++ ;
 8fa:	0007871b          	sext.w	a4,a5
   while(temp >>=1)
 8fe:	4015551b          	sraiw	a0,a0,0x1
 902:	2785                	addiw	a5,a5,1
 904:	f97d                	bnez	a0,8fa <tournament_create+0x40>
 906:	00000797          	auipc	a5,0x0
 90a:	72e7a723          	sw	a4,1838(a5) # 1034 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 90e:	00000797          	auipc	a5,0x0
 912:	7267a783          	lw	a5,1830(a5) # 1034 <num_levels>
 916:	4505                	li	a0,1
 918:	00f5153b          	sllw	a0,a0,a5
 91c:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 91e:	0025151b          	slliw	a0,a0,0x2
 922:	00000097          	auipc	ra,0x0
 926:	eb4080e7          	jalr	-332(ra) # 7d6 <malloc>
 92a:	87aa                	mv	a5,a0
 92c:	00000717          	auipc	a4,0x0
 930:	6ea73e23          	sd	a0,1788(a4) # 1028 <lock_ids>
    return 1 ;    
 934:	4505                	li	a0,1
    if (!lock_ids)
 936:	dfd1                	beqz	a5,8d2 <tournament_create+0x18>
}
 938:	60a2                	ld	ra,8(sp)
 93a:	6402                	ld	s0,0(sp)
...
0000000000000940 <tournament_acquire>:
...
000000000000094e <tournament_release>:
