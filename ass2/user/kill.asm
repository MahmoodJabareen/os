...
main(int argc, char **argv)
{
  ...
  4c:	88858593          	addi	a1,a1,-1912 # 8d0 <tournament_release+0x16>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	50050513          	addi	a0,a0,1280 # 8f0 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	434b8b93          	addi	s7,s7,1076 # 8f0 <digits>
 ...
 600:	2ec90913          	addi	s2,s2,748 # 8e8 <tournament_release+0x2e>
        while(*s != 0){
 ...
 6f6:	00e6ea63          	bltu	a3,a4,70a <free+0x50>
{
 ...
 738:	8cf73e23          	sd	a5,-1828(a4) # 1010 <freep>
}
 73c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76a:	8aa53503          	ld	a0,-1878(a0) # 1010 <freep>
 ...
 792:	88290913          	addi	s2,s2,-1918 # 1010 <freep>
  if(p == (char*)-1)
 796:	5afd                	li	s5,-1
 798:	a88d                	j	80a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 79a:	00001797          	auipc	a5,0x1
 79e:	89678793          	addi	a5,a5,-1898 # 1030 <base>
 ...
 7cc:	84a73423          	sd	a0,-1976(a4) # 1010 <freep>
      return (void*)(p + 1);
...
static int is_power_of_two(int x) {
 ...
 82a:	47bd                	li	a5,15
 82c:	00e7eb63          	bltu	a5,a4,842 <tournament_create+0x1c>
 830:	fff5079b          	addiw	a5,a0,-1
 834:	8fe9                	and	a5,a5,a0
 836:	2781                	sext.w	a5,a5
 838:	c799                	beqz	a5,846 <tournament_create+0x20>
}
 ...
 83c:	8082                	ret
   ...
   lock_ids = malloc(sizeof(int) * total_locks);
    if (!lock_ids)
        return -1;
 83e:	557d                	li	a0,-1
 840:	a095                	j	8a4 <tournament_create+0x7e>
   if(  processes > MAX_PROCESSES ||!is_power_of_two(processes)) return -1 ;
 842:	557d                	li	a0,-1
...
int tournament_create(int processes) {
 ...
 852:	7ca7a923          	sw	a0,2002(a5) # 1020 <num_processes>
   while(temp >>=1)
 856:	4015551b          	sraiw	a0,a0,0x1
 85a:	c105                	beqz	a0,87a <tournament_create+0x54>
 85c:	00000797          	auipc	a5,0x0
 860:	7c87a783          	lw	a5,1992(a5) # 1024 <num_levels>
 ...
 870:	f97d                	bnez	a0,866 <tournament_create+0x40>
 872:	00000797          	auipc	a5,0x0
 876:	7ae7a923          	sw	a4,1970(a5) # 1024 <num_levels>
   int total_locks = (1 << num_levels) -1 ;
 87a:	00000797          	auipc	a5,0x0
 87e:	7aa7a783          	lw	a5,1962(a5) # 1024 <num_levels>
 882:	4505                	li	a0,1
 884:	00f5153b          	sllw	a0,a0,a5
 888:	357d                	addiw	a0,a0,-1
   lock_ids = malloc(sizeof(int) * total_locks);
 88a:	0025151b          	slliw	a0,a0,0x2
 88e:	00000097          	auipc	ra,0x0
 892:	eb4080e7          	jalr	-332(ra) # 742 <malloc>
 896:	87aa                	mv	a5,a0
 898:	00000717          	auipc	a4,0x0
 89c:	78a73023          	sd	a0,1920(a4) # 1018 <lock_ids>
    return 1 ;    
 8a0:	4505                	li	a0,1
    if (!lock_ids)
 8a2:	dfd1                	beqz	a5,83e <tournament_create+0x18>
}
 8a4:	60a2                	ld	ra,8(sp)
 8a6:	6402                	ld	s0,0(sp)
...
00000000000008ac <tournament_acquire>:
...
00000000000008ba <tournament_release>:
